namespace qpoa.HumanResources
{
    ...
    public class WorkTime : Page
    {
        ...
        {
            base.Response.Redirect("WorkTime_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee5g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "eeee5g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee5g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee5g", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_WorkTime  ";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_WorkTime   " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_WorkTime   where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除上下班时间[" + this.CheckCbxNameDel() + "]", "上下班时间设置");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("WorkTime_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("WorkTime_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
