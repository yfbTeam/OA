namespace xyoa
{
    ...
    public class main_d : Page
    {
        ...
        public void BindList(string leixing)
        {
            ...
            string sql = string.Concat(new object[] { "select   * from qp_oa_AllUrl  as [A] inner join [qp_oa_DIYMould] as [B] on [A].[id] = [B].[KeyId] where (CHARINDEX(''+A.quanxian+'','", str, "')   >   0 ) and A.menhulm='1' and A.ParentNodesID!='0' and A.ifopen='1' and B.username='", this.Session["username"], "' order by B.paixun asc" });
            ...
            while (list.Read())
            {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], "  * from qp_oa_MakeListTing  where username='", this.Session["username"], "'  order by id desc" });
                ...
                {
                    num2 = 0;
                    str3 = "select top  " + (int.Parse(this.ViewState["LookMuch"].ToString()) * 3) + "  A.id,A.MoveTel,A.Name, B.[Name] as BuMenName,  D.[Name] as ZhiweiName from [qp_oa_CompanyGroup] as [A] inner join [qp_oa_Bumen] as [B] on [A].[BuMenId] = [B].[Id] inner join [qp_oa_Zhiwei] as [D] on [A].[Zhiweiid] = [D].[Id]";
                    reader2 = this.List.GetList(str3);
                ...
                {
                    num2 = 0;
                    str3 = string.Concat(new object[] { "select top  ", int.Parse(this.ViewState["LookMuch"].ToString()) * 3, " id,Name,Sex,BothDay,Post,CName from qp_oa_MyGroup where username='", this.Session["username"], "' order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\"><tr>";
                    while (reader2.Read())
                    {
                ...
                {
                    num2 = 0;
                    str3 = string.Concat(new object[] { "select top  ", int.Parse(this.ViewState["LookMuch"].ToString()) * 3, " id,Name,Sex,Post,CName from qp_oa_WBGroup where username='", this.Session["username"], "' order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\"><tr>";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " * from qp_oa_Paper where username='", this.Session["username"], "' order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " * from qp_oa_Quxian where CHARINDEX(','+Username+',',','+(select RyUsername from qp_oa_QuxianSz where ZgUsername='", this.Session["username"], "')+',') > 0 order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " id,titles,StartTime,EndTime,Username,Realname,Gongkai from qp_oa_MyRicheng where CHARINDEX(','+Username+',',','+(select Glusername from qp_oa_Richengsz where Username='", this.Session["username"], "')+',') > 0 order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " A.id,A.Name,A.MettingName,A.Starttime,A.Endtime,A.State from [qp_oa_MettingApply] as [A] where (State='2' or State='3'  or State='4' or State='5' ) and   CHARINDEX(',", this.Session["Username"], ",',','+NbPeopleUser+',')   >   0   order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " id,titles,StartTime,EndTime,Username,Gongkai from qp_oa_MyRicheng  where username='", this.Session["username"], "'  order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                if (list["urlname"].ToString() == "图片新闻")
                {
                    ...
                    string str6 = null;
                    int num3 = 0;
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " id,titles,Photo from qp_oa_TupianNew where (CHARINDEX(',", this.Session["BuMenId"], ",',','+ZdBumenId+',') > 0 and States='2') or (CHARINDEX(',", this.Session["username"], ",',','+ZdUsername+',') > 0 and States='3') or (States='1') order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " id,titles,Settime,Username,Realname,YdUsername from qp_oa_BumenNewsMg where (CHARINDEX(',", this.Session["BuMenId"], ",',','+ZdBumenId+',') > 0 and States='2') or (CHARINDEX(',", this.Session["username"], ",',','+ZdUsername+',') > 0 and States='3') or (States='1') order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = "select top  " + this.ViewState["LookMuch"] + " id,titles,Settime,Realname,Username from qp_oa_NewsMg  order by id desc";
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = "select top  " + this.ViewState["LookMuch"] + " id,titles from qp_oa_ComThingMg   order by id desc";
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top ", this.ViewState["LookMuch"], " A.id,A.Titles,A.Settime,A.username,A.Realname from [qp_oa_ZhiduMg] as [A] join [qp_oa_ZhiduLx] as [C] on [A].[TypeId] = [C].id  and   ((CHARINDEX(',", this.Session["BuMenId"], ",',','+[C].ZdBumenId+',') > 0 and [C].States='2') or (CHARINDEX(',", this.Session["username"], ",',','+[C].ZdUsername+',') > 0 and [C].States='3') or ([C].States='1')) order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top ", this.ViewState["LookMuch"], " A.id,A.Titles,A.Settime,A.username,A.Realname from [qp_oa_ShipinMg] as [A] join [qp_oa_ShipinLx] as [C] on [A].[TypeId] = [C].id  and   ((CHARINDEX(',", this.Session["BuMenId"], ",',','+[C].ZdBumenId+',') > 0 and [C].States='2') or (CHARINDEX(',", this.Session["username"], ",',','+[C].ZdUsername+',') > 0 and [C].States='3') or ([C].States='1')) order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top ", this.ViewState["LookMuch"], " * from [qp_oa_MettingApply] as [A]  where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0  and (LcZhuangtai='1' or LcZhuangtai='2')  order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], "  A.*, C.CarName from [qp_oa_CarApply] as [A] join [qp_oa_CarInfo] as [C] on [A].[CarId] = [C].id where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2')   order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top ", this.ViewState["LookMuch"], " A.id,A.Biaoti,A.Leixing,A.StartTime,A.EndTime,A.Youxian,A.DqState,A.SetTimes,A.Username,A.Realname, B.[Leixing] as LeixingName from [qp_oa_MyPlan] as [A] inner join [qp_oa_MyPlanLx] as [B] on [A].[Leixing] = [B].[Id]  where 1=1 and Username='", this.Session["Username"], "' order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top ", this.ViewState["LookMuch"], " A.id,A.titles,A.NowTimes,A.Username,A.Realname,A.LeiBie, B.[name] as LeiBieName from [qp_oa_MyRizhi] as [A] inner join [qp_oa_RizhiLx] as [B] on [A].[LeiBie] = [B].[Id]  where username='", this.Session["username"], "' order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top ", this.ViewState["LookMuch"], " A.id,A.titles,A.NowTimes,A.Username,A.Realname,A.LeiBie, B.[name] as LeiBieName from [qp_oa_MyRizhi] as [A] inner join [qp_oa_RizhiLx] as [B] on [A].[LeiBie] = [B].[Id]  where CHARINDEX(','+Username+',',','+(select RyUsername from qp_oa_Rizhisz where ZgUsername='", this.Session["username"], "')+',') > 0 order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top ", this.ViewState["LookMuch"], " A.WcTime,A.Benbi,A.id,A.titles,A.Starttime,A.Endtime,A.ZbUsername,A.ZbRealname,A.Leixing,A.Benbi,A.State,A.Username,A.Realname,A.SetTime, B.[name] as LeiBieName from [qp_oa_Renwu] as [A] inner join [qp_oa_RenwuLx] as [B] on [A].[Leixing] = [B].[Id]  where (ZbUsername='", this.Session["username"], "' or (CHARINDEX(',", this.Session["username"], ",',','+JbUsername+',')   >   0 )) order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], "  * from qp_oa_Messages  where  sfck='0' and  acceptusername='", this.Session["username"], "' and tablekey='1'  order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], "  id,Titles,IfRead,FsUsername,FsRealname,FsTime  from qp_oa_NbEmail_sj  where IfDel='0' and  JsUsername='", this.Session["username"], "'  order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " * from qp_oa_InfoSend where CHARINDEX(',", this.Session["username"], ",',','+JsUsername+',') > 0 order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top ", this.ViewState["LookMuch"], " A.* from [qp_oa_shouji] as [A]  where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2') order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top ", this.ViewState["LookMuch"], " A.id,A.Titles,A.TxTime,A.Username,A.TxRealname, C.Name from [qp_oa_YjBox] as [A] join [qp_oa_YjBoxSz] as [C] on [A].[BoxId] = [C].id and CHARINDEX('", this.Session["username"], ",',C.Username) > 0 where  CHARINDEX(',", this.Session["username"], ",',','+YdUsername+',')   =0 order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " *  from qp_oa_toupiaobt  where (type='1' or type='2') and  (CHARINDEX(',", this.Session["Username"], ",',','+Gkusername+',')   >   0 or Gkusername='0')  order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    num2 = 0;
                    str3 = string.Concat(new object[] { "select top  ", int.Parse(this.ViewState["LookMuch"].ToString()) * 3, "  id,Name  from qp_oa_InsideBBSBig  where ((CHARINDEX(',", this.Session["BuMenId"], ",',','+ZdBumenId+',') > 0 and States='2') or (CHARINDEX(',", this.Session["username"], ",',','+ZdUsername+',') > 0 and States='3') or (States='1')) and Zhuangtai=1  order by Paixun asc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\"><tr>";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " id,Titles,Realname,Username,State,TxTime from qp_oa_QingShi  where JsUsername='", this.Session["username"], "'  order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    num2 = 0;
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " A.id,A.shuliang,A.Laiyuan,C.ZyNum, C.ZyName, D.Name as ZyLeibieName from [qp_oa_MyRes] as [A] inner join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id inner join [qp_oa_ResourcesType] as [D] on [C].[ZyLeibie] = [D].id where username='", this.Session["username"], "'   order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\"><tr>";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " A.*, C.ZyName, C.ZyNum from [qp_oa_ResGm] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2')  order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " A.*, C.ZyName, C.ZyNum from [qp_oa_ResBf] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2')  order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " A.*, C.ZyName, C.ZyNum from [qp_oa_ResAppJy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2')  order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " A.*, C.ZyName, C.ZyNum from [qp_oa_ResAppSy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2')  order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " A.*, C.ZyName, C.ZyNum from [qp_oa_ResWx] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2')  order by A.id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " A.JinJiChengDu,A.id,A.Shuxing,A.Number,A.Sequence,A.FormName,A.Name,A.FlowNumber,A.FqUsername,A.FqRealname,A.NodeName,A.UpNodeName,A.UpNodeId,A.FormId from [qp_oa_AddWorkFlow] as [A] inner join [qp_oa_AddWorkFlowPicRy] as [C] on [A].[Number] = [C].KeyFile and [A].[UpNodeNum] = [C].xuhao and [A].[GlNum] = [C].GlNum where BLusername='", this.Session["username"], "' and ((States='未接收' and State='正在办理') or (States='办理中' and State='正在办理')) and Ifdel='0' order by A.UpTimeSet desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    num2 = 0;
                    str3 = "select " + (int.Parse(this.ViewState["LookMuch"].ToString()) * 4) + " id,Xingming  from [qp_hr_Yuangong] order by Xingming asc";
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\"><tr>";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " from [qp_hr_MyAttendance]  where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2') and type='1' order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " from [qp_hr_MyAttendance]  where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2') and type='2' order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
                ...
                {
                    str3 = string.Concat(new object[] { "select top  ", this.ViewState["LookMuch"], " from [qp_hr_MyAttendance]  where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2') and type='3' order by id desc" });
                    reader2 = this.List.GetList(str3);
                    str4 = str4 + "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
                    while (reader2.Read())
                    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!base.IsPostBack)
                {
                    ...
                    this.daibanshiyi.Text = "<table width=\"247\" border=\"0\" cellspacing=\"0\" cellpadding=\"1\"><tr>";
                    int num = 0;
                    ...
                    while (list.Read())
                    {
                        ...
                        try
                        {
                            if (int.Parse(this.pulicss.Daibanshiyi(list["Name"].ToString())) > 0)
                            {
                                ...
                                this.daibanshiyi.Text = text + "<td align=\"center\" height=\"30\" width=\"15\" background=\"oaimg/zst/dd.jpg\"><img src=\"oaimg/news.gif\" width=\"15\" height=\"10\"></td><td background=\"oaimg/zst/dd.jpg\" width=\"232\"><a href='" + list["Url"].ToString() + "' onclick='parent.UploadComplete();'><font  color=\"blue\">" + list["Name"].ToString() + "</font></a>（<a href='" + list["Url"].ToString() + "' onclick='parent.UploadComplete();'><font  color=\"blue\">" + this.pulicss.Daibanshiyi(list["Name"].ToString()) + "</font></a>）</td>";
                            }
                            else
                            {
                                text = this.daibanshiyi.Text;
                                this.daibanshiyi.Text = text + "<td align=\"center\" height=\"30\" width=\"15\" background=\"oaimg/zst/dd.jpg\"><img src=\"oaimg/news.gif\" width=\"15\" height=\"10\"></td><td background=\"oaimg/zst/dd.jpg\" width=\"232\"><a href='" + list["Url"].ToString() + "' onclick='parent.UploadComplete();'><font  color=\"#000000\">" + list["Name"].ToString() + "</font></a>（<a href='" + list["Url"].ToString() + "' onclick='parent.UploadComplete();'><font  color=\"#000000\">" + this.pulicss.Daibanshiyi(list["Name"].ToString()) + "</font></a>）</td>";
                            }
                        }
                        catch
                        {
                    ...
                    list.Close();
                    string str2 = "select count(id) from qp_oa_username where onlinetime>(select onlinetime from qp_oa_username where username='" + this.Session["username"] + "')";
                    this.ViewState["count"] = this.List.GetCount(str2) + 1;
                    string str3 = "select jifen,BuMenId,lasttime from qp_oa_username where Username='" + this.Session["username"] + "'";
                    SqlDataReader reader2 = this.List.GetList(str3);
                    if (reader2.Read())
                    {
                        this.ViewState["lasttime"] = reader2["lasttime"].ToString();
                        this.ViewState["BuMen"] = this.pulicss.TypeCode("qp_oa_Bumen", reader2["BuMenId"].ToString());
                        ...
                        if (reader3.Read())
                        {
                            this.ViewState["zhishitang"] = "<img src=\"/InfoManage/zhiao/img/d_" + reader3["dengji"].ToString() + ".gif\"  alt=\"积" + reader2["jifen"].ToString() + "分\" border=0/>，共积分：" + reader2["jifen"].ToString() + "";
                        }
                        reader3.Close();
                    }
                    reader2.Close();
                    string str5 = "select * from qp_oa_MakeTing where username='" + this.Session["username"] + "'";
                    SqlDataReader reader4 = this.List.GetList(str5);
                    if (reader4.Read())
                    {
                        this.BYcontent = reader4["content"].ToString();
                    }
                    reader4.Close();
                    Utility.RegisterTypeForAjax(typeof(AjaxMethod));
                    string leixing = null;
                    leixing = leixing + "0";
                    string str7 = "select * from qp_oa_DIYMould where username='" + this.Session["username"] + "'";
                    SqlDataReader reader5 = this.List.GetList(str7);
                    if (reader5.Read())
                    {
                        this.ViewState["LookMuch"] = reader5["LookMuch"].ToString();
                    }
                    else
                    {
                        this.ViewState["LookMuch"] = "4";
                    }
                    reader5.Close();
                    this.BindList(leixing);
                }
                base.Response.Write("<!--\n当前是合法使用单位。\n-->");
            }
        }
