namespace xyoa.OfficeMenu.WorkPlan
{
    ...
    public class MyPlanSz : Page
    {
        ...
        {
            base.Response.Redirect("MyPlanSz_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk5e", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk5e", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk5e", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "kkkk5e", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_MyPlanSz";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select id,ZgRealname,RyRealname from qp_oa_MyPlanSz " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_MyPlanSz  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除监控设置", "工作计划监控设置");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("MyPlanSz_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
