namespace xyoa.OfficeMenu.WorkPlan
{
    ...
    public class MyPlanJk_show : Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            {
                base.Response.Redirect("MyPlanJk_list.aspx");
            }
        }

        protected void Button2_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("MyPlanGx_update.aspx?id=" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "");
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                {
                    base.Response.Write("<script language=javascript>alert('未找到相关数据！');window.location.href='MyPlanJk_list.aspx'</script>");
                }
                list.Close();
                this.DataBindToGridview();
