namespace xyoa.OfficeMenu.WorkPlan
{
    ...
    public class MyPlanSz_update : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string str = "select * from qp_oa_MyPlanSz where ZgUsername='" + this.pulicss.GetFormatStr(this.ZgUsername.Text) + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = "select * from qp_oa_MyPlanSz  where id='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "' ";
