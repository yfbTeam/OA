namespace xyoa.OfficeMenu.WorkPlan
{
    ...
    public class MyPlanGx_show : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = string.Concat(new object[] { "select * from qp_oa_MyPlan  where id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "' and ((CHARINDEX(',", this.Session["username"], ",',','+SharingUserZd+',')   >   0  and Sharing=2) or (CHARINDEX(',", this.Session["username"], ",',','+SharingUserKx+',')   >   0  and Sharing=2)) " });
                ...
                if (list.Read())
                {
                    ...
                    string str2 = "," + list["SharingUserKx"].ToString() + ",";
                    string str3 = "," + this.Session["username"] + ",";
