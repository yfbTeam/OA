namespace xyoa.OfficeMenu.WorkPlan
{
    ...
    public class MyPlanLx : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.Button2, "kkkk5d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.Button3, "kkkk5d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk5d", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_MyPlanLx where 1=1";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_MyPlanLx where 1=1 " + Sqlsort + "";
        ...
        {
            base.Response.Redirect("MyPlanLx_add.aspx");
        }

        protected void ImageButton2_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("MyPlanLx_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void ImageButton3_Click(object sender, EventArgs e)
        {
            string str = this.CheckCbxDel();
            string sql = "  Delete from qp_oa_MyPlanLx  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除工作计划类型[" + this.CheckCbxNameDel() + "]", "工作计划类型");
            this.DataBindToGridview(this.SortText.Value);
        }
