namespace xyoa.OfficeMenu.Metting
{
    ...
    public class MettingApply_sp : Page
    {
        ...
        {
            base.Response.Redirect("MettingApply_sp_fb.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk2ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "kkkk2bc", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_oa_MettingApply] as [A]  where CHARINDEX('," + this.Session["username"] + ",',','+DqBlUsername+',')   >0  and (LcZhuangtai='1' or LcZhuangtai='2') ";
            string str2 = "select count(id) from qp_oa_MettingApply where  CHARINDEX('," + this.Session["username"] + ",',','+DqBlUsername+',')   >0  and (LcZhuangtai='1' or LcZhuangtai='2')";
