namespace xyoa.OfficeMenu.Metting
{
    ...
    public class MettingApply_ysp : Page
    {
        ...
        {
            base.Response.Redirect("MettingApply_ysp.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_oa_MettingApply] as [A]  where  CHARINDEX('," + this.Session["username"] + ",',','+YjbUser+',')   >0 ";
            string str2 = "select count(id) from qp_oa_MettingApply where  CHARINDEX('," + this.Session["username"] + ",',','+YjbUser+',')   >0 ";
