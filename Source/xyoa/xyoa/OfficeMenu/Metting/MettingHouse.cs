namespace xyoa.OfficeMenu.Metting
{
    ...
    public class MettingHouse : Page
    {
        ...
        {
            base.Response.Redirect("MettingHouse_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk2fa", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk2fc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "kkkk2fb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk2fd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,Name,PeopleNum,Equipment,Introduction,Address from qp_oa_MettingHouse where 1=1";
            string str2 = "select count(id) from qp_oa_MettingHouse where  1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_MettingHouse  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除会议室管理 ", "会议室管理 ");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("MettingHouse_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("MettingHouse_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
