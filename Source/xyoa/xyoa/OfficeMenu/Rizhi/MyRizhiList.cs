namespace xyoa.OfficeMenu.Rizhi
{
    ...
    public class MyRizhiList : Page
    {
        ...
        public void Bindquanxian()
        {
            ...
            this.pulicss.QuanXianVis(this.ShowData, "kkkk6ab", this.Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.id,A.titles,A.NowTimes,A.Username,A.Realname,A.LeiBie, B.[name] as LeiBieName from [qp_oa_MyRizhi] as [A] inner join [qp_oa_RizhiLx] as [B] on [A].[LeiBie] = [B].[Id]  where username='" + this.Session["username"] + "'";
            string str2 = "select count(A.id) from [qp_oa_MyRizhi] as [A] inner join [qp_oa_RizhiLx] as [B] on [A].[LeiBie] = [B].[Id]  where username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_MyRizhi  where ID in (" + str + ")";
        ...
        {
            base.Response.Redirect("MyRizhi_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("MyRizhi_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
