namespace xyoa.OfficeMenu.Car
{
    ...
    public class CarType : Page
    {
        ...
        {
            base.Response.Redirect("CarType_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk3j", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk3j", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk3j", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_CarType ";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_CarType " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_CarType  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除车辆类型", "车辆类型");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("CarType_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
