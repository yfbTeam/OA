namespace xyoa.OfficeMenu.Car
{
    ...
    public class CarReques : Page
    {
        ...
        {
            base.Response.Redirect("CarReques_add.aspx");
        }

        public void BindAttribute()
        {
            this.PersonName.Attributes["onkeydown"] = "if (event.keyCode==13) { document.all.SearchData.click(); return false;}";
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk3ea", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk3ec", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "kkkk3eb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk3ed", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,CarName,FsAddress,FsTimes,PersonName from qp_oa_CarReques where  1=1 ";
            string str2 = "select count(id) from qp_oa_CarReques where  1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_CarReques  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除车辆事故 ", "车辆事故管理 ");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("CarReques_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("CarReques_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
