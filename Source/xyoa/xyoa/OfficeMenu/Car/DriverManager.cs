namespace xyoa.OfficeMenu.Car
{
    ...
    public class DriverManager : Page
    {
        ...
        {
            base.Response.Redirect("DriverManager_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk3ha", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk3hc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk3hd", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "kkkk3hb", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            if (this.titles.Text != "")
            {
                str = str + " and Realname like '%" + this.pulicss.GetFormatStr(this.titles.Text) + "%'";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_DriverManager  where 1=1";
            string str2 = "select count(id) from qp_oa_DriverManager where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_DriverManager  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除驾驶员管理", "驾驶员管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("DriverManager_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
