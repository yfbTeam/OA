namespace xyoa.OfficeMenu.Car
{
    ...
    public class CarFyType_add : Page
    {
        ...
        {
            string sql = "insert into qp_oa_CarFyType (Name) values ('" + this.pulicss.GetFormatStr(this.Name.Text) + "')";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("新增费用类型", "费用类型");
