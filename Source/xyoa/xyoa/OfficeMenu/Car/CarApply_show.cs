namespace xyoa.OfficeMenu.Car
{
    ...
    public class CarApply_show : Page
    {
        ...
        protected Label GhBeizhu;
        protected Label GhShijian;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                if (list.Read())
                {
                    ...
                    if (this.State.Text == "已结束")
                    {
                        this.GhShijian.Text = list["GhShijian"].ToString();
                        this.Miles.Text = list["Miles"].ToString();
                        this.GhBeizhu.Text = list["GhBeizhu"].ToString();
                    }
                    else
                    {
                        this.GhShijian.Text = "未结束使用";
                        this.Miles.Text = "未结束使用";
                        this.GhBeizhu.Text = "未结束使用";
                    }
                }
                list.Close();
