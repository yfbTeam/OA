namespace xyoa.OfficeMenu.Car
{
    ...
    public class CarFyType : Page
    {
        ...
        {
            base.Response.Redirect("CarFyType_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk3k", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk3k", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk3k", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_CarFyType ";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_CarFyType " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_CarFyType  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除费用类型", "费用类型");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("CarFyType_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
