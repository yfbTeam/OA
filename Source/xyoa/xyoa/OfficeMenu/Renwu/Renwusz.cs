namespace xyoa.OfficeMenu.Renwu
{
    ...
    public class Renwusz : Page
    {
        ...
        {
            base.Response.Redirect("Renwusz_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk7e", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk7e", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk7e", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "kkkk7e", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_Renwusz";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select id,ZgRealname,RyRealname from qp_oa_Renwusz " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_Renwusz  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除领导设置", "领导设置");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("Renwusz_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
