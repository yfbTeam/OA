namespace xyoa.OfficeMenu.Renwu
{
    ...
    public class Renwusz_update : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string str = "select * from qp_oa_Renwusz where ZgUsername='" + this.pulicss.GetFormatStr(this.ZgUsername.Text) + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = "select * from qp_oa_Renwusz  where id='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "' ";
