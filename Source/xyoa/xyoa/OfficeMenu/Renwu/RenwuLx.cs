namespace xyoa.OfficeMenu.Renwu
{
    ...
    public class RenwuLx : Page
    {
        ...
        {
            base.Response.Redirect("RenwuLx_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk7f", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk7f", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk7f", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string str = "select count(id) from qp_oa_RenwuLx where  1=1";
            string sql = "select * from qp_oa_RenwuLx where 1=1";
            this.GridView1.DataSource = this.List.GetGrid_Pages_not(sql);
            this.GridView1.DataBind();
            string str3 = str;
            this.CountsLabel.Text = "" + this.List.GetCount(str3) + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_RenwuLx  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除任务类型[" + this.CheckCbxNameDel() + "]", "任务类型");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("RenwuLx_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("RenwuLx_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
