namespace xyoa.MyWork.Renwu
{
    ...
    public class RenwuBz : Page
    {
        ...
        {
            base.Response.Redirect("RenwuBz_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhh3ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh3bc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "hhhh3bb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh3bd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,Starttime,Endtime,ZbRealname,State,ZbUsername from qp_oa_Renwu where username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_Renwu where username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            this.pulicss.InsertLog("删除任务", "任务布置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("RenwuBz_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("RenwuBz_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
