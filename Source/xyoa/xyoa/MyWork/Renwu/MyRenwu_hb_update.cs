namespace xyoa.MyWork.Renwu
{
    ...
    public class MyRenwu_hb_update : Page
    {
        ...
        {
            string sql = string.Concat(new object[] { "Update qp_oa_RenwuHb  Set  content='", this.pulicss.GetFormatStr(this.content.Text), "'  where id='", int.Parse(base.Request.QueryString["id"]), "' " });
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("修改任务汇报", "任务汇报");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = "select * from qp_oa_RenwuHb  where id='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "' ";
