namespace xyoa.MyWork.Renwu
{
    ...
    public class Renwumg : Page
    {
        ...
        {
            base.Response.Redirect("Renwumg_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.DelData, "hhhh3cd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,Starttime,Endtime,ZbRealname,State,ZbUsername,Username,Realname from qp_oa_Renwu where (CHARINDEX('," + this.Session["username"] + ",',','+Jkusername+',') > 0)";
            string str2 = "select count(id) from qp_oa_Renwu where (CHARINDEX('," + this.Session["username"] + ",',','+Jkusername+',') > 0)";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            this.pulicss.InsertLog("删除任务", "任务管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("Renwumg_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("Renwumg_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
