namespace xyoa.MyWork.Renwu
{
    ...
    public class MyRenwuXb : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,Starttime,Endtime,Realname,State,Username,ZbUsername,ZbRealname from qp_oa_Renwu where ( CHARINDEX('," + this.Session["username"] + ",',','+JbUsername+',')   >   0 )";
            string str2 = "select count(id) from qp_oa_Renwu where ( CHARINDEX('," + this.Session["username"] + ",',','+JbUsername+',')   >   0 )";
