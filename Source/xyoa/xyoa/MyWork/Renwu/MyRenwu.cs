namespace xyoa.MyWork.Renwu
{
    ...
    public class MyRenwu : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,Starttime,Endtime,Realname,State,Username,ZbUsername from qp_oa_Renwu where ZbUsername='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_Renwu where ZbUsername='" + this.Session["username"] + "'";
