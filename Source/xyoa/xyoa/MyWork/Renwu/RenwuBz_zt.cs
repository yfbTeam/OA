namespace xyoa.MyWork.Renwu
{
    ...
    public class RenwuBz_zt : Page
    {
        ...
        {
            string sql = string.Concat(new object[] { "Update qp_oa_Renwu  Set  State='", this.State.SelectedValue, "'  where id='", int.Parse(base.Request.QueryString["id"]), "'  and username='", this.Session["username"], "'  " });
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("修改状态", "任务布置");
