namespace xyoa.MyWork.YinZhang
{
    ...
    public class MyYinZhang : Page
    {
        ...
        {
            base.Response.Redirect("MyYinZhang_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhhb1a", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhhb1c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "hhhhb1b", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhhb1d", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_YinZhang  where Username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_YinZhang where  Username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_YinZhang  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除印章[" + this.CheckCbxNameDel() + "]", "我的印章");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("MyYinZhang_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("MyYinZhang_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
