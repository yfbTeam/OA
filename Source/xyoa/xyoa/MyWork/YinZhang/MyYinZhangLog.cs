namespace xyoa.MyWork.YinZhang
{
    ...
    public class MyYinZhangLog : Page
    {
        ...
        protected TextBox MkName;
        protected TextBox Name;
        private publics pulicss = new publics();
        protected Button SearchData;
        protected HtmlInputHidden SortText;
        protected TextBox Usetime;
        ...
        {
            this.pulicss.QuanXianVis(this.DelData, "hhhhb2", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("MyYinZhangLog.aspx");
        }
        ...
        public string CreateMidSql()
        {
            ...
            if (this.MkName.Text != "")
            {
                str = str + " and MkName like '%" + this.pulicss.GetFormatStr(this.MkName.Text) + "%'";
            }
            if (this.Usetime.Text != "")
            {
                str = str + " and convert(char(10),cast(Usetime as datetime),120)=convert(char(10),cast('" + this.pulicss.GetFormatStr(this.Usetime.Text) + "' as datetime),120) ";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_SealUseLog   where Username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_SealUseLog  where  Username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_SealUseLog   where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除印章使用记录", "印章使用记录");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
