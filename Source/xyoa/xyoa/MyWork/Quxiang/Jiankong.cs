namespace xyoa.MyWork.Quxiang
{
    ...
    public class Jiankong : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "hhhhc2", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("Jiankong.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_Quxian  where CHARINDEX(','+Username+',',','+(select RyUsername from qp_oa_QuxianSz where ZgUsername='" + this.Session["username"] + "')+',') > 0";
            string str2 = "select count(id) from qp_oa_Quxian where CHARINDEX(','+Username+',',','+(select RyUsername from qp_oa_QuxianSz where ZgUsername='" + this.Session["username"] + "')+',') > 0";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sQL = "select username, Realname  from qp_oa_username  where 1=1 and ifdel='0' and CHARINDEX(','+Username+',',','+(select RyUsername from qp_oa_QuxianSz where ZgUsername='" + this.Session["username"] + "')+',') > 0";
