namespace xyoa.MyWork.Quxiang
{
    ...
    public class QuxianSz : Page
    {
        ...
        {
            base.Response.Redirect("QuxianSz_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhhc3", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhhc3", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhhc3", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "hhhhc3", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_QuxianSz";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select id,ZgRealname,RyRealname from qp_oa_QuxianSz " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_QuxianSz  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除监控设置", "人员去向监控设置");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("QuxianSz_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
