namespace xyoa.MyWork.Quxiang
{
    ...
    public class MyQuxiang : Page
    {
        ...
        {
            base.Response.Redirect("Quxian_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhhc1", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhhc1", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhhc1", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_Quxian  where Username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_Quxian where Username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_Quxian  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除人员去向", "我的去向");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                if (list.Read() && (list["Leixing"].ToString() == "3"))
                {
                    this.FONT1.Visible = false;
                }
                list.Close();
            }
        }
        ...
        {
            base.Response.Redirect("Quxian_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
