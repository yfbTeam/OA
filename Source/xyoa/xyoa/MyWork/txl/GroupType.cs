namespace xyoa.MyWork.txl
{
    ...
    public class GroupType : Page
    {
        ...
        {
            base.Response.Redirect("GroupType_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhh5d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh5d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh5d", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_GroupType where username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_GroupType where  username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_GroupType  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除通讯录类别[" + this.CheckCbxNameDel() + "]", "通讯录类别");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("GroupType_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("GroupType_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
