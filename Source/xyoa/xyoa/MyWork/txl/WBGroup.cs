namespace xyoa.MyWork.txl
{
    ...
    public class WBGroup : Page
    {
        ...
        {
            base.Response.Redirect("WBGroup_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.Button3, "hhhh5ca", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.AddData, "hhhh5ca", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh5cc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "hhhh5cb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh5cd", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("WBGroup_dr.aspx");
        }
        ...
        public string CreateMidSql()
        {
            ...
            if (this.CName.Text != "")
            {
                str = str + " and CName like '%" + this.CName.Text + "%'";
            }
            if (this.HMoveTel.Text != "")
            {
                str = str + " and HMoveTel like '%" + this.HMoveTel.Text + "%'";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,Name,Sex,Post,CName,HMoveTel from qp_oa_WBGroup where 1=1";
            string str2 = "select count(id) from qp_oa_WBGroup where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_WBGroup  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除外部通讯录[" + this.CheckCbxNameDel() + "]", "外部通讯录");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("WBGroup_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("WBGroup_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
