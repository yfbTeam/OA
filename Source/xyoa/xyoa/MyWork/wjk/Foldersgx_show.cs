namespace xyoa.MyWork.wjk
{
    ...
    public class Foldersgx_show : Page
    {
        ...
        {
            base.Response.Redirect("Foldersgx_show.aspx?id=" + base.Request.QueryString["id"] + "");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_Paper where 1=1 and FoldersID='" + base.Request.QueryString["id"] + "'";
            string str2 = "select count(id) from qp_oa_Paper where 1=1 and FoldersID='" + base.Request.QueryString["id"] + "'";
