namespace xyoa.MyWork.MySet
{
    ...
    public class MyWebsite : Page
    {
        ...
        {
            base.Response.Redirect("MyWebsite_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhh9n", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh9n", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh9n", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_MyWebsite where username='" + this.Session["username"] + "'";
            string str2 = string.Concat(new object[] { "select * from qp_oa_MyWebsite where username='", this.Session["username"], "' ", Sqlsort, "" });
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_MyWebsite  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除常用网址", "常用网址");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("MyWebsite_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
