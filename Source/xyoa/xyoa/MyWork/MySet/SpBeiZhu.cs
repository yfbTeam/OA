namespace xyoa.MyWork.MySet
{
    ...
    public class SpBeiZhu : Page
    {
        ...
        {
            base.Response.Redirect("SpBeiZhu_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhh9g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh9g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh9g", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_SpBeiZhu  where username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_SpBeiZhu where username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_SpBeiZhu  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除常用评语", "常用评语");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("SpBeiZhu_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
