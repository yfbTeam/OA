namespace xyoa.MyWork.MySet
{
    ...
    public class Emailprv : Page
    {
        ...
        {
            base.Response.Redirect("Emailprv_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "aaaab1", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "aaaab1", this.Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_Emailprv where username='" + this.Session["username"] + "'";
            string str2 = string.Concat(new object[] { "select * from qp_oa_Emailprv  where username='", this.Session["username"], "' ", Sqlsort, "" });
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_Emailprv  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除邮件参数", "邮件参数设置");
            this.DataBindToGridview("order by id desc");
        }
        ...
        {
            base.Response.Redirect("Emailprv_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
