namespace xyoa.MyWork.MySet
{
    ...
    public class MyUserList : Page
    {
        ...
        {
            base.Response.Redirect("MyUserList_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhh9e", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh9e", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh9e", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_MyUserList where Username='" + this.Session["username"] + "'";
            string str2 = string.Concat(new object[] { "select * from qp_oa_MyUserList where Username='", this.Session["username"], "'", Sqlsort, "" });
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_MyUserList  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除自定义用户组", "自定义用户组");
            this.DataBindToGridview("order by Paixun asc");
        }
        ...
        {
            base.Response.Redirect("MyUserList_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
