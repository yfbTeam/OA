namespace xyoa.MyWork.MySet
{
    ...
    public class OftenModleType : Page
    {
        ...
        {
            base.Response.Redirect("OftenModleType_add.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_OftenModleType where username='" + this.Session["username"] + "'";
            string str2 = string.Concat(new object[] { "select * from qp_oa_OftenModleType  where username='", this.Session["username"], "' ", Sqlsort, "" });
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_OftenModleType  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除常用模版类别", "常用模版类别");
            this.DataBindToGridview("order by id asc");
        }
        ...
        {
            base.Response.Redirect("OftenModleType_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
