namespace xyoa.MyWork.MySet
{
    ...
    public class OftenModle : Page
    {
        ...
        {
            base.Response.Redirect("OftenModle_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhh9h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh9h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh9h", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and typeid = '" + this.Types.SelectedValue + "'";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_OftenModle  where username='" + this.Session["username"] + "' ";
            string str2 = "select count(id) from  qp_oa_OftenModle where username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_OftenModle  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除常用模版", "常用模版设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sQL = "select id,Name from  qp_oa_OftenModleType where username='" + this.Session["username"] + "' ";
                this.list.Bind_DropDownList_kong(this.Types, sQL, "id", "Name");
                this.BindAttribute();
                this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
                this.Bindquanxian();
            }
        ...
        {
            base.Response.Redirect("OftenModle_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
