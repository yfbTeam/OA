namespace xyoa.MyWork.Richeng
{
    ...
    public class Richengjk_show : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = string.Concat(new object[] { "select * from qp_oa_MyRicheng  where id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "' and CHARINDEX(','+Username+',',','+(select Glusername from qp_oa_Richengsz where Username='", this.Session["username"], "')+',') > 0 " });
