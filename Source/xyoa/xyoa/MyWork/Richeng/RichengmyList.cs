namespace xyoa.MyWork.Richeng
{
    ...
    public class RichengmyList : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhh8aaa", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh8aac", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "hhhh8aab", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh8aad", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("RichengmyList.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,StartTime,EndTime,Username,Gongkai from qp_oa_MyRicheng  where username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_MyRicheng where username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_MyRicheng  where ID in (" + str + ")";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                {
                    this.StartTime.Text = base.Request.QueryString["StartTime"].ToString();
                }
                this.BindAttribute();
                this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
                this.Bindquanxian();
        ...
        {
            base.Response.Redirect("RichengmyList_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("RichengmyList_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
