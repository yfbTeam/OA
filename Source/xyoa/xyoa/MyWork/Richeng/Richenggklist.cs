namespace xyoa.MyWork.Richeng
{
    ...
    public class Richenggklist : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.ShowData, "hhhh8d", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("Richenggklist.aspx");
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and Username = '" + this.Username.Text + "'";
            }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,StartTime,EndTime,Username,Realname from qp_oa_MyRicheng  where Gongkai='是'";
            string str2 = "select count(id) from qp_oa_MyRicheng where Gongkai='是'";
        ...
        {
            base.Response.Redirect("Richenggk_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
