namespace xyoa.MyWork.Richeng
{
    ...
    public class RichengXbZhou : Page
    {
        ...
        public void BindList()
        {
            ...
            string str3 = null;
            string str4 = "select id,titles,StartTime,Realname,username,EndTime from qp_oa_MyRicheng where  (CHARINDEX('," + this.Session["username"] + ",',','+XbUsername+',') > 0) and ";
            ...
            for (int i = 0; i < 0x18; i++)
            {
                ...
                for (int j = 0; j < 7; j++)
                {
                    ...
                    string str14 = null;
                    string str15 = string.Concat(new object[] { "select id,titles,StartTime,Realname,username,EndTime from qp_oa_MyRicheng  where (CHARINDEX(',", this.Session["username"], ",',','+XbUsername+',') > 0) and datediff(hh,StartTime,'", str13, "')=0 and datediff(hh,EndTime,'", str13, "')=0" });
