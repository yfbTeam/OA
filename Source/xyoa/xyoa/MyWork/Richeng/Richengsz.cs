namespace xyoa.MyWork.Richeng
{
    ...
    public class Richengsz : Page
    {
        ...
        {
            base.Response.Redirect("Richengsz_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhh8e2", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh8e2", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh8e2", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_Richengsz ";
            string str2 = "select * from qp_oa_Richengsz " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_Richengsz  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除监控设置", "日程监控设置");
            this.DataBindToGridview("order by id asc");
        }
        ...
        {
            base.Response.Redirect("Richengsz_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
