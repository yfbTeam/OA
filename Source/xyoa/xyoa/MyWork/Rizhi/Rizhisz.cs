namespace xyoa.MyWork.Rizhi
{
    ...
    public class Rizhisz : Page
    {
        ...
        {
            base.Response.Redirect("Rizhisz_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk6c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk6c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk6c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "kkkk6c", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_Rizhisz";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select id,ZgRealname,RyRealname from qp_oa_Rizhisz " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_Rizhisz  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除日志设置", "日志设置");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("Rizhisz_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
