namespace xyoa.MyWork.Rizhi
{
    ...
    public class RizhiLx : Page
    {
        ...
        {
            base.Response.Redirect("RizhiLx_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "kkkk6d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "kkkk6d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "kkkk6d", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string str = "select count(id) from qp_oa_RizhiLx where  1=1";
            string sql = "select * from qp_oa_RizhiLx where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_RizhiLx  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除日志类型[" + this.CheckCbxNameDel() + "]", "日志类型");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("RizhiLx_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("RizhiLx_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
