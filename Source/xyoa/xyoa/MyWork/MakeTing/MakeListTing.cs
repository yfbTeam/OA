namespace xyoa.MyWork.MakeTing
{
    ...
    public class MakeListTing : Page
    {
        ...
        {
            base.Response.Redirect("MakeListTing_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "hhhh2b", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "hhhh2b", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "hhhh2b", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            if (this.titles.Text != "")
            {
                str = str + " and Content like '%" + this.pulicss.GetFormatStr(this.titles.Text) + "%'";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_MakeListTing  where username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_MakeListTing where username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_MakeListTing  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除便签管理", "便签管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("MakeListTing_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
