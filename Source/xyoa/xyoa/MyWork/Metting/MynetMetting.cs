namespace xyoa.MyWork.Metting
{
    ...
    public class MynetMetting : Page
    {
        ...
        {
            base.Response.Redirect("MynetMetting.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.id,A.Name,A.MettingIp,A.Starttime,A.Endtime,A.State,A.MettingHeader,A.MettingHeaderUser, C.CodeName from [qp_oa_NetMetting] as [A] join [SystemCode] as [C] on [A].[State] = [C].CodeId and [C].FieldName = '8' where CHARINDEX('," + this.Session["Username"] + ",',','+NbPeopleUser+',')   >   0 ";
            string str2 = "select count(id) from qp_oa_NetMetting where  CHARINDEX('," + this.Session["Username"] + ",',','+NbPeopleUser+',')   >   0 ";
