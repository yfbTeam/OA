namespace xyoa.InfoSpeech.Messages
{
    ...
    public class Messages_yf : Page
    {
        ...
        {
            base.Response.Redirect("Messages_yf.aspx");
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and acceptusername = '" + this.sendrealname.Text + "'";
            }
            if (this.itimes.Text != "")
            {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_Messages  where sendusername='" + this.Session["username"] + "' and tablekey='2'";
            string str2 = "select count(id) from qp_oa_Messages where sendusername='" + this.Session["username"] + "' and tablekey='2'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            this.pulicss.InsertLog("删除已读消息", "已读消息");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
