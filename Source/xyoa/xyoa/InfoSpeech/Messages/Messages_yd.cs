namespace xyoa.InfoSpeech.Messages
{
    ...
    public class Messages_yd : Page
    {
        ...
        {
            base.Response.Redirect("Messages_yd.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_Messages  where sfck='1' and acceptusername='" + this.Session["username"] + "' and tablekey='1'";
            string str2 = "select count(id) from qp_oa_Messages where sfck='1' and acceptusername='" + this.Session["username"] + "' and tablekey='1'";
