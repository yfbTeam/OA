namespace xyoa.InfoSpeech.Messages
{
    ...
    public class Messages_show : Page
    {
        ...
        {
            base.Response.Redirect("Messages_add.aspx?user=" + this.sendusername.Text + "&name=" + this.sendrealname.Text + "");
        }

        protected void Button4_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("" + this.url.Text + "");
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = string.Concat(new object[] { "select * from qp_oa_Messages where  id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "' and (acceptusername='", this.Session["username"], "') and tablekey='1'" });
                ...
                if (list.Read())
                {
                    ...
                    string str2 = string.Concat(new object[] { "Update qp_oa_Messages Set sfck='1',CkTime='", DateTime.Now.ToString(), "'  where  acceptusername='", this.Session["username"], "' and  id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "' and tablekey='1'" });
