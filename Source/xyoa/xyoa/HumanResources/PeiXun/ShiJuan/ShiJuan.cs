namespace xyoa.HumanResources.PeiXun.ShiJuan
{
    ...
    public class ShiJuan : Page
    {
        ...
        {
            base.Response.Redirect("ShiJuan_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee2j", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee2j", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee2j", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee2j", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,D.[Mingcheng] as Mingcheng from [qp_hr_ShiJuan] as [A]  inner join [qp_hr_TikuLb] as [D] on [A].[MingchengID] = [D].[Id] where 1=1";
            string str2 = "select count(id) from qp_hr_ShiJuan as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_ShiJuan  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除试卷管理", "试卷管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string sql = "select id from qp_hr_KaoShi where ShijuanID='" + label.Text + "'";
        ...
        {
            base.Response.Redirect("ShiJuan_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
