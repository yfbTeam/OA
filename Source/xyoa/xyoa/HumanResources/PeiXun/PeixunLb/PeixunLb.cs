namespace xyoa.HumanResources.PeiXun.PeixunLb
{
    ...
    public class PeixunLb : Page
    {
        ...
        {
            base.Response.Redirect("PeixunLb_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee2k", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee2k", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee2k", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee2k", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("PeixunLb.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from [qp_hr_PeixunLb]  where 1=1";
            string str2 = "select count(id) from [qp_hr_PeixunLb]  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_PeixunLb  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除培训类别", "培训类别");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("PeixunLb_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
