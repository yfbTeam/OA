namespace xyoa.HumanResources.PeiXun.PeixunLb
{
    ...
    public class PeixunLb_add : Page
    {
        ...
        {
            string sql = "insert into qp_hr_PeixunLb  (Mingcheng) values ('" + this.pulicss.GetFormatStr(this.Mingcheng.Text) + "')";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("新增培训类别", "培训类别");
