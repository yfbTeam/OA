namespace xyoa.HumanResources.PeiXun
{
    ...
    public class TikuLb : Page
    {
        ...
        {
            base.Response.Redirect("TikuLb_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee2l", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee2l", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee2l", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee2l", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("TikuLb.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from [qp_hr_TikuLb]  where 1=1";
            string str2 = "select count(id) from [qp_hr_TikuLb]  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_TikuLb  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除题库类别", "题库类别");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("TikuLb_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
