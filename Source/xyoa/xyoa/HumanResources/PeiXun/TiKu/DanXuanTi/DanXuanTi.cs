namespace xyoa.HumanResources.PeiXun.TiKu.DanXuanTi
{
    ...
    public class DanXuanTi : Page
    {
        ...
        {
            base.Response.Redirect("DanXuanTi_add.aspx");
        }
        ...
        {
            base.Response.Redirect("DanXuanTi.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,D.[Mingcheng] as Mingcheng from [qp_hr_DanXuanTi] as [A]  inner join [qp_hr_TikuLb] as [D] on [A].[MingchengID] = [D].[Id] where 1=1";
            string str2 = "select count(id) from qp_hr_DanXuanTi as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_DanXuanTi  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除单选题", "单选题");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("DanXuanTi_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
