namespace xyoa.HumanResources.PeiXun.TiKu.DuoXuanTi
{
    ...
    public class DuoXuanTi : Page
    {
        ...
        {
            base.Response.Redirect("DuoXuanTi_add.aspx");
        }
        ...
        {
            base.Response.Redirect("DuoXuanTi.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,D.[Mingcheng] as Mingcheng from [qp_hr_DuoXuanTi] as [A]  inner join [qp_hr_TikuLb] as [D] on [A].[MingchengID] = [D].[Id] where 1=1";
            string str2 = "select count(id) from qp_hr_DuoXuanTi as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_DuoXuanTi  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除多选题", "多选题");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("DuoXuanTi_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
