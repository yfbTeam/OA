namespace xyoa.HumanResources.PeiXun.TiKu.WenDaTi
{
    ...
    public class WenDaTi : Page
    {
        ...
        {
            base.Response.Redirect("WenDaTi_add.aspx");
        }
        ...
        {
            base.Response.Redirect("WenDaTi.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,D.[Mingcheng] as Mingcheng from [qp_hr_WenDaTi] as [A]  inner join [qp_hr_TikuLb] as [D] on [A].[MingchengID] = [D].[Id] where 1=1";
            string str2 = "select count(id) from qp_hr_WenDaTi as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_WenDaTi  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除问答题", "问答题");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("WenDaTi_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
