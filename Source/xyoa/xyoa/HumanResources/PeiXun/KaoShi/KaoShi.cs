namespace xyoa.HumanResources.PeiXun.KaoShi
{
    ...
    public class KaoShi : Page
    {
        ...
        {
            base.Response.Redirect("KaoShi_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee2d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee2d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee2d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee2d", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("KaoShi.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.id,A.ShijuanID,A.Zhuti,A.Starttime,A.Endtime,A.Zhuangtai,D.[Titles] as ShijuanS from [qp_hr_KaoShi] as [A]  inner join [qp_hr_ShiJuan] as [D] on [A].[ShijuanID] = [D].[Id] where  username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_hr_KaoShi as [A] where  username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_KaoShi  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            string str3 = "  Delete from qp_hr_MyKaoShi  where KaoShiID in (" + str + ")";
            this.List.ExeSql(str3);
            this.pulicss.InsertLog("删除网上考试", "网上考试");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("KaoShi_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
