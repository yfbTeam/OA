namespace xyoa.HumanResources.PeiXun.MyPage
{
    ...
    public class KaoShi : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "eeee2b", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            if (this.Zhuti.Text != "")
            {
                str = str + " and B.Zhuti like '%" + this.pulicss.GetFormatStr(this.Zhuti.Text) + "%'";
            }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,B.Zhuti as ZhutiS,B.Starttime as StarttimeS,B.Endtime as EndtimeS,B.Zhuangtai as ZhuangtaiS,B.Shijian as ShijianS from [qp_hr_MyKaoShi] as [A]  inner join [qp_hr_KaoShi] as [B] on [A].[KaoShiID] = [B].[Id] where A.Username='" + this.Session["username"] + "'";
            string str2 = "select count(A.id) from [qp_hr_MyKaoShi] as [A]  inner join [qp_hr_KaoShi] as [B] on [A].[KaoShiID] = [B].[Id] where A.Username='" + this.Session["username"] + "'";
