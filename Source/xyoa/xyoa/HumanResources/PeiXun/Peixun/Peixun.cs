namespace xyoa.HumanResources.PeiXun.Peixun
{
    ...
    public class Peixun : Page
    {
        ...
        {
            base.Response.Redirect("Peixun_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee2c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee2c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee2c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee2c", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and Leibie = '" + this.Leibie.SelectedValue + "'";
            }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,D.[Mingcheng] as Mingcheng from [qp_hr_Peixun] as [A]  inner join [qp_hr_PeixunLb] as [D] on [A].[Leibie] = [D].[Id] where username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_hr_Peixun as [A] where username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_Peixun  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            string str3 = "  Delete from qp_hr_PeixunXinde  where Pxid in (" + str + ")";
            this.List.ExeSql(str3);
            this.pulicss.InsertLog("删除培训管理", "培训管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("Peixun_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
