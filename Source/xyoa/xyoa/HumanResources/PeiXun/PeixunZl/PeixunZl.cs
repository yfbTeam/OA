namespace xyoa.HumanResources.PeiXun.PeixunZl
{
    ...
    public class PeixunZl : Page
    {
        ...
        {
            base.Response.Redirect("PeixunZl_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee2h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee2h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee2h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee2h", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("PeixunZl.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str2 = "select count(id) from qp_hr_PeixunZl as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_PeixunZl  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除培训资料", "培训资料");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("PeixunZl_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
