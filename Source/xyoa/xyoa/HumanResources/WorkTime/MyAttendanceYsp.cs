namespace xyoa.HumanResources.WorkTime
{
    ...
    public class MyAttendanceYsp : Page
    {
        ...
        {
            base.Response.Redirect("MyAttendanceYsp.aspx?type=" + base.Request.QueryString["type"] + "");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = string.Concat(new object[] { "select * from [qp_hr_MyAttendance]  where CHARINDEX(',", this.Session["username"], ",',','+YjbUser+',')   >0 and type='", base.Request.QueryString["type"], "'" });
            string str2 = string.Concat(new object[] { "select count(id) from qp_hr_MyAttendance where CHARINDEX(',", this.Session["username"], ",',','+YjbUser+',')   >0 and type='", base.Request.QueryString["type"], "'" });
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                label3.Text = " <a href='MyAttendance_showYsp.aspx?id=" + label.Text + "&type=" + base.Request.QueryString["type"].ToString() + "' class=\"LinkLine\">" + label2.Text + "</a>";
            }
        }
