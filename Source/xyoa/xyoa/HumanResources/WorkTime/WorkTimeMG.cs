namespace xyoa.HumanResources.WorkTime
{
    ...
    public class WorkTimeMG : Page
    {
        ...
        {
            this.Button1.Attributes.Add("onclick", "javascript:return sc();");
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "eeee5e", this.Session["perstr"].ToString());
        }

        protected void Button1_Click(object sender, EventArgs e)
        {
            string sql = "  Delete from qp_WorkTimeDj";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("清空考勤记录", "考勤管理");
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and Username='" + this.pulicss.GetFormatStr(this.UsernameYG.Text) + "'";
            }
        ...
        {
            string str = "select Username,Realname from [qp_oa_username] where ifdel='0'";
