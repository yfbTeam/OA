namespace xyoa.HumanResources.Fenxi
{
    ...
    public class Info_left : Page
    {
        ...
        {
            string sql = string.Concat(new object[] { "select id,urlname,url,pic,quanxian,SelectAction from qp_oa_AllUrl where (CHARINDEX(''+quanxian+'','", this.ViewState["qxstr"], "')   >   0 ) and ParentNodesID='", IDStr, "' and quanxian='eeee8'  order by Paixu asc" });
            ...
            while (list.Read())
            {
                ...
                Nds.Add(child);
                this.BindTree(Nds[Nds.Count - 1].ChildNodes, iDStr);
            }
            list.Close();
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.BindTree(this.ListTreeView.Nodes, 0x28f);
                this.pulicss.QuanXianVis(this.ListTreeView, "eeee8", this.Session["perstr"].ToString());
            }
        }
    }
}
