            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        object obj2;
                        string str3 = "select id,name,fenlei from qp_hr_Fenxi where type='3'  order by id asc";
                        int num = 1;
                        SqlDataReader list = this.List.GetList(str3);
                        while (list.Read())
                        {
                            string str4 = "select count(A.id) from  [qp_hr_HetongMg] as [A] where A.Zhuangtai='" + list["fenlei"] + "'";
