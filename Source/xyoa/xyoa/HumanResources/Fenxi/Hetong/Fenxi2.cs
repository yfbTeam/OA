namespace xyoa.HumanResources.Fenxi.Hetong
{
    ...
    public class Fenxi2 : Page
    {
        ...
        {
            base.Response.Redirect("Fenxi2List.aspx?SYear=" + this.SYear.SelectedValue + "&SMonth=" + this.SMonth.SelectedValue + "&EYear=" + this.EYear.SelectedValue + "&EMonth=" + this.EMonth.SelectedValue + "");
        }
