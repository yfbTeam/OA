    ...
    public class Fenxi26 : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                try
                {
                    string sql = "select count(A.id) from  [qp_hr_YuangongJC] as [A]  where 1=1 and Jiangcheng='2'";
                    ...
                    else
                    {
                        ...
                        object obj2;
                        string str3 = "select id,name from qp_hr_YuangongLx where type='12'  order by id asc";
                        int num = 1;
                        SqlDataReader list = this.List.GetList(str3);
                        while (list.Read())
                        {
                            string str4 = "select count(A.id) from  [qp_hr_YuangongJC] as [A] where A.Leibie='" + list["id"] + "' and Jiangcheng='2'";
