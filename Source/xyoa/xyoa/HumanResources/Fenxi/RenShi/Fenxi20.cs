namespace xyoa.HumanResources.Fenxi.RenShi
{
    ...
    public class Fenxi20 : Page
    {
        ...
        {
            base.Response.Redirect("Fenxi20List.aspx?SYear=" + this.SYear.SelectedValue + "&SMonth=" + this.SMonth.SelectedValue + "&EYear=" + this.EYear.SelectedValue + "&EMonth=" + this.EMonth.SelectedValue + "");
        }
