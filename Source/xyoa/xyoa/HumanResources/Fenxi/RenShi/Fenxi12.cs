            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        object obj2;
                        string str3 = "select id,name from qp_hr_YuangongLx where type='7'  order by id asc";
                        int num = 1;
                        SqlDataReader list = this.List.GetList(str3);
                        while (list.Read())
                        {
                            string str4 = "select count(A.id) from  [qp_hr_Yuangong] as [A] where A.Leixing='" + list["id"] + "' and Zaizhi='1'";
