namespace xyoa.HumanResources.Fenxi.RenShi
{
    ...
    public class Fenxi19 : Page
    {
        ...
        {
            base.Response.Redirect("Fenxi19List.aspx?SYear=" + this.SYear.SelectedValue + "&SMonth=" + this.SMonth.SelectedValue + "&EYear=" + this.EYear.SelectedValue + "&EMonth=" + this.EMonth.SelectedValue + "");
        }
