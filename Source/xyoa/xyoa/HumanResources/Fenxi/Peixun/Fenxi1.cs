namespace xyoa.HumanResources.Fenxi.Peixun
{
    ...
    public class Fenxi1 : Page
    {
        ...
        {
            base.Response.Redirect("Fenxi1.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,D.[Mingcheng] as Mingcheng from [qp_hr_Peixun] as [A]  inner join [qp_hr_PeixunLb] as [D] on [A].[Leibie] = [D].[Id] where 1=1";
            string str2 = "select count(id) from qp_hr_Peixun as [A] where 1=1";
