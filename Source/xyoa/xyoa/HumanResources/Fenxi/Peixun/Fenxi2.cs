namespace xyoa.HumanResources.Fenxi.Peixun
{
    ...
    public class Fenxi2 : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.id,A.ShijuanID,A.Zhuti,A.Starttime,A.Endtime,A.Zhuangtai,D.[Titles] as ShijuanS from [qp_hr_KaoShi] as [A]  inner join [qp_hr_ShiJuan] as [D] on [A].[ShijuanID] = [D].[Id] where  1=1";
            string str2 = "select count(id) from qp_hr_KaoShi as [A] where 1=1";
