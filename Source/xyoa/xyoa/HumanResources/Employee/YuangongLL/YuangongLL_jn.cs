namespace xyoa.HumanResources.Employee.YuangongLL
{
    ...
    public class YuangongLL_jn : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,F.[Name] as LeixingName from [qp_hr_YuangongJN] as [A]  inner join [qp_hr_YuangongLx] as [F] on [A].[Leibie] = [F].[id] where A.UsernameYG='" + this.ViewState["Username"] + "'";
            string str2 = "select count(A.id) from [qp_hr_YuangongJN] as [A]  inner join [qp_hr_YuangongLx] as [F] on [A].[Leibie] = [F].[id] where A.UsernameYG='" + this.ViewState["Username"] + "'";
