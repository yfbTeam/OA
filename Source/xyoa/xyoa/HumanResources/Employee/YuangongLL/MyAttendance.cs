namespace xyoa.HumanResources.Employee.YuangongLL
{
    ...
    public class MyAttendance : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = string.Concat(new object[] { "select * from [qp_hr_MyAttendance]  where type='", base.Request.QueryString["type"].ToString(), "' and  Username='", this.ViewState["Username"], "'" });
            string str2 = string.Concat(new object[] { "select count(id) from qp_hr_MyAttendance where type='", base.Request.QueryString["type"].ToString(), "' and  Username='", this.ViewState["Username"], "'" });
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                {
                    this.ViewState["btncss1"] = "btn2on";
                    this.ViewState["btncss2"] = "btn2off";
                    this.ViewState["btncss3"] = "btn2off";
                    this.ViewState["typename"] = "出差管理";
                }
                if (base.Request.QueryString["type"].ToString() == "2")
                {
                    this.ViewState["btncss1"] = "btn2off";
                    this.ViewState["btncss2"] = "btn2on";
                    this.ViewState["btncss3"] = "btn2off";
