namespace xyoa.HumanResources.Employee.YuangongLL
{
    ...
    public class YuangongLL_xz : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_hr_GongziUser] as [A]  where (CHARINDEX('," + this.ViewState["Username"] + ",',','+Username+',') > 0)";
            string str2 = "select count(id) from qp_hr_GongziUser as [A] where (CHARINDEX('," + this.ViewState["Username"] + ",',','+Username+',') > 0)";
