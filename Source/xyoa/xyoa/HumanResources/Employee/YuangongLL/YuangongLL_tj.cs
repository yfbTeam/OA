namespace xyoa.HumanResources.Employee.YuangongLL
{
    ...
    public class YuangongLL_tj : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,F.[Name] as LeixingName from [qp_hr_YuangongTJ] as [A]  inner join [qp_hr_YuangongLx] as [F] on [A].[Jieguo] = [F].[id] where  A.UsernameYG='" + this.ViewState["Username"] + "'";
            string str2 = "select count(A.id) from [qp_hr_YuangongTJ] as [A]  inner join [qp_hr_YuangongLx] as [F] on [A].[Jieguo] = [F].[id] where  A.UsernameYG='" + this.ViewState["Username"] + "'";
