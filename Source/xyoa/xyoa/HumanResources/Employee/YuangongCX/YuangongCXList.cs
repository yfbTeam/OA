namespace xyoa.HumanResources.Employee.YuangongCX
{
    ...
    public class YuangongCXList : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "eeee4d", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            if (this.Session["YuangongCX"] != null)
            {
                str = this.Session["YuangongCX"].ToString();
            }
            return str;
        }
