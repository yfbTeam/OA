namespace xyoa.HumanResources.Employee.YuangongJN
{
    ...
    public class YuangongJN : Page
    {
        ...
        {
            base.Response.Redirect("YuangongJN_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee4ja", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee4jc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee4jd", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee4jb", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("YuangongJN.aspx");
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and Mingcheng like '%" + this.pulicss.GetFormatStr(this.Mingcheng.Text) + "%'";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,F.[Name] as LeixingName from [qp_hr_YuangongJN] as [A]  inner join [qp_hr_YuangongLx] as [F] on [A].[Leibie] = [F].[id] where 1=1";
            string str2 = "select count(A.id) from [qp_hr_YuangongJN] as [A]  inner join [qp_hr_YuangongLx] as [F] on [A].[Leibie] = [F].[id] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_YuangongJN  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除技能信息", "技能信息");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("YuangongJN_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
