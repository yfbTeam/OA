namespace xyoa.HumanResources.Employee.YuangongGH
{
    ...
    public class YuangongGH_show : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "eeee4h", this.Session["perstr"].ToString());
        }
        ...
        {
            string str = string.Empty;
            if (base.Request.QueryString["bdays"] != null)
            {
                str = str + " and  (((month(ChuSheng)=month(getdate())) and (day(ChuSheng)-day(getdate())) between 0 and " + this.pulicss.GetFormatStr(base.Server.UrlDecode(base.Request.QueryString["bdays"])) + ") or ((month(ChuSheng-" + this.pulicss.GetFormatStr(base.Server.UrlDecode(base.Request.QueryString["bdays"])) + ")=month(getdate())) and (day(ChuSheng-" + this.pulicss.GetFormatStr(base.Server.UrlDecode(base.Request.QueryString["bdays"])) + ")-day(getdate())) between -" + this.pulicss.GetFormatStr(base.Server.UrlDecode(base.Request.QueryString["bdays"])) + " and 0))";
            }
            return str;
        }
