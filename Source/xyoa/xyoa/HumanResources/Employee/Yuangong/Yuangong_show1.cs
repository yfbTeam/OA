namespace xyoa.HumanResources.Employee.Yuangong
{
    ...
    public class Yuangong_show1 : Page
    {
        ...
        {
            base.Response.Redirect("Yuangong_update.aspx?tmp=" + this.pulicss.GetFormatStr(base.Request.QueryString["tmp"]) + "&id=" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "&bmid=" + this.pulicss.GetFormatStr(base.Request.QueryString["bmid"]) + "");
        }

        protected void Button5_Click(object sender, EventArgs e)
        {
            string sql = "  Delete from qp_hr_Yuangong  where id=" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.pulicss.QuanXianVis(this.Button1, "eeee4ac", this.Session["perstr"].ToString());
                this.pulicss.QuanXianBack("eeee4ab", this.Session["perstr"].ToString());
                this.pulicss.QuanXianVis(this.Button5, "eeee4ad", this.Session["perstr"].ToString());
                this.Button5.Attributes["onclick"] = "javascript:return zx();";
