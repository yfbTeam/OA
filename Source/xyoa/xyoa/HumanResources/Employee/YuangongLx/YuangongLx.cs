namespace xyoa.HumanResources.Employee.YuangongLx
{
    ...
    public class YuangongLx : Page
    {
        ...
        {
            base.Response.Redirect("YuangongLx_add.aspx?type=" + base.Request.QueryString["type"].ToString() + "");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee4h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee4h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee4h", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_hr_YuangongLx where type='" + base.Request.QueryString["type"].ToString() + "' and ifdel=0";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_hr_YuangongLx  where type='" + base.Request.QueryString["type"].ToString() + "' and ifdel=0 " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = " update qp_hr_YuangongLx set IfDel='1' where  ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除" + this.ViewState["FileName"] + "", "人事管理数据字典");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("YuangongLx_update.aspx?id=" + this.CheckCbxUpdate() + "&type=" + base.Request.QueryString["type"].ToString() + "");
        }
    }
}
