namespace xyoa.HumanResources.Hetong.HetongCX
{
    ...
    public class HetongCX_show : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            base.Response.Write("<script language=javascript>window.parent.location.href='HetongCX_SearchList.aspx?LeibieID=" + this.LeibieID.SelectedValue + "&Qixian=" + this.Qixian.SelectedValue + "&Zhuangtai=" + this.Zhuangtai.SelectedValue + "&QyUsername=" + this.QyUsername.Text + "&DQtime=" + this.DQtime.SelectedValue + "&Starttime=" + this.Starttime.Text + "&Endtime=" + this.Endtime.Text + "'</script>");
        }
