namespace xyoa.HumanResources.Hetong.HetongCX
{
    ...
    public class HetongCX_SearchList : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "eeee3j", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            if (base.Request.QueryString["Qixian"] != "")
            {
                str = str + " and A.Qixian = '" + this.pulicss.GetFormatStr(base.Server.UrlDecode(base.Request.QueryString["Qixian"])) + "'";
            }
