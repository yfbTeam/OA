namespace xyoa.HumanResources.Hetong.HetongLb
{
    ...
    public class HetongLb : Page
    {
        ...
        {
            base.Response.Redirect("HetongLb_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee3h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee3h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee3h", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee3h", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from [qp_hr_HetongLb]  where 1=1";
            string str2 = "select count(id) from [qp_hr_HetongLb]  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_HetongLb  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            string str3 = "  Delete from qp_hr_HetongZd  where LeibieID in (" + str + ")";
            this.List.ExeSql(str3);
            this.pulicss.InsertLog("删除合同类别", "合同类别");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("HetongLb_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
