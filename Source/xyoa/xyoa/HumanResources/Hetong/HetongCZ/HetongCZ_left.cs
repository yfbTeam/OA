namespace xyoa.HumanResources.Hetong.HetongCZ
{
    ...
    public class HetongCZ_left : Page
    {
        ...
        private void BindTree(TreeNodeCollection Nds, int IDStr)
        {
            ...
            while (list.Read())
            {
                ...
                if (IDStr == 0)
                {
                    ...
                    node.Text = string.Concat(new object[] { " <a href='HetongCZ_show.aspx?bmid=", num, "' target='nextrform' >", list["Name"].ToString(), "</a>" });
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.pulicss.QuanXianVis(this.ListTreeView, "eeee3c", this.Session["perstr"].ToString());
            }
        }
    }
}
