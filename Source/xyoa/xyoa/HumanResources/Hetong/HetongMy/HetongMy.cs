namespace xyoa.HumanResources.Hetong.HetongMy
{
    using qiupeng.hr;
    ...
    public class HetongMy : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "eeee3a", this.Session["perstr"].ToString());
        }
