namespace xyoa.HumanResources.Hetong.HetongMy
{
    ...
    public class HetongMy_show : Page
    {
        ...
        {
            this.pulicss.QuanXianBack("eeee3a", this.Session["perstr"].ToString());
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.BindAttribute();
                string sql = string.Concat(new object[] { "select * from qp_hr_HetongMg where id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "' and [QyUsername]='", this.Session["username"], "'" });
