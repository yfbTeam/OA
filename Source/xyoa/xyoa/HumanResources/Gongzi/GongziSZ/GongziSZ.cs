namespace xyoa.HumanResources.Gongzi.GongziSZ
{
    ...
    public class GongziSZ : Page
    {
        ...
        {
            base.Response.Redirect("GongziSZ_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee7d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee7d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee7d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee7d", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("GongziSZ.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_hr_GongziSZ] as [A]  where 1=1";
            string str2 = "select count(A.id) from qp_hr_GongziSZ as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_GongziSZ  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            string str3 = "  Delete from qp_hr_GongziSZMX  where GzId in (" + str + ")";
            this.List.ExeSql(str3);
            this.pulicss.InsertLog("删除工资设置", "工资设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("GongziSZ_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
