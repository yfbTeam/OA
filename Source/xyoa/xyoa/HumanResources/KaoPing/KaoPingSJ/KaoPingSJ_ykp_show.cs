namespace xyoa.HumanResources.KaoPing.KaoPingSJ
{
    ...
    public class KaoPingSJ_ykp_show : Page
    {
            ...
            else
            {
                ...
                if (!this.Page.IsPostBack)
                {
                    ...
                    if (list.Read())
                    {
                        ...
                        if ((list["KpZhuangtai5"].ToString() == "2") && (list["User5"].ToString() == this.Session["username"].ToString()))
                        {
                        ...
                        else if ((list["KpZhuangtai4"].ToString() == "2") && (list["User4"].ToString() == this.Session["username"].ToString()))
                        {
                            this.ViewState["XianshiCss1"] = "";
                            this.ViewState["XianshiCss2"] = "";
                            this.ViewState["XianshiCss3"] = "";
                        ...
                        else if ((list["KpZhuangtai3"].ToString() == "2") && (list["User3"].ToString() == this.Session["username"].ToString()))
                        {
                            this.ViewState["XianshiCss1"] = "";
                            this.ViewState["XianshiCss2"] = "";
                            this.ViewState["XianshiCss3"] = "";
                        ...
                        else if ((list["KpZhuangtai2"].ToString() == "2") && (list["User2"].ToString() == this.Session["username"].ToString()))
                        {
                            this.ViewState["XianshiCss1"] = "";
                            this.ViewState["XianshiCss2"] = "";
                            this.ViewState["XianshiCss3"] = "display: none";
                        ...
                        else if ((list["KpZhuangtai1"].ToString() == "2") && (list["User1"].ToString() == this.Session["username"].ToString()))
                        {
                            this.ViewState["XianshiCss1"] = "";
                            this.ViewState["XianshiCss2"] = "display: none";
                            this.ViewState["XianshiCss3"] = "display: none";
