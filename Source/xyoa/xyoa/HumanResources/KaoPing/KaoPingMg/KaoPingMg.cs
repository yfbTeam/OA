namespace xyoa.HumanResources.KaoPing.KaoPingMg
{
    ...
    public class KaoPingMg : Page
    {
        ...
        {
            base.Response.Redirect("KaoPingMg_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee6fa", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee6fc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee6fd", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee6fb", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("KaoPingMg.aspx");
        }
        ...
        public string CreateMidSql()
        {
            ...
            if (this.LeixingID.SelectedValue != "")
            {
                str = str + " and LeixingID = '" + this.LeixingID.SelectedValue + "'";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.id,A.LeixingID,A.Zhuti,A.Starttime,A.Endtime,A.Zhuangtai,D.[Leixing] as LeixingName from [qp_hr_KaoPingMg] as [A]  inner join [qp_hr_KaoPingSz] as [D] on [A].[LeixingID] = [D].[Id] where 1=1";
            string str2 = "select count(A.id) from [qp_hr_KaoPingMg] as [A]  inner join [qp_hr_KaoPingSz] as [D] on [A].[LeixingID] = [D].[Id] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_KaoPingMg  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            string str3 = "  Delete from qp_hr_KaoPingMgMx  where KaopingId in (" + str + ")";
            this.List.ExeSql(str3);
            this.pulicss.InsertLog("删除考评管理", "考评管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("KaoPingMg_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
