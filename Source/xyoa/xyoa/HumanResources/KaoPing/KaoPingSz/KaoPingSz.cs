namespace xyoa.HumanResources.KaoPing.KaoPingSz
{
    ...
    public class KaoPingSz : Page
    {
        ...
        {
            base.Response.Redirect("KaoPingSz_add.aspx");
        }

        public void BindAttribute()
        {
            this.Leixing.Attributes["onkeydown"] = "if (event.keyCode==13) { document.all.SearchData.click(); return false;}";
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee6g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee6g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee6g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee6g", this.Session["perstr"].ToString());
        }
        ...
        {
            string str = string.Empty;
            if (this.Leixing.Text != "")
            {
                str = str + " and Leixing like '%" + this.pulicss.GetFormatStr(this.Leixing.Text) + "%'";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.id,A.Leixing,A.Zongfen from [qp_hr_KaoPingSz] as [A] where 1=1";
            string str2 = "select count(A.id) from [qp_hr_KaoPingSz] as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_KaoPingSz  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除考评设置", "考评设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string sql = "select id from qp_hr_KaoPingMg where LeixingID='" + label.Text + "'";
        ...
        {
            base.Response.Redirect("KaoPingSz_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
