namespace xyoa.HumanResources.ZhaoPin.QuDao
{
    ...
    public class QuDao : Page
    {
        ...
        {
            base.Response.Redirect("QuDao_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "eeee1g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "eeee1g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "eeee1g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "eeee1g", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("QuDao.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from [qp_hr_QuDao]  where 1=1";
            string str2 = "select count(id) from [qp_hr_QuDao]  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_hr_QuDao  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除招聘渠道", "招聘渠道");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("QuDao_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
