    ...
    public class JianLi_show : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                string str2 = "select  * from qp_hr_MianShi  where  XingmingId='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "'  order by id asc";
