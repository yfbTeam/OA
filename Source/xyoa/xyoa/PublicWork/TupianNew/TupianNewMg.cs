namespace xyoa.PublicWork.TupianNew
{
    ...
    public class TupianNewMg : Page
    {
        ...
        {
            base.Response.Redirect("TupianNewMg_add.aspx");
        }
        ...
        public void Bindquanxian()
        {
            ...
            this.pulicss.QuanXianVis(this.AddData, "jjjja3ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjja3bc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "jjjja3bb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjja3bd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,Settime,Username,Realname from qp_oa_TupianNew where 1=1";
            string str2 = "select count(id) from qp_oa_TupianNew where  1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_TupianNew  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除图片新闻", "图片新闻");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("TupianNewMg_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("TupianNewMg_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
