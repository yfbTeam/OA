namespace xyoa.PublicWork.ComThingMg
{
    ...
    public class ComThingMg_add : Page
    {
        ...
        {
            this.pulicss.QuanXianBack("jjjj2ba", this.Session["perstr"].ToString());
        ...
        {
            string sql = "insert into qp_oa_ComThingMg  (Number,titles,Content) values ('" + this.pulicss.GetFormatStr(this.Number.Text) + "','" + this.pulicss.GetFormatStr(this.titles.Text) + "','" + this.pulicss.GetFormatStrbjq(this.Content.Value) + "')";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("新增大事记", "大事记");
