namespace xyoa.PublicWork.ComThingMg
{
    ...
    public class ComThingMg : Page
    {
        ...
        {
            base.Response.Redirect("ComThingMg_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "jjjj2ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjj2bc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "jjjj2bb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjj2bd", this.Session["perstr"].ToString());
        }
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_ComThingMg  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除大事记", "大事记");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("ComThingMg_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("ComThingMg_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
