namespace xyoa.PublicWork.Tupian
{
    ...
    public class Tupian_show : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.LinkButton1, "jjjj7bd", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.LinkButton2, "jjjj7ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.LinkButton3, "jjjj7bc", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("Tupian_show.aspx?id=" + base.Request.QueryString["id"] + "");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            {
                str = "select * from qp_oa_TupianMg where 1=1 ";
                str2 = "select count(id) from qp_oa_TupianMg where 1=1 ";
                str3 = str + SqlCreate;
                str4 = str2 + SqlCreate;
                str5 = "" + str3 + " " + Sqlsort + "";
            ...
            {
                str = "select * from qp_oa_TupianMg where TypeId='" + base.Request.QueryString["id"] + "'";
                str2 = "select count(id) from qp_oa_TupianMg where TypeId='" + base.Request.QueryString["id"] + "'";
                str3 = str + SqlCreate;
                str4 = str2 + SqlCreate;
                str5 = "" + str3 + " " + Sqlsort + "";
                this.GridView1.DataSource = this.List.GetGrid_Pages_not(str5);
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_TupianMg  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除文件[" + this.CheckCbxNameDel() + "]", "图片管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }

        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("Tupian_add.aspx?typeid=" + base.Request.QueryString["id"] + "");
        }

        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("Tupian_update.aspx?id=" + this.CheckCbxUpdate() + "&typeid=" + base.Request.QueryString["id"] + "");
        }
