namespace xyoa.PublicWork.Tupian
{
    ...
    public class TupianLx : Page
    {
        ...
        {
            base.Response.Redirect("TupianLx_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "jjjj7c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjj7c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjj7c", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_TupianLx";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_TupianLx " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_TupianLx  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除图片目录", "图片目录");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("TupianLx_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
