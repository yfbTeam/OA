namespace xyoa.PublicWork.NewsMg
{
    ...
    public class NewsMgList : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "jjjj1a", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,Settime,Realname,Username,ScUsername from qp_oa_NewsMg where 1=1";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "shoucan")
            {
                ...
                string sql = string.Concat(new object[] { "Update qp_oa_NewsMg  Set ScUsername=ScUsername+'", this.Session["username"], ",' where ID='", num, "'" });
        ...
        {
            base.Response.Redirect("NewsMgList_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
