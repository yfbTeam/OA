namespace xyoa.PublicWork.NewsMg
{
    ...
    public class NewsMg : Page
    {
        ...
        {
            base.Response.Redirect("NewsMg_add.aspx");
        }
        ...
        public void Bindquanxian()
        {
            ...
            this.pulicss.QuanXianVis(this.AddData, "jjjj1ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjj1bc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "jjjj1bb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjj1bd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,Settime,Realname,Username from qp_oa_NewsMg where 1=1";
            string str2 = "select count(id) from qp_oa_NewsMg where  1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_NewsMg  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除新闻管理", "新闻管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("NewsMg_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("NewsMg_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
