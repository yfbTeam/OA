namespace xyoa.PublicWork.NewsMg
{
    ...
    public class NewsMgListSc : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "jjjj1c", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,Settime,Realname,Username,ScUsername from qp_oa_NewsMg where  CHARINDEX('," + this.Session["username"] + ",',','+ScUsername+',')   >0";
            string str2 = "select count(id) from qp_oa_NewsMg where   CHARINDEX('," + this.Session["username"] + ",',','+ScUsername+',')   >0";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "shoucan")
            {
                ...
                string sql = string.Concat(new object[] { "Update qp_oa_NewsMg  Set ScUsername=replace(ScUsername,'", this.Session["username"].ToString(), ",','')  where ID='", num, "'" });
        ...
        {
            base.Response.Redirect("NewsMgListSc_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
