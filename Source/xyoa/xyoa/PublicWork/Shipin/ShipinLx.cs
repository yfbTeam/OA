namespace xyoa.PublicWork.Shipin
{
    ...
    public class ShipinLx : Page
    {
        ...
        {
            base.Response.Redirect("ShipinLx_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "jjjj9c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjj9c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjj9c", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_ShipinLx";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_ShipinLx " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_ShipinLx  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除视频目录", "视频目录");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("ShipinLx_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
