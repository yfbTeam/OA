namespace xyoa.PublicWork.BumenNewsMg
{
    ...
    public class BumenNewsMgListALL : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "jjjj3a", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = string.Concat(new object[] { "select id,titles,Settime,Username,Realname,FqBumen,YdUsername,ScUsername from qp_oa_BumenNewsMg where (CHARINDEX(',", this.Session["BuMenId"], ",',','+ZdBumenId+',') > 0 and States='2') or (CHARINDEX(',", this.Session["username"], ",',','+ZdUsername+',') > 0 and States='3') or (States='1')" });
            string str2 = string.Concat(new object[] { "select count(id) from qp_oa_BumenNewsMg where  (CHARINDEX(',", this.Session["BuMenId"], ",',','+ZdBumenId+',') > 0 and States='2') or (CHARINDEX(',", this.Session["username"], ",',','+ZdUsername+',') > 0 and States='3') or (States='1')" });
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "shoucan")
            {
                ...
                string sql = string.Concat(new object[] { "Update qp_oa_BumenNewsMg  Set ScUsername=ScUsername+'", this.Session["username"], ",' where ID='", num, "'" });
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label label3 = (Label) e.Row.FindControl("ScUsername");
        ...
        {
            base.Response.Redirect("BumenNewsMgList_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
