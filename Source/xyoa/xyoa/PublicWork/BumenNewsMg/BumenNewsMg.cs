namespace xyoa.PublicWork.BumenNewsMg
{
    ...
    public class BumenNewsMg : Page
    {
        ...
        {
            base.Response.Redirect("BumenNewsMg_add.aspx");
        }
        ...
        public void Bindquanxian()
        {
            ...
            this.pulicss.QuanXianVis(this.AddData, "jjjj3ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjj3bc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "jjjj3bb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjj3bd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,titles,Settime,Username,Realname,FqBumen from qp_oa_BumenNewsMg where 1=1";
            string str2 = "select count(id) from qp_oa_BumenNewsMg where  1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_BumenNewsMg  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除通知公告", "通知公告");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("BumenNewsMg_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("BumenNewsMg_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
