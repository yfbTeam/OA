namespace xyoa.PublicWork.BumenNewsMg
{
    ...
    public class BumenNewsMgListy : Page
    {
        ...
        {
            base.Response.Redirect("BumenNewsMgListy.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = string.Concat(new object[] { "select id,titles,Settime,Username,Realname,FqBumen,ScUsername from qp_oa_BumenNewsMg where ((CHARINDEX(',", this.Session["BuMenId"], ",',','+ZdBumenId+',') > 0 and States='2') or (CHARINDEX(',", this.Session["username"], ",',','+ZdUsername+',') > 0 and States='3') or (States='1')) and CHARINDEX(',", this.Session["username"], ",',','+YdUsername+',')   >0" });
            string str2 = string.Concat(new object[] { "select count(id) from qp_oa_BumenNewsMg where  ((CHARINDEX(',", this.Session["BuMenId"], ",',','+ZdBumenId+',') > 0 and States='2') or (CHARINDEX(',", this.Session["username"], ",',','+ZdUsername+',') > 0 and States='3') or (States='1')) and CHARINDEX(',", this.Session["username"], ",',','+YdUsername+',')   >0" });
        ...
        {
            base.Response.Redirect("BumenNewsMgListy_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
