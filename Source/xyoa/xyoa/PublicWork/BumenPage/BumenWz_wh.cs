namespace xyoa.PublicWork.BumenPage
{
    ...
    public class BumenWz_wh : Page
    {
        ...
        {
            base.Response.Redirect("BumenWz_wh_add.aspx?ZhuyeId=" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "");
        }
        ...
        public void Bindquanxian()
        {
            ...
            this.pulicss.QuanXianVis(this.GridView1, "jjjja2b", this.Session["perstr"].ToString());
        ...
        {
            base.Response.Redirect("BumenWz_wh.aspx?id=" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "");
        }
        ...
        {
            base.Response.Redirect("BumenWz_wh_show.aspx?id=" + this.CheckCbxUpdate() + "&ZhuyeId=" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("BumenWz_wh_update.aspx?id=" + this.CheckCbxUpdate() + "&ZhuyeId=" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "");
        }
    }
}
