namespace xyoa.PublicWork.BumenPage
{
    ...
    public class BumenWzLb : Page
    {
        ...
        {
            base.Response.Redirect("BumenWzLb_add.aspx?LeibieId=" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "");
        }

        protected void ImageButton2_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("BumenWzLb_update.aspx?id=" + this.CheckCbxUpdate() + "&LeibieId=" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "");
        }
