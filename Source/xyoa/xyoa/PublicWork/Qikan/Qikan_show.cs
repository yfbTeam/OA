namespace xyoa.PublicWork.Qikan
{
    ...
    public class Qikan_show : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.LinkButton1, "jjjj5bd", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.LinkButton2, "jjjj5ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.LinkButton3, "jjjj5bc", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("Qikan_show.aspx?id=" + base.Request.QueryString["id"] + "");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            {
                str = "select id,Titles,Settime from qp_oa_QikanMg where 1=1";
                str2 = "select count(id) from qp_oa_QikanMg where 1=1";
                str3 = str + SqlCreate;
                str4 = str2 + SqlCreate;
                str5 = "" + str3 + " " + Sqlsort + "";
            ...
            {
                str = "select id,Titles,Settime from qp_oa_QikanMg where TypeId='" + base.Request.QueryString["id"] + "'";
                str2 = "select count(id) from qp_oa_QikanMg where TypeId='" + base.Request.QueryString["id"] + "'";
                str3 = str + SqlCreate;
                str4 = str2 + SqlCreate;
                str5 = "" + str3 + " " + Sqlsort + "";
                this.GridView1.DataSource = this.List.GetGrid_Pages_not(str5);
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_QikanMg  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除文件[" + this.CheckCbxNameDel() + "]", "电子期刊");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }

        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("Qikan_add.aspx?typeid=" + base.Request.QueryString["id"] + "");
        }

        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("Qikan_update.aspx?id=" + this.CheckCbxUpdate() + "&typeid=" + base.Request.QueryString["id"] + "");
        }
