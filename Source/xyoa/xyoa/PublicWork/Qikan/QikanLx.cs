namespace xyoa.PublicWork.Qikan
{
    ...
    public class QikanLx : Page
    {
        ...
        {
            base.Response.Redirect("QikanLx_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "jjjj5c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjj5c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjj5c", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_QikanLx";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_QikanLx " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_QikanLx  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除期刊目录", "期刊目录");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("QikanLx_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
