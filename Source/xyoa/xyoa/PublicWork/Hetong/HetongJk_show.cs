namespace xyoa.PublicWork.Hetong
{
    ...
    public class HetongJk_show : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = string.Concat(new object[] { "select * from qp_oa_HeTong   where id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "' and CHARINDEX(','+Username+',',','+(select RyUsername from qp_oa_HetongSz where ZgUsername='", this.Session["username"], "')+',') > 0" });
