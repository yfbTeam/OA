namespace xyoa.PublicWork.Hetong
{
    ...
    public class HetongSp : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string sql = string.Concat(new object[] { "select sum(A.Jine) as AllShuliang from  [qp_oa_HeTong] as [A] inner join [qp_oa_HetongLb] as [B] on [A].[Fenlei] = [B].id where CHARINDEX(',", this.Session["username"], ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2') ", SqlCreate, " " });
            ...
            string str6 = ("select count(A.id) from [qp_oa_HeTong] as [A] inner join [qp_oa_HetongLb] as [B] on [A].[Fenlei] = [B].id where A.DqBlUsername='" + this.Session["username"] + "' and (LcZhuangtai='1' or LcZhuangtai='2')") + SqlCreate;
