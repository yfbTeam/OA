namespace xyoa.PublicWork.Hetong
{
    ...
    public class HetongLb : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "jjjj8g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjj8g", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjj8g", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_HetongLb where 1=1";
            string str2 = "select count(id) from qp_oa_HetongLb where  1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_HetongLb  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除合同类别[" + this.CheckCbxNameDel() + "]", "合同类别");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("HetongLb_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }
