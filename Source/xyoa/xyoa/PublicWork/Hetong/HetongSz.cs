namespace xyoa.PublicWork.Hetong
{
    ...
    public class HetongSz : Page
    {
        ...
        {
            base.Response.Redirect("HetongSz_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "jjjj8c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjj8c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjj8c", this.Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_HetongSz";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select id,ZgRealname,RyRealname from qp_oa_HetongSz " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_HetongSz  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除合同监控设置", "合同监控设置");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("HetongSz_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
