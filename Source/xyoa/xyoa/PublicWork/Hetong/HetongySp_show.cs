namespace xyoa.PublicWork.Hetong
{
    ...
    public class HetongySp_show : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = string.Concat(new object[] { "select * from qp_oa_HeTong   where id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "' and CHARINDEX(',", this.Session["username"], ",',','+YjbUser+',')   >0" });
