namespace xyoa.PublicWork.Zhidu
{
    ...
    public class Zhidu_add : Page
    {
        ...
        {
            this.pulicss.QuanXianBack("jjjj6ba", this.Session["perstr"].ToString());
