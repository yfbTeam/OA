namespace xyoa.PublicWork.Zhidu
{
    ...
    public class ZhiduLx_update : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            string sql = string.Concat(new object[] { 
                "Update qp_oa_ZhiduLx  Set  Name='", this.pulicss.GetFormatStr(this.Name.Text), "',States='", this.States.SelectedValue, "',ZdBumenId='", this.ZdBumenId.Text, "',ZdBumen='", this.ZdBumen.Text, "',ZdUsername='", this.ZdUsername.Text, "',ZdRealname='", this.ZdRealname.Text, "',Paixun='", this.Paixun.Text, "'  where id='", int.Parse(base.Request.QueryString["id"]), 
                "'  "
             });
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("修改制度目录", "制度目录");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = "select * from qp_oa_ZhiduLx  where id='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "'  ";
