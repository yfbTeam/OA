namespace xyoa.PublicWork.Zhidu
{
    ...
    public class ZhiduLx : Page
    {
        ...
        {
            base.Response.Redirect("ZhiduLx_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "jjjj6c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "jjjj6c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "jjjj6c", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_ZhiduLx";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_ZhiduLx " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_ZhiduLx  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除制度目录", "制度目录");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("ZhiduLx_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
