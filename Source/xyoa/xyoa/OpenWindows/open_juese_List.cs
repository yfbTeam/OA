namespace xyoa.OpenWindows
{
    ...
    public class open_juese_List : Page
    {
        ...
        public void DataBindToDownList()
        {
            ...
            {
                string sQL = "select * from qp_oa_Juese where id not in (" + this.strlist + ")";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                if (base.Request.QueryString["requeststr"] != null)
                {
                    string sQL = "select * from qp_oa_Juese  where id in (" + this.strlist + ")";
