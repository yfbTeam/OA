namespace xyoa.OpenWindows
{
    ...
    public class open_biaodan : Page
    {
        ...
        public void DataBindToDownList()
        {
            ...
            {
                string sQL = "select * from qp_oa_DIYForm where id not in (" + this.strlist + ")";
                this.list.Bind_DropDownList_ListBox(this.SourceListBox, sQL, "id", "FormName");
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                if (base.Request.QueryString["requeststr"] != null)
                {
                    string sQL = "select * from qp_oa_DIYForm  where id in (" + this.strlist + ")";
                    this.list.Bind_DropDownList_ListBox(this.TargetListBox, sQL, "id", "FormName");
                }
