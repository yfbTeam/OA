namespace xyoa.OpenWindows
{
    ...
    public class open_mokuai : Page
    {
        ...
        public void DataBindToDownList()
        {
            ...
            {
                string sQL = "select * from qp_oa_AllUrl where id not in (" + this.strlist + ") and menhulm='1' and ParentNodesID!='0' and ifopen='1'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                if (base.Request.QueryString["requeststr"] != null)
                {
                    string sQL = "select * from qp_oa_AllUrl  where id in (" + this.strlist + ") and menhulm='1' and ParentNodesID!='0' and ifopen='1'";
                    this.list.Bind_DropDownList_ListBox(this.TargetListBox, sQL, "id", "urlname");
                }
