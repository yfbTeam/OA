namespace xyoa.OpenWindows
{
    ...
    public class open_user_list_yj : Page
    {
        ...
        protected void Button10_Click(object sender, EventArgs e)
        {
            ...
            {
                string sQL = null;
                sQL = "select Email, Realname from qp_oa_Username  where Email in (" + this.ViewState["strlist"] + ") and  ifdel='0' order by paixu asc ";
                this.TargetListBox.Items.Clear();
                this.list.Bind_DropDownList_ListBox(this.TargetListBox, sQL, "Email", "Realname");
            }
        ...
        public void DataBindToGridview(string Sqlsort, string Sqlstr)
        {
            ...
            if (base.Request.QueryString["requeststr"] != null)
            {
                str2 = ("select Email, Realname  from qp_oa_username  where 1=1 and Email not in (" + this.ViewState["strlist"] + ") and  ifdel='0' ") + Sqlstr + Sqlsort;
                this.list.Bind_DropDownList_ListBox(this.SourceListBox, str2, "Email", "Realname");
            }
            else
            {
                string str = "select Email, Realname  from qp_oa_username  where 1=1 and  ifdel='0'  ";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!this.Page.IsPostBack)
                {
                    ...
                    {
                        string str5 = null;
                        str5 = "select Email, Realname from qp_oa_Username  where Email in (" + this.ViewState["strlist"] + ") and  ifdel='0' order by paixu asc";
                        this.TargetListBox.Items.Clear();
                        this.list.Bind_DropDownList_ListBox(this.TargetListBox, str5, "Email", "Realname");
                    }
                    this.DataBindToGridview("order by paixu asc", this.CreateMidSql());
                }
            }
