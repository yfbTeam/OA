namespace xyoa.OpenWindows
{
    ...
    public class open_Username_two : Page
    {
        ...
        {
            base.Response.Redirect("open_Username_two.aspx?key=1&name=" + this.name.Text + "&Unit=" + this.Unit.SelectedValue + "&yhz=" + this.MyUserList.SelectedValue + "&requeststr=" + base.Server.UrlDecode(base.Request.QueryString["requeststr"].ToString()) + "");
        }
        ...
        public void DataBindToGridview()
        {
            ...
            string str = string.Concat(new object[] { "select id,Username,QxString,Realname from  qp_oa_username where 1=1 and  ifdel='0'  ", this.ViewState["keystr"], "", this.ViewState["yhzstr"], " " });
            ...
            {
                str4 = string.Concat(new object[] { "select * from qp_oa_username where 1=1  and  ifdel='0' ", this.ViewState["keystr"], "", this.ViewState["yhzstr"], "  order by paixu asc" });
                this.GridView1.DataSource = this.List.GetGrid_Pages_not(str4);
                this.GridView1.DataBind();
            }
        }
