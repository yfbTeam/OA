namespace xyoa.OpenWindows
{
    ...
    public class open_ProChengJie : Page
    {
        ...
        {
            base.Response.Redirect("open_ProChengJie.aspx?key=1&Name=" + this.Name.Text + "&Xinyong=" + this.Xinyong.SelectedValue + "&requeststr=" + base.Server.UrlDecode(base.Request.QueryString["requeststr"].ToString()) + "");
        }
        ...
        {
            string str4;
            string str = "select * from qp_oa_ProChengJie where 1=1";
            ...
            {
                str4 = "select * from qp_oa_ProChengJie where 1=1 ";
                this.GridView1.DataSource = this.List.GetGrid_Pages_not(str4);
                this.GridView1.DataBind();
            }
        }
