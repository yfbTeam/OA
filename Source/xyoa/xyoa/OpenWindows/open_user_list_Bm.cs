namespace xyoa.OpenWindows
{
    ...
    public class open_user_list_Bm : Page
    {
        ...
        public string CreateMidSql()
        {
            ...
            if (base.Request.QueryString["BuMenId"] != null)
            {
        ...
        public void DataBindToGridview(string Sqlsort, string Sqlstr)
        {
            ...
            if (base.Request.QueryString["requeststr"] != null)
            {
                str2 = ("select username, Realname  from qp_oa_username  where 1=1 and username not in (" + this.ViewState["strlist"] + ") and  ifdel='0' ") + Sqlstr + Sqlsort;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!this.Page.IsPostBack)
                {
                    ...
                    {
                        string str4 = null;
                        str4 = "select * from qp_oa_Username  where username in (" + this.ViewState["strlist"] + ") and  ifdel='0' order by paixu asc ";
                        this.TargetListBox.Items.Clear();
                        this.list.Bind_DropDownList_ListBox(this.TargetListBox, str4, "Username", "Realname");
                    }
                    this.DataBindToGridview("order by paixu asc", this.CreateMidSql());
                }
            }
