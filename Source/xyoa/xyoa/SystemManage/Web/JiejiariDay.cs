namespace xyoa.SystemManage.Web
{
    ...
    public class JiejiariDay : Page
    {
        ...
        {
            base.Response.Redirect("JiejiariDay_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "iiiic7", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "iiiic7", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "iiiic7", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_web_JiejiariDay  where 1=1";
            string str2 = "select count(id) from qp_web_JiejiariDay  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_web_JiejiariDay  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除节假日设置", "门户网站设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("JiejiariDay_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
