namespace xyoa.SystemManage.Web
{
    ...
    public class ZhuantiLb : Page
    {
        ...
        {
            base.Response.Redirect("ZhuantiLb_add.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_web_ZhuantiLb  where 1=1";
            string str2 = "select count(id) from qp_web_ZhuantiLb  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_web_ZhuantiLb  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除专题类别", "门户网站设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("ZhuantiLb_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
