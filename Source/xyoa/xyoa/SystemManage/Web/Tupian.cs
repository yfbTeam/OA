namespace xyoa.SystemManage.Web
{
    ...
    public class Tupian : Page
    {
        ...
        {
            base.Response.Redirect("Tupian_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "iiiic1", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "iiiic1", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "iiiic1", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from qp_web_Tupian as [A]  where 1=1";
            string str2 = "select count(A.id) from qp_web_Tupian as [A]  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_web_Tupian  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除图片新闻", "门户网站设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("Tupian_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
