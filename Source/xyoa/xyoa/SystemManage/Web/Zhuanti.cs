namespace xyoa.SystemManage.Web
{
    ...
    public class Zhuanti : Page
    {
        ...
        {
            base.Response.Redirect("Zhuanti_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "iiiic3", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "iiiic3", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "iiiic3", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,B.Name as LeibieName from qp_web_Zhuanti as [A] left join [qp_web_ZhuantiLb] as [B] on [A].[Leibie] = [B].[Id]  where 1=1";
            string str2 = "select count(A.id) from qp_web_Zhuanti as [A] left join [qp_web_ZhuantiLb] as [B] on [A].[Leibie] = [B].[Id]  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_web_Zhuanti  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除专题报道", "门户网站设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("Zhuanti_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
