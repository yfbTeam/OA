namespace xyoa.SystemManage.Web
{
    ...
    public class LanmuLb : Page
    {
        ...
        {
            base.Response.Redirect("LanmuLb_add.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_web_LanmuLb  where 1=1";
            string str2 = "select count(id) from qp_web_LanmuLb  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_web_LanmuLb  where ID in (" + str + ")";
        ...
        {
            base.Response.Redirect("LanmuLb_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
