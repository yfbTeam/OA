namespace xyoa.SystemManage.Web
{
    ...
    public class Xinwen : Page
    {
        ...
        {
            base.Response.Redirect("Xinwen_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "iiiic2", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "iiiic2", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "iiiic2", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from qp_web_Xinwen as [A]  where 1=1";
            string str2 = "select count(A.id) from qp_web_Xinwen as [A]  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_web_Xinwen  where ID in (" + str + ")";
        ...
        {
            base.Response.Redirect("Xinwen_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
