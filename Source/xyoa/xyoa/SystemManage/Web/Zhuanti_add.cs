namespace xyoa.SystemManage.Web
{
    ...
    public class Zhuanti_add : Page
    {
        ...
        {
            string sql = "insert into qp_web_Zhuanti (Titles,Content,Shijian,Leibie) values ('" + this.pulicss.GetFormatStr(this.Titles.Text) + "','" + this.pulicss.GetFormatStrbjq(this.d_content.Value) + "','" + DateTime.Now.ToString() + "','" + this.Leibie.SelectedValue + "')";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("新增专题报道", "门户网站设置");
