namespace xyoa.SystemManage.Web
{
    ...
    public class YuandiLb : Page
    {
        ...
        {
            base.Response.Redirect("YuandiLb_add.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_web_YuandiLb  where 1=1";
            string str2 = "select count(id) from qp_web_YuandiLb  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_web_YuandiLb  where ID in (" + str + ")";
        ...
        {
            base.Response.Redirect("YuandiLb_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
