namespace xyoa.SystemManage.Web
{
    ...
    public class Lanmu_update : Page
    {
        ...
        {
            string sql = "Update qp_web_Lanmu  Set Titles='" + this.pulicss.GetFormatStr(this.Titles.Text) + "',Content='" + this.pulicss.GetFormatStrbjq(this.d_content.Value) + "',Leibie='" + this.Leibie.SelectedValue + "' where id='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "'";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("修改栏目新闻", "门户网站设置");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                string sql = "select * from qp_web_Lanmu where id='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "'";
