        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (this.uploadFile.PostedFile.ContentLength != 0)
            {
                ...
                else
                {
                    ...
                    str2 = str3 + extension;
                    string sql = "insert into qp_web_Tupian (Titles,Content,Shijian,Tupian) values ('" + this.pulicss.GetFormatStr(this.Titles.Text) + "','" + this.pulicss.GetFormatStrbjq(this.d_content.Value) + "','" + DateTime.Now.ToString() + "','" + str2 + "')";
                    this.List.ExeSql(sql);
                    this.pulicss.InsertLog("新增图片新闻", "门户网站设置");
