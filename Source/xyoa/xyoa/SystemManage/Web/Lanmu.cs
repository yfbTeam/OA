namespace xyoa.SystemManage.Web
{
    ...
    public class Lanmu : Page
    {
        ...
        {
            base.Response.Redirect("Lanmu_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "iiiic8", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "iiiic8", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "iiiic8", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,B.Name as LeibieName from qp_web_Lanmu as [A] left join [qp_web_LanmuLb] as [B] on [A].[Leibie] = [B].[Id]  where 1=1";
            string str2 = "select count(A.id) from qp_web_Lanmu as [A] left join [qp_web_LanmuLb] as [B] on [A].[Leibie] = [B].[Id]  where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_web_Lanmu  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除栏目新闻", "门户网站设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sQL = "select id,name  from qp_web_LanmuLb order by paixu asc";
        ...
        {
            base.Response.Redirect("Lanmu_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
