namespace xyoa.SystemManage.sms
{
    ...
    public class Sms_BadOut : Page
    {
        ...
        {
            base.Response.Redirect("Sms_BadOut.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from send_info where  s_style=2";
            string str2 = "select count(id) from send_info where  s_style=2";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            this.pulicss.InsertLog("删除发送失败短信", "发送失败短信");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
