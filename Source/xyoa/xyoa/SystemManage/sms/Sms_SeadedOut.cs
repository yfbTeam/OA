namespace xyoa.SystemManage.sms
{
    ...
    public class Sms_SeadedOut : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.DelData, "iiiia1", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "iiiia1", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("Sms_SeadedOut.aspx");
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and s_realname like '%" + this.pulicss.GetFormatStr(this.Realname.Text) + "%'";
            }
            if (this.Settimes.Text != "")
            {
                str = str + " and convert(char(10),cast(SendTime as datetime),120)=convert(char(10),cast('" + this.pulicss.GetFormatStr(this.Settimes.Text) + "' as datetime),120) ";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from send_info where  s_style=1";
            string str2 = "select count(id) from send_info where  s_style=1";
