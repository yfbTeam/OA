namespace xyoa.SystemManage.sms
{
    ...
    public class Sms_Out : Page
    {
        ...
        {
            base.Response.Redirect("Sms_Out.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from send_info where s_style=0";
            string str2 = "select count(id) from send_info where s_style=0";
