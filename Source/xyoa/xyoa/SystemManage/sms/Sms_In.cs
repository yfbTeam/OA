namespace xyoa.SystemManage.sms
{
    ...
    public class Sms_In : Page
    {
        ...
        {
            base.Response.Redirect("Sms_In.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from get_info where 1=1";
            string str2 = "select count(id) from get_info where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            this.pulicss.InsertLog("删除接收短信", "接收短信");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
