namespace xyoa.SystemManage.SystemLog
{
    ...
    public class SystemLog : Page
    {
        ...
        public void Bindquanxian()
        {
            ...
            this.pulicss.QuanXianVis(this.DelData, "iiii9d", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.Button3, "iiii9d", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("SystemLog.aspx");
        }

        protected void Button3_Click(object sender, EventArgs e)
        {
            string sql = "Delete from qp_oa_SystemLog";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除系统日志", "系统日志");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and B.BuMenId = '" + this.BuMenId.SelectedValue + "'";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select *, C.[Name] as BuMenName from qp_oa_SystemLog  as [A] inner join [qp_oa_username] as [B] on [A].[Username] = [B].[Username] inner join [qp_oa_Bumen] as [C] on [B].[BuMenId] = [C].[Id]  where 1=1";
            string str2 = "select count(A.id) from qp_oa_SystemLog  as [A] inner join [qp_oa_username] as [B] on [A].[Username] = [B].[Username] inner join [qp_oa_Bumen] as [C] on [B].[BuMenId] = [C].[Id] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_SystemLog  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除系统日志", "系统日志");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
