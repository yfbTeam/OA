namespace xyoa.SystemManage.OtherMenu
{
    ...
    public class OtherMenu : Page
    {
        ...
        {
            base.Response.Redirect("OtherMenu_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "iiiia6", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "iiiia6", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "iiiia6", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_OtherMenu where 1=1";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_OtherMenu where 1=1" + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_OtherMenu  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除扩展应用", "扩展应用");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("OtherMenu_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
