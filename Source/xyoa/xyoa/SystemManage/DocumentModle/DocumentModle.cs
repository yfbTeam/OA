namespace xyoa.SystemManage.DocumentModle
{
    ...
    public class DocumentModle : Page
    {
        ...
        {
            base.Response.Redirect("DocumentModle_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "iiii4a", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "iiii4c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "iiii4d", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_DocumentModle";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_DocumentModle " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_DocumentModle  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除红头文件", "红头文件管理");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("DocumentModle_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
