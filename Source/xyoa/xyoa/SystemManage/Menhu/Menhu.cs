namespace xyoa.SystemManage.Menhu
{
    ...
    public class Menhu : Page
    {
        ...
        {
            base.Response.Redirect("Menhu_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "iiiib4", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "iiiib4", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "iiiib4", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_Menhu where 1=1";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_Menhu where 1=1" + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_Menhu  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除门户中心", "门户中心");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("Menhu_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
