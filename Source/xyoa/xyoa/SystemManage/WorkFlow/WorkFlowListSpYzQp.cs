namespace xyoa.SystemManage.WorkFlow
{
    ...
    public class WorkFlowListSpYzQp : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (list.Read())
            {
                ...
                base.Response.Write(string.Concat(new object[] { "<script language=javascript>window.opener.document.getElementById(\"strhtm\").innerHTML+=\"<img src='/seal/", this.DropDownList1.SelectedValue, "'  class='dragAble' style='width: 175px'  alt='印章名称：", this.DropDownList1.SelectedItem.Text, "&#10;操作人：", this.Session["realname"], "&#10;操作时间：", DateTime.Now.ToString(), "&#10;使用步骤：", base.Request.QueryString["NodeName"], "'/> \";window.close();</script>" }));
            }
            else
            {
