namespace xyoa.SystemManage.WorkFlow
{
    ...
    public class DIYForm_add_zdy : Page
    {
        ...
        {
            string sql = "insert into qp_oa_FormFile (leixing,sqlstr,KeyFile,Number,Name,Type,KxGuoLvUser,KxGuoLvName,BmGuoLvUser,BmGuoLvName) values ('" + this.leixing.SelectedValue + "','" + this.sqlstr.Text + "','" + this.Number.Text + "','" + this.TextBox2.Text + "','" + this.pulicss.GetFormatStr(this.Name.Text) + "','[常规型]','','','','')";
