namespace xyoa.SystemManage.WorkFlow
{
    ...
    public class WorkFlowName_show_add_node_bmzd : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (this.TargetListBox.Items.Count > 0)
            {
                ...
                str4 = string.Concat(new object[] { "Update qp_oa_WorkFlowNode  Set SecFileID='", str, "',SecFileName='", str2, "' where id='", int.Parse(base.Request.QueryString["id"]), "'" });
                this.List.ExeSql(str4);
            }
            else
            {
                str4 = "Update qp_oa_WorkFlowNode  Set SecFileID='',SecFileName='' where id='" + int.Parse(base.Request.QueryString["id"]) + "'";
                this.List.ExeSql(str4);
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                if (list.Read())
                {
                    ...
                    this.SecFileID.Text = list["SecFileID"].ToString();
                }
                list.Close();
