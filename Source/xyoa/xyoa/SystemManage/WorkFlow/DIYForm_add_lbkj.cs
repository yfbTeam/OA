namespace xyoa.SystemManage.WorkFlow
{
    ...
    public class DIYForm_add_lbkj : Page
    {
        protected Button Button1;
        protected HtmlForm form1;
        protected HtmlHead Head1;
        protected DropDownList kjname;
        ...
        {
            string sql = "insert into qp_oa_FormFile (KeyFile,Number,Name,Type,KxGuoLvUser,KxGuoLvName,BmGuoLvUser,BmGuoLvName) values ('" + this.Number.Text + "','" + this.TextBox2.Text + "','" + this.pulicss.GetFormatStr(this.Name.Text) + "','[常规型]','','','','')";
