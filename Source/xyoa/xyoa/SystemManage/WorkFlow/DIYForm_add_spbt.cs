namespace xyoa.SystemManage.WorkFlow
{
    ...
    public class DIYForm_add_spbt : Page
    {
        ...
        {
            string sql = "insert into qp_oa_FormFile (KeyFile,Number,Name,Type,KxGuoLvUser,KxGuoLvName,BmGuoLvUser,BmGuoLvName) values ('" + this.Number.Text + "','" + this.TextBox2.Text + "','" + this.pulicss.GetFormatStr(this.Name.Text) + "','[表单域]','','','','')";
