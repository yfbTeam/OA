namespace xyoa.SystemManage.Seal
{
    ...
    public class SealUseLog : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.DelData, "iiii3", this.Session["perstr"].ToString());
        ...
        {
            base.Response.Redirect("SealUseLog.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_SealUseLog   where 1=1";
            string str2 = "select count(id) from qp_oa_SealUseLog  where  1=1";
