namespace xyoa.SystemManage.Seal
{
    ...
    public class SealManagePb : Page
    {
        ...
        {
            base.Response.Redirect("SealManagePb_add.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_YinZhangPb    where 1=1";
            string str2 = "select count(id) from qp_oa_YinZhangPb   where  1=1";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "ShanChu")
            {
                ...
                str = "select * from qp_oa_YinZhangPb where id='" + num + "'";
                list = this.List.GetList(str);
                if (list.Read())
                {
                    string sql = "  Delete from qp_oa_YinZhangPb where ID='" + num + "'";
                    this.List.ExeSql(sql);
                    string str3 = "  Delete from qp_oa_YinZhang where Number='" + list["Number"] + "'";
            ...
            if (e.CommandName == "Tingzhi")
            {
                ...
                if (list.Read())
                {
                    ...
                    {
                        str4 = "Update qp_oa_YinZhangPb    Set State='正常' where id='" + num + "'";
                        this.List.ExeSql(str4);
                        str5 = "Update qp_oa_YinZhang    Set State='正常' where Number='" + list["Number"] + "'";
                        this.List.ExeSql(str5);
                    }
                    else
                    {
                        str4 = "Update qp_oa_YinZhangPb    Set State='停止' where id='" + num + "'";
                        this.List.ExeSql(str4);
                        str5 = "Update qp_oa_YinZhang    Set State='停止' where Number='" + list["Number"] + "'";
                        this.List.ExeSql(str5);
                    }
                    this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
            ...
            if (e.CommandName == "Chongzhi")
            {
                ...
                if (list.Read())
                {
                    string str6 = FormsAuthentication.HashPasswordForStoringInConfigFile("666666", "MD5");
                    str4 = string.Concat(new object[] { "Update qp_oa_YinZhangPb  Set Password='", str6, "' where id='", num, "'" });
                    this.List.ExeSql(str4);
                    str5 = string.Concat(new object[] { "Update qp_oa_YinZhang  Set Password='", str6, "' where Number='", list["Number"], "'" });
                    this.List.ExeSql(str5);
                    this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
