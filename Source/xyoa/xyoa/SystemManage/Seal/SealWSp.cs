namespace xyoa.SystemManage.Seal
{
    ...
    public class SealWSp : Page
    {
        ...
        {
            base.Response.Redirect("SealWSp.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_YinZhang  where State!='等待审批'";
            string str2 = "select count(id) from qp_oa_YinZhang where  State!='等待审批'";
