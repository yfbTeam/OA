namespace xyoa.WorkFlow
{
    ...
    public class WorkFlowNodeFF : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "mmmmb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "mmmmb", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("WorkFlowNodeFF.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select  id,Titles,IfRead,FsUsername,FsRealname,FsTime,Number  from qp_oa_AddWorkFlowFF  where IfDel='0' and  JsUsername='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_AddWorkFlowFF where  IfDel='0' and  JsUsername='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "delete from qp_oa_AddWorkFlowFF where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除工作流传阅", "工作流传阅");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
