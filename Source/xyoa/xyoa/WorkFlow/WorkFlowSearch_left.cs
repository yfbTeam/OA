namespace xyoa.WorkFlow
{
    ...
    public class WorkFlowSearch_left : Page
    {
        ...
        private void BindTree(TreeNodeCollection Nds)
        {
            ...
            while (list.Read())
            {
                ...
                while (reader2.Read())
                {
                    ...
                    node2.Text = string.Concat(new object[] { " <a href='WorkFlowSearch_show.aspx?id=", num2, "' target='nextrform'>", reader2["FormName"].ToString(), "</a>" });
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.pulicss.QuanXianVis(this.ListTreeView, "mmmm4", this.Session["perstr"].ToString());
            }
        }
    }
}
