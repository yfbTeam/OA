namespace xyoa
{
    ...
    public class senduser_update : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            base.Response.Redirect("senduser.aspx?user=" + base.Request.QueryString["user"].ToString() + "");
        }
