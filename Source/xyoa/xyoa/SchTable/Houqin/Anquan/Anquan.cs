namespace xyoa.SchTable.Houqin.Anquan
{
    ...
    public class Anquan : Page
    {
        ...
        {
            base.Response.Redirect("Anquan_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "pppp6ea", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "pppp6ec", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "pppp6ed", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("Anquan.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_sch_Anquan] as [A] where 1=1";
            string str2 = "select count(id) from qp_sch_Anquan as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_sch_Anquan  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除学生安全教育[" + this.CheckCbxNameDel() + "]", "学生安全教育");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("Anquan_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
