namespace xyoa.SchTable.Houqin.Xiaofang
{
    ...
    public class Xiaofang : Page
    {
        ...
        {
            base.Response.Redirect("Xiaofang_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "pppp6da", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "pppp6dc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "pppp6dd", this.Session["perstr"].ToString());
        }
        ...
        {
            base.Response.Redirect("Xiaofang.aspx");
        }
        ...
        public string CreateMidSql()
        {
            ...
            if (this.Weizhi.Text != "")
            {
                str = str + " and Weizhi like '%" + this.pulicss.GetFormatStr(this.Weizhi.Text) + "%'";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_sch_Xiaofang] as [A] where 1=1";
            string str2 = "select count(id) from qp_sch_Xiaofang as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_sch_Xiaofang  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除消防器材登记[" + this.CheckCbxNameDel() + "]", "消防器材登记");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("Xiaofang_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
