namespace xyoa.SchTable.Houqin.Jiaofei
{
    ...
    public class Jiaofei_left : Page
    {
        ...
        private void BindTree(TreeNodeCollection Nds)
        {
            ...
            while (list.Read())
            {
                ...
                while (reader2.Read())
                {
                    ...
                    node2.Text = string.Concat(new object[] { "<a href='Jiaofei_Lb.aspx?id=", num, "' target='nextrform'><font color=blue>", reader2["Mingcheng"].ToString(), "</font></a>" });
