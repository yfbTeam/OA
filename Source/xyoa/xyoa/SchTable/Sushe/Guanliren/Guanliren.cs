namespace xyoa.SchTable.Sushe.Guanliren
{
    ...
    public class Guanliren : Page
    {
        ...
        {
            base.Response.Redirect("Guanliren_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "pppp5eb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.AddData, "pppp5ea", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "pppp5ec", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "pppp5ed", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,C.Mingcheng from [qp_sch_SuSheGuanli] as [A] inner join [qp_sch_Gongyu] as [C] on [A].[JianzhuId] = [C].[Id] where 1=1";
            string str2 = "select count(A.id) from qp_sch_SuSheGuanli as [A] inner join [qp_sch_Gongyu] as [C] on [A].[JianzhuId] = [C].[Id] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_sch_SuSheGuanli  where ID in (" + str + ")";
        ...
        {
            base.Response.Redirect("Guanliren_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
