namespace xyoa.SchTable.Sushe.Sushe
{
    ...
    public class Sushe : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.Shengcheng, "pppp5ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.AddData, "pppp5ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "pppp5bc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "pppp5bd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*,C.Mingcheng from [qp_sch_Sushe] as [A] inner join [qp_sch_Gongyu] as [C] on [A].[JianzhuId] = [C].[Id] where 1=1";
            string str2 = "select count(A.id) from qp_sch_Sushe as [A] inner join [qp_sch_Gongyu] as [C] on [A].[JianzhuId] = [C].[Id] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_sch_Sushe  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除宿舍管理[" + this.CheckCbxNameDel() + "]", "宿舍管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        protected void Shengcheng_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("Sushe_sc.aspx");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("Sushe_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
