namespace xyoa.SchTable.Sushe.Fenpei
{
    ...
    public class Fenpei_Xx_Wfp : Page
    {
        ...
        protected void FenpeiData_Click(object sender, EventArgs e)
        {
            ...
            base.Response.Redirect("Fenpei_Xx_Wfp_Fp.aspx?XsId=" + this.CheckCbxUpdate() + "&Name=" + this.CheckCbxNameDel() + "&id=" + base.Request.QueryString["id"].ToString() + "");
        }
