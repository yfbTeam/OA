namespace xyoa.SchTable.Sushe.Fenpei
{
    ...
    public class Fenpei_Xx_Yfp : Page
    {
        ...
        public void BindAttribute()
        {
            ...
            this.FenpeiData.Attributes["onclick"] = "javascript:return sendfile();";
        ...
        {
            this.pulicss.QuanXianVis(this.FenpeiData, "pppp5c", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            return (str + " and C.Zhuxiao = '是'" + " and C.Sushe != '0'");
        }
        ...
        protected void FenpeiData_Click(object sender, EventArgs e)
        {
            string str = this.CheckCbxDel();
            base.Response.Redirect("Fenpei_Xx_Wfp_CxFp.aspx?XsId=" + this.CheckCbxUpdate() + "&Name=" + this.CheckCbxNameDel() + "&id=" + base.Request.QueryString["id"].ToString() + "");
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label label7 = (Label) e.Row.FindControl("Sushe");
                Label label8 = (Label) e.Row.FindControl("LSushe");
                ...
                label8.Text = this.divsch.TypeCode("Bianhao", "qp_sch_Sushe", label7.Text);
            }
        }
