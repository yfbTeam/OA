namespace xyoa.SchTable.Sushe.Gongyu
{
    ...
    public class Gongyu : Page
    {
        ...
        {
            base.Response.Redirect("Gongyu_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "pppp5aa", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "pppp5ac", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "pppp5ad", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_sch_Gongyu] as [A] where 1=1";
            string str2 = "select count(id) from qp_sch_Gongyu as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_sch_Gongyu  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除公寓信息[" + this.CheckCbxNameDel() + "]", "公寓信息");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("Gongyu_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
