namespace xyoa.SchTable.Chengji.Dengdi
{
    ...
    public class Dengdi : Page
    {
        ...
        {
            base.Response.Redirect("Dengdi_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "pppp3fb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.AddData, "pppp3fa", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "pppp3fc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "pppp3fd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_sch_Dengdi] as [A] where 1=1";
            string str2 = "select count(id) from qp_sch_Dengdi as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_sch_Dengdi  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除分数等第转换[" + this.CheckCbxNameDel() + "]", "分数等第转换");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("Dengdi_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
