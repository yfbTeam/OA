    ...
    public class Biangeng_xn : Page
    {
        ...
        private void BindTree(TreeNodeCollection Nds)
        {
            ...
            while (list.Read())
            {
                ...
                child.Text = " <a href='Biangeng_Rz.aspx?Xueqi=" + list["Mingcheng"].ToString() + "' target='nextrform'>" + list["Mingcheng"].ToString() + "</a>";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                child.Text = "<a href='Biangeng_Rz.aspx?Xueqi=all' target='nextrform'>全部学期</a>";
                child.SelectAction = TreeNodeSelectAction.None;
                child.Expanded = false;
