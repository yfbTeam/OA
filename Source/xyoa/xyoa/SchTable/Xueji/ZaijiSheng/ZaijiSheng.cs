namespace xyoa.SchTable.Xueji.ZaijiSheng
{
    ...
    public class ZaijiSheng : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.FONT1, "pppp2aa", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.FONT2, "pppp2aa", this.Session["perstr"].ToString());
