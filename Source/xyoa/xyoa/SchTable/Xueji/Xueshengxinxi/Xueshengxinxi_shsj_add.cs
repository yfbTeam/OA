namespace xyoa.SchTable.Xueji.Xueshengxinxi
{
    ...
    public class Xueshengxinxi_shsj_add : Page
    {
        ...
        {
            string sql = "insert into qp_sch_Stu_shsj   (XsId,Xueqi,Xueduan,Xiangmu,Shijian,Dizhi,Miaoshu) values ('" + this.XsId.SelectedValue + "','" + this.Xueqi.SelectedValue + "','" + this.Xueduan.SelectedValue + "','" + this.pulicss.GetFormatStr(this.Xiangmu.Text) + "','" + this.pulicss.GetFormatStr(this.Shijian.Text) + "','" + this.pulicss.GetFormatStr(this.Dizhi.Text) + "','" + this.pulicss.GetFormatStr(this.Miaoshu.Text) + "')";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("新增社会实践[" + this.XsId.SelectedItem.Text + "]", "社会实践");
            ...
            {
                base.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='Xueshengxinxi_shsj.aspx?id=" + this.Banji.SelectedValue + "&Xueduan=" + base.Request.QueryString["Xueduan"] + "&Xueqi=" + base.Request.QueryString["Xueqi"] + "'</script>");
            }
        }
