namespace xyoa.SchTable.Xueji.Xueshengxinxi
{
    ...
    public class Xueshengxinxi_jtxx_add : Page
    {
        ...
        {
            string sql = "insert into qp_sch_Stu_jtxx   (XsId,Xingming,Guanxi,Dianhua,Youzheng,Xinxiang,Dizhi,Danwei,DwDizhi,Zhiwu,Xiuxiri,Techang,Yixiang,Jilu) values ('" + this.XsId.SelectedValue + "','" + this.pulicss.GetFormatStr(this.Xingming.Text) + "','" + this.pulicss.GetFormatStr(this.Guanxi.Text) + "','" + this.pulicss.GetFormatStr(this.Dianhua.Text) + "','" + this.pulicss.GetFormatStr(this.Youzheng.Text) + "','" + this.pulicss.GetFormatStr(this.Xinxiang.Text) + "','" + this.pulicss.GetFormatStr(this.Dizhi.Text) + "','" + this.pulicss.GetFormatStr(this.Danwei.Text) + "','" + this.pulicss.GetFormatStr(this.DwDizhi.Text) + "','" + this.pulicss.GetFormatStr(this.Zhiwu.Text) + "','" + this.pulicss.GetFormatStr(this.Xiuxiri.Text) + "','" + this.pulicss.GetFormatStr(this.Techang.Text) + "','" + this.pulicss.GetFormatStr(this.Yixiang.Text) + "','" + this.pulicss.GetFormatStr(this.Jilu.Text) + "')";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("新增家庭信息[" + this.XsId.SelectedItem.Text + "]", "家庭信息");
            ...
            {
                base.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='Xueshengxinxi_jtxx.aspx?id=" + this.Banji.SelectedValue + "&Xueduan=" + base.Request.QueryString["Xueduan"] + "&Xueqi=" + base.Request.QueryString["Xueqi"] + "'</script>");
            }
        }
