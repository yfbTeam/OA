namespace xyoa.SchTable.Xueji.Xueshengxinxi
{
    ...
    public class Xueshengxinxi_qtxx_add : Page
    {
        ...
        {
            string sql = "insert into qp_sch_Stu_qtxx   (XsId,Xueqi,Xueduan,Xiaochehao,Yanchangban,Tigaoban,Dabiao,Yixiao,Leyuan,Qita) values ('" + this.XsId.SelectedValue + "','" + this.Xueqi.SelectedValue + "','" + this.Xueduan.SelectedValue + "','" + this.pulicss.GetFormatStr(this.Xiaochehao.Text) + "','" + this.pulicss.GetFormatStr(this.Yanchangban.Text) + "','" + this.pulicss.GetFormatStr(this.Tigaoban.Text) + "','" + this.pulicss.GetFormatStr(this.Dabiao.Text) + "','" + this.pulicss.GetFormatStr(this.Yixiao.Text) + "','" + this.pulicss.GetFormatStr(this.Leyuan.Text) + "','" + this.pulicss.GetFormatStr(this.Qita.Text) + "')";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("新增其他信息[" + this.XsId.SelectedItem.Text + "]", "其他信息");
            ...
            {
                base.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='Xueshengxinxi_qtxx.aspx?id=" + this.Banji.SelectedValue + "&Xueduan=" + base.Request.QueryString["Xueduan"] + "&Xueqi=" + base.Request.QueryString["Xueqi"] + "'</script>");
            }
        }
