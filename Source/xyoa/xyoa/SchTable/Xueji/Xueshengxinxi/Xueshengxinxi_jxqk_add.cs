namespace xyoa.SchTable.Xueji.Xueshengxinxi
{
    ...
    public class Xueshengxinxi_jxqk_add : Page
    {
        ...
        {
            string sql = "insert into qp_sch_Stu_jxqk   (XsId,Xueqi,Xueduan,Budui,Chengji,Kaishi,Jieshu) values ('" + this.XsId.SelectedValue + "','" + this.Xueqi.SelectedValue + "','" + this.Xueduan.SelectedValue + "','" + this.pulicss.GetFormatStr(this.Budui.Text) + "','" + this.pulicss.GetFormatStr(this.Chengji.Text) + "','" + this.pulicss.GetFormatStr(this.Kaishi.Text) + "','" + this.pulicss.GetFormatStr(this.Jieshu.Text) + "')";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("新增军训情况[" + this.XsId.SelectedItem.Text + "]", "军训情况");
            ...
            {
                base.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='Xueshengxinxi_jxqk.aspx?id=" + this.Banji.SelectedValue + "&Xueduan=" + base.Request.QueryString["Xueduan"] + "&Xueqi=" + base.Request.QueryString["Xueqi"] + "'</script>");
            }
        }
