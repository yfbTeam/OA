namespace xyoa.SchTable.Paike
{
    ...
    public class Shoudong_left : Page
    {
        ...
        private void BindTree(TreeNodeCollection Nds)
        {
            ...
            while (list.Read())
            {
                ...
                while (reader2.Read())
                {
                    ...
                    node2.Text = string.Concat(new object[] { "<a href='Shoudong_Pk.aspx?id=", num, "' target='nextrform'><font color=blue>", reader2["Mingcheng"].ToString(), "</font></a>" });
