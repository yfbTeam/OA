namespace xyoa.SchTable.Paike
{
    ...
    public class Jiaoshi_Pk : Page
    {
        ...
        {
            this.ViewState["Mingcheng"] = base.Request.QueryString["LsRealname"].ToString();
            string sql = "select A.Jieci,A.Xingqi,A.Kecheng,B.Mingcheng from qp_sch_KechengBiao as [A] inner join [qp_sch_Banji] as [B] on [A].[Banji] = [B].[Id] where A.Xueqi='" + this.Xueqi.SelectedValue + "' and A.Xueduan='" + this.Xueduan.SelectedValue + "' and A.LsUsername='" + this.pulicss.GetFormatStr(base.Request.QueryString["LsUsername"]) + "' order by A.id asc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (base.Request.QueryString["LsUsername"] != null)
                {
                    if (base.Request.QueryString["LsUsername"].ToString() == "0")
                    {
