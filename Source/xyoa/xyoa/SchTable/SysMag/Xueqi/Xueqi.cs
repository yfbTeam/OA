namespace xyoa.SchTable.SysMag.Xueqi
{
    ...
    public class Xueqi : Page
    {
        ...
        {
            base.Response.Redirect("Xueqi_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "pppp7aa", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "pppp7ac", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "pppp7ad", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_sch_Xueqi] as [A] where 1=1";
            string str2 = "select count(id) from qp_sch_Xueqi as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_sch_Xueqi  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除学期设置[" + this.CheckCbxNameDel() + "]", "学期设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("Xueqi_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
