namespace xyoa.SchTable.SysMag.Banji
{
    ...
    public class Banji : Page
    {
        ...
        {
            base.Response.Redirect("Banji_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "pppp7ca", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "pppp7cc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "pppp7cd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.* from [qp_sch_Banji] as [A] where 1=1";
            string str2 = "select count(A.id) from [qp_sch_Banji] as [A] where 1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_sch_Banji  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除班级设置[" + this.CheckCbxNameDel() + "]", "班级设置");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                this.list.Bind_DropDownList_kong(this.Xueqi, sQL, "Mingcheng", "Mingcheng");
        ...
        protected void Piliang_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("Banji_pl.aspx");
        }
        ...
        {
            base.Response.Redirect("Banji_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
