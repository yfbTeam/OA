namespace xyoa.InfoManage.toupiao
{
    ...
    public class toupiaobt : Page
    {
        ...
        {
            base.Response.Redirect("toupiaobt_add.aspx");
        }
        ...
        public void Bindquanxian()
        {
            ...
            this.pulicss.QuanXianVis(this.DelData, "aaaa6b", this.Session["perstr"].ToString());
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_toupiaobt where username='" + this.Session["username"] + "' ";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = string.Concat(new object[] { "select * from qp_oa_toupiaobt  where username='", this.Session["username"], "' ", Sqlsort, "" });
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_toupiaobt  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            string str3 = "  Delete from qp_oa_toupiao  where bigid in (" + str + ")";
            this.List.ExeSql(str3);
            this.pulicss.InsertLog("删除投票项", "投票管理");
            this.DataBindToGridview(this.SortText.Value);
        }
