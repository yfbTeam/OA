namespace xyoa.InfoManage.zhiao
{
    ...
    public class ziliao_search : Page
    {
        ...
        public string CreateMidSql()
        {
            ...
            if (base.Request.QueryString["title"] != "")
            {
                str = str + " and A.Name like '%" + this.pulicss.GetFormatStr(base.Server.UrlDecode(base.Request.QueryString["title"])) + "%'";
            }
            return str;
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label label3 = (Label) e.Row.FindControl("Lname");
                Label label4 = (Label) e.Row.FindControl("Lid");
                Label label5 = (Label) e.Row.FindControl("Sname");
                label5.Text = "<a href='javascript:void(0)' onclick='m_show(\"" + label4.Text + "\")'>" + label3.Text.Replace(base.Server.UrlDecode(base.Request.QueryString["title"]), "<font color=\"blue\">" + base.Server.UrlDecode(base.Request.QueryString["title"]) + "</font>") + "</a>";
                label2.Text = null;
