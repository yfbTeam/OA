namespace xyoa.InfoManage.zhiao
{
    ...
    public class wenti_tj_show : Page
    {
        ...
        public void DataBindToGridview()
        {
            ...
            if (list.Read())
            {
                ...
                this.ViewState["Dengji"] = "<img src=\"img/" + this.pulicss.JiFenDengji(list["Username"].ToString()) + "\">";
            ...
            if (reader3.Read())
            {
                ...
                this.ViewState["DengjiZj"] = "<img src=\"img/" + this.pulicss.JiFenDengji(reader3["Username"].ToString()) + "\">";
            }
            reader3.Close();
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = "Update qp_oa_Zst_wenti   Set Dianji=Dianji+1  where id='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "'";
                this.List.ExeSql(sql);
                this.DataBindToGridview();
            }
        }
