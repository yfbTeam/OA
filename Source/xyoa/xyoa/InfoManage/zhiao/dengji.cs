    ...
    public class dengji : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow row in this.GridView4.Rows)
            {
                ...
                string sql = string.Concat(new object[] { "Update qp_oa_Zst_dengji  Set Fenshu1='", ((TextBox) row.FindControl("Fenshu1")).Text.Trim(), "',Fenshu2='", ((TextBox) row.FindControl("Fenshu2")).Text.Trim(), "' where id='", num, "'" });
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.pulicss.QuanXianVis(this.GridView4, "aaaa1a5", this.Session["perstr"].ToString());
