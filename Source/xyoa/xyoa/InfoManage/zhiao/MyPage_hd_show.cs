namespace xyoa.InfoManage.zhiao
{
    ...
    public class MyPage_hd_show : Page
    {
        ...
        public void DataBindToGridview()
        {
            ...
            string sql = string.Concat(new object[] { "select * from qp_oa_Zst_wenti  where id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "' and  CHARINDEX(',", this.Session["username"], ",',','+UsernameHd+',')   >0" });
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = string.Concat(new object[] { "Update qp_oa_Zst_wenti   Set Dianji=Dianji+1  where id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "' and  CHARINDEX(',", this.Session["username"], ",',','+UsernameHd+',')   >0" });
                this.List.ExeSql(sql);
                this.DataBindToGridview();
            }
        }
