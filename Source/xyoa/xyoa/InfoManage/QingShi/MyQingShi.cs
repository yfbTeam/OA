namespace xyoa.InfoManage.QingShi
{
    ...
    public class MyQingShi : Page
    {
        ...
        {
            base.Response.Redirect("MyQingShi_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "aaaa8aa", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "aaaa8ac", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "aaaa8ab", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "aaaa8ad", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and JsUsername like '%" + this.pulicss.GetFormatStr(this.JsUsername.Text) + "%'";
            }
            if (this.TxTime.Text != "")
            {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,Titles,JsRealname,JsUsername,State,TxTime from qp_oa_QingShi  where username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_QingShi where username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_QingShi  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除请示报告", "请示报告");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("MyQingShi_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("MyQingShi_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
