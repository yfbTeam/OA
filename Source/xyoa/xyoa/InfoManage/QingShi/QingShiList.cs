namespace xyoa.InfoManage.QingShi
{
    ...
    public class QingShiList : Page
    {
        ...
        public void BindAttribute()
        {
            ...
            this.TxTime.Attributes.Add("readonly", "readonly");
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "aaaa8b", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and Username like '%" + this.pulicss.GetFormatStr(this.Username.Text) + "%'";
            }
            if (this.TxTime.Text != "")
            {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,Titles,Realname,Username,State,TxTime from qp_oa_QingShi  where JsUsername='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_QingShi where JsUsername='" + this.Session["username"] + "'";
