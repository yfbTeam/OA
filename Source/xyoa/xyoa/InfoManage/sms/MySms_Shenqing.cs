namespace xyoa.InfoManage.sms
{
    ...
    public class MySms_Shenqing : Page
    {
        ...
        {
            base.Response.Redirect("MySms_Sead.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "aaaa4a", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "aaaa4a", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and A.Content like '%" + this.pulicss.GetFormatStr(this.Content.Text) + "%'";
            }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str2 = ("select A.*  from [qp_oa_shouji] as [A]  where A.Username='" + this.Session["username"] + "'") + SqlCreate;
            string sql = "" + str2 + " " + Sqlsort + "";
            this.GridView1.DataSource = this.List.GetGrid_Pages_not(sql);
            this.GridView1.DataBind();
            string str5 = ("select count(A.id) from [qp_oa_shouji] as [A]  where A.Username='" + this.Session["username"] + "'") + SqlCreate;
            this.CountsLabel.Text = "" + this.List.GetCount(str5) + "";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "ShanChu")
            {
                ...
                string sql = "delete from qp_oa_shouji where id='" + num + "'";
            ...
            {
                num = Convert.ToInt32(e.CommandArgument);
                string str2 = "Update qp_oa_shouji  Set LcZhuangtai='4'  where id='" + num + "'";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                button.Attributes.Add("onclick", "javascript:return confirm('确认删除此短信发送吗')");
                LinkButton button2 = (LinkButton) e.Row.FindControl("Zhongzhi");
                button2.Attributes.Add("onclick", "javascript:return confirm('确认终止此短信发送吗')");
                Label label3 = (Label) e.Row.FindControl("Lzt");
                Label label4 = (Label) e.Row.FindControl("Label3");
                if (label3.Text == "1")
                {
                    label4.Text = "<a href='MySms_Shenqing_update.aspx?id=" + label.Text + "'>修改</a>";
                    button.Visible = true;
