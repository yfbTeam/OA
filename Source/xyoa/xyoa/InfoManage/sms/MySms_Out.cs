namespace xyoa.InfoManage.sms
{
    ...
    public class MySms_Out : Page
    {
        ...
        {
            base.Response.Redirect("MySms_Out.aspx");
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and convert(char(10),cast(s_time as datetime),120)=convert(char(10),cast('" + this.Settimes.Text + "' as datetime),120) ";
            }
            return str;
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from send_info where s_userid='" + this.Session["username"] + "' and s_style=0";
            string str2 = "select count(id) from send_info where s_userid='" + this.Session["username"] + "' and s_style=0";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            this.pulicss.InsertLog("删除待发送短信", "待发送短信");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
