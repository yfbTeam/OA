namespace xyoa.InfoManage.filesend
{
    ...
    public class InfoSend : Page
    {
        ...
        {
            base.Response.Redirect("InfoSend_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "aaaa9bb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.AddData, "aaaa9ba", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "aaaa9bc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "aaaa9bb", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "aaaa9bd", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,Name,Filetype,Settime,Username,Realname from qp_oa_InfoSend where Username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_InfoSend where   Username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_InfoSend  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除文件传阅", "文件传阅");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("InfoSend_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("InfoSend_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
