namespace xyoa.InfoManage.filesend
{
    ...
    public class JsInfoSend : Page
    {
        ...
        {
            this.pulicss.QuanXianVis(this.GridView1, "aaaa9ba", this.Session["perstr"].ToString());
        }
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and Username = '" + this.FsUsername.Text + "'";
            }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select id,Name,Filetype,Settime,Username,Realname from qp_oa_InfoSend where CHARINDEX('," + this.Session["username"] + ",',','+JsUsername+',') > 0";
            string str2 = "select count(id) from qp_oa_InfoSend where   CHARINDEX('," + this.Session["username"] + ",',','+JsUsername+',') > 0";
