namespace xyoa.InfoManage.YjBox
{
    ...
    public class MyYjBox : Page
    {
        ...
        {
            base.Response.Redirect("MyYjBox_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "aaaa5aa", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "aaaa5ac", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.ShowData, "aaaa5ab", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "aaaa5ad", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.id,A.Titles,A.TxTime,A.Username,A.IfHf, C.Name from [qp_oa_YjBox] as [A] join [qp_oa_YjBoxSz] as [C] on [A].[BoxId] = [C].id where A.Username='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_YjBox where   Username='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            this.pulicss.InsertLog("删除我的意见", "我的意见");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("MyYjBox_show.aspx?id=" + this.CheckCbxUpdate() + "");
        }

        protected void UpdateData_Click(object sender, EventArgs e)
        {
            base.Response.Redirect("MyYjBox_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
