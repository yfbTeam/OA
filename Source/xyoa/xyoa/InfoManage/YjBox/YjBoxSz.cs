namespace xyoa.InfoManage.YjBox
{
    ...
    public class YjBoxSz : Page
    {
        ...
        {
            base.Response.Redirect("YjBoxSz_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "aaaa5ca", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "aaaa5cc", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "aaaa5cd", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.GridView1, "aaaa5cb", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_YjBoxSz  ";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select id,Name,Realname from qp_oa_YjBoxSz  " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_YjBoxSz  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除意见箱", "意见箱维护");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("YjBoxSz_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
