namespace xyoa.InfoManage.wbemail
{
    ...
    public class OutEmail : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_crm_CustomerLx where  Username='" + this.Session["username"] + "' and edit_flag=0";
            string str2 = "select count(id) from qp_crm_CustomerLx where  Username='" + this.Session["username"] + "' and edit_flag=0";
