namespace xyoa.InfoManage.Taolunzu
{
    ...
    public class TaolunzuMy : Page
    {
        ...
        {
            base.Response.Redirect("TaolunzuMy_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "aaaac1", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "aaaac1", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "aaaac1", this.Session["perstr"].ToString());
        }
        ...
        {
            string sql = "select count(id) from  qp_oa_Taolunzu";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_Taolunzu " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_Taolunzu  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除讨论组", "讨论组");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("TaolunzuMy_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
