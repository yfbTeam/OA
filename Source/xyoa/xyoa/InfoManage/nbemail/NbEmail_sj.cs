namespace xyoa.InfoManage.nbemail
{
    ...
    public class NbEmail_sj : Page
    {
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and FsUsername = '" + this.FsUsername.Text + "'";
            }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select  id,Titles,IfRead,FsUsername,FsRealname,FsTime,Number  from qp_oa_NbEmail_sj  where IfDel='0' and  JsUsername='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_NbEmail_sj where  IfDel='0' and  JsUsername='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "Update qp_oa_NbEmail_sj  Set IfDel='1' where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除内部邮件", "收件箱");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Label label3 = (Label) e.Row.FindControl("LabVisible");
                label2.Text = null;
                ...
                if (list.Read())
                {
                    ...
                    while (reader2.Read())
                    {
                        ...
                        label2.Text = text + " <td width=100% ><img src=\"/oaimg/filetype/" + reader2["filetype"].ToString() + ".gif\" align=\"baseline\"/> <a href=NbEmail_sj_down.aspx?number=" + reader2["NewName"].ToString() + "&id=" + label3.Text + "  target=_blank>" + reader2["Name"].ToString() + "</a><a href='javascript:void(0)' onclick=\"fileadd('" + reader2["NewName"].ToString() + "')\" class=zccss>[转存]</a></td>";
                        num++;
                        if (num == 1)
                        {
