namespace xyoa.InfoManage.nbemail
{
    ...
    public class NbEmail_cg : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select  id,Titles,FsUsername,FsRealname,JsRealname,JsUsername,FsTime,Number  from qp_oa_NbEmail_cg  where  FsUsername='" + this.Session["username"] + "'";
            string str2 = "select count(id) from qp_oa_NbEmail_cg where   FsUsername='" + this.Session["username"] + "'";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_NbEmail_cg  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除内部邮件", "草稿箱");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
