namespace xyoa.InfoManage.nbemail
{
    ...
    public class Info_left : Page
    {
        ...
        {
            string sql = "select id,urlname,url,pic,quanxian from qp_oa_AllUrl where (CHARINDEX(''+quanxian+'','" + this.ViewState["qxstr"] + "')   >   0 ) and ParentNodesID='148'  order by Paixu asc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.pulicss.QuanXianVis(this.ListTreeView, "aaaa2", this.Session["perstr"].ToString());
            }
        }
    }
}
