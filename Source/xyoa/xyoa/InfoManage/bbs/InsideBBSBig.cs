namespace xyoa.InfoManage.bbs
{
    ...
    public class InsideBBSBig : Page
    {
        ...
        {
            base.Response.Redirect("InsideBBSBig_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "aaaa7b", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "aaaa7b", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "aaaa7b", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select * from qp_oa_InsideBBSBig where 1=1";
            string str2 = "select count(id) from qp_oa_InsideBBSBig where  1=1";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_InsideBBSBig  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除版块", "版块管理");
            this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
        }
        ...
        {
            base.Response.Redirect("InsideBBSBig_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
