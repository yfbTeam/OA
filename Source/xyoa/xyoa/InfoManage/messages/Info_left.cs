namespace xyoa.InfoManage.messages
{
    ...
    public class Info_left : Page
    {
        ...
        {
            string sql = "select id,urlname,url,pic,quanxian from qp_oa_AllUrl where (CHARINDEX(''+quanxian+'','" + this.ViewState["qxstr"] + "')   >   0 ) and ParentNodesID='143'  order by Paixu asc";
