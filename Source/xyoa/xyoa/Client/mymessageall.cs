namespace xyoa.Client
{
    ...
    public class mymessageall : Page
    {
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select   id,titles,itimes,acceptusername,acceptrealname,sfck,sendusername,sendrealname  from qp_oa_Messages  where  acceptusername='" + this.Session["username"] + "' and tablekey='1'  order by id desc";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (list.Read())
                {
                    ...
                    {
                        label2.Text = string.Concat(new object[] { "<a href=\"messagealldel.aspx?yyid=", list["id"].ToString(), "&user=", this.Session["username"], "&pwd=", base.Request.QueryString["pwd"].ToString(), "\">已阅</a>&nbsp;" });
                    }
