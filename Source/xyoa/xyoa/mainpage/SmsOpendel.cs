        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (base.Request.QueryString["delid"] != null)
                {
                    ...
                    str2 = "Update qp_oa_Messages  Set sfck='1' , CkTime='" + DateTime.Now.ToString() + "' where number='" + base.Request.QueryString["number"] + "' and sfck='0' and tablekey='2'";
                    this.List.ExeSql(str2);
                    base.Response.Redirect("SmsOpen.aspx");
                }
                ...
                {
                    str2 = string.Concat(new object[] { "Update qp_oa_Messages  Set sfck='1' , CkTime='", DateTime.Now.ToString(), "' where acceptusername='", this.Session["username"], "' and sfck='0' and tablekey='1'" });
                    this.List.ExeSql(str2);
                    str = "  Delete from qp_oa_Messages  where acceptusername='" + this.Session["username"] + "' and sfck='0' and tablekey='2'";
                    this.List.ExeSql(str);
                    base.Response.Redirect("SmsOpen.aspx");
                }
            }
