namespace xyoa.Resources.ResMg
{
    ...
    public class MyResJyApplyYsp : Page
    {
        ...
        {
            base.Response.Redirect("MyResJyApplyYsp.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*, C.ZyName, C.ZyNum from [qp_oa_ResAppJy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where  CHARINDEX('," + this.Session["username"] + ",',','+YjbUser+',')   >0";
            string str2 = "select count(A.id) from [qp_oa_ResAppJy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where  CHARINDEX('," + this.Session["username"] + ",',','+YjbUser+',')   >0";
