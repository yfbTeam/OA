namespace xyoa.Resources.ResMg
{
    ...
    public class MyResJyApply : Page
    {
        ...
        public void Bindquanxian()
        {
            ...
            this.pulicss.QuanXianVis(this.GridView1, "bbbb2e", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*, C.ZyName, C.ZyNum from [qp_oa_ResAppJy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where CHARINDEX('," + this.Session["username"] + ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2')";
            string str2 = "select count(A.id) from [qp_oa_ResAppJy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where CHARINDEX('," + this.Session["username"] + ",',','+DqBlUsername+',')   >0 and (LcZhuangtai='1' or LcZhuangtai='2')";
