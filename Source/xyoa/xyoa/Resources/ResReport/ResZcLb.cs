        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                try
                {
                    ...
                    {
                        string str3 = "select id,Name from qp_oa_ResourcesType  order by id asc";
                        int num = 1;
                        ...
                        while (list.Read())
                        {
                            ...
                            object obj2;
                            string str4 = "select count(id) from qp_oa_ResourcesAdd where ZyLeibie='" + list["id"].ToString() + "'";
