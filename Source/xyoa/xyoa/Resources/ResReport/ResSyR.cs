namespace xyoa.Resources.ResReport
{
    ...
    public class ResSyR : Page
    {
        ...
        {
            base.Response.Redirect("ResSyR.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*, C.ZyName, C.ZyNum from [qp_oa_ResAppSy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where 1=1";
            string str2 = "select count(A.id) from [qp_oa_ResAppSy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where 1=1";
