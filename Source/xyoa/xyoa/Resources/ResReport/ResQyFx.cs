namespace xyoa.Resources.ResReport
{
    ...
    public class ResQyFx : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.pulicss.QuanXianBack("bbbb3i", this.Session["perstr"].ToString());
                try
                {
                    ...
                    {
                        string str3 = "select id,Name from qp_oa_ResourcesQuyu  order by id asc";
                        int num = 1;
                        ...
                        while (list.Read())
                        {
                            ...
                            object obj2;
                            string str4 = "select count(id) from qp_oa_ResourcesAdd where Quyu='" + list["id"].ToString() + "'";
