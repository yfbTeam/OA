namespace xyoa.Resources.MyRes
{
    ...
    public class MyResJy : Page
    {
        ...
        {
            base.Response.Redirect("MyResJy.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort, string SqlCreate)
        {
            ...
            string str = "select A.*, C.ZyName, C.ZyNum from [qp_oa_ResAppJy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where (A.Username='" + this.Session["username"] + "') ";
            string str2 = "select count(A.id) from [qp_oa_ResAppJy] as [A] join [qp_oa_ResourcesAdd] as [C] on [A].[ZyId] = [C].id where (A.Username='" + this.Session["username"] + "')";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Baofei")
            {
                ...
                string sql = "select ZyId,Shuliang from qp_oa_ResAppJy where id='" + num + "'";
                SqlDataReader list = this.List.GetList(sql);
                if (list.Read())
                {
                    str2 = "Update qp_oa_ResAppJy  Set WpStates='3'  where ID='" + num + "'";
                    this.List.ExeSql(str2);
                    string str3 = "  Delete from qp_oa_MyRes  where KeyId='" + num + "' and  Laiyuan='借用'";
                    this.List.ExeSql(str3);
                    string str4 = string.Concat(new object[] { "Update qp_oa_ResourcesAdd    Set KuCun=KuCun+", list["Shuliang"], " where id='", list["ZyId"], "'" });
            ...
            {
                num = Convert.ToInt32(e.CommandArgument);
                string str5 = "delete from qp_oa_ResAppJy where id='" + num + "'";
            ...
            {
                num = Convert.ToInt32(e.CommandArgument);
                str2 = "Update qp_oa_ResAppJy  Set LcZhuangtai='4'  where id='" + num + "'";
                this.List.ExeSql(str2);
                this.DataBindToGridview(this.SortText.Value, this.CreateMidSql());
            }
        }
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (label2.Text == "1")
                {
                    label3.Text = "<a href='MyResJy_update.aspx?id=" + label.Text + "'>修改</a>";
                    button.Visible = true;
                ...
                if (label4.Text == "2")
                {
                    ...
                    button3.Attributes.Add("onclick", "javascript:return confirm('确认归还此物品吗？')");
                }
                else
                {
