namespace xyoa.Resources.MyRes
{
    ...
    public class MyResSy_update : Page
    {
        ...
        {
            string sql = string.Concat(new object[] { "Update qp_oa_ResAppSy  Set  Shuliang='", this.pulicss.GetFormatStr(this.Shuliang.Text), "',Liyou='", this.pulicss.GetFormatStr(this.Liyou.Text), "'  where id='", int.Parse(base.Request.QueryString["id"]), "'  and Username='", this.Session["username"], "' " });
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("修改物品使用", "物品使用");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                string sql = string.Concat(new object[] { "select * from qp_oa_ResAppSy  where id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "'  and  Username='", this.Session["username"], "'" });
