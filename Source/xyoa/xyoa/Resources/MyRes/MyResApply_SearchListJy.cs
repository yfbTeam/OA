namespace xyoa.Resources.MyRes
{
    ...
    public class MyResApply_SearchListJy : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else if (this.ZbRealname.Text != "")
            {
                ...
                string sql = string.Concat(new object[] { 
                    "insert into qp_oa_ResAppJy  (FormId,Starttime,Endtime,WpStates,Number,DqBlUsername,DqBlXinming,LcZhuangtai,YjbUser,GlNum,DqNodeId,DqNodeName,YjbNodeId,SNodeId,ZyId,Shuliang,Liyou,Username,Realname,NowTimes) values ('", this.FormId.SelectedValue, "','", this.Starttime.Text, "','", this.Endtime.Text, "','1','", this.Number.Text, "','", this.ZbUsername.Text, "','", this.ZbRealname.Text, "','1','','", glNum, "','", this.FormName.SelectedValue, 
                ...
                base.Response.Write("<script language=javascript>alert('提交成功！');window.location.href='MyResJy.aspx'</script>");
            }
            else
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                string str3 = string.Concat(new object[] { "select id,Name from qp_pro_WorkFlow where (CHARINDEX(',", this.Session["BuMenId"], ",',','+ZdBumenId+',') > 0 and States='2') or (CHARINDEX(',", this.Session["username"], ",',','+ZdUsername+',') > 0 and States='3') or (States='1') and FormId='13'" });
