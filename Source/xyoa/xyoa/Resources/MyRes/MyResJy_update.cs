namespace xyoa.Resources.MyRes
{
    ...
    public class MyResJy_update : Page
    {
        ...
        {
            string sql = string.Concat(new object[] { "Update qp_oa_ResAppJy  Set  Shuliang='", this.pulicss.GetFormatStr(this.Shuliang.Text), "',Starttime='", this.pulicss.GetFormatStr(this.Starttime.Text), "',Endtime='", this.pulicss.GetFormatStr(this.Endtime.Text), "',Liyou='", this.pulicss.GetFormatStr(this.Liyou.Text), "'  where id='", int.Parse(base.Request.QueryString["id"]), "'  and Username='", this.Session["username"], "' " });
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("修改物品借用", "物品借用");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                string sql = string.Concat(new object[] { "select * from qp_oa_ResAppJy  where id='", this.pulicss.GetFormatStr(base.Request.QueryString["id"]), "'  and  Username='", this.Session["username"], "'" });
                ...
                if (list.Read())
                {
                    ...
                    this.Liyou.Text = list["Liyou"].ToString();
