namespace xyoa.Resources.ResSet
{
    ...
    public class ResourcesType : Page
    {
        ...
        {
            base.Response.Redirect("ResourcesType_add.aspx");
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_ResourcesType";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_ResourcesType " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_ResourcesType  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除物品类别", "物品类别");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("ResourcesType_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
