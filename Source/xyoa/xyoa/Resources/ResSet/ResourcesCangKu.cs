namespace xyoa.Resources.ResSet
{
    ...
    public class ResourcesCangKu : Page
    {
        ...
        {
            base.Response.Redirect("ResourcesCangKu_add.aspx");
        }
        ...
        {
            this.pulicss.QuanXianVis(this.AddData, "bbbb4c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.UpdateData, "bbbb4c", this.Session["perstr"].ToString());
            this.pulicss.QuanXianVis(this.DelData, "bbbb4c", this.Session["perstr"].ToString());
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_oa_ResourcesCangKu";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_oa_ResourcesCangKu " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_oa_ResourcesCangKu  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除仓库设置", "仓库设置");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        {
            base.Response.Redirect("ResourcesCangKu_update.aspx?id=" + this.CheckCbxUpdate() + "");
        }
    }
}
