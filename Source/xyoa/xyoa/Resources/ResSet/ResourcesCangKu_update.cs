namespace xyoa.Resources.ResSet
{
    ...
    public class ResourcesCangKu_update : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            string sql = string.Concat(new object[] { 
                "Update qp_oa_ResourcesCangKu  Set  Name='", this.pulicss.GetFormatStr(this.Name.Text), "',States='", this.States.SelectedValue, "',ZdBumenId='", this.ZdBumenId.Text, "',ZdBumen='", this.ZdBumen.Text, "',ZdUsername='", this.ZdUsername.Text, "',ZdRealname='", this.ZdRealname.Text, "',Paixun='", this.Paixun.Text, "'  where id='", int.Parse(base.Request.QueryString["id"]), 
                "'  "
             });
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("修改物品类别", "物品类别");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = "select * from qp_oa_ResourcesCangKu  where id='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "'  ";
