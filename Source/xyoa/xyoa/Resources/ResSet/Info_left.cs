namespace xyoa.Resources.ResSet
{
    ...
    public class Info_left : Page
    {
        ...
        {
            string sql = "select id,urlname,url,pic,quanxian,SelectAction from qp_oa_AllUrl where (CHARINDEX(''+quanxian+'','" + this.ViewState["qxstr"] + "')   >   0 ) and ParentNodesID='211' order by Paixu asc";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.BindTree(this.ListTreeView.Nodes, 0xd3);
                this.pulicss.QuanXianVis(this.ListTreeView, "bbbb4", this.Session["perstr"].ToString());
            }
        }
    }
}
