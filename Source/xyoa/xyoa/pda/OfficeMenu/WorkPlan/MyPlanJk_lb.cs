namespace xyoa.pda.OfficeMenu.WorkPlan
{
    ...
    public class MyPlanJk_lb : Page
    {
        ...
        public string CreateMidSql()
        {
            ...
            if (this.Biaoti.Text != "")
            {
                str = str + " and A.Biaoti like '%" + this.pulicss.GetFormatStr(this.Biaoti.Text) + "%'";
            }
