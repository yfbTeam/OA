namespace xyoa.pda.PublicWork.NewsMg
{
    ...
    public class NewsMgList : Page
    {
        ...
        {
            string sql = "select id,titles,Settime,Realname,Username,ScUsername from qp_oa_NewsMg where 1=1 " + this.CreateMidSql() + " order by id desc";
