namespace xyoa.pda.MyWork.Richeng
{
    ...
    public class RichengRi : Page
    {
        ...
        {
            string sql = string.Concat(new object[] { "select id,titles,StartTime,EndTime,Username,Gongkai from qp_oa_MyRicheng  where username='", this.Session["username"], "' ", this.CreateMidSql(), " order by id desc" });
