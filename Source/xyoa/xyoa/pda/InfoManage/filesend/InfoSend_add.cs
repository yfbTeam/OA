namespace xyoa.pda.InfoManage.filesend
{
    ...
    public class InfoSend_add : Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (builder.Length <= 0)
            {
                string path = base.Server.MapPath("/InfoManage/filesend/UpLoad");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                {
                    this.JsUsername.Text = "" + base.Server.UrlDecode(base.Request.QueryString["sendusername"]) + ",";
                    this.JsRealname.Text = "" + base.Server.UrlDecode(base.Request.QueryString["sendrealname"]) + ",";
                }
            }
        }
    }
