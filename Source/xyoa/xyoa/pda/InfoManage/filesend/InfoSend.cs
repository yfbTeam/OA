namespace xyoa.pda.InfoManage.filesend
{
    ...
    public class InfoSend : Page
    {
        ...
        {
            string sql = string.Concat(new object[] { "select id,Name,Filetype,Settime,Username,Realname from qp_oa_InfoSend where Username='", this.Session["username"], "' ", this.CreateMidSql(), " order by id desc" });
