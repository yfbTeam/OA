namespace xyoa.pda.InfoManage.Metting
{
    ...
    public class MyMetting : Page
    {
        ...
        {
            string sql = string.Concat(new object[] { "select A.* from [qp_oa_MettingApply] as [A]  where  (State='2' or State='3'  or State='4' or State='5' ) and   CHARINDEX(',", this.Session["Username"], ",',','+NbPeopleUser+',')   >   0 ", this.CreateMidSql(), " order by id desc" });
