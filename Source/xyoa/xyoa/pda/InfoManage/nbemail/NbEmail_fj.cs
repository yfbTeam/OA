namespace xyoa.pda.InfoManage.nbemail
{
    ...
    public class NbEmail_fj : Page
    {
        ...
        public string CreateMidSql()
        {
            ...
            {
                str = str + " and JsRealname like '%" + this.pulicss.GetFormatStr(this.FsRealname.Text) + "%'";
            }
        ...
        {
            string sql = string.Concat(new object[] { "select  id,Titles,FsUsername,FsRealname,JsRealname,JsUsername,FsTime,Number  from qp_oa_NbEmail_fj  where  FsUsername='", this.Session["username"], "' ", this.CreateMidSql(), " order by id desc" });
