namespace xyoa.WorkFlowSysMag
{
    ...
    public class WorkFlow : Page
    {
        ...
        {
            base.Response.Redirect("WorkFlow_add.aspx?FormId=" + base.Request.QueryString["FormId"] + "");
        }
        ...
        public void DataBindToGridview(string Sqlsort)
        {
            ...
            string sql = "select count(id) from  qp_pro_WorkFlow where FormId='" + base.Request.QueryString["FormId"] + "'";
            this.CountsLabel.Text = "" + this.List.GetCount(sql) + "";
            string str2 = "select * from qp_pro_WorkFlow where FormId='" + base.Request.QueryString["FormId"] + "' " + Sqlsort + "";
        ...
        protected void DelData_Click(object sender, EventArgs e)
        {
            ...
            string sql = "  Delete from qp_pro_WorkFlow  where ID in (" + str + ")";
            this.List.ExeSql(sql);
            this.pulicss.InsertLog("删除表单工作流", "" + this.ViewState["LeixingName"] + "");
            this.DataBindToGridview(this.SortText.Value);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                this.BindAttribute();
                this.DataBindToGridview(this.SortText.Value);
                string sql = "select * from qp_pro_WorkFlowQy  where FormId='" + this.pulicss.GetFormatStr(base.Request.QueryString["FormId"]) + "'  ";
        ...
        protected void Zhuangtai_SelectedIndexChanged(object sender, EventArgs e)
        {
            string sql = "Update qp_pro_WorkFlowQy  Set  Zhuangtai='" + this.Zhuangtai.SelectedValue + "' where FormId='" + base.Request.QueryString["FormId"] + "'";
            this.List.ExeSql(sql);
        }
    }
}
