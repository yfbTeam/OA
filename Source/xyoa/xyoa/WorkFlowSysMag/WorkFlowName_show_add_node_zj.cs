    ...
    public class WorkFlowName_show_add_node_zj : Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string str7 = "insert into qp_Pro_WorkFlowNodeLine (Source,Object,LineContent,NodeNumber,FormId) values ('" + this.shangbu.Text + "','" + this.NodeNum.Text + "','" + str6 + "','" + this.pulicss.GetFormatStr(this.NodeNumber.Text) + "','" + base.Request.QueryString["FormId"] + "')";
                ...
                if (this.TargetListBox.Items.Count > 0)
                {
                    for (int i = 0; i <= (this.TargetListBox.Items.Count - 1); i++)
                    {
                        ...
                        for (int j = 0; j < strArray.Length; j++)
                        {
                            ...
                            string str8 = "insert into qp_Pro_WorkFlowNodeLine (Source,Object,LineContent,NodeNumber,FormId) values ('" + this.NodeNum.Text + "','" + strArray[j] + "','" + str3 + "','" + this.pulicss.GetFormatStr(this.NodeNumber.Text) + "','" + base.Request.QueryString["FormId"] + "')";
                ...
                string str10 = "Update qp_Pro_WorkFlowNode  Set UpNodeNum=UpNodeNum+'" + this.pulicss.GetFormatStr(this.NodeNum.Text) + ",'  where id='" + this.pulicss.GetFormatStr(base.Request.QueryString["id"]) + "'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                list.Close();
                string str2 = "select top 1 *  from qp_Pro_WorkFlowNode where FormId='" + this.pulicss.GetFormatStr(base.Request.QueryString["FormId"]) + "' order by NodeNum desc";
                SqlDataReader reader2 = this.List.GetList(str2);
                if (reader2.Read())
                {
                ...
                this.NodeNumber.Text = "" + DateTime.Now.Year.ToString() + "" + DateTime.Now.Month.ToString() + "" + DateTime.Now.Day.ToString() + "" + DateTime.Now.Hour.ToString() + "" + DateTime.Now.Minute.ToString() + "" + DateTime.Now.Second.ToString() + "" + DateTime.Now.Millisecond.ToString() + "" + str3 + "";
            }
        }
    }
}
