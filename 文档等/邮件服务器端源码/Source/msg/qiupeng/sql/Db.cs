namespace qiupeng.sql
{
    ...
    public class Db
    {
        ...
        {
            return ("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Application.StartupPath + @"\oahelp.accdb;Persist Security Info=False;Jet OLEDB:Database Password=qiupeng;");
        }
