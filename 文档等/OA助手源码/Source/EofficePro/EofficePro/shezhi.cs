namespace EofficePro
{
    ...
    public class shezhi : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MainLogin owner = (MainLogin) base.Owner;
            ((TextBox) owner.Controls["username"]).Text = this.List.GetFormatStr(this.username.Text);
            ((TextBox) owner.Controls["password"]).Text = this.List.GetFormatStr(this.password.Text);
            ((TextBox) owner.Controls["url"]).Text = this.List.GetFormatStr(this.url.Text);
            MainLogin.oaurl = this.List.GetFormatStr(this.url.Text);
            MainLogin.oaautoLogin = str;
            MainLogin.oaautoStart = str2;
            if (this.autoLogin.Checked)
            {
                ((CheckBox) owner.Controls["autoLogin"]).Checked = true;
            }
            else
            {
                ((CheckBox) owner.Controls["autoLogin"]).Checked = false;
            }
            base.Close();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                string str = new WebClient().DownloadString("" + this.url.Text + "/Client/ceshi.aspx");
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(shezhi));
            ...
            this.groupBox1.Location = new Point(0x1f, 12);
            ...
            this.groupBox2.Location = new Point(0x1f, 0xd0);
            ...
            this.button2.Location = new Point(0xf3, 0x13b);
            ...
            base.ClientSize = new Size(0x1c0, 0x161);
            ...
            this.Text = "助手设置";
            base.TopMost = true;
            base.Load += new EventHandler(this.shezhi_Load);
