<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JiSiTongXun.aspx.cs"
...
<body style="overflow: auto" bgcolor="white">
    <form id="form1" runat="server">
        ...
        <asp:TreeView ID="TreeView9" runat="server" NodeIndent="10" ShowLines="True">
            <Nodes>
                <asp:TreeNode Expanded="False" SelectAction="Expand" Text="教师云盘" Value="jjjj3" ImageUrl="~/oaimg/menu/Menu46.gif">
            ...
            <div class="center">
                ...
                <div class="box">
                    ...
                    <div class="left" id="sliderbox" style="height: 918px;">
                        <div class="menubox">
                            ...
                            <div class="menu" id="menubox">
                                <ul id="ul_leftmenu">
                                    <li>
                                        <a class="menuclick" href="javascript:;">即时通讯<span class="iconfont icon-icoxiala"></span></a>
                                        <ul class="submenu" style="display: block;">
                                            <li><a href="javascript:void(0);" data-src="/InfoManage/messages/Messages_add.aspx">发送消息</a></li>
                                            <li><a href="javascript:void(0);" data-src="/InfoManage/messages/Messages.aspx">未读消息</a></li>
                                            <li><a href="javascript:void(0);" data-src="/InfoManage/messages/Messages_yd.aspx">已读消息</a></li>
                                            <li><a href="javascript:void(0);" data-src="/InfoManage/messages/Messages_yf.aspx">已发消息</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="right" style="height: 918px;">
                        <iframe id="iframbox" src="/InfoManage/messages/Messages_add.aspx" width="100%" frameborder="0" height="100%" style="height: 918px;"></iframe>
                    </div>
                </div>
            </div>
        </div>
