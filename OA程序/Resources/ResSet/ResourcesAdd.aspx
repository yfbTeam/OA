<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ResourcesAdd.aspx.cs" Inherits="xyoa.Resources.ResSet.ResourcesAdd" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ResourcesAdd.aspx';showwait();">
                                                                <font class="shadow_but">物品登记</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    物品编号：<asp:TextBox ID="ZyNum" runat="server" Width="82px"></asp:TextBox>
                                                                    物品名称：<asp:TextBox ID="ZyName" runat="server" Width="78px"></asp:TextBox>
                                                                    类别：<asp:DropDownList ID="ZyLeibie" runat="server">
                                                                    </asp:DropDownList>
                                                                    仓库：<asp:DropDownList ID="Cangku" runat="server">
                                                                    </asp:DropDownList>
                                                                    区域：<asp:DropDownList ID="Quyu" runat="server">
                                                                    </asp:DropDownList>
                                                                    物品性质：<asp:DropDownList ID="ZyXingzhi" runat="server">
                                                                        <asp:ListItem></asp:ListItem>
                                                                        <asp:ListItem Value="1">消耗品</asp:ListItem>
                                                                        <asp:ListItem Value="2">借用品</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    物品状态：<asp:DropDownList ID="Zhuangtai" runat="server">
                                                                        <asp:ListItem></asp:ListItem>
                                                                    ...
                                                                    库警物品：<asp:DropDownList ID="KjZy" runat="server">
                                                                        <asp:ListItem></asp:ListItem>
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ZyName") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="物品编号" SortExpression="ZyNum">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='ResourcesAdd_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="物品名称" SortExpression="ZyName">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='ResourcesAdd_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="Xinghao" HeaderText="物品型号" SortExpression="Xinghao">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="物品状态" SortExpression="A.Zhuangtai">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("Zhuangtai").ToString().Replace("1", "正常").Replace("2", "丢失").Replace("3", "停用").Replace("4", "维修")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="物品性质" SortExpression="A.ZyXingzhi">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("ZyXingzhi").ToString().Replace("1", "消耗品").Replace("2", "借用品")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="AllKuCun" HeaderText="总库存" SortExpression="AllKuCun">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="KuCun" HeaderText="当前库存" SortExpression="KuCun">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="LimitsS" HeaderText="库警上限" SortExpression="LimitsS">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="LimitsE" HeaderText="库警下限" SortExpression="LimitsE">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
