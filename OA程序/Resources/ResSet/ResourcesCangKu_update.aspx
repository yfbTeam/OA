<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ResourcesCangKu_update.aspx.cs"
    Inherits="xyoa.Resources.ResSet.ResourcesCangKu_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="ResourcesCangKu.aspx">仓库设置</a>
                                                            >> 修改仓库设置</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">仓库设置</font></button></td>
