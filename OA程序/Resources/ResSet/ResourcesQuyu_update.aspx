<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourcesQuyu_update.aspx.cs" Inherits="xyoa.Resources.ResSet.ResourcesQuyu_update" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="ResourcesQuyu.aspx">所属区域</a>
                                                            >> 修改所属区域</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">所属区域</font></button></td>
