<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourcesCangKu.aspx.cs" Inherits="xyoa.Resources.ResSet.ResourcesCangKu" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">仓库设置</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Name" HeaderText="仓库名称" SortExpression="Name">
