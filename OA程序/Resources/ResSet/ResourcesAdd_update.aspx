<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ResourcesAdd_update.aspx.cs"
    Inherits="xyoa.Resources.ResSet.ResourcesAdd_update" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">资源登记</font></button></td>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" width="35%" style="height: 17px">
                                                        <asp:TextBox ID="Danjia" runat="server" Width="100%"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" nowrap="nowrap" width="17%" style="height: 17px">
                                                        供应商：</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" width="33%" style="height: 17px">
                                                        <asp:TextBox ID="AllKuCun" runat="server" Width="100%" CssClass="ReadOnlyText"></asp:TextBox>
                                                    </td>
                                                    <td align="right" class="newtd1" nowrap="nowrap" width="17%" style="height: 17px">
                                                        可分配库存：</td>
                                                    <td class="newtd2" width="33%" style="height: 17px">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" nowrap="nowrap" width="17%" style="height: 17px">
                                                        已借用(正在使用)：</td>
                                                    <td class="newtd2" width="33%" style="height: 17px">
                                                        <asp:TextBox ID="YjyKuCun" runat="server" Width="100%" CssClass="ReadOnlyText"></asp:TextBox></td>
                                                    <td align="right" class="newtd1" nowrap="nowrap" width="17%" style="height: 17px">
                                                        已报废：</td>
                                                    <td class="newtd2" width="33%" style="height: 17px">
                                                        <asp:TextBox ID="BfKuCun" runat="server" Width="100%" CssClass="ReadOnlyText"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" nowrap="nowrap" width="15%" style="height: 17px">
