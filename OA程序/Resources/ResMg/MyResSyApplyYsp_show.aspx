<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyResSyApplyYsp_show.aspx.cs" Inherits="xyoa.Resources.ResMg.MyResSyApplyYsp_show" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">使用记录</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" width="83%" colspan="3">
                                                        <asp:Label ID="Shuliang" runat="server" Text=""></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        申请理由：</td>
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:Label ID="Liyou" runat="server" Text=""></asp:Label>&nbsp;</td>
                                                </tr>
                                                <tr>
