<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ResFp_update.aspx.cs" Inherits="xyoa.Resources.ResMg.ResFp_update" %>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" width="35%" style="height: 17px">
                                                        <asp:TextBox ID="GmTime"  onClick="WdatePicker()" runat="server"></asp:TextBox>
                                                        </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" nowrap="nowrap" width="17%" style="height: 17px">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" nowrap="nowrap" width="17%" style="height: 17px">
                                                        当前状态：</td>
                                                    <td class="newtd2" colspan="3" style="height: 17px">
                                                        <asp:TextBox ID="States" runat="server" Width="100%" CssClass="ReadOnlyText" ></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr class="">
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
