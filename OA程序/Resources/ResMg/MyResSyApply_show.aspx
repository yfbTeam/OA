<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyResSyApply_show.aspx.cs"
    Inherits="xyoa.Resources.ResMg.MyResSyApply_show" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="MyResSyApply.aspx">物品使用</a> >> 审批物品使用</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">物品使用</font></button></td>
