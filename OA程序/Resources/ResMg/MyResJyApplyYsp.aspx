<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyResJyApplyYsp.aspx.cs" Inherits="xyoa.Resources.ResMg.MyResJyApplyYsp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyResJyApply.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyResJyApplyYsp.aspx';showwait();">
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                ...
                                                                物品编号：
                                                                    ...
                                                                    创建人：
                                                                    <asp:TextBox ID="Realname" runat="server" CssClass="ReadOnlyText" Width="90px"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="物品名称" SortExpression="ZyId">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyResJyApplyYsp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
