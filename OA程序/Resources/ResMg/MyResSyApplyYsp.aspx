<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyResSyApplyYsp.aspx.cs" Inherits="xyoa.Resources.ResMg.MyResSyApplyYsp" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyResSyApply.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyResSyApplyYsp.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="物品名称" SortExpression="ZyId">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyResSyApplyYsp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
