<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyResJyApply_show.aspx.cs"
    Inherits="xyoa.Resources.ResMg.MyResJyApply_show" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="MyResJyApply.aspx">物品借用</a> >> 审批物品借用</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">物品借用</font></button></td>
