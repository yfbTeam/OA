<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ResFp.aspx.cs" Inherits="xyoa.Resources.ResMg.ResFp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ResFp.aspx';showwait();">
                                                                ...
                                                                <td valign="top">
                                                                    ...
                                                                    分配时间：<asp:TextBox ID="Startime" runat="server" onClick="WdatePicker()" Width="66px"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" onClick="WdatePicker()"
                                                                                Width="66px"></asp:TextBox>接收人：<asp:TextBox ID="JsRealname" runat="server"
                                                                                            Width="53px" CssClass="ReadOnlyText"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="收回">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="jieshu">收回</asp:LinkButton>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                </Columns>
