<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyResGmApplyYsp.aspx.cs" Inherits="xyoa.Resources.ResMg.MyResGmApplyYsp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyResGmApply.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyResGmApplyYsp.aspx';showwait();">
                                                                ...
                                                                <td valign="top">
                                                                 物品编号：
                                                                    ...
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="opencp();" alt="" src="/oaimg/FDJ.gif" border="0"></a>购买时间从<asp:TextBox
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="物品名称" SortExpression="ZyId">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyResGmApplyYsp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="GmTime" HeaderText="购买时间" SortExpression="GmTime" DataFormatString="{0:yyyy-MM-dd}"
                                                                        HtmlEncode="False">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="GmNum" HeaderText="购买数量" SortExpression="GmNum">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="GmFeiyong" HeaderText="购买费用" SortExpression="GmFeiyong">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
