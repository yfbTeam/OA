<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ResMap.aspx.cs" Inherits="xyoa.Resources.ResMg.ResMap" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ResMap.aspx';showwait();">
                                                                <font class="shadow_but">物品分布</font></button>
                                                        </td>
                                                                ...
                                                                <td valign="top">
                                                                 物品编号：
                                                                    ...
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="opencp();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 物品类别：<asp:DropDownList
                                                                            ID="ZyLeibie" runat="server">
                                                                        </asp:DropDownList>
                                                                    仓库：<asp:DropDownList ID="Cangku" runat="server">
                                                                    </asp:DropDownList>
                                                                    区域：<asp:DropDownList ID="Quyu" runat="server">
                                                                    </asp:DropDownList>
                                                                    来源：<asp:DropDownList ID="Laiyuan" runat="server">
                                                                        <asp:ListItem></asp:ListItem>
                                                                        <asp:ListItem>借用</asp:ListItem>
                                                                        <asp:ListItem>使用</asp:ListItem>
                                                                        <asp:ListItem>分配</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    拥有人：<asp:TextBox ID="Realname" runat="server" Width="54px" CssClass="ReadOnlyText"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="shuliang" HeaderText="拥有数量" SortExpression="shuliang">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Laiyuan" HeaderText="物品来源" SortExpression="Laiyuan">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="拥有人" SortExpression="Username">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="syguihuan">收回</asp:LinkButton>
                                                                            ...
                                                                            <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="fbguihuan">收回</asp:LinkButton>
                                                                        </ItemTemplate>
