<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ResJyR.aspx.cs" Inherits="xyoa.Resources.ResReport.ResJyR" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ResJyR.aspx';showwait();">
                                                                 ...
                                                                 物品编号：
                                                                    ...
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="opencp();" alt="" src="/oaimg/FDJ.gif" border="0"></a>申请时间从<asp:TextBox
                                                                            ID="Starttime" runat="server" Width="80px" onClick="WdatePicker()"></asp:TextBox>
                                                                            至<asp:TextBox ID="Endtime" runat="server" Width="80px"
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Shuliang" HeaderText="申请数量" SortExpression="Shuliang">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='ResJyR_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                                查看</a>
                                                                        </ItemTemplate>
