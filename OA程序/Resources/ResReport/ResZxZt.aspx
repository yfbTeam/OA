<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResZxZt.aspx.cs" Inherits="xyoa.Resources.ResReport.ResZxZt" %>
<html>
<script>
                                                ...
                                                <tr>
                                                    <td align="center" class="newtd2" colspan="4" height="26" >
                                                        <table width="100%" border="0" cellpadding="4" cellspacing="1" class="nextpage">
                                                          <tr> 
                                                            <td width="16%" class="newtd2"><div align="center">状态</div></td>
