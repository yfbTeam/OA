<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResZhCx.aspx.cs" Inherits="xyoa.Resources.ResReport.ResZhCx" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ResZhCx.aspx';showwait();">
                                                                <font class="shadow_but">物品列表</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="物品编号" SortExpression="ZyNum">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='ResZhCx_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
