<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ResGMR.aspx.cs" Inherits="xyoa.Resources.ResReport.ResGMR" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ResGMR.aspx';showwait();">
                                                                <font class="shadow_but">物品购买报表</font></button>
                                                        </td>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                  物品编号：
                                                                    ...
                                                                    经办人：<asp:TextBox ID="JbName" runat="server" Width="52px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='ReGmR_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                                查看 </a>
                                                                        </ItemTemplate>
