<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyResJy.aspx.cs" Inherits="xyoa.Resources.MyRes.MyResJy" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyResJy.aspx';showwait();">
                                                                <font class="shadow_but">借用记录</font></button>
                                                        </td>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="opencp();" alt="" src="/oaimg/FDJ.gif" border="0"></a>申请时间从<asp:TextBox
                                                                    ...
                                                                    物品状态：<asp:DropDownList ID="WpStates" runat="server">
                                                                        <asp:ListItem></asp:ListItem>
                                                                        <asp:ListItem Value="1">审批中</asp:ListItem>
                                                                        <asp:ListItem Value="2">正在使用</asp:ListItem>
                                                                        <asp:ListItem Value="3">已报废</asp:ListItem>
                                                                    </asp:DropDownList>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="物品名称" SortExpression="ZyId">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyResJy_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="NowTimes" HeaderText="申请时间" SortExpression="NowTimes">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="Starttime" HeaderText="使用开始时间" SortExpression="Starttime">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Endtime" HeaderText="使用结束时间" SortExpression="Endtime">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="物品状态" SortExpression="A.WpStates">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("WpStates").ToString().Replace("1", "审批中").Replace("2", "正在使用").Replace("3", "已归还")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" Width="130px" />
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="Lzt" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "LcZhuangtai")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="WpStates" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "WpStates")%>'
                                                                                Visible="false"></asp:Label>
                                                                            ...
                                                                            <asp:LinkButton ID="Baofei" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="Baofei">归还</asp:LinkButton>
                                                                        </ItemTemplate>
