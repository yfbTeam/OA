<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyResApply_Search.aspx.cs"
    Inherits="xyoa.Resources.MyRes.MyResApply_Search" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:TextBox ID="ZyName" runat="server" Width="100%"></asp:TextBox></td>
                                                </tr>
                                                <tr>
