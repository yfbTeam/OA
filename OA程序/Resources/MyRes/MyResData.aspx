<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyResData.aspx.cs" Inherits="xyoa.Resources.MyRes.MyResData" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyResData.aspx';showwait();">
                                                                <font class="shadow_but">我的物品</font></button>
                                                        </td>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="syguihuan">归还</asp:LinkButton>
                                                                            ...
                                                                            <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="fbguihuan">归还</asp:LinkButton>
                                                                        </ItemTemplate>
