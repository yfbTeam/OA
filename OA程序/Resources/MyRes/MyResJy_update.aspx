<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyResJy_update.aspx.cs" Inherits="xyoa.Resources.MyRes.MyResJy_update" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">借用记录</font></button></td>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    <td align="center" class="newtd2" colspan="4" width="33%">
                                                        <b>使用信息</b></td>
                                                </tr>
                                                 <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                ...
                                                <tr id="printshow4">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                         <asp:Button ID="Button2" runat="server" Text="提 交" CssClass="button_css" OnClick="Button1_Click" />
                                                            <input id="Button1" class="button_css" onclick="history.back()" type="button" value="返 回" />
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
