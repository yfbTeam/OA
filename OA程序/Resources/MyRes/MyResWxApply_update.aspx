<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyResWxApply_update.aspx.cs" Inherits="xyoa.Resources.MyRes.MyResWxApply_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="MyResWxApply.aspx">物品维修</a> >>
                                                            修改物品维修</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">物品维修</font></button></td>
