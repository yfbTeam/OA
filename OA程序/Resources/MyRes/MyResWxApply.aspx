<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyResWxApply.aspx.cs" Inherits="xyoa.Resources.MyRes.MyResWxApply" %>
<html>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyResWxApply.aspx';showwait();">
                                                                <font class="shadow_but">物品维修申请</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="物品名称" SortExpression="ZyId">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyResWxApply_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
