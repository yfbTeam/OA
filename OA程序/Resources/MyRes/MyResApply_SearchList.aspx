<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyResApply_SearchList.aspx.cs"
    Inherits="xyoa.Resources.MyRes.MyResApply_SearchList" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyResApply_SearchList.aspx';showwait();">
                                                                <font class="shadow_but">物品申请</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    物品编号：<asp:TextBox ID="ZyNum" runat="server"></asp:TextBox>
                                                                    物品名称：<asp:TextBox ID="ZyName" runat="server"></asp:TextBox>
                                                                    物品类别：<asp:DropDownList ID="ZyLeibie" runat="server">
                                                                    </asp:DropDownList>
                                                                    所属仓库：<asp:DropDownList ID="Cangku" runat="server">
                                                                    </asp:DropDownList>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        <ItemStyle HorizontalAlign="Center" Wrap="True" Width="60px" />
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="StringId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                Visible="false"></asp:Label>
                                                                                 <asp:Label ID="ZyXingzhi" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ZyXingzhi")%>'
                                                                                Visible="false"></asp:Label>
