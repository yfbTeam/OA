<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SmsOpen.aspx.cs" Inherits="xyoa.mainpage.SmsOpen" %>
...
<head id="Head1" runat="server">
    ...
    <script>
function openwindows(urlstr,strid)
{
    //控件宽
    var aw = 695;
    //控件高
    ...
    AjaxMethod.UpdateMessages(strid);
    window.location.href='SmsOpen.aspx';
}

function xianqing(str,strid)
{
    window.opener.parent.rform.location.href=''+str+'';
    AjaxMethod.UpdateMessages(strid);
    window.location.href='SmsOpen.aspx';
}
...
function queding()
{
 window.opener.send_request1('CountMessage.aspx?tmp='+Math.random()+'');
}

    </script>

</head>
<body class="newbody" onload="queding()">
                                                                            ...
                                                                            <table class="nextpage" width="100%" cellspacing="0" cellpadding="2">
                                                                                <tr>
                                                                                        ...
                                                                                        <img src='/InfoManage/nbemail/<%# DataBinder.Eval(Container.DataItem, "sfck") %>.gif'
                                                                                            align="absMiddle">
                                                                                                <a href='javascript:void(0)' onclick='openwindows("/InfoManage/messages/talk.aspx?user=<%# DataBinder.Eval(Container.DataItem, "sendusername") %>","<%#DataBinder.Eval(Container.DataItem, "id")%>")', "_blank", "height=500, width=600,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'><font class="lefttd"><%# DataBinder.Eval(Container.DataItem, "sendrealname")%>：</font></a>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="newtd2">
                                                                                        ...
                                                                                        <div align="right">
                                                                                            ...
                                                                                            <a href='javascript:void(0)' onclick='openwindows("mainpage/msglog.aspx?user=<%# DataBinder.Eval(Container.DataItem, "sendusername") %>","<%#DataBinder.Eval(Container.DataItem, "id")%>")', "_blank", "height=500, width=600,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'>
                                                                                                消息记录</a> <a href='javascript:void(0)' onclick='openwindows("/InfoManage/messages/talk.aspx?user=<%# DataBinder.Eval(Container.DataItem, "sendusername") %>","<%#DataBinder.Eval(Container.DataItem, "id")%>")', "_blank", "height=500, width=600,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'>
                                                                                                    回复</a>&nbsp; <a href="SmsOpendel.aspx?delid=<%# DataBinder.Eval(Container.DataItem, "id") %>&number=<%# DataBinder.Eval(Container.DataItem, "number") %>">
                                                                                                        删除</a>&nbsp;<a href="SmsOpendel.aspx?allyyid=1">全部已阅</a>&nbsp;<a href="SmsOpendel.aspx?alldelid=1">全部删除</a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
