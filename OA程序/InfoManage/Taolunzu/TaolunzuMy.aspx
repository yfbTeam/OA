<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TaolunzuMy.aspx.cs" Inherits="xyoa.InfoManage.Taolunzu.TaolunzuMy" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">讨论组管理</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Name" HeaderText="讨论组" SortExpression="Name">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="状态" SortExpression="Zhuangtai">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("Zhuangtai").ToString().Replace("1", "活动中").Replace("0", "已停止")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="加入权限" SortExpression="Leixing">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("Leixing").ToString().Replace("0", "不允许主动加入").Replace("1", "需要验证加入").Replace("2", "有权限的用户随时可以加入")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            &nbsp;<font color="#000000">页码：<asp:TextBox ID="GoPage" runat="server" Width="25px"></asp:TextBox>
                                                                ...
                                                                &nbsp;每页<font color="red">12</font>条数据&nbsp; 共有<font color="red"><asp:Label ID="CountsLabel"
