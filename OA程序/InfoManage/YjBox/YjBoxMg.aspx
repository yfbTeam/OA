<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YjBoxMg.aspx.cs" Inherits="xyoa.InfoManage.YjBox.YjBoxMg" %>
    ...
    <form id="form1" runat="server">
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='YjBoxMg.aspx';showwait();">
                                                                <font class="shadow_but">未阅读</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='YjBoxMgyd.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    意见标题：<asp:TextBox ID="Titles" runat="server"></asp:TextBox>
                                                                    填写时间：<asp:TextBox ID="TxTime" runat="server" Width="127px" onClick="WdatePicker()"></asp:TextBox>
                                                                   填写人：
                                                                    <asp:TextBox ID="TxRealname" runat="server" CssClass="ReadOnlyText"></asp:TextBox>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="意见标题" SortExpression="Titles">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='YjBoxMg_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>' class="LinkLine">
                                                                                <%# DataBinder.Eval(Container.DataItem, "Titles") %>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="TxTime" HeaderText="填写时间" SortExpression="TxTime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Name" HeaderText="意见箱" SortExpression="Name">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="TxRealname" HeaderText="填写人" SortExpression="TxRealname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
        ...
        <script language="javascript">	
          ...
          var  wName_3;  
            ...
            {  
                var num=Math.random();
                var str=""+document.getElementById('Username').value+"|"+document.getElementById('TxRealname').value+"";
                ...
                { 
                    ...
                    document.getElementById("TxRealname").value=arr[1]; 
                }
            }
