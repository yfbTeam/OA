<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyYjBox_show.aspx.cs" Inherits="xyoa.InfoManage.YjBox.MyYjBox_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"  id="tableprint">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        回复内容：</td>
                                                    <td class="newtd2" colspan="3" height="17">
                                                        <asp:Label ID="HfCotent" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
