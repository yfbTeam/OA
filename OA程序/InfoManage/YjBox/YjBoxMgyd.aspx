<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YjBoxMgyd.aspx.cs" Inherits="xyoa.InfoManage.YjBox.YjBoxMgyd" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='YjBoxMg.aspx';showwait();">
                                                                <font class="shadow_but">未阅读</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='YjBoxMgyd.aspx';showwait();">
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    填写人：<asp:TextBox ID="TxRealname" runat="server"
