<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyYjBox.aspx.cs" Inherits="xyoa.InfoManage.YjBox.MyYjBox" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyYjBox.aspx';showwait();">
                                                                <font class="shadow_but">我的意见</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="意见标题" SortExpression="Titles">
                                                                        ...
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='MyYjBox_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>' class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="IfHf" HeaderText="是否回复" SortExpression="IfHf">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
