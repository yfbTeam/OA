<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Messages_yd.aspx.cs" Inherits="xyoa.InfoSpeech.Messages.Messages_yd" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Messages_yd.aspx';showwait();">
                                                                <font class="shadow_but">已读消息</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="发送人" SortExpression="sendusername">
