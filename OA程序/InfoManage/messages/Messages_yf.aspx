<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Messages_yf.aspx.cs" Inherits="xyoa.InfoSpeech.Messages.Messages_yf" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Messages_yf.aspx';showwait();">
                                                                <font class="shadow_but">已发消息</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    消息标题：<asp:TextBox ID="titles" runat="server" Width="100px"></asp:TextBox>
                                                                    接收人员：
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="消息标题" SortExpression="titles">
                                                                        ...
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Messages_yf_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="接收人" SortExpression="acceptrealname">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='senduser("<%# DataBinder.Eval(Container.DataItem, "acceptusername")%>")'>
