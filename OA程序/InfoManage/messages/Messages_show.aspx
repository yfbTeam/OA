<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Messages_show.aspx.cs"
    Inherits="xyoa.InfoSpeech.Messages.Messages_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr id="printshow4">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <asp:Button ID="Button2" runat="server" Text="回 复" CssClass="button_css" OnClick="Button2_Click" />&nbsp;
                                                            <asp:Button ID="Button4" runat="server" Text="链 接" CssClass="button_css" OnClick="Button4_Click" />&nbsp;
