<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BadEmail.aspx.cs" Inherits="xyoa.InfoManage.wbemail.BadEmail" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='BadEmail.aspx';showwait();">
                                                                <font class="shadow_but">失败邮件</font></button>
                                                        </td>
