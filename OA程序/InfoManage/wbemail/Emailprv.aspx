<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Emailprv.aspx.cs" Inherits="xyoa.MyWork.MySet.Emailprv" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="/main_d.aspx" class="line_b">工作台</a> >> 邮件参数设置</td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        <HeaderStyle CssClass="newtitle"  Wrap="False" Width="80px" />
                                                                        <ItemTemplate>
                                                                            <a href='Emailprv_Pass.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'
                                                                                onclick="showwait();">修改密码</a>
                                                                        </ItemTemplate>
