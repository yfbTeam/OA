<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutEmail.aspx.cs" Inherits="xyoa.InfoManage.wbemail.OutEmail" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='OutEmail.aspx';showwait();">
                                                                <font class="shadow_but">待发邮件</font></button>
                                                        </td>
