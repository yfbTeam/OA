<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InsideBBSListShowBack.aspx.cs"
    Inherits="xyoa.InfoManage.bbs.InsideBBSListShowBack" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">回复帖子</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap"  width="17%">
                                                        <font color="red">※</font>回复内容(<a href="javascript:void(0)" onclick="openqiupengmodle()">模版</a>)：</td>
