<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InsideBBSList.aspx.cs"
    Inherits="xyoa.InfoManage.bbs.InsideBBSList" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="AddData" runat="server" Text="发表新帖" CssClass="button_css" OnClick="AddData_Click" />
                                                            <asp:Button ID="Button3" runat="server" Text="返回列表" CssClass="button_css" OnClick="Button3_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="主题" SortExpression="Titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='InsideBBSListShow.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&BigId=<%# DataBinder.Eval(Container.DataItem, "BigId")%>'
                                                                                class='LinkLine'>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="回/阅">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" Width="80px" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Lid1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="Label1" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" Width="80px" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="最后回复时间">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" Width="180px" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="最后回复人">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" Width="180px" />
                                                                        <ItemTemplate>
