<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InsideBBSBig.aspx.cs" Inherits="xyoa.InfoManage.bbs.InsideBBSBig" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='InsideBBSBig.aspx';showwait();">
                                                                <font class="shadow_but">版块管理</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="版块图片">
                                                                        ...
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='InsideBBSList.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ID") %>'>
                                                                                <img height="45" src="tupian/<%# DataBinder.Eval(Container.DataItem, "Tupian") %>"
                                                                                    border="0" width="80" /></a>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="简要介绍">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            &nbsp;<img src="/oaimg/JianTou.gif" /><%# DataBinder.Eval(Container.DataItem, "Miaosu") %><br />
                                                                            &nbsp;版主：<%# DataBinder.Eval(Container.DataItem, "BzRealname") %>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                </Columns>
