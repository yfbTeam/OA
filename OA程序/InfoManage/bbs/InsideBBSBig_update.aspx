<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InsideBBSBig_update.aspx.cs"
    Inherits="xyoa.InfoManage.bbs.InsideBBSBig_update" %>
<html>
...
<body class="newbody" onload="select_type()">
    <form id="form1" runat="server">
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">版块管理</font></button></td>
                                                        <td style="height: 26px" align="left">
                                                            提醒：版主可以对此版块的帖子进行删除。</td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="17">
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        版块描述：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Miaosu" runat="server" Width="100%" MaxLength="25"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                    <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>版主姓名：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="BzRealname" runat="server" Width="85%" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Paixun" runat="server" Width="100%" MaxLength="25">0</asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
        ...
        <script language="javascript">	
            ...
            {  
                var num=Math.random();
                var str=""+document.getElementById('BzUsername').value+"";
