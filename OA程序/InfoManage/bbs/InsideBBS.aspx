<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InsideBBS.aspx.cs" Inherits="xyoa.InfoManage.bbs.InsideBBS" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='InsideBBS.aspx';showwait();">
                                                                <font class="shadow_but">论坛BBS</font></button>
                                                        </td>
