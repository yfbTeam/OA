<%@ Page Language="C#" AutoEventWireup="true" Codebehind="toupiao.aspx.cs" Inherits="xyoa.InfoManage.toupiao.toupiao" %>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="投票主题">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='toupiao_tp.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();" class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a href='toupiao_tp.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' onclick="showwait();">
                                                                                参加投票</a>
                                                                        </ItemTemplate>
