<%@ Page Language="C#" AutoEventWireup="true" Codebehind="toupiaobtmanage_update.aspx.cs"
    Inherits="xyoa.InfoManage.toupiao.toupiaobtmanage_update" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        票数：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="83%">
                                                        <asp:Label ID="piaoshu" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="83%">
                                                        <asp:Label ID="YTpRealname" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
