<%@ Page Language="C#" AutoEventWireup="true" Codebehind="toupiaobt.aspx.cs" Inherits="xyoa.InfoManage.toupiao.toupiaobt" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='toupiaobt.aspx';showwait();">
                                                                <font class="shadow_but">投票管理</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="投票主题">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='toupiaobt_add_next.aspx?bigid=<%# DataBinder.Eval(Container.DataItem, "id") %>'
                                                                                onclick="showwait();" class="LinkLine">
                                                                                <%# DataBinder.Eval(Container.DataItem, "title") %>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="选择类型" SortExpression="xuanze">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("xuanze").ToString().Replace("1", "单选").Replace("2", "多选")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="当前状态" SortExpression="type">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("type").ToString().Replace("1", "进行中").Replace("2", "已结束").Replace("3", "隐藏投票")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="是否允许匿名" SortExpression="type">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("ifopen").ToString().Replace("1", "允许").Replace("2", "不允许")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a href='toupiaobt_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'
                                                                                onclick="showwait();">修改主题</a> <a href='toupiaobt_add_next.aspx?bigid=<%# DataBinder.Eval(Container.DataItem, "id") %>'
                                                                                    onclick="showwait();">管理分项</a>
                                                                        </ItemTemplate>
