<%@ Page Language="C#" AutoEventWireup="true" Codebehind="toupiaobt_add.aspx.cs"
    Inherits="xyoa.InfoManage.toupiao.toupiaobt_add" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:RadioButtonList ID="type" runat="server" RepeatDirection="Horizontal">
                                                            ...
                                                            <asp:ListItem Selected="True" Value="3">隐藏投票</asp:ListItem>
                                                        </asp:RadioButtonList>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                <asp:Button ID="Button1" runat="server" Text="保存并设置选项" CssClass="button_css" OnClick="Button1_Click" />
                                                                <asp:Button ID="Button5" runat="server" Text="保存并返回" CssClass="button_css" OnClick="Button5_Click" />
