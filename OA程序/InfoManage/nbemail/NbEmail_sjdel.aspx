<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NbEmail_sjdel.aspx.cs"
    Inherits="xyoa.InfoManage.nbemail.NbEmail_sjdel" %>
...
<body class="newbody">
    <form id="form1" runat="server">
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='NbEmail_sjdel.aspx';showwait();">
                                                                <font class="shadow_but">已删除</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="AddData" runat="server" Text="写新邮件" CssClass="button_blue" OnClick="AddData_Click" />
                                                            <asp:Button ID="Button3" runat="server" Text="还 原" CssClass="button_blue" OnClick="Button3_Click" />
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    邮件主题：<asp:TextBox ID="titles" runat="server" Width="95px"></asp:TextBox>
                                                                    发件人：
                                                                    <asp:TextBox ID="FsRealname" runat="server" Width="68px" CssClass="ReadOnlyText"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 发件时间从<asp:TextBox
                                                                            ID="Starttime" runat="server" Width="62px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" Width="62px"
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="状态" SortExpression="IfRead">
                                                                        <ItemStyle Wrap="True" HorizontalAlign="Center" Width="30px" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <img src='<%# DataBinder.Eval(Container.DataItem, "IfRead") %>.gif'>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="邮件主题" SortExpression="titles">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='NbEmail_sj_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="附件">
                                                                        ...
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Lid2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Number")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="Label2" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="发件人" SortExpression="FsRealname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='senduser("<%# DataBinder.Eval(Container.DataItem, "FsUsername")%>")'>
                                                                                <%# DataBinder.Eval(Container.DataItem, "FsRealname")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="FsTime" HeaderText="发送时间" SortExpression="FsTime">
        ...
        <asp:TextBox ID="FsUsername" runat="server" Width="90%" Style="display: none"></asp:TextBox>
        ...
        <script type="text/javascript">
          ...
          var  wName_3;  
            ...
            {  
                var num=Math.random();
                var str=""+document.getElementById('FsUsername').value+"|"+document.getElementById('FsRealname').value+"";
                ...
                { 
                    document.getElementById("FsUsername").value=arr[0]; 
                    document.getElementById("FsRealname").value=arr[1]; 
                }
            }
        </script>
