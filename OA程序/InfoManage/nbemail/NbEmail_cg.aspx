<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NbEmail_cg.aspx.cs" Inherits="xyoa.InfoManage.nbemail.NbEmail_cg" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='NbEmail_cg.aspx';showwait();">
                                                                <font class="shadow_but">草稿箱</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="邮件主题" SortExpression="titles">
                                                                        ...
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='NbEmail_cg_send.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="收件人" SortExpression="FsRealname">
