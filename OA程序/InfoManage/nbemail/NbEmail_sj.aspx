<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NbEmail_sj.aspx.cs" Inherits="xyoa.InfoManage.nbemail.NbEmail_sj" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='NbEmail_sj.aspx';showwait();">
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    发件人：
                                                                    <asp:TextBox ID="FsRealname" runat="server" Width="62px" CssClass="ReadOnlyText"></asp:TextBox>
