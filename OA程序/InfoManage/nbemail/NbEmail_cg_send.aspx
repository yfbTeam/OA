<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NbEmail_cg_send.aspx.cs"
    Inherits="xyoa.InfoManage.nbemail.NbEmail_cg_send" %>
        ...
        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="top">
                    ...
                    </table> <asp:TextBox ID="Number" runat="server" Style="display: none"></asp:TextBox>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:TextBox ID="JsRealname" runat="server" Width="90%" Height="57px" TextMode="MultiLine"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        发件人：</td>
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:TextBox ID="SendName" runat="server" Width="100%" CssClass="ReadOnlyText"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        发送时间：</td>
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:TextBox ID="SeadTime" runat="server" Width="100%" CssClass="ReadOnlyText"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        邮件正文(<a href="javascript:void(0)" onclick="openqiupengmodle()">模版</a>)：</td>
                                                    <td class="newtd2" height="17" colspan="3">
                                                    ...
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                ...
                                                                <asp:Button ID="Button6" runat="server" Text="暂 存" CssClass="button_css" OnClick="Button6_Click" />
