<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NbEmail_fj.aspx.cs" Inherits="xyoa.InfoManage.nbemail.NbEmail_fj" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='NbEmail_fj.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="邮件主题" SortExpression="titles">
                                                                        ...
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='NbEmail_fj_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'>
