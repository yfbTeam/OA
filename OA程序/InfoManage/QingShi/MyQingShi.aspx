<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyQingShi.aspx.cs" Inherits="xyoa.InfoManage.QingShi.MyQingShi" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">报告填写</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    标题：<asp:TextBox ID="Titles" runat="server" Width="109px"></asp:TextBox>状态：<asp:DropDownList
                                                                        ID="State" runat="server">
                                                                        <asp:ListItem></asp:ListItem>
                                                                        <asp:ListItem>等待批阅</asp:ListItem>
                                                                        <asp:ListItem>已批阅</asp:ListItem>
                                                                    </asp:DropDownList>接受人：<asp:TextBox ID="JsRealname" runat="server" CssClass="ReadOnlyText"
                                                                        Width="91px"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 填写时间：<asp:TextBox
                                                                            ID="TxTime" runat="server" Width="84px" onClick="WdatePicker()"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="MyQingShi_show.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>" class="LinkLine">
                                                                                <%#DataBinder.Eval(Container.DataItem, "Titles")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="接受人" SortExpression="JsRealname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
