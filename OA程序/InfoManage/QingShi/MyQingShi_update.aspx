<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyQingShi_update.aspx.cs"
    Inherits="xyoa.InfoManage.QingShi.MyQingShi_update" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">请示报告</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="State" runat="server" Width="100%" ReadOnly="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>报告标题：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        报告内容(<a href="javascript:void(0)" onclick="openqiupengmodle()">模版</a>)：</td>
                                                ...
                                                <tr class="" id="nextrs22">
                                                    ...
                                                    <td class="newtd2" height="17" width="33%" colspan="3">
                                                        <asp:DropDownList ID="fjlb" runat="server" Width="65%">
                                                        </asp:DropDownList>&nbsp;
                                                ...
                                                <tr class="" id="nextrs23">
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        上传附件：</td>
                                                    <td class="newtd2" height="17" width="33%" colspan="3">
                                                        <input id="uploadFile" runat="server" style="width: 333px" type="file" name="uploadFile" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="JsRealname" runat="server" Width="85%" CssClass="ReadOnlyText"></asp:TextBox>
