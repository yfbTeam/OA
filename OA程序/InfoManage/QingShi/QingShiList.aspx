<%@ Page Language="C#" AutoEventWireup="true" Codebehind="QingShiList.aspx.cs" Inherits="xyoa.InfoManage.QingShi.QingShiList" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">报告批阅</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    标题：<asp:TextBox ID="Titles" runat="server" Width="103px"></asp:TextBox>状态：<asp:DropDownList
                                                                        ID="State" runat="server">
                                                                        <asp:ListItem></asp:ListItem>
                                                                        <asp:ListItem>等待批阅</asp:ListItem>
                                                                        <asp:ListItem>已批阅</asp:ListItem>
                                                                    </asp:DropDownList>填写人：<asp:TextBox ID="Realname" runat="server" CssClass="ReadOnlyText"
                                                                        Width="112px"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 填写时间：<asp:TextBox
                                                                            ID="TxTime" runat="server" Width="96px"  onClick="WdatePicker()"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="标题">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="QingShiList_py.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>" class="LinkLine">
                                                                                <%#DataBinder.Eval(Container.DataItem, "Titles")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="填写人" SortExpression="Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="批阅">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="QingShiList_py.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">批阅</a>
                                                                        </ItemTemplate>
