<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MySms_Out.aspx.cs" Inherits="xyoa.InfoManage.sms.MySms_Out" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MySms_Out.aspx';showwait();">
