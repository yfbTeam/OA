<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MySms_Shenpi.aspx.cs" Inherits="xyoa.InfoManage.sms.MySms_Shenpi" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MySms_Shenpi.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MySms_Shenpi_ysp.aspx';showwait();">
                                                                <font class="shadow_but">已审批</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="AddData" runat="server" Text="直接发送" CssClass="button_blue" OnClick="AddData_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    短息内容：<asp:TextBox ID="Content" runat="server" Width="76px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="短信内容" SortExpression="Content">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MySms_Shenpi_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="Starttime" HeaderText="计划发送时间" SortExpression="Starttime">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
