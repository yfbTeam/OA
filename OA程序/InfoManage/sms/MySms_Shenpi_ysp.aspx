<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MySms_Shenpi_ysp.aspx.cs" Inherits="xyoa.InfoManage.sms.MySms_Shenpi_ysp" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MySms_Shenpi.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MySms_Shenpi_ysp.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="短信内容" SortExpression="Content">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MySms_Shenpi_ysp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
