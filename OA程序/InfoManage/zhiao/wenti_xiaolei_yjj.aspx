<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wenti_xiaolei_yjj.aspx.cs" Inherits="xyoa.InfoManage.zhiao.wenti_xiaolei_yjj" %>

<%@ Register Src="xiaolei_wt.ascx" TagName="xiaolei_wt" TagPrefix="uc3" %>
...
<body class="newbody">
    <form id="form1" runat="server">
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                                            ...
                                                                                            <td valign="top">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td width="50%" valign="bottom">
                                                                                                            <a href="zhishitang.aspx" class="line_b">知识堂</a> >> <a href="wenti_all.aspx" class="line_b">
                                                                                                                全部问题分类</a> >> <a href="wenti_xiaolei.aspx?ParentNodesID=<%=Request.QueryString["ParentNodesID"] %>&id=0"
                                                                                                                    class="line_b">
                                                                                                                    <%=ViewState["Name"] %>
                                                                                                                </a>>>
                                                                                                            <%=ViewState["XName"] %>
                                                                    ...
                                                                    <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td height="35">
                                                                                <uc3:xiaolei_wt id="Xiaolei_wt1" runat="server">
                                                                                </uc3:xiaolei_wt>
                                                                                <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                                ...
                                                                                                <table align="center" background="img/bg0003.gif" border="0" cellpadding="0" cellspacing="0"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="height: 26px;">
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='wenti_xiaolei.aspx?ParentNodesID=<%=Request.QueryString["ParentNodesID"] %>&id=<%=Request.QueryString["id"] %>';showwait();">
                                                                                                                <font class="shadow_but">全部问题</font></button>
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='wenti_xiaolei_tj.aspx?ParentNodesID=<%=Request.QueryString["ParentNodesID"] %>&id=<%=Request.QueryString["id"] %>';showwait();"><font class="shadow_but">推荐问题</font></button>
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='wenti_xiaolei_wjj.aspx?ParentNodesID=<%=Request.QueryString["ParentNodesID"] %>&id=<%=Request.QueryString["id"] %>';showwait();"><font class="shadow_but">未解决问题</font></button>
                                                                                                            <button class="btn4on" type="button" onclick="javascript:window.location='wenti_xiaolei_yjj.aspx?ParentNodesID=<%=Request.QueryString["ParentNodesID"] %>&id=<%=Request.QueryString["id"] %>';showwait();"><font class="shadow_but">已解决问题</font></button>
                                                                                                        </td>
                                                                                                ...
                                                                                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:TemplateField HeaderText="点击/回答" SortExpression="A.Dianji">
                                                                                                            <HeaderStyle BackColor="#F2EBB7" ForeColor="#444659" Wrap="False" />
                                                                                                            <ItemTemplate>
                                                                                                                <%# DataBinder.Eval(Container.DataItem, "Dianji")%>/<%# DataBinder.Eval(Container.DataItem, "Huida")%>
                                                                                                            </ItemTemplate>
        ...
        <input id="SortText" type="hidden" runat="server" value="order by A.Settimes desc" />
    </form>
</body>
</html>