<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyPage_zl.aspx.cs" Inherits="xyoa.InfoManage.zhiao.MyPage_zl" %>
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="文件名称" SortExpression="A.Name">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a href="MyPage_zl_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lStringName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Name")%>'
