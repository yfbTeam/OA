<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leibie_wt_update.aspx.cs" Inherits="xyoa.InfoManage.zhiao.leibie_wt_update" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">问题分类设置</font></button></td>
                                                    ...
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                ...
                                                                <asp:Button ID="Button3" runat="server" Text="删 除" CssClass="button_css" OnClick="Button3_Click" />
                                                            </font>
                                                        </div>
                                                    </td>
                                                </tr>
