<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyPage_zl_update.aspx.cs"
    Inherits="xyoa.InfoManage.zhiao.MyPage_zl_update" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        ...
                                                        <a href="/MyWebDiskdown.aspx?number=<%=ViewState["NewNames"]%>" target="_blank">点击下载文件</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
