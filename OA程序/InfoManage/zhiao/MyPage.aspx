<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyPage.aspx.cs" Inherits="xyoa.InfoManage.zhiao.MyPage" %>
                                            ...
                                            <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="81%" valign="bottom">
                                                        <a href="zhishitang.aspx" class="line_b">知识堂</a> >> 我的主页</td>
                                                    <td width="16%">
                                                        &nbsp;</td>
                                                </tr>
                                            </table>
                                                ...
                                                <tr>
                                                    <td style="height: 26px;">
                                                        <button class="btn4off" type="button">
                                                            <font class="shadow_but">我的主页</font></button>
                    ...
                    <table align="center" border="0" cellpadding="4" cellspacing="0" width="100%" height="<%=ViewState["tableheigh"] %>">
                        <tr>
                           ...
                           <td class="newtd2" width="200px" height="100%" valign="top" id="td1">
                                <iframe name="nexthead" marginwidth="0" marginheight="0" src="MyPage_left.aspx" frameborder="1"
                                    width="100%" height="100%" scrolling="auto"></iframe>
                            </td>
                            <td class="newtd2"  valign="top" height="100%" id="td2">
                                <iframe name="nextrform" marginwidth="0" marginheight="0" src="<%=ViewState["urlstr"] %>"
