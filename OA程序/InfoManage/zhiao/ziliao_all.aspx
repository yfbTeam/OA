<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ziliao_all.aspx.cs" Inherits="xyoa.InfoManage.zhiao.ziliao_all" %>
                                                                                                ...
                                                                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                                                                        <td width="50%" valign="bottom">
                                                                                                            <a href="zhishitang.aspx" class="line_b">知识堂</a> >> 全部资料</td>
                                                                                                ...
                                                                                                <table align="center" background="img/bg0003.gif" border="0" cellpadding="0" cellspacing="0"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="height: 26px;">
                                                                                                            <button class="btn4on" type="button" onclick="javascript:window.location='ziliao_all.aspx';showwait();">
                                                                                                                <font class="shadow_but">全部资料</font></button>
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ziliao_tj.aspx';showwait();">
                                                                                                                <font class="shadow_but">推荐资料</font></button>
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ziliao_xzph.aspx';showwait();">
