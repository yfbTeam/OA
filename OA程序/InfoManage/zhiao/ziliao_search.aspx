<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ziliao_search.aspx.cs"
    Inherits="xyoa.InfoManage.zhiao.ziliao_search" %>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td width="50%" valign="bottom">
                                                                                                            <a href="zhishitang.aspx" class="line_b">知识堂</a> >> <a href="ziliao_all.aspx" class="line_b">
                                                                                                                全部资料</a> >> 搜索结果 >> 关键字【<font color="blue"><%= Server.UrlDecode(Request.QueryString["title"]) %></font>】</td>
                                                                                                ...
                                                                                                <table align="center" background="img/bg0003.gif" border="0" cellpadding="0" cellspacing="0"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="height: 26px;">
                                                                                                            <button class="btn4on" type="button">
                                                                                                                <font class="shadow_but">搜索结果</font></button>
                                                                                                        </td>
                                                                                                ...
                                                                                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        <asp:TemplateField HeaderText="文件名称" SortExpression="A.Name">
                                                                                                            ...
                                                                                                            <ItemTemplate>
                                                                                                                <img src="/oaimg/filetype/<%# DataBinder.Eval(Container.DataItem, "Filetype")%>.gif" /><asp:Label ID="Sname" runat="server"></asp:Label> 
                                                                                                                 <asp:Label ID="Lid" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "id") %>'
                                                                                                                    Visible="False" Width="0px"></asp:Label>
                                                                                                                    <asp:Label ID="Lname" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Name") %>'
                                                                                                                    Visible="False" Width="0px"></asp:Label>
                                                                                                            </ItemTemplate>
