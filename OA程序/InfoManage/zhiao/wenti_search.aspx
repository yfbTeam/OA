<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wenti_search.aspx.cs" Inherits="xyoa.InfoManage.zhiao.wenti_search" %>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td width="50%" valign="bottom">
                                                                                                             <a href="zhishitang.aspx" class="line_b">知识堂</a> >> <a href="wenti_all.aspx" class="line_b">
                                                                                                                全部问题</a> >> 搜索结果 >> 关键字【<font color="blue"><%= Server.UrlDecode(Request.QueryString["title"]) %></font>】</td>
