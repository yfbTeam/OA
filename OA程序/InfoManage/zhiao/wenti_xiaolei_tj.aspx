<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wenti_xiaolei_tj.aspx.cs" Inherits="xyoa.InfoManage.zhiao.wenti_xiaolei_tj" %>
                                                                                                ...
                                                                                                <table align="center" background="img/bg0003.gif" border="0" cellpadding="0" cellspacing="0"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="height: 26px;">
                                                                                                            ...
                                                                                                            <button class="btn4on" type="button" onclick="javascript:window.location='wenti_xiaolei_tj.aspx?ParentNodesID=<%=Request.QueryString["ParentNodesID"] %>&id=<%=Request.QueryString["id"] %>';showwait();"><font class="shadow_but">推荐问题</font></button>
