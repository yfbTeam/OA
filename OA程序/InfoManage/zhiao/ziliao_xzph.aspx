<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ziliao_xzph.aspx.cs" Inherits="xyoa.InfoManage.zhiao.ziliao_xzph" %>

<%@ Register Src="dalei_zl.ascx" TagName="dalei_zl" TagPrefix="uc3" %>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                                                ...
                                                                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                                                                        <td width="50%" valign="bottom">
                                                                                                            <a href="zhishitang.aspx" class="line_b">知识堂</a> >> 下载排行榜</td>
                                                                    ...
                                                                    <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td height="35">
                                                                                <uc3:dalei_zl ID="Dalei_zl1" runat="server" />
                                                                                <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td valign="top" style="height: 40px">
                                                                                            <div id="Div1">
                                                                                                <table align="center" background="img/bg0003.gif" border="0"
                                                                                                    cellpadding="0" cellspacing="0" width="100%">
                                                                                                    <tr>
                                                                                                        <td style="height: 26px;">
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ziliao_all.aspx';showwait();">
                                                                                                                <font class="shadow_but">全部资料</font></button>
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ziliao_tj.aspx';showwait();"><font class="shadow_but">推荐资料</font></button>
                                                                                                            <button class="btn4on" type="button" onclick="javascript:window.location='ziliao_xzph.aspx';showwait();"><font class="shadow_but">下载排行榜</font></button>
                                                                                                        </td>
