<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyPage_wt.aspx.cs" Inherits="xyoa.InfoManage.zhiao.MyPage_wt" %>
...
{ 
var num=Math.random();
window.showModalDialog('MyPage_wt_show.aspx?id='+id+'&tmp='+num+'','window','dialogWidth:727px;DialogHeight=700px;status:no;help=no;scroll=on');
}  
    </script>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lStringName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Zhuti")%>'
                                                                            ...
                                                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="syguihuan">删除</asp:LinkButton>
                                                                        </ItemTemplate>
                                                        ...
                                                        <table align="center" class="nextpage" border="0" cellpadding="4" cellspacing="1"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="newtd2" colspan="3" width="85%" style="height: 17px">
                                                                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">新建问题</asp:LinkButton>
                                                                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">删除选中问题</asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                        </table>
