<%@ Page Language="C#" AutoEventWireup="true" Codebehind="jifen.aspx.cs" Inherits="xyoa.InfoManage.zhiao.jifen" %>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    <td class="newtd2" colspan="4" width="33%" style="height: 26px" align="center">
                                                        <asp:GridView ID="GridView4" runat="server"  AutoGenerateColumns="False"
                                                            BorderStyle="None" GridLines="None" Width="372px">
                                                            <Columns>
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                                        ...
                                                                        <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                                            <tr>
                                                                                <td align="center" class="newtd2" height="17" nowrap="nowrap" width="34%">
                                                                                    ...
                                                                                    </asp:Label><%# Eval("Leibie")%></td>
                                                                                <td class="newtd2" height="17" width="33%">
                                                                                <%# Eval("gongsi") %><asp:TextBox ID="Fenshu" runat="server" Width="31px" Style="border-bottom: gray   1px   solid" BorderStyle="None" Text='<%# Eval("Fenshu") %>'></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </ItemTemplate>
