<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wenti_all.aspx.cs" Inherits="xyoa.InfoManage.zhiao.wenti_all" %>
                                                                                                ...
                                                                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                                                                        <td width="50%" valign="bottom">
                                                                                                            <a href="zhishitang.aspx" class="line_b">知识堂</a> >> 全部问题</td>
                                                                                                ...
                                                                                                <table align="center" background="img/bg0003.gif" border="0" cellpadding="0" cellspacing="0"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="height: 26px;">
                                                                                                            <button class="btn4on" type="button" onclick="javascript:window.location='wenti_all.aspx';showwait();">
