<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wenti_wjj.aspx.cs" Inherits="xyoa.InfoManage.zhiao.wenti_wjj" %>

<%@ Register Src="dalei_wt.ascx" TagName="dalei_wt" TagPrefix="uc3" %>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                                                ...
                                                                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                                                                        <td width="50%" valign="bottom">
                                                                                                            <a href="zhishitang.aspx" class="line_b">知识堂</a> >> 未解决问题</td>
                                                                    ...
                                                                    <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td height="35">
                                                                                <uc3:dalei_wt ID="Dalei_wt1" runat="server" />
                                                                                <table width="100%" height="35" border="0" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                                ...
                                                                                                <table align="center" background="img/bg0003.gif" border="0" cellpadding="0" cellspacing="0"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="height: 26px;">
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='wenti_all.aspx';showwait();">
                                                                                                                <font class="shadow_but">全部问题</font></button>
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='wenti_tj.aspx';showwait();"><font class="shadow_but">推荐问题</font></button>
                                                                                                            <button class="btn4on" type="button" onclick="javascript:window.location='wenti_wjj.aspx';showwait();"><font class="shadow_but">未解决问题</font></button>
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='wenti_yjj.aspx';showwait();"><font class="shadow_but">已解决问题</font></button>
                                                                                                        </td>
