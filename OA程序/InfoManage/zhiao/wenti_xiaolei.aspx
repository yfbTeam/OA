<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wenti_xiaolei.aspx.cs" Inherits="xyoa.InfoManage.zhiao.wenti_xiaolei" %>
                                                                                                ...
                                                                                                <table align="center" background="img/bg0003.gif" border="0" cellpadding="0" cellspacing="0"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="height: 26px;">
                                                                                                            <button class="btn4on" type="button" onclick="javascript:window.location='wenti_xiaolei.aspx?ParentNodesID=<%=Request.QueryString["ParentNodesID"] %>&id=<%=Request.QueryString["id"] %>';showwait();">
