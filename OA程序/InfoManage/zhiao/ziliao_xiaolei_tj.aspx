<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ziliao_xiaolei_tj.aspx.cs" Inherits="xyoa.InfoManage.zhiao.ziliao_xiaolei_tj" %>
                                                                                                ...
                                                                                                <table align="center" background="img/bg0003.gif" border="0" cellpadding="0" cellspacing="0"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="height: 26px;">
                                                                                                            ...
                                                                                                            <button class="btn4on" type="button" onclick="javascript:window.location='ziliao_xiaolei_tj.aspx?ParentNodesID=<%=Request.QueryString["ParentNodesID"] %>&id=<%=Request.QueryString["id"] %>';showwait();">
                                                                                                                <font class="shadow_but">推荐资料</font></button>
                                                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ziliao_xiaolei_xzph.aspx?ParentNodesID=<%=Request.QueryString["ParentNodesID"] %>&id=<%=Request.QueryString["id"] %>';showwait();">
