<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyPage_wt_update.aspx.cs"
    Inherits="xyoa.InfoManage.zhiao.MyPage_wt_update" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        问题内容(<a href="javascript:void(0)" onclick="openqiupengmodle()">模版</a>)：</td>
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:TextBox ID="Content" runat="server" Height="204px" MaxLength="3000" TextMode="MultiLine"
