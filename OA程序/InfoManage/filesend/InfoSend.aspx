<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InfoSend.aspx.cs" Inherits="xyoa.InfoManage.filesend.InfoSend" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='InfoSend.aspx';showwait();">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="文件名称" SortExpression="Name">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <img src="/oaimg/filetype/<%# DataBinder.Eval(Container.DataItem, "Filetype")%>.gif" /><a
                                                                                href='InfoSend_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'>
