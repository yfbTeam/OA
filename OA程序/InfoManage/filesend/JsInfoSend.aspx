<%@ Page Language="C#" AutoEventWireup="true" Codebehind="JsInfoSend.aspx.cs" Inherits="xyoa.InfoManage.filesend.JsInfoSend" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='JsInfoSend.aspx';showwait();">
                                                                <font class="shadow_but">接收文件</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    文件名称：<asp:TextBox ID="Name" runat="server"></asp:TextBox>
                                                                    传阅时间：<asp:TextBox ID="Startime" runat="server" onClick="WdatePicker()" Width="66px"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" onClick="WdatePicker()"
                                                                    ...
                                                                    发送人：
                                                                    <asp:TextBox ID="FsRealname" runat="server" Width="88px" CssClass="ReadOnlyText"></asp:TextBox>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="文件名称" SortExpression="Name">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <img src="/oaimg/filetype/<%# DataBinder.Eval(Container.DataItem, "Filetype")%>.gif" /><a
                                                                                href='JsInfoSend_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'>
                                                                                <%# DataBinder.Eval(Container.DataItem, "Name") %>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="传阅人" SortExpression="Realname">
                                                                    ...
                                                                    <asp:BoundField DataField="Settime" HeaderText="传阅时间" SortExpression="Settime">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
