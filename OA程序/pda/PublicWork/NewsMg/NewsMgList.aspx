<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NewsMgList.aspx.cs" Inherits="xyoa.pda.PublicWork.NewsMg.NewsMgList" %>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='NewsMgList_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
