<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BumenNewsMg_show.aspx.cs"
    Inherits="xyoa.pda.PublicWork.BumenNewsMg.BumenNewsMg_show" %>
            ...
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li><a id="A1" onclick="LoadingShow();location.href='BumenNewsMgList.aspx';">
            ...
            <table align="center" border="0" cellpadding="4" cellspacing="1" width="99%" class="nextpage"
                ...
                <tr>
                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                        发起部门：</td>
                    <td class="newtd2" height="17" colspan="3" width="85%">
                        <asp:Label ID="FqBumen" runat="server"></asp:Label>&nbsp;
                    </td>
                </tr>
                <tr>
                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
