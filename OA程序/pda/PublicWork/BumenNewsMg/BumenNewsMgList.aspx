<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BumenNewsMgList.aspx.cs"
    Inherits="xyoa.pda.PublicWork.BumenNewsMg.BumenNewsMgList" %>
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        ...
                        <li>是否阅读：<asp:DropDownList ID="IfRead" runat="server" Width="100px">
                            ...
                            <li>通知标题：<asp:TextBox ID="titles" runat="server" Width="100px"></asp:TextBox></li>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='BumenNewsMg_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
                                    <%# DataBinder.Eval(Container.DataItem, "titles")%>
                                </h2>
                                <h1>
                                    <%# DataBinder.Eval(Container.DataItem, "FqBumen")%>→<%# DataBinder.Eval(Container.DataItem, "Realname")%>
