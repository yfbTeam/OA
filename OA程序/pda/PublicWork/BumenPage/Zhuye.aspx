<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zhuye.aspx.cs" Inherits="xyoa.pda.PublicWork.BumenPage.Zhuye" %>
            ...
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li>是否阅读：<asp:DropDownList ID="Pizhu" runat="server">
                                <asp:ListItem></asp:ListItem>
                                <asp:ListItem>未阅读</asp:ListItem>
                                <asp:ListItem>已阅读</asp:ListItem>
                            </asp:DropDownList></li>
                            <li>新闻标题：<asp:TextBox ID="titles" runat="server" Width="100px"></asp:TextBox></li>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='Zhuye_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
                                    <%# DataBinder.Eval(Container.DataItem, "titles")%>
                                </h2>
                                <h1>
                                    <%# DataBinder.Eval(Container.DataItem, "BuMenName")%> → <%# DataBinder.Eval(Container.DataItem, "Realname")%>  <%# DataBinder.Eval(Container.DataItem, "Settime")%>
                                </h1>
                                <div class="clear">
                                </div>
                            </div>
