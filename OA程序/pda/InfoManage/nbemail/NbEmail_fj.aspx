<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NbEmail_fj.aspx.cs" Inherits="xyoa.pda.InfoManage.nbemail.NbEmail_fj" %>
                    ...
                    <div class="social_share">
                        <ul>
                            ...
                            <li><a id="box_meun4" onclick="showMenu();">
                                ...
                                查询</a></li>
                            <li><a id="A2" onclick="LoadingShow();location.href='NbEmail_sj.aspx';">
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='NbEmail_fj_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
