<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InfoSend_show.aspx.cs"
    Inherits="xyoa.pda.InfoManage.filesend.InfoSend_show" %>
            ...
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li><a id="A1" onclick="LoadingShow();location.href='InfoSend.aspx';">
                ...
                <tr id="nextrs3" style="display: none">
                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                        <div align="center" id="Div2">
                            <asp:Button ID="Button3" runat="server" Text="提交讨论内容" CssClass="button_css" OnClick="Button3_Click" />
                        </div>
                    </td>
                </tr>
            </table>
