<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Messages.aspx.cs" Inherits="xyoa.pda.InfoManage.messages.Messages" %>
            ...
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li>是否阅读：<asp:DropDownList ID="sfck" runat="server" Width="100px">
                            ...
                            <li>发送人员：<asp:TextBox ID="sendrealname" runat="server" Width="100px"></asp:TextBox></li>
                            <li>发送时间：<asp:TextBox ID="itimes" runat="server" Width="100px" onClick="WdatePicker()"></asp:TextBox></li>
                        </ul>
                    ...
                    <div class="social_share">
                        <ul>
                            ...
                            <li><a id="box_meun3">
                                ...
                                已读消息</a></li>
                            <li><a id="A2" onclick="LoadingShow();location.href='Messages_yf.aspx';">
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='Messages_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
