<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Messages_yf_show.aspx.cs" Inherits="xyoa.pda.InfoManage.messages.Messages_yf_show" %>
<!DOCTYPE html>
<html>
            ...
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                           <li><a id="A1" onclick="LoadingShow();location.href='Messages.aspx';">
            ...
            <table align="center" border="0" cellpadding="4" cellspacing="1" width="99%" class="nextpage"
                ...
                <tr>
                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                        接收人：</td>
                    <td class="newtd2" colspan="3" height="17">
                        <asp:Label ID="acceptrealname" runat="server" Width="90%"></asp:Label>
                         <asp:Label ID="acceptusername" runat="server" Width="90%" Visible="false"></asp:Label>
                         &nbsp;</td>
                </tr>
                <tr>
                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
