<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CarApply_sp.aspx.cs" Inherits="xyoa.pda.OfficeMenu.Car.CarApply_sp" %>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='CarApply_sp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
