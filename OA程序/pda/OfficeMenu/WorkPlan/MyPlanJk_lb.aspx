<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyPlanJk_lb.aspx.cs" Inherits="xyoa.pda.OfficeMenu.WorkPlan.MyPlanJk_lb" %>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='MyPlanJk_lb_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
