<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyRizhiJk_lb.aspx.cs" Inherits="xyoa.pda.OfficeMenu.Rizhi.MyRizhiJk_lb" %>
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            ...
                            <li>日志标题：<asp:TextBox ID="titles" runat="server" Width="100px"></asp:TextBox></li>
                            <li>创建人员：<asp:TextBox ID="Realname" runat="server" Width="100px"></asp:TextBox></li>
                            <li>日志类别：<asp:DropDownList ID="LeiBie" runat="server">
                            </asp:DropDownList></li>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='MyRizhiJk_lb_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
                                    (<%# DataBinder.Eval(Container.DataItem, "LeiBieName")%>)<%# DataBinder.Eval(Container.DataItem, "titles")%>
                                </h2>
                                <h1>
                                    <font color="red">
