<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyRizhi.aspx.cs" Inherits="xyoa.pda.OfficeMenu.Rizhi.MyRizhi" %>
        ...
        <div id="box_meun" class="box">
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li><a id="A2" onclick="LoadingShow();location.href='MyRizhi_add.aspx';">
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='MyRizhi_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
