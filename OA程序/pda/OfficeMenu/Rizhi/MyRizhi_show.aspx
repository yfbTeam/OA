<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyRizhi_show.aspx.cs" Inherits="xyoa.pda.OfficeMenu.Rizhi.MyRizhi_show" %>
            ...
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li><a id="A2" onclick="LoadingShow();location.href='MyRizhi.aspx';">
                                <img border="0" alt="" src="/pda/images/home.png"><br>
                                我的日志</a></li>
                            <li><a id="A1" onclick="LoadingShow();location.href='MyRizhi_add.aspx';">
