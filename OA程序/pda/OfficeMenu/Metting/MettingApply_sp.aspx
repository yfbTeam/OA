<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MettingApply_sp.aspx.cs"
    Inherits="xyoa.pda.OfficeMenu.Metting.MettingApply_sp" %>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='MettingApply_sp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
                                    <%# DataBinder.Eval(Container.DataItem, "Name")%>
                                </h2>
                                <h1>
                                    <%# DataBinder.Eval(Container.DataItem, "MettingName")%>
