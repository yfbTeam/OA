<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MettingApply_ysp.aspx.cs" Inherits="xyoa.pda.OfficeMenu.Metting.MettingApply_ysp" %>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='MettingApply_ysp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
