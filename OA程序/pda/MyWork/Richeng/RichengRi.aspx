<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RichengRi.aspx.cs" Inherits="xyoa.pda.MyWork.Richeng.RichengRi" %>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='RichengmyList_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
