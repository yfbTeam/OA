<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RichenggkRi.aspx.cs" Inherits="xyoa.pda.MyWork.Richeng.RichenggkRi" %>
<!DOCTYPE html>
<html>
            ...
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li>日程标题：<asp:TextBox ID="titles" runat="server" Width="100px"></asp:TextBox></li>
                    ...
                    <div class="social_share">
                        <ul>
                            ...
                            <li><a id="box_meun4" onclick="showMenu();">
                                ...
                                查询</a></li>
                            <li><a id="A1">
                                <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="/pda/images/myspace.png"
                                    OnClick="ImageButton3_Click" /><br>
                                今日日程</a></li>
                            <li>
                                <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="/pda/images/myspace.png"
                                    OnClick="ImageButton4_Click" />
                                <br>
                                本周日程</li>
                            <li>
                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="/pda/images/myspace.png"
                                    OnClick="ImageButton1_Click" />
                                <br>
                                本月日程</li>
                            <li><a id="A4">
                                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="/pda/images/myspace.png"
                                    OnClick="ImageButton2_Click" /><br>
                                我的日程</a></li>
                            <li><a id="A3" onclick="LoadingShow();location.href='RichengXb.aspx';">
                                <img border="0" alt="" src="/pda/images/rss.png"><br>
                                协办日程</a></li>
                            <li><a id="A2" onclick="LoadingShow();location.href='RichenggkRi.aspx';">
                                <img border="0" alt="" src="/pda/images/rss.png"><br>
                                公开日程 </a></li>
                        </ul>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='Richenggk_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
                                    <%# DataBinder.Eval(Container.DataItem, "titles")%>
                                </h2>
                                <h1>
                                    <%# DataBinder.Eval(Container.DataItem, "Realname")%>  <%# DataBinder.Eval(Container.DataItem, "StartTime")%>
                                    -
