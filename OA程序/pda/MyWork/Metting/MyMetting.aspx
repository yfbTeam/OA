<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyMetting.aspx.cs" Inherits="xyoa.pda.InfoManage.Metting.MyMetting" %>
<!DOCTYPE html>
<html>
            ...
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li>会议名称：<asp:TextBox ID="Name" runat="server" Width="100px"></asp:TextBox></li>
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="LoadingShow();location.href='MettingApply_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>';">
                                <h2>
                                    <%# DataBinder.Eval(Container.DataItem, "Name")%>
                                </h2>
                                <h1>
                                    <%# DataBinder.Eval(Container.DataItem, "MettingName")%>  <%# DataBinder.Eval(Container.DataItem, "StartTime")%>
                                    -
