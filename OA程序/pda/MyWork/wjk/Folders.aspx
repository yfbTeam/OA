<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Folders.aspx.cs" Inherits="xyoa.pda.MyWork.wjk.Folders" %>
            ...
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li>文件名称：<asp:TextBox ID="OldName" runat="server" Width="131px"></asp:TextBox></li>
                            <li>文件目录：<asp:DropDownList ID="Folder" runat="server" Width="131px">
                            </asp:DropDownList></li>
                        </ul>
        ...
        <div id="box_meun" class="box">
            <div class="box_content">
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            <li><a id="box_meun1" onclick="LoadingShow();location.href='Folders_add.aspx';">
        ...
        <div id="divgrid" class="divheight">
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <div class="corner_wrap" onclick="location.href='/Foldersdown.aspx?number=<%# DataBinder.Eval(Container.DataItem, "NewName")%>';">
                                <h2>
                                    <img src="/oaimg/filetype/<%# DataBinder.Eval(Container.DataItem, "Fjtype")%>.gif" /><%# DataBinder.Eval(Container.DataItem, "OldName")%>
                                </h2>
                                <h1>
