<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyAddWorkFlow.aspx.cs"
    Inherits="xyoa.pda.WorkFlow.MyAddWorkFlow" %>
                ...
                <div class="box_content_center">
                    <div class="social_share">
                        <ul>
                            ...
                            <li>办理状态：<asp:DropDownList ID="State" runat="server">
                        ...
                        <ItemTemplate>
                            <div class="corner_wrap">
                                ...
                                <h1>
                                    ...
                                    <font color="red">主办人：</font><%# DataBinder.Eval(Container.DataItem, "ZbObjectName")%><br>
                                    <font color="red">步骤：</font><asp:Label ID="Label2" runat="server"></asp:Label><br>
                                    <font color="red">状态：</font><%# DataBinder.Eval(Container.DataItem, "State")%><br>
                                    <font color="red">工作发起时间：</font><%# DataBinder.Eval(Container.DataItem, "NowTimes")%>
