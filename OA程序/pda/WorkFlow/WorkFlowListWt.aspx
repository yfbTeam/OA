<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowListWt.aspx.cs"
    Inherits="xyoa.pda.WorkFlow.WorkFlowListWt" %>
        ...
        <div id="divgrid" class="divheight">
            <table align="center" border="0" cellpadding="4" cellspacing="1" width="99%" class="nextpage">
                ...
                <tr>
                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                        委托人：</td>
                    <td class="newtd2" height="17" colspan="3" width="100%">
                        <asp:DropDownList ID="Wtrealname" runat="server" Width="95%">
                        </asp:DropDownList><br>
                        <asp:TextBox ID="Realname" runat="server" Width="119px"></asp:TextBox>
                ...
                <tr>
                    <td align="center" colspan="4" class="newtd2">
                        <asp:Button ID="Button2" runat="server" Text="确定委托" OnClick="Button2_Click1" />
                    </td>
                </tr>
            </table>
