<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAddWorkFlowYj.aspx.cs" Inherits="xyoa.pda.WorkFlow.MyAddWorkFlowYj" %>
            ...
            <table align="center" border="0" cellpadding="4" cellspacing="1" width="99%" class="nextpage">
                ...
                <tr>
                    <td align="left" colspan="2" class="newtd2">
                        ...
                        </asp:GridView>  <asp:TextBox ID="GlNum" runat="server" Style="display: none"></asp:TextBox>
                    </td>
                </tr>
            </table>
