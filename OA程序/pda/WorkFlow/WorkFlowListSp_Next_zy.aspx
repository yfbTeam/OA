<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowListSp_Next_zy.aspx.cs"
    Inherits="xyoa.pda.WorkFlow.WorkFlowListSp_Next_zy" %>
            ...
            <table width="99%" border="0" cellspacing="1" cellpadding="4" class="nextpage">
                ...
                <tr>
                    <td class="newtd1" nowrap="nowrap" align="center">
                        <asp:Button ID="Button5" runat="server" Text="确定转交" OnClick="Button5_Click" />
                        <asp:Button ID="Button2" runat="server" Text="结束归档"  OnClick="Button2_Click1" />
