<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAddWorkFlowJb.aspx.cs" Inherits="xyoa.pda.WorkFlow.MyAddWorkFlowJb" %>
<!DOCTYPE html>
<html>
                        ...
                        <ItemTemplate>
                            <div class="corner_wrap">
                                ...
                                <h1>
                                    ...
                                    <font color="red">办理步骤：</font><%# DataBinder.Eval(Container.DataItem, "UpNodeName")%><br>
                                    <font color="red">发起人：</font><%# DataBinder.Eval(Container.DataItem, "FqRealname")%><br>
                                    <font color="red">办理时间：</font><%# DataBinder.Eval(Container.DataItem, "NowTimes")%>
