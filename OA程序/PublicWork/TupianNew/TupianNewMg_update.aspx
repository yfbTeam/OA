<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TupianNewMg_update.aspx.cs" Inherits="xyoa.PublicWork.TupianNew.TupianNewMg_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="TupianNewMg.aspx">图片新闻管理</a>
                                                            >> 修改图片新闻管理</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        新闻内容(<a href="javascript:void(0)" onclick="openqiupengmodle()">模版</a>)：</td>
                                                ...
                                                <tr class="" id="nextrs23">
                                                    ...
                                                    <td class="newtd2" height="17" width="33%" colspan="3">
                                                        <asp:Image ID="Photo" runat="server" Height="132px" Width="300px" /><br>
