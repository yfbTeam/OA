<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NewsMgList.aspx.cs" Inherits="xyoa.PublicWork.NewsMg.NewsMgList" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='NewsMgList.aspx';showwait();">
                                                                <font class="shadow_but">新闻浏览</font></button>
                                                        </td>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 是否阅读：<asp:DropDownList
                                                                            ID="Pizhu" runat="server">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='NewsMgList_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="发布人" SortExpression="Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
