<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NewsMg.aspx.cs" Inherits="xyoa.PublicWork.NewsMg.NewsMg" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='NewsMg.aspx';showwait();">
                                                                <font class="shadow_but">新闻管理</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='NewsMg_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
