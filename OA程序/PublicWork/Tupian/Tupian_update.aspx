<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tupian_update.aspx.cs" Inherits="xyoa.PublicWork.Tupian.Tupian_update" %>
<html>
                                               ...
                                               <tr>
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        附件：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <input id="uploadFile" runat="server" name="uploadFile" style="width: 314px" type="file" />
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Text="同时修改图片" /></td>
                                                </tr>
                                                <tr id="printshow3">
