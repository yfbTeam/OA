<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ComThingMg_update.aspx.cs"
    Inherits="xyoa.PublicWork.ComThingMg.ComThingMg_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="ComThingMg.aspx">大事记管理</a>
                                                            >> 修改大事记</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">大事记</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        大事记内容(<a href="javascript:void(0)" onclick="openqiupengmodle()">模版</a>)：</td>
