<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Zhuye.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.Zhuye" %>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="76%" valign="top">
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#E0E0E0"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="最新发表文章">
                                                                            <ItemStyle Wrap="False" />
                                                                            <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                            <ItemTemplate>
                                                                                <img src="/oaimg/point.gif" />&nbsp;<a  href='Zhuye_show.aspx?key=1&id=<%# DataBinder.Eval(Container.DataItem, "id")%>&ZhuyeId=<%# DataBinder.Eval(Container.DataItem, "ZhuyeId")%>'>
                                                                    ...
                                                                    <EmptyDataTemplate>
                                                                        <div align="center">
                                                                            <font color="white">未更新文章！</font></div>
                                                                    </EmptyDataTemplate>
