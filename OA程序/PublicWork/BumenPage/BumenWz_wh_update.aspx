<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BumenWz_wh_update.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.BumenWz_wh_update" %>
...
function chknull()
{
    ...
    if(document.getElementById('WzLeibie').value=='')
    {
    alert('文章类别不能为空');
    form1.WzLeibie.focus();
    return false;
    }	
    showwait();	
}  
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="BumenWz_wh.aspx?id=<%=Request.QueryString["ZhuyeId"] %>" class="line_b"><%=ViewState["BuMenName"] %></a> >>  <a href="BumenWz_wh.aspx?id=<%=Request.QueryString["ZhuyeId"] %>">文章管理</a>
                                                            >> 修改文章</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">文章管理</font></button></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="titles" runat="server" Width="100%"></asp:TextBox>
                                                                 ...
                                                                 <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>文章类别：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:DropDownList ID="WzLeibie" runat="server" Width="100%">
                                                        </asp:DropDownList></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        文章内容(<a href="javascript:void(0)" onclick="openqiupengmodle()">模版</a>)：</td>
