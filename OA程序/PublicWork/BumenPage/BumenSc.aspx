<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BumenSc.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.BumenSc" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='BumenSc.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='BumenSc_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&ZhuyeId=<%# DataBinder.Eval(Container.DataItem, "ZhuyeId")%>' class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="取消收藏">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="shoucan" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="shoucan">取消收藏</asp:LinkButton>
                                                                        </ItemTemplate>
