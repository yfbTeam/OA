<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zhuye_lb_list.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.Zhuye_lb_list" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                             <a href="Zhuye_list.aspx?id=<%=Request.QueryString["ZhuyeId"] %>" class="line_b">
                                                                <%=ViewState["BuMenName"] %>
                                                            </a>>> (<%=ViewState["Leixing"] %>)文章浏览
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" >
                                                                <font class="shadow_but">文章浏览</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                          <asp:Button id="Button3" runat="server" CssClass="button_css" Text="返 回" OnClick="Button3_Click"></asp:Button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    发布时间从<asp:TextBox ID="Starttime" runat="server" Width="80px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" Width="80px"
                                                                                onClick="WdatePicker()"></asp:TextBox>发布人：
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='Zhuye_show.aspx?key=3&id=<%# DataBinder.Eval(Container.DataItem, "id")%>&ZhuyeId=<%# DataBinder.Eval(Container.DataItem, "ZhuyeId")%>&WzLeibie=<%# DataBinder.Eval(Container.DataItem, "WzLeibie")%>' class="LinkLine">
                                                                                <%# DataBinder.Eval(Container.DataItem, "titles")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                                    <asp:BoundField DataField="LeixingName" HeaderText="文章类别" SortExpression="A.WzLeibie">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="主页→发布人" SortExpression="Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "BuMenName")%>
