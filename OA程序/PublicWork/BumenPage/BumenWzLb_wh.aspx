<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BumenWzLb_wh.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.BumenWzLb_wh" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="BumenWh.aspx" class="line_b"><%=ViewState["BuMenName"] %></a> >> 文章类别
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">文章类别</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="Button2" runat="server" Text="增 加" CssClass="button_blue" OnClick="ImageButton1_Click" />
                                                            <asp:Button ID="Button3" runat="server" Text="修 改" CssClass="button_blue" OnClick="ImageButton2_Click" />
                                                            <asp:Button ID="DelData" runat="server" Text="删 除" CssClass="button_blue" OnClick="ImageButton3_Click" />
                                                            <asp:Button ID="Button4" runat="server" Text="返 回" CssClass="button_blue" OnClick="Button4_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Leixing" HeaderText="文章类别" SortExpression="Leixing">
