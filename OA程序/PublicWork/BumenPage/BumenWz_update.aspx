<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BumenWz_update.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.BumenWz_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="BumenWz.aspx?id=<%=Request.QueryString["ZhuyeId"] %>" class="line_b"><%=ViewState["BuMenName"] %></a> >>  <a href="BumenWz.aspx?id=<%=Request.QueryString["ZhuyeId"] %>">文章管理</a>
                                                            >> 修改文章</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
