<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BumenZyLb.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.BumenZyLb" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="../main_d.aspx" class="line_b">工作台</a> >> 部门主页类别
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                    </tr>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='BumenZyLb.aspx';showwait();">
                                                                <font class="shadow_but">部门主页类别</font>
                                                            </button>
                                                        </td>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Leixing" HeaderText="部门主页类别" SortExpression="Leixing">
