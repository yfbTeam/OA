<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BumenWz_add.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.BumenWz_add" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="BumenWz.aspx?id=<%=Request.QueryString["ZhuyeId"] %>"
                                                                class="line_b">
                                                                <%=ViewState["BuMenName"] %>
                                                            </a>>> <a href="BumenWz.aspx?id=<%=Request.QueryString["ZhuyeId"] %>">文章管理</a> >>
                                                            新增文章</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
