<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BumenWz_wh_show.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.BumenWz_wh_show" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="BumenWz_wh.aspx?id=<%=Request.QueryString["ZhuyeId"] %>"
                                                                class="line_b">
                                                                <%=ViewState["BuMenName"] %>
                                                            </a>>> <a href="BumenWz_wh.aspx?id=<%=Request.QueryString["ZhuyeId"] %>">文章管理</a> >>
                                                            查看文章</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="sc" runat="server" Text="收 藏" class="button_css" OnClick="sc_Click"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
