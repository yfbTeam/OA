<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BumenWzLb.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.BumenWzLb" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="BumenSz.aspx" class="line_b"><%=ViewState["BuMenName"] %></a> >> 文章类别
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                    </tr>
