<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BumenWz.aspx.cs" Inherits="xyoa.PublicWork.BumenPage.BumenWz" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="BumenSz.aspx" class="line_b">
                                                                <%=ViewState["BuMenName"] %>
                                                            </a>>> 管理文章
                                                        </td>
                                                        <td width="16%">
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">管理文章</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            ...
                                                            <asp:Button ID="Button3" runat="server" Text="返 回" CssClass="button_blue" OnClick="Button3_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    标题：<asp:TextBox ID="titles" runat="server" Width="97px"></asp:TextBox>
                                                                    文章类别：<asp:DropDownList ID="WzLeibie" runat="server">
                                                                    </asp:DropDownList>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="A.titles">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='BumenWz_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&ZhuyeId=<%# DataBinder.Eval(Container.DataItem, "ZhuyeId")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="Settime" HeaderText="发布时间" SortExpression="A.Settime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="主页→发布人" SortExpression="A.Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
