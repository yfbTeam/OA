<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BumenNewsMgListy.aspx.cs"
    Inherits="xyoa.PublicWork.BumenNewsMg.BumenNewsMgListy" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='BumenNewsMgListALL.aspx';showwait();">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='BumenNewsMgListy.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='BumenNewsMgListy_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="部门名称→发布人姓名" SortExpression="Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
