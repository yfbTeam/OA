<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BumenNewsMgListALL.aspx.cs"
    Inherits="xyoa.PublicWork.BumenNewsMg.BumenNewsMgListALL" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='BumenNewsMgListALL.aspx';showwait();">
                                                                <font class="shadow_but">全部通知</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='BumenNewsMgList.aspx';showwait();">
                                                                <font class="shadow_but">未阅读</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='BumenNewsMgListy.aspx';showwait();">
                                                                <font class="shadow_but">已阅读</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="ShowData" runat="server" Text="查 看" CssClass="button_blue" OnClick="ShowData_Click" /></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    发布时间：<asp:TextBox ID="Startime" runat="server" onClick="WdatePicker()" Width="66px"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" onClick="WdatePicker()"
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='BumenNewsMgListALL_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="Settime" HeaderText="发布时间" SortExpression="Settime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="部门名称→发布人姓名" SortExpression="FqBumen">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "FqBumen")%>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="是否阅读">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="YdUsername" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "YdUsername")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="Label2" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" Width="120px" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="收藏">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" Width="40px" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="ScUsername" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ScUsername")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:LinkButton ID="shoucan" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="shoucan">收藏</asp:LinkButton>
                                                                        </ItemTemplate>
