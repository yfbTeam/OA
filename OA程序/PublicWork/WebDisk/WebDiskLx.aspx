<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WebDiskLx.aspx.cs" Inherits="xyoa.PublicWork.WebDisk.WebDiskLx" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">硬盘目录</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            ...
                                                            <asp:Button ID="QuanxianData" runat="server" Text="权限设置" CssClass="button_blue" OnClick="QuanxianData_Click" />
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Name" HeaderText="目录名称" SortExpression="Name">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="创建人" SortExpression="SetRealname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='senduser("<%# DataBinder.Eval(Container.DataItem, "SetUsername")%>")'>
                                                                                <%# DataBinder.Eval(Container.DataItem, "SetRealname")%>
                                                                            </a>
                                                                        </ItemTemplate>
