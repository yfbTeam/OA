<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WebDiskLx_qxbm_add.aspx.cs"
    Inherits="xyoa.PublicWork.WebDisk.WebDiskLx_qxbm_add" %>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="height: 302px">
                                    <tr>
                                        <td align="center" style="width: 113px" valign="top">
                                            <asp:ListBox ID="SourceListBox" runat="server" Height="411px" Width="157px" SelectionMode="Multiple">
                                            </asp:ListBox></td>
                                        ...
                                        <td align="center" style="width: 100px" valign="top">
                                            <asp:ListBox ID="TargetListBox" runat="server" Height="411px" Width="157px" SelectionMode="Multiple">
                                            </asp:ListBox></td>
                                    </tr>
                                </table>
                            </td>
