<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WebDiskLx_add.aspx.cs"
    Inherits="xyoa.PublicWork.WebDisk.WebDiskLx_add" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                <asp:Button ID="Button1" runat="server" Text="下一步" CssClass="button_css" OnClick="Button1_Click" />
