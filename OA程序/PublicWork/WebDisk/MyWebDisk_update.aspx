<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyWebDisk_update.aspx.cs"
    Inherits="xyoa.PublicWork.WebDisk.MyWebDisk_update" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        ...
                                                        <asp:Label ID="FjtypeLb" runat="server"></asp:Label>
                                                        <img src="/oaimg/menu/arrow_down.gif" />
                                                        <a href="/MyWebDiskdown.aspx?number=<%=ViewState["NewNames"]%>"
                                                            target="_blank">点击下载文件</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
