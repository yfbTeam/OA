<%@ Page Language="C#" AutoEventWireup="true" Codebehind="QikanLxList.aspx.cs" Inherits="xyoa.PublicWork.Qikan.QikanLxList" %>
                                ...
                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                    ...
                                    <tr>
                                        <td style="height: 26px;">
                                            <button class="btn4off" type="button" onclick="javascript:window.nexthead.location='QikanLxList_left.aspx';">
                                                <font class="shadow_but">期刊浏览</font></button>
        ...
        <table align="center" border="0" cellpadding="4" cellspacing="0" width="100%" height="<%=ViewState["tableheigh"] %>">
            <tr>
                ...
                <td class="newtd2" width="200px" height="100%" valign="top" id="td1">
                    <iframe name="nexthead" marginwidth="0" marginheight="0" src="QikanLxList_left.aspx"
                        frameborder="1" width="100%" height="100%" scrolling="auto"></iframe>
                </td>
                <td class="newtd2" valign="top" height="100%" id="td2">
                    <iframe name="nextrform" marginwidth="0" marginheight="0" src="QikanLxList_show.aspx?id=0"
                        frameborder="1" width="100%" height="100%" scrolling="auto"></iframe>
                </td>
                <td width="5" height="100%">
                    &nbsp;</td>
