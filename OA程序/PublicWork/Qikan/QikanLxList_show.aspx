<%@ Page Language="C#" AutoEventWireup="true" Codebehind="QikanLxList_show.aspx.cs"
    Inherits="xyoa.PublicWork.Qikan.QikanLxList_show" %>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="期刊标题" SortExpression="Titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='QikanLxList_show_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
