<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Shipin_show.aspx.cs" Inherits="xyoa.PublicWork.Shipin.Shipin_show" %>
                                                        ...
                                                        <table align="center" class="nextpage" border="0" cellpadding="4" cellspacing="1"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="newtd2" colspan="3" width="85%" style="height: 17px">
                                                                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">删除选中视频</asp:LinkButton>
                                                                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">新建视频</asp:LinkButton>
                                                                    <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">修改视频</asp:LinkButton>
