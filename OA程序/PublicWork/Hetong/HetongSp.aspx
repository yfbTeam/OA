<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HetongSp.aspx.cs" Inherits="xyoa.PublicWork.Hetong.HetongSp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='HetongSp.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                                 <button class="btn4off" type="button" onclick="javascript:window.location='HetongySp.aspx';showwait();">
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="合同主题" SortExpression="Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a href='HetongSp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
