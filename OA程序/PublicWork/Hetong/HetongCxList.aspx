<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HetongCxList.aspx.cs" Inherits="xyoa.PublicWork.Hetong.HetongCxList" %>
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="合同主题" SortExpression="Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a href='HetongCxList_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
