<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyHetong.aspx.cs" Inherits="xyoa.PublicWork.Hetong.MyHetong" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyHetong.aspx';showwait();">
                                                                <font class="shadow_but">我的合同</font></button>
                                                        </td>
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="合同主题" SortExpression="Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a href='MyHetong_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
