<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HetongJkList.aspx.cs" Inherits="xyoa.PublicWork.Hetong.HetongJkList" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='HetongJk.aspx';showwait();">
                                                                <font class="shadow_but">按人员</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='HetongJkList.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    合同主题：<asp:TextBox ID="Zhuti" runat="server" Width="61px"></asp:TextBox>
                                                                    合同号：<asp:TextBox ID="Hetonghao" runat="server" Width="61px"></asp:TextBox>
                                                                    对方单位：<asp:TextBox ID="Danwei" runat="server" Width="90px"></asp:TextBox>
                                                                    合同类别：<asp:DropDownList ID="Fenlei" runat="server">
                                                                    </asp:DropDownList>
                                                                    状态：<asp:DropDownList ID="Zhuangtai" runat="server">
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="合同主题" SortExpression="Zhuti">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Lid" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <a href='HetongJk_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                                <%# DataBinder.Eval(Container.DataItem, "Zhuti")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="合同号" SortExpression="Hetonghao">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Hetonghao")%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="合同金额(元)" SortExpression="Jine">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Jine")%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="对方单位" SortExpression="Danwei">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Danwei")%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="FenleiName" HeaderText="合同类别" SortExpression="Fenlei">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="状态" SortExpression="A.Zhuangtai">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' class="LinkLine" onclick="var num=Math.random();window.showModalDialog('HeTong_zt.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&tmp='+num+'','window', 'dialogWidth:550px;DialogHeight=350px;status:no;scroll=yes;help:no');">
                                                                                <img src="/oaimg/r/ht_<%# DataBinder.Eval(Container.DataItem, "Zhuangtai")%>.gif"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="创建人" SortExpression="ARealname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' class="LinkLine" onclick='senduser("<%# DataBinder.Eval(Container.DataItem, "AUsername")%>")'>
                                                                                <%# DataBinder.Eval(Container.DataItem, "ARealname")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                        ...
                                                        总金额(元)：<asp:Label ID="AllMoney" runat="server"></asp:Label>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
