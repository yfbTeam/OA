<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HetongySp.aspx.cs" Inherits="xyoa.PublicWork.Hetong.HetongySp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='HetongSp.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                                 <button class="btn4on" type="button" onclick="javascript:window.location='HetongySp.aspx';showwait();">
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                <tr>
                                                    <td valign="top">
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="合同主题" SortExpression="Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a href='HetongySp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                        ...
                                                        总金额：<asp:Label ID="AllMoney" runat="server"></asp:Label>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
