<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HetongSz.aspx.cs" Inherits="xyoa.PublicWork.Hetong.HetongSz" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='HetongSz.aspx';showwait();">
                                                                <font class="shadow_but">合同监控设置</font></button>
                                                        </td>
