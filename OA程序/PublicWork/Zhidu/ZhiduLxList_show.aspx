<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ZhiduLxList_show.aspx.cs"
    Inherits="xyoa.PublicWork.Zhidu.ZhiduLxList_show" %>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    <asp:Button ID="Button2" runat="server" CssClass="button_css" OnClick="Button2_Click"
                                                                        Text="退 出" />
                                                                    当前目录：<font color="red"><asp:Label ID="Namefile" runat="server"></asp:Label></td>
                                                            </tr>
                                                        </table>
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="制度标题" SortExpression="Titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='ZhiduLxList_show_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
