<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Zhidu_show.aspx.cs" Inherits="xyoa.PublicWork.Zhidu.Zhidu_show" %>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="制度标题" SortExpression="Titles">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Zhidu_show_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                        ...
                                                        <table align="center" class="nextpage" border="0" cellpadding="4" cellspacing="1"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="newtd2" colspan="3" width="85%" style="height: 17px">
                                                                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">删除选中制度</asp:LinkButton>
                                                                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">新建制度</asp:LinkButton>
                                                                    <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">修改制度</asp:LinkButton>
