<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DocumentModle_update.aspx.cs"
    Inherits="xyoa.SystemManage.DocumentModle.DocumentModle_update" %>
...
<body class="newbody" onload="select_type();a1()">
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="DocumentModle.aspx">红头文件管理</a>
                                                            >> 修改红头文件</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        红头文件：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:Label ID="wenjian" runat="server"></asp:Label><asp:CheckBox ID="CheckBox1" runat="server" Text="重新上传红头文件" onclick="a1()"/>
                                                    </td>
                                                </tr>
                                                <tr id="nextrs1">
