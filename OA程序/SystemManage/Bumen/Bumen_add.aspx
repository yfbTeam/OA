<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Bumen_add.aspx.cs" Inherits="xyoa.SystemManage.Bumen.Bumen_add" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Bianhao" runat="server" Width="100%">0</asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:TextBox ID="remark" runat="server" Width="100%" MaxLength="200"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="newtd2" colspan="4" height="17" style="text-align: center">
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Text="保存后继续新增" />
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            ...
                                                            <input id="Button2" type="button" value="返 回" onclick="history.go(-1)" class="button_css" /></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
