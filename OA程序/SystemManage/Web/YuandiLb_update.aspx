<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YuandiLb_update.aspx.cs" Inherits="xyoa.SystemManage.Web.YuandiLb_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="YuandiLb.aspx">学习园地</a> >> 修改学习园地类别</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">学习园地类别</font></button></td>
