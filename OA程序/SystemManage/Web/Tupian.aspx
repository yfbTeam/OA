<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Tupian.aspx.cs" Inherits="xyoa.SystemManage.Web.Tupian" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Tupian.aspx';showwait();">
                                                                <font class="shadow_but">图片新闻</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="新闻标题" SortExpression="Titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='/Tupian_View.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' target="_blank">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="图片" SortExpression="Tupian">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <img src="/web/Tupian/<%# DataBinder.Eval(Container.DataItem, "Tupian") %>" height="100px"
                                                                                width="80px">
                                                                        </ItemTemplate>
