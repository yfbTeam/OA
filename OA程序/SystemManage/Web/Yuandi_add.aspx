<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Yuandi_add.aspx.cs" Inherits="xyoa.SystemManage.Web.Yuandi_add" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Yuandi.aspx">学习园地</a> >> 新增学习园地</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">学习园地</font></button></td>
