<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanmuLb.aspx.cs" Inherits="xyoa.SystemManage.Web.LanmuLb" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Lanmu.aspx';showwait();">
                                                                <font class="shadow_but">栏目新闻</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='LanmuLb.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    新闻类别：<asp:TextBox ID="Name" runat="server"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                      ...
                                                                      <asp:BoundField DataField="Name" HeaderText="新闻类别" SortExpression="Name">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                      <asp:TemplateField HeaderText="排序号" SortExpression="Paixu">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                         <%# DataBinder.Eval(Container.DataItem, "Paixu") %>
                                                                        </ItemTemplate>
