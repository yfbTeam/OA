<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Zhuanti.aspx.cs" Inherits="xyoa.SystemManage.Web.Zhuanti" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Zhuanti.aspx';showwait();">
                                                                <font class="shadow_but">专题新闻</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ZhuantiLb.aspx';showwait();">
                                                                <font class="shadow_but">专题类别</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    新闻标题：<asp:TextBox ID="Titles" runat="server"></asp:TextBox>
                                                                    新闻类别： <asp:DropDownList ID="Leibie" runat="server">
                                                                    </asp:DropDownList>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="新闻标题" SortExpression="Titles">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='/web/Zhuangti.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' target="_blank">
                                                                                <%# DataBinder.Eval(Container.DataItem, "Titles")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False"  />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="LeibieName" HeaderText="类别" SortExpression="Leibie">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                      <asp:BoundField DataField="Shijian" HeaderText="发布时间" SortExpression="Shijian">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
