<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LanmuLb_update.aspx.cs" Inherits="xyoa.SystemManage.Web.LanmuLb_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="LanmuLb.aspx">自定义栏目</a> >> 修改新闻类别</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">新闻类别</font></button></td>
