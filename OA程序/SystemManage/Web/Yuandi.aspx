<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Yuandi.aspx.cs" Inherits="xyoa.SystemManage.Web.Yuandi" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Yuandi.aspx';showwait();">
                                                                <font class="shadow_but">学习原地</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='YuandiLb.aspx';showwait();">
                                                                <font class="shadow_but">类别设置</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    类别： <asp:DropDownList ID="Leibie" runat="server">
                                                                    </asp:DropDownList>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="文件名称" SortExpression="Titles">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='/web/Yuandi_dowm.aspx?NewName=<%# DataBinder.Eval(Container.DataItem, "NewName")%>' target="_blank">
