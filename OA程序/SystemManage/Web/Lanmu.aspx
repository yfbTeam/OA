<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lanmu.aspx.cs" Inherits="xyoa.SystemManage.Web.Lanmu" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Lanmu.aspx';showwait();">
                                                                <font class="shadow_but">栏目新闻</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='LanmuLb.aspx';showwait();">
                                                                <font class="shadow_but">新闻类别</font></button>
                                                        </td>
