<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xinwen.aspx.cs" Inherits="xyoa.SystemManage.Web.Xinwen" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Xinwen.aspx';showwait();">
                                                                <font class="shadow_but">单位新闻</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="新闻标题" SortExpression="Titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='/web/Xinwen_View.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' target="_blank">
