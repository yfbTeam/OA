<%@ Page Language="C#" AutoEventWireup="true" Codebehind="JiejiariDay.aspx.cs" Inherits="xyoa.SystemManage.Web.JiejiariDay" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Jiejiari.aspx';showwait();">
                                                                <font class="shadow_but">节假日图片</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='JiejiariDay.aspx';showwait();">
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Leixing") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="StartTime" HeaderText="换肤开始时间" SortExpression="StartTime"  DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="EndTime" HeaderText="换肤结束时间" SortExpression="EndTime"  DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="节假日">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("Leixing").ToString().Replace("1", "元旦").Replace("2", "春节").Replace("3", "五一").Replace("4", "七一").Replace("5", "十一")))%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
