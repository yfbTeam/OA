<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YuandiLb.aspx.cs" Inherits="xyoa.SystemManage.Web.YuandiLb" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                           <button class="btn4off" type="button" onclick="javascript:window.location='Yuandi.aspx';showwait();">
                                                                <font class="shadow_but">学习原地</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='YuandiLb.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    类别：<asp:TextBox ID="Name" runat="server"></asp:TextBox>
