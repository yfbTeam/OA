<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIYForm_add_dxlist.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.DIYForm_add_dxlist" %>
<html>
<head>
<title>单选框列表设定</title>
...
function chknull()
{
    ...
    AjaxMethod.InsertLb(yKeyFile,yNumber,yName,'单选框列表');
    my_submit();
...
function my_submit()
{
  ...
  for(i=1;i<=50;i++)
  {
      ...
      {
        option_str+="<td  bgcolor=\"#FFFFFF\"><input id=\""+yNumber+"_0\" type=\"radio\" name=\""+yNumber+"\" value=\""+document.all(item_str).value+"\" />"+document.all(item_str).value+"</td>";
      }
  }
