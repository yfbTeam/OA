<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowNodeGD_show.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.WorkFlowNodeGD_show" %>
<html>
...
function sc()
{
if (!confirm("是否确定删除此目录，\n此操作将删除对应目录的目录和目录里面的所有文件。"))
return false;
}
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td class="newtd2" colspan="4" height="17" style="text-align: center">
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Checked="True" Text="保存后刷新树形菜单" />
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                ...
                                                                <asp:Button ID="Button2" runat="server" Text="删 除" CssClass="button_css" OnClick="Button2_Click"/>
                                                            </font>
                                                        </div>
                                                    </td>
                                                </tr>
