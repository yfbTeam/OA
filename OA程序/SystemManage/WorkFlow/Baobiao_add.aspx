<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Baobiao_add.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.Baobiao_add" %>
...
function chknull()
{
    ...
    if(document.getElementById('BiaodanName').value=='')
    {
    alert('对应表单不能为空');
    form1.BiaodanName.focus();
    return false;
    }	
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                <asp:Button ID="Button1" runat="server" Text="下一步设计报表" CssClass="button_css" OnClick="Button1_Click" />
                                                                <asp:Button ID="Button2" runat="server" Text="保存并返回" CssClass="button_css" OnClick="Button2_Click" />
