<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkFlowName_show_add_node_yz.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.WorkFlowName_show_add_node_yz" %>
...
<body class="newbody">
    <form id="form1" runat="server">
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td align="center" style="width: 113px" valign="top">
                                                                    <strong>待选印章</strong></td>
                                                                <td align="center" style="width: 42px" valign="top">
                                                                </td>
                                                                <td align="center" style="width: 100px" valign="top">
                                                                    <strong>已选印章</strong></td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" style="width: 113px" valign="top">
                                                                    <asp:ListBox ID="SourceListBox" runat="server" Height="291px" Width="257px" SelectionMode="Multiple">
                                                                    </asp:ListBox></td>
                                                                <td align="center" style="width: 42px" valign="top">
                                                                ...
                                                                <td align="center" style="width: 100px" valign="top">
                                                                    <asp:ListBox ID="TargetListBox" runat="server" Height="291px" Width="257px" SelectionMode="Multiple">
                                                                    </asp:ListBox></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        启用条件：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:RadioButtonList ID="YzTiaojian" runat="server" RepeatDirection="Horizontal">
                                                            <asp:ListItem Selected="True" Value="0">不启用</asp:ListItem>
                                                            <asp:ListItem Value="1">或</asp:ListItem>
                                                            <asp:ListItem Value="2">和</asp:ListItem>
                                                        </asp:RadioButtonList>
                                                    </td>
                                                </tr>
        ...
        <asp:TextBox ID="WriteFileID" runat="server" Style="display: none"></asp:TextBox>
