<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Baobiao_update.aspx.cs"
    Inherits="xyoa.SystemManage.WorkFlow.Baobiao_update" %>
...
function chknull()
{
    ...
    if(document.getElementById('BiaodanId').value=='')
    {
    alert('对应表单不能为空');
    form1.BiaodanId.focus();
    return false;
    }	
...
<body class="newbody" onload="select_type()">
    <form id="form1" runat="server">
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">创建报表</font></button></td>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr  style="display: none">
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>报表类型(<a href="javascript:void(0)" onclick="alert('统计报表：计算每个【字段】的综合，支持多个字段的加减乘除。\n列表报表：将设计表的列表按照行的形式显示')">说明</a>)：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:DropDownList ID="Leixing" runat="server" Width="100%">
                                                            <asp:ListItem Value="1">统计报表</asp:ListItem>
                                                            <asp:ListItem Value="2">列表报表</asp:ListItem>
                                                        </asp:DropDownList></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                          <asp:TextBox ID="BiaodanName" runat="server" Height="58px" TextMode="MultiLine" Width="85%"
                                                            CssClass="ReadOnlyText"></asp:TextBox>
                                                        <a href="javascript:void(0)">
                                                            <img onclick="openbiaodan();" alt="" src="/oaimg/FDJ.gif" border="0"></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
        ...
        <asp:TextBox ID="BiaodanId" runat="server" Width="90%" Style="display: none"></asp:TextBox>
        ...
        <script language="javascript">	
            ...
            {  
                var  wName_1;  
                var num=Math.random();
                var str=""+document.getElementById('BiaodanId').value+"";
                wName_1=window.showModalDialog("/OpenWindows/open_biaodan.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:750px;DialogHeight=580px;status:no;scroll=yes;help:no");                
                if (wName_1 == undefined) {wName_1 = window.returnValue;}var arr = wName_1.split("|");
                for(var i=0;i<arr.length;i++)
                { 
                    document.getElementById("BiaodanId").value=arr[0]; 
                    document.getElementById("BiaodanName").value=arr[1]; 
                }
            }
