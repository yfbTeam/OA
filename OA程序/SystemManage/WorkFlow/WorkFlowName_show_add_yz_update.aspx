<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowName_show_add_yz_update.aspx.cs"
    Inherits="xyoa.SystemManage.WorkFlow.WorkFlowName_show_add_yz_update" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Name" runat="server" CssClass="ReadOnlyText" Width="90%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                        <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:TextBox ID="SyRealname" runat="server" Height="55px" TextMode="MultiLine" Width="85%"
                                                            CssClass="ReadOnlyText"></asp:TextBox>   <input id="Button2" type="button" value="选择人员" onclick="openuser1();" />
