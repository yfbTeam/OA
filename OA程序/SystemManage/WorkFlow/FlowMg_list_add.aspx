<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FlowMg_list_add.aspx.cs"
    Inherits="xyoa.SystemManage.WorkFlow.FlowMg_list_add" %>
...
{
   if (form1.ShuXing.value=="固定流程")
   {
       form1.Button4.style.display='';
       form1.Button2.style.display='';
    
   }
   else if (form1.ShuXing.value=="自由流程")
   {
...
<body class="newbody" onload="select_type();select_faqi()">
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        ...
                                                        <input id="Button9" type="button" value="选择用户" onclick="openuser3()" /><input id="Button10"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:DropDownList ID="ShuXing" runat="server" Width="100%" onchange="select_type()">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Wenhao" runat="server" Width="90%">{F}流程({Y}年{M}月{D}日{W}){U}</asp:TextBox><a
                                                            href="javascript:my_tip()">查看说明</a>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                            <asp:Button ID="Button1" runat="server" Text="保存并返回" CssClass="button_css" OnClick="Button1_Click1" />
                                                            <asp:Button ID="Button4" runat="server" Text="下一步设置节点" CssClass="button_css" OnClick="Button4_Click" />
                                                            <asp:Button ID="Button2" runat="server" Text="下一步复制流程" CssClass="button_css" OnClick="Button2_Click" />
                                                             <asp:Button ID="Button5" runat="server" Text="不保存并返回" CssClass="button_css" OnClick="Button5_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
