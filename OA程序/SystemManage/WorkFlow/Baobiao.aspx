<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Baobiao.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.Baobiao" %>
...
{
    var num=Math.random();
    window.open ("Baobiao_add.aspx?tmp="+num+"", "_blank", "height=707px, width=920px,toolbar=no, menubar=no, top=50,scrollbars=yes,resizable=yes,location=no, status=no")
}
    
function updatefromsx(str)
{
    var num=Math.random();
    window.open ("Baobiao_update.aspx?tmp="+num+"&id="+str+"", "_blank", "height=707px, width=920px,toolbar=no, menubar=no, top=50,scrollbars=yes,resizable=yes,location=no, status=yes")
}

function updatefrombb(str)
{
    var num=Math.random();
    window.open ("BaobiaoSj_update.aspx?tmp="+num+"&id="+str+"", "_blank", "height=707px, width=920px,toolbar=no, menubar=no, top=50,scrollbars=yes,resizable=yes,location=no, status=yes")
}
...
<body class="newbody">
    <form id="form1" runat="server">
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">报表设计</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="Button3" runat="server" Text="创建报表" CssClass="button_blue" OnClick="Button3_Click" />
                                                            <asp:Button ID="DelData" runat="server" Text="删除报表" CssClass="button_blue" OnClick="DelData_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="报表名称" SortExpression="Mingcheng">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href="Baobiao_update.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                <%# DataBinder.Eval(Container.DataItem, "Mingcheng")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="对应表单" SortExpression="BiaodanId">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="FormNameLb" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "BiaodanId") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                            <asp:Label ID="FormName" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="Paixun" HeaderText="排序号" SortExpression="Paixun">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="Baobiao_update.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                修改属性</a>  <a href="BaobiaoSj_update.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">
                                                                                    设计报表</a>
                                                                        </ItemTemplate>
        ...
        <input id="SortText" type="hidden" runat="server" value="order by A.Paixun asc" />
