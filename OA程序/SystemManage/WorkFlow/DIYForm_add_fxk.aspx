<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DIYForm_add_fxk.aspx.cs"
    Inherits="xyoa.SystemManage.WorkFlow.DIYForm_add_fxk" %>
...
{   
    ...
    var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  type="checkbox" />';
