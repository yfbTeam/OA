<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIYForm_add_dx.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.DIYForm_add_dx" %>
...
{  
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  type="text" size="'+csize+'"  value="'+cvalues+'" onkeyup="nst(this,\''+cKongjian+'\')" style="font-size:'+document.getElementById('ITEM_SIZE').value+';border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>';
        window.opener.qiupengmodel(str);
    }
    
    if(document.getElementById('Biankuan').value=='全部边框')
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  type="text" size="'+csize+'"  value="'+cvalues+'" onkeyup="nst(this,\''+cKongjian+'\')" style="font-size:'+document.getElementById('ITEM_SIZE').value+';solid   #000000"/>';
        window.opener.qiupengmodel(str);
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  type="text" size="'+csize+'"  value="'+cvalues+'" onkeyup="nst(this,\''+cKongjian+'\')" style="font-size:'+document.getElementById('ITEM_SIZE').value+';border-left:0px;border-top:0px;border-right:0px;border-bottom:0px   solid   #000000"/>';
        window.opener.qiupengmodel(str);
