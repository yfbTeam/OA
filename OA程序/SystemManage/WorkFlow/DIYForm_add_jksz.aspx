<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIYForm_add_jksz.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.DIYForm_add_jksz" %>
...
{  
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  onchange="JavaScript:UpdateData(event.srcElement.id,event.srcElement.value);"  type="text" size="'+csize+'" value="'+cvalues+'" style="font-size:'+document.getElementById('ITEM_SIZE').value+';IME-MODE: disabled;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"  onkeypress="var k=event.keyCode; return (k>=48&&k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData(\'text\'))"  ondragenter="return false"/>';
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  onchange="JavaScript:UpdateData(event.srcElement.id,event.srcElement.value);"  type="text" size="'+csize+'" value="'+cvalues+'" style="font-size:'+document.getElementById('ITEM_SIZE').value+';IME-MODE: disabled;  solid   #000000"  onkeypress="var k=event.keyCode; return (k>=48&&k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData(\'text\'))"  ondragenter="return false"/>';
        window.opener.qiupengmodel(str);
        //window.close()
    }
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  onchange="JavaScript:UpdateData(event.srcElement.id,event.srcElement.value);"  type="text" size="'+csize+'" value="'+cvalues+'" style="font-size:'+document.getElementById('ITEM_SIZE').value+';IME-MODE: disabled;border-left:0px;border-top:0px;border-right:0px;border-bottom:0px   solid   #000000"  onkeypress="var k=event.keyCode; return (k>=48&&k<=57)||k==46" onpaste="return !/\D/.test(clipboardData.getData(\'text\'))"  ondragenter="return false"/>';
        window.opener.qiupengmodel(str);
       // window.close()
    }
