<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIYForm_add_jk.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.DIYForm_add_jk" %>
...
{  
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'" onchange="JavaScript:UpdateData(event.srcElement.id,event.srcElement.value);" type="text" size="'+csize+'"  value="'+cvalues+'" style="font-size:'+document.getElementById('ITEM_SIZE').value+';border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>';
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'" onchange="JavaScript:UpdateData(event.srcElement.id,event.srcElement.value);" type="text" size="'+csize+'"  value="'+cvalues+'" style="font-size:'+document.getElementById('ITEM_SIZE').value+';solid   #000000"/>';
        window.opener.qiupengmodel(str);
       // window.close()
    }
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'" onchange="JavaScript:UpdateData(event.srcElement.id,event.srcElement.value);" type="text" size="'+csize+'"  value="'+cvalues+'" style="font-size:'+document.getElementById('ITEM_SIZE').value+';border-left:0px;border-top:0px;border-right:0px;border-bottom:0px   solid   #000000"/>';
        window.opener.qiupengmodel(str);
        //window.close()
    }
