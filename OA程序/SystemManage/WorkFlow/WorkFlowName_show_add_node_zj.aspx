<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowName_show_add_node_zj.aspx.cs"
    Inherits="xyoa.SystemManage.WorkFlow.WorkFlowName_show_add_node_zj" %>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr id="nd9">
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="XbTimes" runat="server" Width="42px">24</asp:TextBox>小时（当前步骤若在限办时间内未办理，则步骤为超时步骤）</td>
                                                </tr>
                                                <tr id="nd1">
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                ...
                                                <tr id="yj3">
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:CheckBoxList ID="YoujianXm" runat="server" RepeatDirection="Horizontal">
                                                            ...
                                                            <asp:ListItem Value="4">办理日志</asp:ListItem>
                                                            <asp:ListItem Value="5">办理意见</asp:ListItem>
                                                        </asp:CheckBoxList>
                                                    </td>
                                                </tr>
                                                <tr id="yj2">
