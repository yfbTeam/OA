<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DIYForm_add_sz.aspx.cs"
    Inherits="xyoa.SystemManage.WorkFlow.DIYForm_add_sz" %>
...
{  
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  type="text" size="'+csize+'" value="'+cvalues+'" style="font-size:'+document.getElementById('ITEM_SIZE').value+';IME-MODE: disabled;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"  onchange="if(!/^[-+]?\\d+(\\.\\d+)?$/.test(this.value)){alert(\'只能输入数字\');this.value=\'\';}"/>';
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  type="text" size="'+csize+'" value="'+cvalues+'" style="font-size:'+document.getElementById('ITEM_SIZE').value+';IME-MODE: disabled;  solid   #000000"  onchange="if(!/^[-+]?\\d+(\\.\\d+)?$/.test(this.value)){alert(\'只能输入数字\');this.value=\'\';}"/>';
        window.opener.qiupengmodel(str);
        //window.close()
    }
    ...
    {
        var str='<input disabled id="'+cValue+'"  name="'+cValue+'"  type="text" size="'+csize+'" value="'+cvalues+'" style="font-size:'+document.getElementById('ITEM_SIZE').value+';IME-MODE: disabled;border-left:0px;border-top:0px;border-right:0px;border-bottom:0px   solid   #000000"  onchange="if(!/^[-+]?\\d+(\\.\\d+)?$/.test(this.value)){alert(\'只能输入数字\');this.value=\'\';}"/>';
        window.opener.qiupengmodel(str);
       // window.close()
    }
