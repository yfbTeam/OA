<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FlowMg_list.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.FlowMg_list" %>
...
{
    var num=Math.random();
    window.open ("FlowMg_list_update.aspx?tmp="+num+"&id="+str+"", "_blank", "height=707px, width=820px,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=yes")
}
...
{
    var num=Math.random();
    window.open ("FlowMg_list_add.aspx?tmp="+num+"&FormId=<%=Request.QueryString["FormId"] %>&key=1", "_blank", "height=707px, width=820px,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=yes")
}
    </script>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    <asp:Button ID="SearchData" runat="server" Text="查 询" OnClick="SearchData_Click"
                                                                        CssClass="button_css" />
                                                                    <asp:Button ID="Button2" runat="server" CssClass="button_css" Text="退 出" OnClick="Button2_Click" /></td>
                                                            </tr>
                                                        </table>
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="流程名称" SortExpression="FlowName">
                                                                        ...
                                                                        <ItemTemplate>
                                                                         <a href="FlowMg_list_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>">
                                                                                <%# DataBinder.Eval(Container.DataItem, "FlowName")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="FlowType" HeaderText="流程状态" SortExpression="FlowType">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="WFNId" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>'
                                                        ...
                                                        <table align="center" class="nextpage" border="0" cellpadding="4" cellspacing="1"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="newtd2" colspan="3" width="85%" style="height: 17px">
                                                                    <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">删除选中流程</asp:LinkButton>
                                                                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">新建流程</asp:LinkButton>
