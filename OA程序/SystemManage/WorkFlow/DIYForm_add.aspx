<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DIYForm_add.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.DIYForm_add" %>
...
window.open ("DIYForm_add_cg.aspx?tmp="+num+"&Number="+str+"", "_blank", "height=350px, width=417px,toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no")
}
...
var num=Math.random();
var str  = document.getElementById("Number").value;
window.open ("DIYForm_add_wb.aspx?tmp="+num+"&Number="+str+"", "_blank", "height=350px, width=417px,toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no")
}
...
var num=Math.random();
var str  = document.getElementById("Number").value;
window.open ("DIYForm_add_fxk.aspx?tmp="+num+"&Number="+str+"", "_blank", "height=350px, width=417px,toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no")
}
...
var num=Math.random();
var str  = document.getElementById("Number").value;
window.open ("DIYForm_add_sz.aspx?tmp="+num+"&Number="+str+"", "_blank", "height=350px, width=417px,toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no")
}
...
var num=Math.random();
var str  = document.getElementById("Number").value;
window.open ("DIYForm_add_rq.aspx?tmp="+num+"&Number="+str+"", "_blank", "height=350px, width=417px,toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no")
}
...
{
var str=""+cValue+"";
window.showModalDialog("DIYForm_add_gl.aspx?tmp="+num+"&Number="+str+"","window", "dialogWidth:560px;DialogHeight=400px;status:no;scroll=yes;help:no");  
}              
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" height="100%"
                                                ...
                                                <tr>
                                                    <td align="center" class="newtd2" nowrap="nowrap" rowspan="4" style="width: 14%"
                                                        ...
                                                        <div id="bzkj" style="display: none">
                                                            ...
                                                            <br />
                                                            <br />
                                                            <input id="Button3" onclick="openfile1()" style="width: 100px" type="button" value="宏选择控件" />
                                                            <br />
                                                            <br />
                                                        ...
                                                        <strong>宏控件</strong>
                                                        <hr />
                                                        <input id="Button12" onclick="openfile()" style="width: 100px" type="button" value="选择宏控件" />
                                                        <br />
                                                        <br />
                                                ...
                                                <tr>
                                                    <td class="newtd2" valign="top">
                                                        ...
                                                        <br>
                                                        <FCKeditorV2:FCKeditor ID="d_content" runat="server" Height="90%" ToolbarSet="Qiupeng">
