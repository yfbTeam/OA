<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowNodeGD_add.aspx.cs"
    Inherits="xyoa.SystemManage.WorkFlow.WorkFlowNodeGD_add" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td class="newtd2" colspan="4" height="17" style="text-align: center">
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Checked="True" Text="保存后继续新增" />
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
