<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIYForm_add_jklb.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.DIYForm_add_jklb" %>
<html>
<head>
<title>下拉菜单设定</title>
...
function chknull()
{
    ...
    AjaxMethod.sendmessage(yKeyFile,yNumber,yName);
    my_submit();
}  
...
function my_submit()
{
  ...
  control_html="<select name=\""+ITEM_NAME.value.replace("\"","&quot;")+"\" style=\"font-size:"+ITEM_SIZE.value+"\" onchange=\"JavaScript:UpdateData(event.srcElement.id,event.srcElement.value);\"  id=\""+ITEM_NAME.value.replace("\"","&quot;")+"\">"+option_str+"</select>";
...
function LoadDo()
{
  document.getElementById('ITEM_NAME').value=document.getElementById('TextBox2').value;
...
<table border="1" cellspacing="0" width="100%"  cellpadding="3" align="center">
  ...
  <tr >
      <td nowrap colspan="2">字体大小：<Input name="ITEM_SIZE" type="text"  size="20" title="可选，默认13像素" value="13">
      </td>
  </tr>
  <tr>
