<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menhu.aspx.cs" Inherits="xyoa.SystemManage.Menhu.Menhu" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">门户中心</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Name" HeaderText="门户中心" SortExpression="Name">
