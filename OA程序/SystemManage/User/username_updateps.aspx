<%@ Page Language="C#" AutoEventWireup="true" Codebehind="username_updateps.aspx.cs"
    Inherits="xyoa.SystemManage.User.username_updateps" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" onclick="javascript:window.location='username_update.aspx?id=<%=Request.QueryString["id"]%>';showwait();"
                                                                type="button">
                                                                <font class="shadow_but">用户信息</font></button>
                                                            <button class="btn4on" onclick="javascript:window.location='username_updateps.aspx?id=<%=Request.QueryString["id"]%>';showwait();"
                                                                type="button">
