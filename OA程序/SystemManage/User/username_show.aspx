<%@ Page Language="C#" AutoEventWireup="true" Codebehind="username_show.aspx.cs"
    Inherits="xyoa.SystemManage.User.username_show" %>
...
<body class="newbody">
    <form id="form1" runat="server">
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        所属角色：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:Label ID="JueseId" runat="server"></asp:Label>
                                                    </td>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        所属职位：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:Label ID="paixu" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        允许登陆：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:Label ID="Iflogin" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        在职状况：</td>
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:Label ID="StardType" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
        ...
        <asp:Label ID="IfResponUpdate" runat="server" Visible="false"></asp:Label>
    </form>
</body>
</html>
