<%@ Page Language="C#" AutoEventWireup="true" Codebehind="usernameys.aspx.cs" Inherits="xyoa.SystemManage.User.usernameys" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='username.aspx';showwait();">
                                                                <font class="shadow_but">正常用户</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='usernameys.aspx';showwait();">
                                                                <font class="shadow_but">已删用户</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="DelData" runat="server" Text="还原用户" CssClass="button_blue" OnClick="DelData_Click" />
                                                            <asp:Button ID="Button3" runat="server" Text="彻底删除" CssClass="button_blue" OnClick="Button3_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
