<%@ Page Language="C#" AutoEventWireup="true" Codebehind="username_add.aspx.cs" Inherits="xyoa.SystemManage.User.username_add" %>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:TextBox ID="Password" runat="server" Width="100%">123</asp:TextBox></td>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:TextBox ID="paixu" runat="server" Width="100%"></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" width="33%" colspan="3">
                                                        <input id="uploadFile" runat="server" style="width: 309px" type="file" name="uploadFile" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
