<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SealUseLog.aspx.cs" Inherits="xyoa.SystemManage.Seal.SealUseLog" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='SealUseLog.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    印章名称：<asp:TextBox ID="Name" runat="server" Width="121px"></asp:TextBox>
                                                                    使用人：<asp:TextBox ID="Realname" runat="server" Width="121px"></asp:TextBox>
                                                                    使用位置：<asp:TextBox ID="MkName" runat="server" Width="121px"></asp:TextBox>
                                                                    操作时间：<asp:TextBox ID="Usetime" runat="server" Width="127px" onClick="WdatePicker()"></asp:TextBox>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="MkName" HeaderText="使用位置" SortExpression="MkName">
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="使用人" SortExpression="Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="Usetime" HeaderText="时间" SortExpression="Usetime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
