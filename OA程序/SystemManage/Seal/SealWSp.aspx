<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SealWSp.aspx.cs" Inherits="xyoa.SystemManage.Seal.SealWSp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='SealSp.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='SealWSp.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    印章名称：<asp:TextBox ID="Name" runat="server"></asp:TextBox>
                                                                    创建时间：<asp:TextBox ID="Nowtimes" runat="server" Width="127px" onClick="WdatePicker()"></asp:TextBox>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Nowtimes" HeaderText="录入时间" SortExpression="Nowtimes">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="查看">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="SealSp_show.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">查看</a>
                                                                        </ItemTemplate>
