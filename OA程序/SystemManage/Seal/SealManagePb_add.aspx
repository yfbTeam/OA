<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SealManagePb_add.aspx.cs"
    Inherits="xyoa.SystemManage.Seal.SealManagePb_add" %>
...
function checkForm()
{
    ...
    if(document.getElementById('QxRealname').value=='')
    {
        alert('使用人员不能为空');
        form1.QxRealname.focus();
        return false;
    }	
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="33%">
                                                        <asp:TextBox ID="QxRealname" runat="server" Height="55px" TextMode="MultiLine" Width="85%" CssClass="ReadOnlyText"></asp:TextBox><a
