<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SealSp_show.aspx.cs" Inherits="xyoa.SystemManage.Seal.SealSp_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" width="35%" style="height: 17px">
                                                        <asp:Label ID="YxType" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
