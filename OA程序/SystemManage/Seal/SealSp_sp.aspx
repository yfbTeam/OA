<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SealSp_sp.aspx.cs" Inherits="xyoa.SystemManage.Seal.SealSp_sp" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">印章审批</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" width="35%" style="height: 17px">
                                                        <asp:TextBox ID="YxType" runat="server" Width="100%" CssClass="ReadOnlyText" ReadOnly="True"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="24" width="33%">
                                                        <asp:TextBox ID="Realname" runat="server" Width="100%" CssClass="ReadOnlyText" ReadOnly="True"></asp:TextBox></td>
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap" width="15%">
                                                        录入时间：</td>
                                                    <td class="newtd2" height="24" width="35%">
                                                        <asp:TextBox ID="Nowtimes" runat="server" Width="100%" CssClass="ReadOnlyText" ReadOnly="True"></asp:TextBox></td>
                                                </tr>
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                <asp:Button ID="Button1" runat="server" Text="通 过" CssClass="button_css" OnClick="Button1_Click" />
                                                                <asp:Button ID="Button3" runat="server" Text="拒 绝" CssClass="button_css" OnClick="Button3_Click" />
