<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SealManagePb.aspx.cs" Inherits="xyoa.SystemManage.Seal.SealManagePb" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='SealManagePb.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='SealManagePb_gl.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&number=<%# DataBinder.Eval(Container.DataItem, "number") %>'
                                                                                onclick="showwait();">管理</a>
