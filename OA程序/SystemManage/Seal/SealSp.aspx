<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SealSp.aspx.cs" Inherits="xyoa.SystemManage.Seal.SealSp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='SealSp.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='SealWSp.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="审批">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="SealSp_sp.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id")%>">审批</a>
                                                                        </ItemTemplate>
