<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OtherMenu_update.aspx.cs"
    Inherits="xyoa.SystemManage.OtherMenu.OtherMenu_update" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">扩展应用</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" nowrap="nowrap" width="15%" style="height: 17px">
                                                         <font color="red">※</font>连接地址：</td>
                                                    <td class="newtd2" colspan="3" width="85%" style="height: 17px">
                                                        <asp:TextBox ID="urlname" runat="server" Width="100%" MaxLength="100">http://</asp:TextBox>
                                                    </td>
                                                </tr>
                                                     <tr>
                                                    <td align="right" class="newtd1" nowrap="nowrap" width="15%" style="height: 17px">
                                                        图标：</td>
                                                    <td class="newtd2" colspan="3" width="85%" style="height: 17px">
                                                        <asp:Image ID="pic" runat="server" Height="74px" Width="77px" />
                                                    </td>
                                                </tr>
