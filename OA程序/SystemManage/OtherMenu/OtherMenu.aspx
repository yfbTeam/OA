<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OtherMenu.aspx.cs" Inherits="xyoa.SystemManage.OtherMenu.OtherMenu" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">扩展应用</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="图标">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='<%# DataBinder.Eval(Container.DataItem, "urlname") %>' target="_blank">
                                                                                <img src="/images/desktopIOC/<%# DataBinder.Eval(Container.DataItem, "pic") %>" Height="74px" Width="77px"  border=0/>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="Name" HeaderText="程序名称" SortExpression="Name">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="连接地址">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='<%# DataBinder.Eval(Container.DataItem, "urlname") %>' target="_blank">
