<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Juese_mk3.aspx.cs" Inherits="xyoa.SystemManage.Juese.Juese_mk3" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Juese_mk3.aspx?id=<%=Request.QueryString["id"] %>';showwait();"><font class="shadow_but">版面3</font></button>
