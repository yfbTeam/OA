<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Juese_mk5.aspx.cs" Inherits="xyoa.SystemManage.Juese.Juese_mk5" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            ...
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Juese_mk2.aspx?id=<%=Request.QueryString["id"] %>';showwait();"><font class="shadow_but">版面2</font></button>
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Juese_mk5.aspx?id=<%=Request.QueryString["id"] %>';showwait();"><font class="shadow_but">版面5</font></button>
                                                        </td>
