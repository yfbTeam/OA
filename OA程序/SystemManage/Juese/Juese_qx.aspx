<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Juese_qx.aspx.cs" Inherits="xyoa.SystemManage.Juese.Juese_qx" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td class="newtd2" colspan="4" height="17">
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Checked="True" Text="是否修改此角色对应的所有用户权限，如果选中，对应此角色的所有用户权限将会随此操作而修改"
                                                            ForeColor="Red" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="newtd2" colspan="4" height="17">
                                                        快速导航：[<a href="#grsw">个人事务</a>][<a href="#ggsw">公共信息</a>][<a href="#xzbg">行政办公</a>][<a
                                                            href="#gzlc">工作流程</a>][<a href="#xxjl">互动交流</a>][<a href="#zygl">物品管理</a>][<a
                                                                href="#fjcx">门户应用</a>][<a href="#jwxt">教务系统</a>][<a href="#rlzy">人力资源</a>][<a href="#xtgl">系统设置</a>]</td>
                                                </tr>
                                                <tr>
                                                    <td class="newtd2" colspan="4" height="17">
                                                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="操作权限<a href='javascript:void(0)' onclick='checkAll()' class='line'><font color=#ffffff>【全选】</font></a><a href='javascript:void(0)' onclick='fanAll()' class='line'><font color=#ffffff>【反选】</font></a>">
