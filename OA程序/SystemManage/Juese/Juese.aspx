<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Juese.aspx.cs" Inherits="xyoa.SystemManage.Juese.Juese" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Juese.aspx';showwait();">
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            ...
                                                            <asp:Button ID="ChushiData" runat="server" Text="系统模块初始" CssClass="button_bluebg" OnClick="ChushiData_Click" />
                                                            <asp:Button ID="Kuazhang" runat="server" Text="扩展模块初始" CssClass="button_bluebg" OnClick="Kuazhang_Click" />
                                                            <asp:Button ID="Menhu" runat="server" Text="门户模块初始" CssClass="button_bluebg" OnClick="Menhu_Click" />
                                                            <asp:Button ID="ShouquanData" runat="server" Text="授 权" CssClass="button_blue" OnClick="ShouquanData_Click" />
                                                            <asp:Button ID="Quanxian" runat="server" Text="克隆权限" CssClass="button_blue" OnClick="Quanxian_Click" />
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    角色名称：<asp:TextBox ID="Name" runat="server"></asp:TextBox>
