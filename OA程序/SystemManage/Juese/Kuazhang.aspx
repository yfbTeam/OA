<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Kuazhang.aspx.cs" Inherits="xyoa.SystemManage.Juese.Kuazhang" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Juese.aspx">角色管理</a> >> 扩展模块初始</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">模块初始</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>应用版面：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:DropDownList ID="Banmian" runat="server" Width="100%">
                                                            <asp:ListItem Value="1">版面1</asp:ListItem>
                                                            <asp:ListItem Value="2">版面2</asp:ListItem>
                                                            <asp:ListItem Value="3">版面3</asp:ListItem>
                                                            <asp:ListItem Value="4">版面4</asp:ListItem>
                                                            <asp:ListItem Value="5">版面5</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
