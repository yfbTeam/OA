<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Sms_In.aspx.cs" Inherits="xyoa.SystemManage.sms.Sms_In" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Sms_In.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    收信时间：<asp:TextBox ID="Settimes" runat="server" onClick="WdatePicker()"></asp:TextBox>
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "g_mob") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="g_mob" HeaderText="来信手机号" SortExpression="g_mob">
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="g_info" HeaderText="短信内容" SortExpression="g_info">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="g_time" HeaderText="收信时间" SortExpression="g_time">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="相关操作" SortExpression="DataName">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='window.open ("Sms_In_hf.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height=550, width=600,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'>
                                                                                回复 </a><a href='javascript:void(0)' onclick='window.open ("Sms_In_zf.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height=550, width=600,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'>
                                                                                    转发 </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" Width="65px" />
                                                                    </asp:TemplateField>
                                                                </Columns>
