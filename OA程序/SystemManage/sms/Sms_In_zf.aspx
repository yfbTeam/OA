<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Sms_In_zf.aspx.cs" Inherits="xyoa.SystemManage.sms.Sms_In_zf" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">短信转发</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Content" runat="server" Width="100%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:TextBox ID="acceptrealname" runat="server" Width="90%" Height="126px" TextMode="MultiLine" CssClass="ReadOnlyText"></asp:TextBox>
                                                    ...
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                ...
                                                                &nbsp; &nbsp; &nbsp;&nbsp;
                                                                <input id="Button3" class="button_css" type="button" value="关 闭" onclick="javascript:window.close()" /></font></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
