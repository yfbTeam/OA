<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Sms_Out.aspx.cs" Inherits="xyoa.SystemManage.sms.Sms_Out" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Sms_Out.aspx';showwait();">
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                 发送人：<asp:TextBox ID="Realname" runat="server"></asp:TextBox>
                                                                    计划时间：<asp:TextBox ID="Settimes" runat="server" onClick="WdatePicker()"></asp:TextBox>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="s_mob" HeaderText="待发手机号" SortExpression="s_mob">
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="s_time" HeaderText="计划时间" SortExpression="s_time">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
