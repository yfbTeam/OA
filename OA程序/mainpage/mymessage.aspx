<%@ Page Language="C#" AutoEventWireup="true" Codebehind="mymessage.aspx.cs" Inherits="xyoa.mainpage.mymessage" %>
...
<body class="newbody" oncontextmenu="return false" scroll="auto">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="newtd2">
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <a href='javascript:void(0)' onclick='openwindows("msglog.aspx?user=<%# DataBinder.Eval(Container.DataItem, "sendusername") %>")', "_blank", "height=500, width=600,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'>
                                                                                                记录</a>
