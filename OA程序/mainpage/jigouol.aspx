<%@ Page Language="C#" AutoEventWireup="true" Codebehind="jigouol.aspx.cs" Inherits="xyoa.mainpage.jigouol" %>
...
<body background="../oaimg/menuBG.gif" style="overflow: auto">
    <form id="form1" runat="server">
        <table width="100%" height="20" border="0" cellpadding="0" cellspacing="0" class="blueleft">
            <tr>
                <td align="center">
                    <a href="jigou.aspx" title="点击刷新"><font class="lefttd">【全部人员】</font></a> <a href="jigouol.aspx"
                        title="点击刷新"><font class="lefttd">【在线人员】</font></a></td>
            </tr>
        </table>
        <div>
            <%=showtitle %>
