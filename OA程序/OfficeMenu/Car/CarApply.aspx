<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CarApply.aspx.cs" Inherits="xyoa.OfficeMenu.Car.CarApply" %>
...
{
    var num=Math.random();
    window.showModalDialog("CarApply_zt.aspx?tmp="+num+"&id="+str+"",window,"dialogWidth:580px;DialogHeight=350px;status:no;scroll=yes;help:no")     
}
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CarApply.aspx';showwait();">
                                                                <font class="shadow_but">用车申请</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    驾驶员：
                                                                    <asp:DropDownList ID="Driver" runat="server">
                                                                    </asp:DropDownList>
                                                                    开始时间从<asp:TextBox ID="Starttime" runat="server" Width="80px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" Width="80px"
                                                                                onClick="WdatePicker()"></asp:TextBox>车辆状态：<asp:DropDownList ID="State" runat="server">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                   <asp:TemplateField HeaderText="车辆名称" SortExpression="CarName">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='CarApply_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
