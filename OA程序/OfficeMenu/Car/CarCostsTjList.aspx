<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CarCostsTjList.aspx.cs"
    Inherits="xyoa.OfficeMenu.Car.CarCostsTjList" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="CarCostsTj.aspx" class="line_b">
                                                                车辆费用统计</a> >> 统计结果
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CarCostsTj.aspx';showwait();">
                                                                <font class="shadow_but">费用统计</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="车辆名称" SortExpression="CarName">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='CarCostsTjList_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
