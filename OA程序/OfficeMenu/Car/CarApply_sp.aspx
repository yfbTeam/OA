<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CarApply_sp.aspx.cs" Inherits="xyoa.OfficeMenu.Car.CarApply_sp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='CarApply_sp.aspx';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CarApply_ysp.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="车辆名称" SortExpression="CarName">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='CarApply_sp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
