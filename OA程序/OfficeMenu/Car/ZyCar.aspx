<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZyCar.aspx.cs" Inherits="xyoa.OfficeMenu.Car.ZyCar" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ZyCar.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                       <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    选择车辆：<asp:DropDownList ID="typename" runat="server" Width="340px" AutoPostBack="True">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                        </table>
