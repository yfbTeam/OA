<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CarCostsTj.aspx.cs" Inherits="xyoa.OfficeMenu.Car.CarCostsTj" %>
...
<body class="newbody">
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">车辆费用统计</font></button>
                                                        </td>
                                                ...
                                                <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                    ...
                                                    <tr>
                                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                            经手人员：</td>
                                                        <td class="newtd2" height="17" colspan="3">
                                                          <asp:TextBox ID="PersonName" runat="server" Width="90%" MaxLength="200" CssClass="ReadOnlyText"></asp:TextBox>
    ...
    <script language="javascript">	
            ...
            {  
                var num=Math.random();
                var str=""+document.getElementById('Username').value+"|"+document.getElementById('PersonName').value+"";
                ...
                { 
                    ...
                    document.getElementById("PersonName").value=arr[1]; 
                }
            }
