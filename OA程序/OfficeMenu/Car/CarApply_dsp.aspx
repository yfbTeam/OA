<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CarApply_dsp.aspx.cs" Inherits="xyoa.OfficeMenu.Car.CarApply_dsp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CarApply.aspx';showwait();">
                                                                <font class="shadow_but">全部记录</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='CarApply_dsp.aspx';showwait();">
                                                                <font class="shadow_but">待审批</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CarApply_ytg.aspx';showwait();">
                                                                <font class="shadow_but">已通过</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CarApply_wtg.aspx';showwait();">
                                                                <font class="shadow_but">未通过</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CarApply_syz.aspx';showwait();">
                                                                <font class="shadow_but">使用中</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CarApply_yjs.aspx';showwait();">
                                                                <font class="shadow_but">已结束</font></button>
                                                        </td>
                                                    ...
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    车辆名称：
                                                                    <asp:DropDownList ID="CarId" runat="server">
                                                                    </asp:DropDownList>
                                                                    调度员：
                                                                    <asp:TextBox ID="ManagerName" runat="server" Width="70px" CssClass="ReadOnlyText"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 开始时间从<asp:TextBox
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField DataField="CarId" HeaderText="车辆名称" SortExpression="CarId">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="调度员" SortExpression="ManagerName">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                               <a href='javascript:void(0)' onclick='senduser("<%# DataBinder.Eval(Container.DataItem, "ManagerUser")%>")'>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='CarApply_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&back=2'
                                                                                onclick="showwait();">查看</a> <a href='CarApply_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&back=2'
                                                                                    onclick="showwait();">修改</a>
