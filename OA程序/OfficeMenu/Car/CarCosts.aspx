<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CarCosts.aspx.cs" Inherits="xyoa.OfficeMenu.Car.CarCosts" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CarCosts.aspx';showwait();">
                                                                <font class="shadow_but">费用管理</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    车辆：<asp:DropDownList ID="CarName" runat="server">
                                                                    </asp:DropDownList>
                                                                    部门：<asp:DropDownList ID="BuMenId" runat="server">
                                                                    </asp:DropDownList>
                                                                    类型：<asp:DropDownList ID="CostsType" runat="server">
                                                                    </asp:DropDownList>
                                                                    经手人：<asp:TextBox ID="PersonName" runat="server" Width="50px"></asp:TextBox>
                                                                    费用名称：<asp:TextBox ID="CostsName" runat="server" Width="49px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="CarName" HeaderText="车辆名称" SortExpression="CarName">
                                                                     ...
                                                                     <asp:TemplateField HeaderText="费用时间" SortExpression="CostsTime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("CostsTime").ToString().Replace("00:00:00", "").Replace("1900-01-01", "").Replace("0:00:00", "").Replace("1900-1-1", "")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="Name" HeaderText="所属部门" SortExpression="Name">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="CostsType" HeaderText="费用类型" SortExpression="CostsType">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="CostsName" HeaderText="费用名称" SortExpression="CostsName">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="CostsMoney" HeaderText="费用金额" SortExpression="CostsMoney">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="PersonName" HeaderText="经手人" SortExpression="PersonName">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
                                                        ...
                                                        费用总计：<asp:Label ID="SumLabel" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
