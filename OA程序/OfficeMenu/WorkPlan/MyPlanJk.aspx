<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyPlanJk.aspx.cs" Inherits="xyoa.OfficeMenu.WorkPlan.MyPlanJk" %>
                                ...
                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                    ...
                                    <tr>
                                        <td style="height: 26px;">
                                            <button class="btn4off" type="button" onclick="javascript:window.nexthead.location='MyPlanJk_left.aspx';">
                                                <font class="shadow_but">按人员</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.nexthead.location='MyPlanJkBm_left.aspx';">
                                                <font class="shadow_but">按部门</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.nexthead.location='MyPlanJkSj_left.aspx';">
                                                <font class="shadow_but">按时间</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.nexthead.location='MyPlanJkFl_left.aspx';">
        ...
        <table align="center" border="0" cellpadding="4" cellspacing="0" width="100%" height="<%=ViewState["tableheigh"] %>">
            <tr>
                ...
                <td class="newtd2" valign="top" height="100%" id="td2">
                    <iframe name="nextrform" marginwidth="0" marginheight="0" src="MyPlanJk_list.aspx"
                        frameborder="1" width="100%" height="100%" scrolling="auto"></iframe>
                </td>
                <td width="5">
                    &nbsp;</td>
