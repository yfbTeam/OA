<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyPlanGx_show.aspx.cs"
    Inherits="xyoa.OfficeMenu.WorkPlan.MyPlanGx_show" %>
                                                    ...
                                                    <tr>
                                                        <td width="20%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">共享计划</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" width="85%" colspan="3">
                                                        <asp:Label ID="DqState" runat="server"></asp:Label>&nbsp;
                                                        </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center" id="printshow4">
                                                            <font face="宋体">
                                                             <asp:Button ID="Button1" runat="server" Text="返 回" CssClass="button_css" OnClick="Button1_Click1"
                                                                     />
                                                            </font>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr id="nextrs3" style="display: none">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center" id="Div2">
                                                            <asp:Button ID="Button4" runat="server" Text="提交讨论内容" CssClass="button_css" OnClick="Button1_Click" />
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
