<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyPlan.aspx.cs" Inherits="xyoa.OfficeMenu.WorkPlan.MyPlan" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyPlan.aspx';showwait();">
                                                                <font class="shadow_but">我的计划</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="计划标题" SortExpression="Biaoti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyPlan_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
