<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyPlan_add.aspx.cs" Inherits="xyoa.OfficeMenu.WorkPlan.MyPlan_add" %>
...
<body class="newbody" onload="select_type();aaa()">
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="MyPlan.aspx">我的计划</a> >> 新增我的计划</td>
                                                        <td width="16%">
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" width="85%" colspan="3">
                                                        <asp:RadioButtonList ID="DqState" runat="server" RepeatDirection="Horizontal">
