<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyRizhiJk_lb_show.aspx.cs" Inherits="xyoa.OfficeMenu.Rizhi.MyRizhiJk_lb_show" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="MyRizhiJk_lb.aspx">日志批注</a>
                                                            >> 查看日志</td>
                                                        <td width="81%">
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">日志批注</font></button></td>
