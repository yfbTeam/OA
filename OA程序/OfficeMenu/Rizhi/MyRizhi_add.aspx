<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyRizhi_add.aspx.cs" Inherits="xyoa.OfficeMenu.Rizhi.MyRizhi_add" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="MyRizhi.aspx">我的日志</a> >> 新增我的日志</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">我的日志</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        <font color="red">※</font>类别：</td>
                                                    <td class="newtd2" height="17" width="83%" colspan="3">
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td>
                                                                    <asp:RadioButtonList ID="LeiBie" runat="server" RepeatDirection="Horizontal">
                                                                    </asp:RadioButtonList>
                                                                </td>
                                                                <td>
                                                                    <asp:CheckBox ID="CheckBox1" runat="server" onclick="aaa()" Text="导入我的日程" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr id="nextrs2" style="display: none">
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        <font color="red">※</font>日程开始时间：</td>
                                                    <td class="newtd2" height="17">
                                                        <asp:TextBox ID="STime" runat="server" onClick="WdatePicker()"></asp:TextBox>
                                                    </td>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        <font color="red">※</font>日程结束时间：</td>
                                                    <td class="newtd2" height="17">
                                                        <asp:TextBox ID="ETime" runat="server" onClick="WdatePicker()"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr id="nextrs1" style="display: none">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <asp:Button ID="Button6" runat="server" Text="确定导入" OnClick="Button6_Click" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
