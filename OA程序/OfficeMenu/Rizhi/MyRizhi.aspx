<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyRizhi.aspx.cs" Inherits="xyoa.OfficeMenu.Rizhi.MyRizhi" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="20%" valign="bottom">
                                                            我的日志</td>
                                                        <td width="37%">
                                                            点击日期后面的“<img src="/oaimg/12task.png">”进入我的日志新增页面。 </td>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyRizhi.aspx';showwait();">
                                                                <font class="shadow_but">日历模式</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyRizhiList.aspx';showwait();">
