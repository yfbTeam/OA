<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyRizhi_show.aspx.cs" Inherits="xyoa.OfficeMenu.Rizhi.MyRizhi_show" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            ...
                                                            <asp:Button ID="DelData" runat="server" Text="删 除" CssClass="button_blue" OnClick="DelData_Click" /></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="17">
                                                ...
                                                <tr id="printshow3">
                                                  ...
                                                  <tr>
                                                    <td align="center" class="newtd2" colspan="4" width="33%" style="height: 26px">
                                                        <b>批注信息(<%=ViewState["GridViewCount"] %>)</b><asp:CheckBox ID="CheckBox1" runat="server" onclick="aaa()" /></td>
                                                </tr>
                                                    ...
                                                    <td class="newtd2" nowrap="nowrap" colspan="4">
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="批注信息：">
