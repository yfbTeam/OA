<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RizhiLx.aspx.cs" Inherits="xyoa.MyWork.Rizhi.RizhiLx" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RizhiLx.aspx';showwait();">
                                                                <font class="shadow_but">日志类型</font></button>
                                                        </td>
