<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyRizhiJk_lb.aspx.cs" Inherits="xyoa.OfficeMenu.Rizhi.MyRizhiJk_lb" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyRizhipz.aspx?left=1';">
                                                                <font class="shadow_but">按人员</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyRizhipz.aspx?left=2';">
                                                                <font class="shadow_but">按部门</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyRizhipz.aspx?left=3';">
                                                                <font class="shadow_but">按时间</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyRizhipz.aspx?left=4';">
                                                                <font class="shadow_but">按分类</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyRizhiJk_lb.aspx';">
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    日志时间：<asp:TextBox ID="NowTimes" runat="server" Width="127px"  onClick="WdatePicker()"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyRizhiJk_lb_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
