<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Rizhisz.aspx.cs" Inherits="xyoa.MyWork.Rizhi.Rizhisz" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Rizhisz.aspx';showwait();">
                                                                <font class="shadow_but">日志设置</font></button>
                                                        </td>
