<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyRizhiList.aspx.cs" Inherits="xyoa.OfficeMenu.Rizhi.MyRizhiList" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyRizhi.aspx';showwait();">
                                                                <font class="shadow_but">日历模式</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyRizhiList.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyRizhi_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&key=2' class="LinkLine">
