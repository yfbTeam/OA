<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Faqi.aspx.cs" Inherits="xyoa.OfficeMenu.Metting.Faqi" %>
...
{
    var num=Math.random();
    window.showModalDialog("Faqi_zt.aspx?tmp="+num+"&id="+str+"",window,"dialogWidth:580px;DialogHeight=320px;status:no;scroll=yes;help:no")     
}
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Faqi.aspx';showwait();">
                                                                <font class="shadow_but">会议申请</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    会议开始时间从<asp:TextBox ID="Starttime" runat="server" Width="80px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" Width="80px"
                                                                                onClick="WdatePicker()"></asp:TextBox>会议状态：<asp:DropDownList ID="State" runat="server">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="会议名称" SortExpression="Name">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='Faqi_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="会议状态" SortExpression="A.State">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("State").ToString().Replace("6", "通过审批").Replace("1", "正在审批").Replace("2", "已发起").Replace("3", "进行中").Replace("4", "结束").Replace("5", "终止").Replace("7", "终止审批")))%>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="Lzt" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "State")%>'
                                                                                Visible="false"></asp:Label>
                                                                            ...
                                                                            <asp:LinkButton ID="Zhongzhi" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="Zhongzhi">终止审批</asp:LinkButton>
