<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NetMetting.aspx.cs" Inherits="xyoa.OfficeMenu.Metting.NetMetting" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='NetMetting.aspx';showwait();">
                                                                <font class="shadow_but">正常状态</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='NetMettingJx.aspx';showwait();">
                                                                <font class="shadow_but">正在进行</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='NetMettingJs.aspx';showwait();">
                                                                <font class="shadow_but">已经结束</font></button>
                                                        </td>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='NetMetting_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&back=1'
                                                                                onclick="showwait();">查看</a> <a href='NetMetting_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&back=1'
                                                                                    onclick="showwait();">修改</a>
                                                                            <asp:LinkButton ID="jinxing" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="jinxing">进行</asp:LinkButton>
                                                                            <asp:LinkButton ID="jieshu" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
