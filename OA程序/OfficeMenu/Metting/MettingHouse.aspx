<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MettingHouse.aspx.cs" Inherits="xyoa.OfficeMenu.Metting.MettingHouse" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MettingHouse.aspx';showwait();">
                                                                <font class="shadow_but">会议室管理</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    会议室名称：<asp:TextBox ID="titles" runat="server"></asp:TextBox>
