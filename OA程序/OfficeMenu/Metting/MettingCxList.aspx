<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MettingCxList.aspx.cs"
    Inherits="xyoa.OfficeMenu.Metting.MettingCxList" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="MettingCx.aspx" class="line_b">会议查询</a> >> 查询结果
                                                        </td>
                                                        <td width="16%">
                                                            &nbsp;</td>
                                                    </tr>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MettingCx.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="会议名称" SortExpression="Name">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MettingCxList_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
