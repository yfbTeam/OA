<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NetMettingJx.aspx.cs" Inherits="xyoa.OfficeMenu.Metting.NetMettingJx" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='NetMetting.aspx';showwait();">
                                                                <font class="shadow_but">正常状态</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='NetMettingJx.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='NetMetting_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&back=2'
                                                                                onclick="showwait();">查看</a> <a href='NetMetting_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&back=2'
