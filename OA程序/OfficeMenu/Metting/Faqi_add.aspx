<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Faqi_add.aspx.cs" Inherits="xyoa.OfficeMenu.Metting.Faqi_add" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Faqi.aspx">会议申请</a> >> 新增会议申请</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="85%">
                                                        <asp:TextBox ID="Introduction" runat="server" Height="55px" TextMode="MultiLine"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="85%">
                                                        <asp:TextBox ID="WbPeople" runat="server" Height="45px" TextMode="MultiLine" Width="100%"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                ...
                                                <tr class="" id="Tr2">
                                                    ...
                                                    <td class="newtd2" height="17" width="33%" colspan="3">
                                                        <asp:TextBox ID="Remark" runat="server" Width="100%" Height="55px" TextMode="MultiLine"></asp:TextBox></td>
                                                </tr>
