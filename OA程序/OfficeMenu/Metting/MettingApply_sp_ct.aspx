<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MettingApply_sp_ct.aspx.cs"
    Inherits="xyoa.OfficeMenu.Metting.MettingApply_sp_ct" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            <input id="Button2" type="button" value="关 闭" class="button_css" onclick="window.close()" /></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </td>
