<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RenwuLx.aspx.cs" Inherits="xyoa.OfficeMenu.Renwu.RenwuLx" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RenwuLx.aspx';showwait();">
                                                                <font class="shadow_but">任务类型</font></button>
                                                        </td>
