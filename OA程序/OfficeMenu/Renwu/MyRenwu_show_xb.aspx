<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyRenwu_show_xb.aspx.cs" Inherits="xyoa.OfficeMenu.Renwu.MyRenwu_show_xb" %>
...
function chknull()
{
    ...
    if(document.getElementById('Baifenbi').value=='')
    {
        alert('完成百分比不能为空，没有请填写为0');
        form1.Baifenbi.focus();
        return false;
    }	
    ...
    {    
        var objRe = /^[-+]?\d+(\.\d+)?$/;
        if(!objRe.test(document.getElementById('Baifenbi').value))
        {
            alert("完成百分比只能为数字");
            form1.Baifenbi.focus();
            return false;
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        完成百分比：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="83%">
                                                        <asp:TextBox ID="Baifenbi" runat="server" Width="95%"></asp:TextBox></td>
                                                </tr>
                                                <tr id="printshow3">
