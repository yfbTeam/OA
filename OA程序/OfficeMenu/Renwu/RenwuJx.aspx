<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RenwuJx.aspx.cs" Inherits="xyoa.OfficeMenu.Renwu.RenwuJx" %>
    ...
    <form id="form1" runat="server">
                                                    ...
                                                    <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="newtd2" height="17" colspan="3">
                                                               <asp:TextBox ID="Startime" runat="server" onClick="WdatePicker()" Width="66px"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" onClick="WdatePicker()"
        ...
        <script language="javascript">	
            ...
            {  
                ...
                wName_1=window.showModalDialog("/OpenWindows/open_user_list_rw.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:750px;DialogHeight=580px;status:no;scroll=yes;help:no");                
