<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyRenwuXb.aspx.cs" Inherits="xyoa.OfficeMenu.Renwu.MyRenwuXb" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyRenwu.aspx';showwait();">
                                                                <font class="shadow_but">全部任务</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyRenwuZb.aspx';showwait();">
                                                                <font class="shadow_but">主办任务</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyRenwuXb.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    标题：<asp:TextBox ID="titles" runat="server" Width="119px"></asp:TextBox>
                                                                    任务类型：<asp:DropDownList ID="Leixing" runat="server">
                                                                    </asp:DropDownList>
                                                                    创建时间：<asp:TextBox ID="SetTime" runat="server" Width="102px" onClick="WdatePicker()"></asp:TextBox>
                                                                   创建人：<asp:TextBox ID="ZbRealname" runat="server"
                                                                                CssClass="ReadOnlyText" Width="106px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyRenwuXb_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="Endtime" HeaderText="预计结束时间" SortExpression="Endtime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="LeiBieName" HeaderText="任务类型" SortExpression="Leixing">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                     <asp:TemplateField HeaderText="状态" SortExpression="State">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("State").ToString().Replace("1", "进行中").Replace("2", "已暂停").Replace("3", "强行停止").Replace("4", "已完成")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" Width="50px" />
                                                                    </asp:TemplateField>
                                                                     <asp:TemplateField HeaderText="完成比例" SortExpression="Benbi">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("Benbi").ToString()))%>%
                                                                        </ItemTemplate>
                                                                      ...
                                                                      <asp:TemplateField HeaderText="完成时间" SortExpression="WcTime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("WcTime").ToString().Replace("2000-01-01", "--").Replace("2000-1-1", "--").Replace("0:00:00", "")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
