<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyRenwuZb.aspx.cs" Inherits="xyoa.OfficeMenu.Renwu.MyRenwuZb" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyRenwuZb.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyRenwuZb_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
