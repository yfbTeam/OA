<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RenwuJk_lb.aspx.cs" Inherits="xyoa.OfficeMenu.Renwu.RenwuJk_lb" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RenwuJk.aspx?left=1';">
                                                                <font class="shadow_but">按人员</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RenwuJk.aspx?left=2';">
                                                                <font class="shadow_but">按部门</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RenwuJk.aspx?left=3';">
                                                                <font class="shadow_but">按时间</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RenwuJk.aspx?left=4';">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='RenwuJk_lb_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
