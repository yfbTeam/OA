<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Renwusz.aspx.cs" Inherits="xyoa.OfficeMenu.Renwu.Renwusz" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Renwusz.aspx';showwait();">
                                                                <font class="shadow_but">领导设置</font></button>
                                                        </td>
