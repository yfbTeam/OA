<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RenwuJk_list.aspx.cs" Inherits="xyoa.OfficeMenu.Renwu.RenwuJk_list" %>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    标题：<asp:TextBox ID="titles" runat="server" Width="70px"></asp:TextBox>
                                                                    ...
                                                                    创建时间：<asp:TextBox ID="Startime" runat="server" onClick="WdatePicker()" Width="66px"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" onClick="WdatePicker()"
                                                                                Width="66px"></asp:TextBox>创建人：<asp:TextBox ID="ZbRealname" runat="server"
