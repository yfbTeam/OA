<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mymessageall.aspx.cs" Inherits="xyoa.Client.mymessageall" %>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="newtd2">
                                                                                        ...
                                                                                        <div align="right">
                                                                                            ...
                                                                                            <a href="messagealldel.aspx?delid=<%# DataBinder.Eval(Container.DataItem, "id") %>&user=<%=Session["username"] %>&pwd=<%=Request.QueryString["pwd"].ToString() %>">
                                                                                                删除</a>&nbsp;
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
