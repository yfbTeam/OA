<%@ Page Language="C#" AutoEventWireup="true" Codebehind="mymessagenew.aspx.cs" Inherits="xyoa.Client.mymessagenew" %>
...
function openwindows(urlstr)
{
    ...
    window.open("/Client/urlcheck.aspx?url="+urlstr+"&user=<%=Session["username"] %>&pwd=<%=Request.QueryString["pwd"].ToString() %>","_blank","height="+ah+",width="+aw+",status=0,toolbar=no,menubar=no,location=no,top="+at+",left="+al+",resizable=yes");
}
    </script>
                                                    ...
                                                    <td valign="top">
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                                ...
                                                                Width="100%" OnRowDataBound="GridView1_RowDataBound" ShowHeader="False">
                                                                                ...
                                                                                <tr>
                                                                                 <td class="newtitle">
                                                                                        <img src='/InfoManage/nbemail/<%# DataBinder.Eval(Container.DataItem, "sfck") %>.gif'
                                                                                            align="absMiddle">
                                                                                                <a href='javascript:void(0)' onclick='openwindows("/senduser.aspx?user=<%# DataBinder.Eval(Container.DataItem, "sendusername") %>")', "_blank", "height=500, width=600,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'><font class="lefttd"><%# DataBinder.Eval(Container.DataItem, "sendrealname")%>：</font></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="newtd2">
                                                                                        ...
                                                                                        <div align="right">
                                                                                            ...
                                                                                            <a href="messagenewdel.aspx?delid=<%# DataBinder.Eval(Container.DataItem, "id") %>&number=<%# DataBinder.Eval(Container.DataItem, "number") %>&user=<%=Session["username"] %>&pwd=<%=Request.QueryString["pwd"].ToString() %>">
                                                                                                删除</a>&nbsp;
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                ...
                                                                <EmptyDataTemplate>
                                                                    <div align="center">
                                                                        <font color="black">无新短消息！</font></div>
                                                                </EmptyDataTemplate>
                                                            </asp:GridView>
                                                            &nbsp;
                                                        </div>
