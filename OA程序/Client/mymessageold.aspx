<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mymessageold.aspx.cs" Inherits="xyoa.Client.mymessageold" %>
<html>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="newtd2">
                                                                                        ...
                                                                                        <div align="right">
                                                                                            ...
                                                                                            <a href="messageolddel.aspx?delid=<%# DataBinder.Eval(Container.DataItem, "id") %>&user=<%=Session["username"] %>&pwd=<%=Request.QueryString["pwd"].ToString() %>">
                                                                                                删除</a>&nbsp;
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
