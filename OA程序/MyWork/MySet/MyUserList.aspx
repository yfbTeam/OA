<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyUserList.aspx.cs" Inherits="xyoa.MyWork.MySet.MyUserList" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">自定义用户组</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Name" HeaderText="用户组名称" SortExpression="Name">
