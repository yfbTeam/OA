<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BeijingBt.aspx.cs" Inherits="xyoa.MyWork.MySet.BeijingBt" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='BeijingBt.aspx';showwait();"><font class="shadow_but">标题栏样式</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='BeijingNy.aspx';showwait();"><font class="shadow_but">内页样式</font></button>
                                                        </td>
