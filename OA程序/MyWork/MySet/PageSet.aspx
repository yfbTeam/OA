<%@ Page Language="C#" AutoEventWireup="true" Codebehind="PageSet.aspx.cs" Inherits="xyoa.MyWork.MySet.PageSet" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">界面主题</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:DropDownList ID="Name" runat="server" Width="100%">
                                                         <asp:ListItem Value="NewStyleQian">浅灰简洁</asp:ListItem>
