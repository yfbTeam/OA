<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BeijingXt.aspx.cs" Inherits="xyoa.MyWork.MySet.BeijingXt" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td  style="height: 26px">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='BeijingXt.aspx';showwait();">
                                                        ...
                                                        <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="更 新" class="button_blue"/></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="17">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    <td class="newtd2" height="17" align="center">
                                                        <asp:RadioButtonList ID="tupian" runat="server" RepeatDirection="Horizontal" RepeatColumns="7" CellPadding="6" CellSpacing="2" TextAlign="Left">
                                                        </asp:RadioButtonList>
                                                    </td>
                                                </tr>
                                            </table>
