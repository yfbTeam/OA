<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Mokuai_show.aspx.cs" Inherits="xyoa.MyWork.MySet.Mokuai_show" %>
...
function addWin(liid,str,urlname,url,openkey,chuangzhi,bigpic)
{
    ...
    AjaxMethod.addWin(str,'<%=Request.QueryString["menhu"] %>','1',document.getElementById('Paixun').value);
    ...
    window.top.setli(liid,<%=Request.QueryString["menhu"] %>,str,urlname,url,openkey,chuangzhi,bigpic)
}
