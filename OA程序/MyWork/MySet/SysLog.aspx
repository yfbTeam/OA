<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SysLog.aspx.cs" Inherits="xyoa.MyWork.MySet.SysLog" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='SysLog.aspx';showwait();">
                                                                <font class="shadow_but">操作日志</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="Button3" runat="server" Text="全部删除" CssClass="button_blue" OnClick="Button3_Click" />
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    内容：<asp:TextBox ID="Name" runat="server" Width="100px"></asp:TextBox>
                                                                    操作时间：<asp:TextBox ID="Nowtimes" runat="server" onClick="WdatePicker()"></asp:TextBox>
