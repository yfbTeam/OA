<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MokuaiMh_show.aspx.cs" Inherits="xyoa.MyWork.MySet.MokuaiMh_show" %>
...
function addWin(liid,str,urlname,url,openkey,chuangzhi,bigpic)
{
    ...
    AjaxMethod.addWin(str,'<%=Request.QueryString["menhu"] %>','3',document.getElementById('Paixun').value);
    document.getElementById('mhkeyid'+str+'').style.display="none";
    ...
    window.top.setli(liid,<%=Request.QueryString["menhu"] %>,''+str+'91221',urlname,url,openkey,chuangzhi,bigpic)
}
