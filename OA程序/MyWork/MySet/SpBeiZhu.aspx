<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SpBeiZhu.aspx.cs" Inherits="xyoa.MyWork.MySet.SpBeiZhu" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='SpBeiZhu.aspx';showwait();">
                                                                <font class="shadow_but">常用评语</font></button>
                                                        </td>
