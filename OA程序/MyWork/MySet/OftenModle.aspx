<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OftenModle.aspx.cs" Inherits="xyoa.MyWork.MySet.OftenModle" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">常用模版</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    模版名称：<asp:TextBox ID="Name" runat="server" Width="174px"></asp:TextBox>
                                                                    模版类别：
