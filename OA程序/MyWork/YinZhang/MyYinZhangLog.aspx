<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyYinZhangLog.aspx.cs"
    Inherits="xyoa.MyWork.YinZhang.MyYinZhangLog" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyYinZhangLog.aspx';showwait();">
