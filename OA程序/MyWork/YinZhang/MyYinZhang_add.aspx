<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyYinZhang_add.aspx.cs"
    Inherits="xyoa.MyWork.YinZhang.MyYinZhang_add" %>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>印章密码：</td>
                                                    <td class="newtd2" colspan="3" height="17" width="85%">
                                                        <asp:TextBox ID="Password" runat="server" Width="100%"></asp:TextBox></td>
                                                </tr>
