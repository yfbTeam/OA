<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyYinZhang_show.aspx.cs"
    Inherits="xyoa.MyWork.YinZhang.MyYinZhang_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="24" width="35%">
                                                        <asp:Label ID="Nowtimes" runat="server"></asp:Label>&nbsp;</td>
                                                </tr>
                                                <tr id="printshow4">
