<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WBGroup.aspx.cs" Inherits="xyoa.MyWork.txl.WBGroup" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='WBGroup.aspx';showwait();">
                                                                <font class="shadow_but">外部通讯录</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="AddData" runat="server" Text="增 加" CssClass="button_blue" OnClick="AddData_Click" />
                                                            <asp:Button ID="Button3" runat="server" Text="导 入" CssClass="button_blue" OnClick="Button3_Click" />
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    姓名：<asp:TextBox ID="Name" runat="server" Width="77px"></asp:TextBox>
                                                                    单位名称：<asp:TextBox ID="CName" runat="server" Width="77px"></asp:TextBox>
                                                                    手机：<asp:TextBox ID="HMoveTel" runat="server" Width="77px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="名称" SortExpression="Name">
                                                                        ...
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='WBGroup_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="HMoveTel" HeaderText="手机" SortExpression="HMoveTel">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
