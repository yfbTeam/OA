<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GroupType.aspx.cs" Inherits="xyoa.MyWork.txl.GroupType" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='GroupType.aspx';showwait();">
