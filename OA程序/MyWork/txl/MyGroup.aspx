<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyGroup.aspx.cs" Inherits="xyoa.MyWork.txl.MyGroup" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyGroup.aspx';showwait();">
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    类别：<asp:DropDownList ID="GroupName" runat="server">
                                                                    </asp:DropDownList>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="名称" SortExpression="Name">
                                                                        ...
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='MyGroup_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="BothDay" HeaderText="生日" SortExpression="BothDay">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
