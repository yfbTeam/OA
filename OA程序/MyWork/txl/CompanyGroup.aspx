<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CompanyGroup.aspx.cs" Inherits="xyoa.MyWork.txl.CompanyGroup" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='CompanyGroup.aspx';showwait();">
                                                                <font class="shadow_but">单位通讯录</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    部门：<asp:DropDownList ID="BuMenId" runat="server" Width="131px">
                                                                    </asp:DropDownList>
                                                                    职位：<asp:DropDownList ID="Zhiweiid" runat="server" Width="93px">
                                                                    </asp:DropDownList>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="名称" SortExpression="A.Name">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='CompanyGroup_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>' class="LinkLine">
