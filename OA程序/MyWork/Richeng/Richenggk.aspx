<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Richenggk.aspx.cs" Inherits="xyoa.MyWork.Richeng.Richenggk" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                           <button class="btn4off" type="button" onclick="javascript:window.location='RichenggkRi.aspx';showwait();">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Richenggk.aspx';showwait();"><font class="shadow_but">月视图</font></button>
