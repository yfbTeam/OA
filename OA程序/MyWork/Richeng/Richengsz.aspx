<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Richengsz.aspx.cs" Inherits="xyoa.MyWork.Richeng.Richengsz" %>
                                                        ...
                                                        <div id="Div1" class="mainDiv">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Realname" HeaderText="职员领导" SortExpression="Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Glrealname" HeaderText="管辖职员" SortExpression="Glrealname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
