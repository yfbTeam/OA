<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Richengsz_add.aspx.cs"
    Inherits="xyoa.MyWork.Richeng.Richengsz_add" %>
...
function chknull()
{
    ...
    if(document.getElementById('Glrealname').value=='')
    {
    alert('管辖职员不能为空');
    form1.Glrealname.focus();
    return false;
    }	
    showwait();	
}  
...
<body class="newbody">
    <form id="form1" runat="server">
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Realname" runat="server" Width="90%" CssClass="ReadOnlyText"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Glrealname" runat="server" Width="90%" Height="83px" TextMode="MultiLine" CssClass="ReadOnlyText"></asp:TextBox>
                                                        <a href="javascript:void(0)">
        ...
        <asp:TextBox ID="Glusername" runat="server" Width="90%" style="DISPLAY: none"></asp:TextBox>
        ...
        <script language="javascript">	
            ...
            {  
                var num=Math.random();
                var str=""+document.getElementById('Glusername').value+"";
                ...
                for(var i=0;i<arr.length;i++)
                { 
                    document.getElementById("Glusername").value=arr[0]; 
                    document.getElementById("Glrealname").value=arr[1]; 
                }
            }
