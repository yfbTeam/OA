<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RichengmyList_update.aspx.cs"
    Inherits="xyoa.MyWork.Richeng.RichengmyList_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Richengmy.aspx">我的日程</a> >> 修改我的日程</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr class="" id="nextrs22">
                                                    ...
                                                    <td class="newtd2" height="17" width="33%" colspan="3">
                                                        ...
                                                        <input id="Button6" type="button" value="转  存" onclick="zcfile();" /></td>
                                                </tr>
                                                ...
                                                <tr style="display: none" id="nextrs1">
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        提醒类型：</td>
                                                    <td class="newtd2" height="17" width="35%">
