<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Richenggklist.aspx.cs"
    Inherits="xyoa.MyWork.Richeng.Richenggklist" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                              <button class="btn4off" type="button" onclick="javascript:window.location='RichenggkRi.aspx';showwait();">
                                                                <font class="shadow_but">日视图</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RichenggkZhou.aspx';showwait();"><font class="shadow_but">周视图</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Richenggk.aspx';showwait();"><font class="shadow_but">月视图</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Richenggklist.aspx';showwait();"><font class="shadow_but">列表模式</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    公开人：<asp:TextBox ID="Realname" runat="server" CssClass="ReadOnlyText"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 日程时间：<asp:TextBox
                                                                            ID="StartTime" runat="server" Width="127px" onClick="WdatePicker()"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='Richenggk_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="公开人" SortExpression="Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
