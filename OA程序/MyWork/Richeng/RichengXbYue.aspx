<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RichengXbYue.aspx.cs" Inherits="xyoa.MyWork.Richeng.RichengXbYue" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='RichengXbYue.aspx';showwait();">
                                                                <font class="shadow_but">月视图</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RichengXbList.aspx';showwait();">
