<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RichenggkZhou.aspx.cs" Inherits="xyoa.MyWork.Richeng.RichenggkZhou" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='RichenggkZhou.aspx';showwait();"><font class="shadow_but">周视图</font></button>
                                                            ...
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Richenggklist.aspx';showwait();"><font class="shadow_but">列表模式</font></button>
                                                        </td>
