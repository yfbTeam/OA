<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Richengjklist.aspx.cs"
    Inherits="xyoa.MyWork.Richeng.Richengjklist" %>
    ...
    <form id="form1" runat="server">
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                           <button class="btn4off" type="button" onclick="javascript:window.location='RichengjkRi.aspx';showwait();">
                                                            ...
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Richengjk.aspx';showwait();"><font class="shadow_but">月视图</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Richengjklist.aspx';showwait();"><font class="shadow_but">列表模式</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='Richengjk_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
        ...
        <script language="javascript">	
            ...
            {  
                ...
                wName_3=window.showModalDialog("open_Richengjk.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:550px;DialogHeight=480px;status:no;scroll=yes;help:no");                
