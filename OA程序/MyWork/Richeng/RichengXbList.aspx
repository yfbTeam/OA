<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RichengXbList.aspx.cs" Inherits="xyoa.MyWork.Richeng.RichengXbList" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RichengXb.aspx';showwait();">
                                                                <font class="shadow_but">日视图</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RichengXbZhou.aspx';showwait();">
                                                                <font class="shadow_but">周视图</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='RichengXbYue.aspx';showwait();">
                                                                <font class="shadow_but">月视图</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='RichengXbList.aspx';showwait();">
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    日程时间：<asp:TextBox ID="StartTime" runat="server" Width="127px" onClick="WdatePicker()"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='RichengXb_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="Gongkai" HeaderText="是否公开" SortExpression="Gongkai">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
