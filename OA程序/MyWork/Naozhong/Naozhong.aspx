<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Naozhong.aspx.cs" Inherits="xyoa.MyWork.Naozhong.Naozhong" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Naozhong.aspx';showwait();">
                                                                <font class="shadow_but">电子闹钟</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    内容：<asp:TextBox ID="titles" runat="server"></asp:TextBox>
                                                                    操作时间：<asp:TextBox ID="Nowtimes" runat="server" Width="85px" onClick="WdatePicker()"></asp:TextBox>
                                                                  提醒类型：<asp:DropDownList ID="Types" runat="server">
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="内容" SortExpression="titles">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Naozhong_update.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="txtime" HeaderText="提醒时间" SortExpression="txtime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="cTypes" HeaderText="提醒类型" SortExpression="cTypes">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
