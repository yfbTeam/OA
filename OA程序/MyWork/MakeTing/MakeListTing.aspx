<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MakeListTing.aspx.cs" Inherits="xyoa.MyWork.MakeTing.MakeListTing" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MakeListTing.aspx';showwait();">
                                                                <font class="shadow_but">便签管理</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="内容" SortExpression="content">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MakeListTing_update.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
