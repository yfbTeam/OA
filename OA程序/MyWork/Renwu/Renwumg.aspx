<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Renwumg.aspx.cs" Inherits="xyoa.MyWork.Renwu.Renwumg" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Renwumg.aspx';showwait();">
                                                                <font class="shadow_but">任务监控</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='Renwumg_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='window.open ("RenwuBz_fj.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height=500, width=680,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'"'>
                                                                                [分解]</a> <a href='javascript:void(0)' onclick='window.open ("Renwumg_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height=600, width=680,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'>
                                                                                    [查看]</a> <a href='javascript:void(0)' onclick='window.open ("RenwuBz_hb.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height=500, width=680,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'"'>
                                                                                        [汇报]</a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
