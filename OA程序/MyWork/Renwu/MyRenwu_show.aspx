<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyRenwu_show.aspx.cs" Inherits="xyoa.MyWork.Renwu.MyRenwu_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage" id="tableprint">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        几天汇报一次：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:Label ID="HbDay" runat="server"></asp:Label>天&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
