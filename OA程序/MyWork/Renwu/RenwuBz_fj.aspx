<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RenwuBz_fj.aspx.cs" Inherits="xyoa.MyWork.Renwu.RenwuBz_fj" %>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="查看" SortExpression="Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='window.open ("RenwuBz_fj_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height=500, width=600,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'>
                                                                                查看 </a>
                                                                        </ItemTemplate>
