<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RenwuBz_add.aspx.cs" Inherits="xyoa.MyWork.Renwu.RenwuBz_add" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            说明：1.只有“主办人”才能更改任务的状态。2.系统将根据“几天汇报一次”自动提醒相关人员进行工作汇报。</td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="17">
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="33%">
                                                        <img src="/oaimg/menu/chatroom.gif" />
                                                        <asp:CheckBox ID="CheckBox3" runat="server" Text="内部消息" Checked="True" />
                                                        <img src="/oaimg/menu/Menu30.gif" id="IMG2" runat="server" />
                                                        <asp:CheckBox ID="CheckBox5" runat="server" Text="手机短信" />
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
