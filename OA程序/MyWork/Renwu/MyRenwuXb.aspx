<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyRenwuXb.aspx.cs" Inherits="xyoa.MyWork.Renwu.MyRenwuXb" %>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="标题" SortExpression="titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MyRenwu_show.aspx?back=2&id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='window.open ("MyRenwuXb_fj.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height=600, width=680,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'>
                                                                                [分解]</a> <a href='MyRenwu_show.aspx?back=2&id=<%# DataBinder.Eval(Container.DataItem, "id")%>'>
                                                                                    [查看]</a> <a href='javascript:void(0)' onclick='window.open ("MyRenwuXb_hb.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height=600, width=680,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=200,left=350")'>
                                                                                        [汇报]</a>
                                                                        </ItemTemplate>
