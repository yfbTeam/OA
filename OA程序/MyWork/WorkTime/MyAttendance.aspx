<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyAttendance.aspx.cs" Inherits="xyoa.MyWork.WorkTime.MyAttendance" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyAttendance.aspx?type=<%=Request.QueryString["type"] %>';showwait();">
                                                                <font class="shadow_but"><%=ViewState["typename"] %></font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    事由：<asp:TextBox ID="Subject" runat="server" Width="88px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                        ...
                                                                        <ItemTemplate>
                                                                           <asp:Label ID="LabVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Subject") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                            <a href='MyAttendance_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&type=<%# DataBinder.Eval(Container.DataItem, "Type")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="耗时" SortExpression="DiffTime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "DiffTime")%><%#((Eval("Type").ToString().Replace("1", "天").Replace("2", "天").Replace("3", "小时")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
