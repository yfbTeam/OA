<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Quxiang.aspx.cs" Inherits="xyoa.MyWork.Quxiang.Quxiang" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyQuxiang.aspx';showwait();">
                                                                <font class="shadow_but">我的动态</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Quxiang.aspx';showwait();">
                                                                <font class="shadow_but">他人动态</font></button>
                                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        主题：<asp:TextBox ID="Zhuti" runat="server" Width="104px"></asp:TextBox>
                                                        人员名称：
                                                        <asp:TextBox ID="Realname" runat="server" Width="70px" CssClass="ReadOnlyText"></asp:TextBox>
                                                        <a href="javascript:void(0)">
                                                            <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 时间<asp:TextBox
                                                                ID="Startime" runat="server" onClick="WdatePicker()" Width="66px"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" onClick="WdatePicker()"
                                            ...
                                            <div id="Div1">
                                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="姓名" SortExpression="Realname">
                                                            <HeaderStyle CssClass="newtitle" Wrap="False" Width="50px" />
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:BoundField DataField="Zhuti" HeaderText="主题" SortExpression="Zhuti">
