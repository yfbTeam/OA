<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyQuxiang.aspx.cs" Inherits="xyoa.MyWork.Quxiang.MyQuxiang" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                                 <button class="btn4on" type="button" onclick="javascript:window.location='MyQuxiang.aspx';showwait();">
                                                                <font class="shadow_but">我的动态</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Quxiang.aspx';showwait();" id="FONT1" runat="server">他人动态</button>
                                                        </td>
