<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Jiankong.aspx.cs" Inherits="xyoa.MyWork.Quxiang.Jiankong" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='Jiankong.aspx';showwait();">
                                                                <font class="shadow_but">按列表</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='JiankongRy.aspx';showwait();">
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    时间<asp:TextBox ID="Startime" runat="server" onClick="WdatePicker()" Width="66px"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" onClick="WdatePicker()"
