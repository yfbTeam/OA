<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MynetMettingYcy.aspx.cs"
    Inherits="xyoa.MyWork.Metting.MynetMettingYcy" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MynetMetting.aspx';showwait();">
                                                                <font class="shadow_but">全部会议</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MynetMettingYcy.aspx';showwait();">
