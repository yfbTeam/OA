<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyMetting.aspx.cs" Inherits="xyoa.MyWork.Metting.MyMetting" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyMetting.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="会议名称" SortExpression="Name">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MettingApply_show.aspx?back=1&id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MettingApply_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&back=1'
