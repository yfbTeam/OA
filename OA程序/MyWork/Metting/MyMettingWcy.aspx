<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyMettingWcy.aspx.cs" Inherits="xyoa.MyWork.Metting.MyMettingWcy" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; ">
                                                            ...
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyMettingYcy.aspx';showwait();">
                                                                <font class="shadow_but">已参与</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyMettingWcy.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="会议名称" SortExpression="Name">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MettingApply_show.aspx?back=3&id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MettingApply_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>&back=3'
