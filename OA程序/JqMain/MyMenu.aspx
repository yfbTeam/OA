<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyMenu.aspx.cs" Inherits="xyoa.JqMain.MyMenu" %>
<html>
        ...
        <table width="100%" height="20" border="0" cellpadding="0" cellspacing="0" class="blueleft">
            <tr>
                <td width="30%" align="right" valign="top">
                    <img src="../oaimg/menu/knowledge.gif" width="16" height="16" hspace="10"></td>
                <td width="70%">
                    <font class="lefttd"><%=ViewState["name"] %></font></td>
            </tr>
        </table>
