<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_juese.aspx.cs" Inherits="xyoa.OpenWindows.open_juese" %>
		...
		<form id="Form1" method="post" runat="server">
           ...
           <asp:TextBox ID="requeststr" runat="server" style="DISPLAY: none"></asp:TextBox>
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="/oaimg/nextline.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　请选择角色</td>
				</tr>
				<tr>
