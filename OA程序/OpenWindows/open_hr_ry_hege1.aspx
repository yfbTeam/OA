<%@ Page Language="C#" AutoEventWireup="true" Codebehind="open_hr_ry_hege1.aspx.cs"
    Inherits="xyoa.OpenWindows.open_hr_ry_hege1" %>

<html>
<head>
    <title>请选择人员（只能选择面试合格的人员）</title>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="width: 518px; height: 49px"  align=center>
                        <tr>
                            <td colspan="2" style="height: 31px; text-align: left">
                                姓名：<asp:TextBox ID="Xingming" runat="server" Width="67px"></asp:TextBox>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="选择">
                                            ...
                                            <ItemTemplate>
                                                <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "id")%>|<%#DataBinder.Eval(Container.DataItem, "Xingming")%>'
                                                    name="Rad" />
                                            </ItemTemplate>
