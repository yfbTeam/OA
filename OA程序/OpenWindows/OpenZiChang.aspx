<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpenZiChang.aspx.cs" Inherits="xyoa.OpenWindows.OpenZiChang" %>
<html>
<head>
    <title>请选择物品</title>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" height="550">
                                    <tr>
                                        <td valign="top" width="50%">
                                            <iframe name="lhead" marginwidth="0" marginheight="0" src="OpenZiChangLeft.aspx?type=<%=Request.QueryString["type"]%>"
                                                frameborder="0" width="100%" height="100%" scrolling="auto"></iframe>
                                        </td>
                                        <td valign="top" width="50%">
                                            <iframe name="rform" marginwidth="0" marginheight="0" src="OpenZiChangMc.aspx?id=<%=Request.QueryString["id"]%>"
