<%@ Page Language="C#" AutoEventWireup="true" Codebehind="open_wbuser_list.aspx.cs"
    Inherits="xyoa.OpenWindows.open_wbuser_list" %>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="width: 693px; height: 49px">
                        <tr>
                            <td colspan="2">
                                ...
                                类别：<asp:DropDownList ID="GroupName" runat="server" Width="93px" AutoPostBack="True" OnSelectedIndexChanged="ListChangedBind">
                                </asp:DropDownList>
