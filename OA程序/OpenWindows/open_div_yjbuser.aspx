<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_div_yjbuser.aspx.cs" Inherits="xyoa.OpenWindows.open_div_yjbuser" %>
<HTML>
	<HEAD>
		 <title>请选择用户</title>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
			    ...
			    <table  border="0" cellspacing="0" cellpadding="0" style="width: 693px; height: 49px">
                    ...
                    <tr>
                      ...
                      <tr>
                          <td colspan="2" style="height: 31px; text-align: center;">
                             <INPUT  TYPE="button"  VALUE="确定"  onclick="return checkbutton();" style="width: 70px" class="button_css" id="Button1">  <INPUT  TYPE="button"  VALUE="关闭"  onclick="closewin();" style="width: 72px" class="button_css" id="Button3">
                             </td>
                      </tr>                        
                    </table></td>
				</tr>
