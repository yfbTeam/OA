<%@ Page Language="C#" AutoEventWireup="true" Codebehind="open_AddWorkFlow_add_Next_Zb.aspx.cs"
    Inherits="xyoa.OpenWindows.open_AddWorkFlow_add_Next_Zb" %>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="width: 518px; height: 49px" align=center>
                        <tr>
                            <td colspan="2" style="height: 31px; text-align: left">
                                部门：<asp:DropDownList ID="Unit" runat="server" Width="224px" AutoPostBack="True" OnSelectedIndexChanged="ListChangedBind">
                                </asp:DropDownList>名称关键字：<asp:TextBox ID="name" runat="server" Width="130px"></asp:TextBox>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="选择">
                                            ...
                                            <ItemTemplate>
                                                <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "username")%>|<%#DataBinder.Eval(Container.DataItem, "realname")%>'
                                                    name="Rad" />
                                            </ItemTemplate>
