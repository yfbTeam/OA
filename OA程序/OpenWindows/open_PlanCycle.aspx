<%@ Page Language="C#" AutoEventWireup="true" Codebehind="open_PlanCycle.aspx.cs"
    Inherits="xyoa.OpenWindows.open_PlanCycle" %>

<html>
<head>
    <title>续易网络办公系统(政务版-专用)</title>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="选择">
                                            ...
                                            <ItemTemplate>
                                                <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "name")%>'
                                                    name="Rad" />
                                            </ItemTemplate>
