<%@ Page Language="C#" AutoEventWireup="true" Codebehind="open_user_list_all.aspx.cs"
    Inherits="xyoa.OpenWindows.open_user_list_all" %>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td colspan="2">
                                ...
                                职位：<asp:DropDownList ID="Zhiweiid" runat="server" Width="93px" AutoPostBack="True" OnSelectedIndexChanged="ListChangedBind">
                                </asp:DropDownList>
