<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_Username_two_zz.aspx.cs" Inherits="xyoa.OpenWindows.open_Username_two_zz" %>
		...
		<form id="Form1" method="post" runat="server">
           ...
           <asp:TextBox ID="requeststr" runat="server" style="DISPLAY: none"></asp:TextBox>
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="/oaimg/nextline.gif" align="left" style="font-size: 12px; font-family: 宋体"> 　选择在职员工</td>
				</tr>
				<tr>
