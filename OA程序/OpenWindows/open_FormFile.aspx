<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_FormFile.aspx.cs" Inherits="xyoa.OpenWindows.open_FormFile" %>
<HTML>
	<HEAD>
		...
		<form id="Form1" method="post" runat="server">
           ...
           <asp:TextBox ID="requeststr" runat="server" style="DISPLAY: none"></asp:TextBox>
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
				<tr>
					<td height="22" background="/oaimg/nextline.gif" align="left" style="font-size: 12px; font-family: 宋体">请选择表单字段（只能从可写字段中选择）</td>
				</tr>
				<tr>
			    <td valign="top" style="text-align: center">
			    <table  border="0" cellspacing="0" cellpadding="0" style="width: 318px; height: 49px"  align=center>
                    <tr>
                        <td colspan="2" style="height: 31px; text-align: left">
                            名称关键字：<asp:TextBox ID="name" runat="server" Width="130px"></asp:TextBox>
