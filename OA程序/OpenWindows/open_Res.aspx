<%@ Page Language="C#" AutoEventWireup="true" Codebehind="open_Res.aspx.cs" Inherits="xyoa.OpenWindows.open_Res" %>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="width: 518px; height: 49px"  align=center>
                        <tr>
                            <td colspan="2" style="height: 31px; text-align: left">
                                资源类别：<asp:DropDownList ID="ZyLeibie" runat="server" Width="224px" AutoPostBack="True" OnSelectedIndexChanged="ListChangedBind">
                                </asp:DropDownList>资源名称：<asp:TextBox ID="ZyName" runat="server" Width="130px"></asp:TextBox>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="选择">
                                            ...
                                            <HeaderStyle CssClass="newtitle" HorizontalAlign="Center"
                                                Wrap="False" />
                                            <ItemTemplate>
                                                <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "id")%>|<%#DataBinder.Eval(Container.DataItem, "ZyName")%>|<%#DataBinder.Eval(Container.DataItem, "ZyXingzhi")%>|<%#DataBinder.Eval(Container.DataItem, "Danwei")%>|<%#DataBinder.Eval(Container.DataItem, "Danjia")%>|<%#DataBinder.Eval(Container.DataItem, "Gongyinshang")%>|<%#DataBinder.Eval(Container.DataItem, "KuCun")%>|<%#DataBinder.Eval(Container.DataItem, "LimitsS")%>|<%#DataBinder.Eval(Container.DataItem, "LimitsE")%>'
                                                    name="Rad" />
                                            </ItemTemplate>
                                            <FooterStyle Wrap="True" />
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="ZyName" HeaderText="资源名称" SortExpression="ZyName">
