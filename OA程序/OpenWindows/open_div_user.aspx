<%@ Page Language="C#" AutoEventWireup="true" Codebehind="open_div_user.aspx.cs"
    Inherits="xyoa.OpenWindows.open_div_user" %>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0"
            ...
            <tr>
                <td valign="top" style="text-align: center">
                    <table border="0" cellspacing="0" cellpadding="0" style="width: 760px; height: 49px">
                        <tr>
                            <td colspan="2">
