<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_div_bm.aspx.cs" Inherits="xyoa.OpenWindows.open_div_bm" %>
<html>
<head>
    <title>请选择部门</title>
...
function checkbutton()
{
    ...
    document.getElementById("TextBox2").value=""+document.getElementById("TextBox2").value+""+document.getElementById('TargetListBox').options[i].text.replace(/-/g,"").replace("|","")+",";
...
var retrunstr="";
retrunstr=""+document.getElementById("TextBox2").value+"";
return retrunstr;
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0"
            ...
            <tr>
                <td valign="top" style="text-align: center">
                    <table border="0" cellspacing="0" cellpadding="0" style="width: 588px; height: 49px"  align=center>
                        <tr>
