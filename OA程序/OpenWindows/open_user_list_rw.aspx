<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="open_user_list_rw.aspx.cs" Inherits="xyoa.OpenWindows.open_user_list_rw" %>
<html>
<head>
    <title>
        请选择人员（只能从允许监控的人员中选择）
            ...
            <tr>
                <td valign="top" style="text-align: center">
                    <table border="0" cellspacing="0" cellpadding="0" style="width: 744px; height: 49px">
                        <tr>
                            <td colspan="2">
                                用户组：<asp:DropDownList ID="MyUserList" runat="server" Width="86px" AutoPostBack="True" OnSelectedIndexChanged="ListChangedBind">
                                </asp:DropDownList>部门：<asp:DropDownList ID="BuMenId" runat="server" Width="125px" AutoPostBack="True" OnSelectedIndexChanged="ListChangedBind">
                                </asp:DropDownList>
                                角色：<asp:DropDownList ID="JueseId" runat="server" Width="93px" AutoPostBack="True" OnSelectedIndexChanged="ListChangedBind">
                                </asp:DropDownList>
                                职位：<asp:DropDownList ID="Zhiweiid" runat="server" Width="86px" AutoPostBack="True" OnSelectedIndexChanged="ListChangedBind">
                                </asp:DropDownList>
