<%@ Page Language="C#" AutoEventWireup="true" Codebehind="open_ProCaiLiao.aspx.cs"
    Inherits="xyoa.OpenWindows.open_ProCaiLiao" %>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="width: 518px; height: 49px"  align=center>
                        <tr>
                            <td colspan="2" style="height: 31px; text-align: left">
                                材料名称：<asp:TextBox ID="Name" runat="server" Width="130px"></asp:TextBox>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="选择">
                                            ...
                                            <ItemTemplate>
                                                <input id="Radio1" type="radio" value='<%#DataBinder.Eval(Container.DataItem, "id")%>|<%#DataBinder.Eval(Container.DataItem, "Name")%>|<%#DataBinder.Eval(Container.DataItem, "Bianhao")%>|<%#DataBinder.Eval(Container.DataItem, "GyName")%>|<%#DataBinder.Eval(Container.DataItem, "Lianxiren")%>'
                                                    name="Rad" />
                                            </ItemTemplate>
