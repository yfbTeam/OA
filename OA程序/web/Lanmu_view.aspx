<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Lanmu_view.aspx.cs" Inherits="xyoa.web.Lanmu_view" %>
                                                    ...
                                                    <td height="32" valign="middle" background="img/nhead_1.jpg" bgcolor="#FFFFFF">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td width="96%">
                                                                    当前位置：<a href="/">首页</a>&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;<a href="Lanmu.aspx?Leibie=<%=Request.QueryString["Leibie"] %>"><%=ViewState["LeftName"] %></a>&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;浏览内容</td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
