<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Lanmu.aspx.cs" Inherits="xyoa.web.Lanmu" %>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    每页16条&nbsp;&nbsp;&nbsp;&nbsp;共<%=totalRows%>条&nbsp;&nbsp;&nbsp;&nbsp;共<%=totalPage%>页&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                        href="Lanmu.aspx?page=1&Leibie=<%=Request.QueryString["Leibie"]%>">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                            href="Lanmu.aspx?page=<%=pre%>&Leibie=<%=Request.QueryString["Leibie"]%>">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                                href="Lanmu.aspx?page=<%=next%>&Leibie=<%=Request.QueryString["Leibie"]%>">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                                    href="Lanmu.aspx?page=<%=totalPage%>&Leibie=<%=Request.QueryString["Leibie"]%>">末页</a></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
