<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Xinwen.aspx.cs" Inherits="xyoa.web.Xinwen" %>
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#FFFFFF">
                                                        <table width="707" height="32" border="0" cellpadding="4" cellspacing="0" align="center">
                                                            <tr>
                                                                <td>
                                                                    标题：<asp:TextBox ID="Titles" runat="server"></asp:TextBox> <asp:Button ID="Button1"
                                                                        runat="server" Text="查 询" OnClick="Button1_Click" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    每页16条&nbsp;&nbsp;&nbsp;&nbsp;共<%=totalRows%>条&nbsp;&nbsp;&nbsp;&nbsp;共<%=totalPage%>页&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                        href="Xinwen.aspx?page=1&Leibie=<%=Request.QueryString["Leibie"]%>">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                            href="Xinwen.aspx?page=<%=pre%>&Leibie=<%=Request.QueryString["Leibie"]%>">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                                href="Xinwen.aspx?page=<%=next%>&Leibie=<%=Request.QueryString["Leibie"]%>">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                                                    href="Xinwen.aspx?page=<%=totalPage%>&Leibie=<%=Request.QueryString["Leibie"]%>">末页</a></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
