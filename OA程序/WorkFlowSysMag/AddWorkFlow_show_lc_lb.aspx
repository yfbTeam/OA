<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWorkFlow_show_lc_lb.aspx.cs" Inherits="xyoa.WorkFlowSysMag.AddWorkFlow_show_lc_lb" %>
<html>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="步骤名称">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                          <asp:Label ID="NodeName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "NodeName")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="NodeNames" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                Visible="false"></asp:Label>
