<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlow.aspx.cs" Inherits="xyoa.WorkFlowSysMag.WorkFlow" %>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                <tr>
                                                    <td width="140px">
                                                        是否启用工作流(<a href="#" onclick="alert('启用工作流以后在发起工作的时候，需要进行工作流审批。如果不启用工作流，将不审批。')">说明</a>)：
                                                    </td>
                                                    <td align="left">
                                                        <asp:RadioButtonList ID="Zhuangtai" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="Zhuangtai_SelectedIndexChanged">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="相关操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href="WorkFlow_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>">修改属性</a>
                                                                            <a href="GongZuoLiu.aspx?FormId=<%# DataBinder.Eval(Container.DataItem, "id") %>">流程步骤</a>
                                                                        </ItemTemplate>
