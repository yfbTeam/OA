<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowName_show_add_node_jb.aspx.cs"
    Inherits="xyoa.WorkFlowSysMag.WorkFlowName_show_add_node_jb" %>
...
<body class="newbody" onload="select_tr();select_type();">
    <form id="form1" runat="server">
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="NodeNum" runat="server" Width="100%" CssClass="ReadOnlyText"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                ...
                                                <tr id="nd6">
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:DropDownList ID="XrGuize" runat="server" Width="100%" onchange="cleartype();select_type();">
        ...
        <asp:TextBox ID="FormId" runat="server" Visible="False"></asp:TextBox>
