<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Info.aspx.cs" Inherits="xyoa.SystemManage.WorkFlow.Info" %>
                                                ...
                                                <tr>
                                                    <td style="height: 26px;">
                                                        <button class="btn4off" type="button" onclick="javascript:window.nexthead.location='Info_left.aspx';">
                                                            <font class="shadow_but">表单工作流</font></button>
                    ...
                    <table align="center" border="0" cellpadding="4" cellspacing="0" width="100%" height="<%=ViewState["tableheigh"] %>">
                        <tr>
                            ...
                            <td valign="top" height="100%" id="td2">
                                <iframe name="nextrform" marginwidth="0" marginheight="0" src="WorkFlow.aspx?FormId=1"
