...
{
var str11=document.getElementById("FormId").value;
LoadWindow("WorkFlowName_show_add_node_add.aspx?FormId="+str11+"");
}
...
{
var str11=document.getElementById("FormId").value;
LoadWindow("WorkFlowName_show_add_node_zj.aspx?FormId="+str11+"&ID="+Process_ID+"");
}
