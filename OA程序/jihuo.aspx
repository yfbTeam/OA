<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jihuo.aspx.cs" Inherits="xyoa.jihuo" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">软件激活</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td class="newtd2" colspan="4" height="17" style="text-align: center">
                                                        <asp:Button ID="Button3" runat="server" Text="软件激活" OnClick="Button3_Click1" />
