...
window.onload=function(){
	...
	var tupian = document.getElementById('tupian').value;
	var tv = new TransformView("idTransformView", "idSlider", 118, tupian, {
	...
	var tv2 = new TransformView("idTransformView2", "idSlider2", 408, tupian, {
