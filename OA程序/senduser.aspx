<%@ Page Language="C#" AutoEventWireup="true" Codebehind="senduser.aspx.cs" Inherits="xyoa.senduser" %>
...
{
    var num=Math.random();
    window.showModalDialog("InfoManage/nbemail/SeadToUser.aspx?user=<%=Request.QueryString["user"].ToString() %>&tmp="+num+"",window,"dialogWidth:780px;DialogHeight=620px;status:no;scroll=yes;help:no")
}
    </script>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" rowspan="4" width="27%" align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="23%">
                                                        职位：</td>
                                                    <td class="newtd2" height="17" width="27%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="newtd1" height="24" nowrap="nowrap" width="23%">
                                                        生日：</td>
                                                    <td class="newtd2" height="24" width="27%">
