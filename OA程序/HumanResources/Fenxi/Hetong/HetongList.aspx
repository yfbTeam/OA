<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HetongList.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.Hetong.HetongList" %>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="签约人" SortExpression="QyRealname">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='HetongMg_show1.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
