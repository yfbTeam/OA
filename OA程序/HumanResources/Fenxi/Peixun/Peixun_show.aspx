<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Peixun_show.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.ZhaoPin.Peixun_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    <td align="center" class="newtd2" colspan="4" width="33%" style="height: 26px">
                                                        <b>心得体会</b><asp:CheckBox ID="CheckBox1" runat="server" onclick="aaa()" /></td>
                                                </tr>
                                                <tr id="nextrs1" style="display: none">
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        心得体会：</td>
                                                    <td class="newtd2" height="17" width="33%" colspan="3">
                                                        <asp:Label ID="Xinde" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
