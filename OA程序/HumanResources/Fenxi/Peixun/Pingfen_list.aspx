<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pingfen_list.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.Peixun.Pingfen_list" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Fenxi2.aspx" class="line_b">
                                                                考试分数/试卷</a> >> 《<asp:Label ID="Zhutis" runat="server"></asp:Label>》参与考试人员列表
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                    </tr>
