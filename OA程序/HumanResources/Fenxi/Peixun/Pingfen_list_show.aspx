<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pingfen_list_show.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.Peixun.Pingfen_list_show" %>
<html>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <table id="Table3" cellspacing="1" cellpadding="1" width="100%" align="center" border="0">
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="2">
                                                                                    参考答案：
                                                                                    <asp:Label ID="Label102" runat="server" Text='<%# ((Eval("Answer").ToString().Replace("0", "")))%>'></asp:Label>
                                                                                    <asp:Label ID="Label106" runat="server" Text='<%# Eval("Answer")%>' Visible="false"></asp:Label>
