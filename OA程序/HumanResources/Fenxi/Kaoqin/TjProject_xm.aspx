<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TjProject_xm.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.Kaoqin.TjProject_xm" %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="WorkTimeMG.aspx" class="line_b">
                                                                考勤统计</a> >> 考勤明细(<%=ViewState["typename"]%>)
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                    </tr>
