<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fenxi12.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.RenShi.Fenxi12" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="41%" valign="bottom">
                                                            员工类型</td>
                                                        <td width="56%">
                                                           <img src="/oaimg/menu/2.gif">提醒：只统计在职员工</td>
                                                    </tr>
                                                </table>
                                                ...
                                                <tr>
                                                    <td align="center" class="newtd2" colspan="4" height="26" >
                                                        <table width="100%" border="0" cellpadding="4" cellspacing="1" class="nextpage">
                                                          <tr> 
                                                            <td width="16%" class="newtd2"><div align="center">方式</div></td>
