<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Fenxi11.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.RenShi.Fenxi11" %>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="部门">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "LineW")%>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="离职">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
