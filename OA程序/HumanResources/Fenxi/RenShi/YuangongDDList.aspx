<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YuangongDDList.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.RenShi.YuangongDDList" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                           <%=ViewState["Title"] %>统计分析表中的统计值由以下数据得出
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                    </tr>
