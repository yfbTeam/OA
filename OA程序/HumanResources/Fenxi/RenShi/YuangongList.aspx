<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YuangongList.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.RenShi.YuangongList" %>
<html>
<head id="Head1" runat="server">
    <title>
       数据提取：统计分析表中的统计值由以下数据得出
    </title>
...
{
    var num=Math.random();
    var k=window.showModalDialog("YuangongList_show.aspx?tmp="+num+"&id="+str+"",window,"dialogWidth:850px;DialogHeight=650px;status:no;scroll=yes;help:no")
}
