<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YuangongJC_show.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.RenShi.YuangongJC_show" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            工作台 >> 
                                                                <%=ViewState["Jiangcheng"] %>记录 >> 查看<%=ViewState["Jiangcheng"] %>记录</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
