<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fenxi18List.aspx.cs" Inherits="xyoa.HumanResources.Fenxi.RenShi.Fenxi18List" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="56%" align=center>
                                                           <asp:Button id="Button2"  runat="server" onclick="Button2_Click" Text="重新统计" CssClass="button_css"></asp:Button></td>
                                                    </tr>
                                                </table>
                                                ...
                                                <tr>
                                                    <td align="center" class="newtd2" colspan="4" height="26" >
                                                        <table width="100%" border="0" cellpadding="4" cellspacing="1" class="nextpage">
                                                          <tr> 
                                                            <td width="16%" class="newtd2"><div align="center">月份</div></td>
