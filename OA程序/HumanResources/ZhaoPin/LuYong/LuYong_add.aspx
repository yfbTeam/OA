<%@ Page Language="C#" AutoEventWireup="true" Codebehind="LuYong_add.aspx.cs" Inherits="xyoa.HumanResources.ZhaoPin.LuYong.LuYong_add" %>
...
function chknull()
{
    ...
    if(document.getElementById('SetTimes').value=='')
    {
        alert('请选择录用日期');
        form1.SetTimes.focus();
        return false;
    }
...
<body class="newbody" onload="aaa();">
    <form id="form1" runat="server">
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">正式录用</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>录用人员：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Xingming" runat="server" Width="95%" CssClass="ReadOnlyText"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>录用日期：</td>
                                                    <td class="newtd2" height="17" width="85%" colspan="3">
                                                        <asp:TextBox ID="SetTimes" runat="server" onClick="WdatePicker()"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="newtd2" colspan="4" height="26" width="33%">
                                                        <div>
                                                            <b>
                                                                <asp:CheckBox ID="CheckBox2" runat="server" Text="同步录入人事档案" onclick="aaa()"></asp:CheckBox></b>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr id="nextrs1">
        ...
        <asp:TextBox ID="Xingmingid" runat="server" Width="90%" Style="display: none"></asp:TextBox>
        ...
        <script language="javascript">	
            ...
            {  
                var num=Math.random();
                var str=""+document.getElementById('Xingmingid').value+"|"+document.getElementById('Xingming').value+"";
                wName_3=window.showModalDialog("/OpenWindows/open_hr_ry_hege1.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:550px;DialogHeight=480px;status:no;scroll=yes;help:no");                
                if (wName_3 == undefined) {wName_3 = window.returnValue;}var arr = wName_3.split("|");
                for(var i=0;i<arr.length;i++)
                { 
                    document.getElementById("Xingmingid").value=arr[0]; 
                    document.getElementById("Xingming").value=arr[1]; 
                }
            }
        </script>
