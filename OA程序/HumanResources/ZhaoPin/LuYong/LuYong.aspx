<%@ Page Language="C#" AutoEventWireup="true" Codebehind="LuYong.aspx.cs" Inherits="xyoa.HumanResources.ZhaoPin.LuYong.LuYong" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='LuYong.aspx';showwait();">
                                                                <font class="shadow_but">正式录用</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    录用日期从<asp:TextBox ID="Starttime" runat="server" Width="80px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" Width="80px"
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="姓名" SortExpression="Xingming">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='LuYong_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="录用日期" SortExpression="A.SetTimes">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("SetTimes").ToString().Replace("00:00:00", "").Replace("1900-01-01", "").Replace("0:00:00", "").Replace("1900-1-1", "")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
