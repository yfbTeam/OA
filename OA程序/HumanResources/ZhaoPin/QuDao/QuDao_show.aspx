<%@ Page Language="C#" AutoEventWireup="true" Codebehind="QuDao_show.aspx.cs" Inherits="xyoa.HumanResources.ZhaoPin.QuDao.QuDao_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        负责人：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:Label ID="Fuzeren" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        城市：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:Label ID="Chengshi" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        邮编：</td>
                                                    <td class="newtd2" height="17" width="35%">
