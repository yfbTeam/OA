<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MianShi.aspx.cs" Inherits="xyoa.HumanResources.ZhaoPin.MianShi.MianShi" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="<%=ViewState["btncss1"] %>" type="button" onclick="javascript:window.location='MianShi.aspx?Hege=1';showwait();">
                                                                <font class="shadow_but">合格</font></button>
                                                            <button class="<%=ViewState["btncss2"] %>" type="button" onclick="javascript:window.location='MianShi.aspx?Hege=2';showwait();">
                                                                <font class="shadow_but">不合格</font></button>
                                                            <button class="<%=ViewState["btncss3"] %>" type="button" onclick="javascript:window.location='MianShi.aspx?Hege=3';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="姓名" SortExpression="Xingming">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='MianShi_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&XingmingId=<%# DataBinder.Eval(Container.DataItem, "XingmingId")%>' class="LinkLine">
