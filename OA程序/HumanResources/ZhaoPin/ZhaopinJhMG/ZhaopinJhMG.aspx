<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ZhaopinJhMG.aspx.cs" Inherits="xyoa.HumanResources.ZhaoPin.ZhaopinJhMG.ZhaopinJhMG" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="<%=ViewState["btncss1"] %>" type="button" onclick="javascript:window.location='ZhaopinJhMG.aspx?Zhuangtai=1';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="<%=ViewState["btncss2"] %>" type="button" onclick="javascript:window.location='ZhaopinJhMG.aspx?Zhuangtai=2';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="是否结束" SortExpression="A.Jieshu">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <img src="/oaimg/h/<%# DataBinder.Eval(Container.DataItem, "Jieshu")%>.png" />
                                                                        </ItemTemplate>
