<%@ Page Language="C#" AutoEventWireup="true" Codebehind="JianLi.aspx.cs" Inherits="xyoa.HumanResources.ZhaoPin.JianLi.JianLi" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="<%=ViewState["btncss1"] %>" type="button" onclick="javascript:window.location='JianLi.aspx?Zhuangtai=1';showwait();">
                                                                <font class="shadow_but">未面试</font></button>
                                                            <button class="<%=ViewState["btncss4"] %>" type="button" onclick="javascript:window.location='JianLi.aspx?Zhuangtai=4';showwait();">
                                                                <font class="shadow_but">预约面试</font></button>
                                                            <button class="<%=ViewState["btncss2"] %>" type="button" onclick="javascript:window.location='JianLi.aspx?Zhuangtai=5';showwait();">
                                                                <font class="shadow_but">已合格</font></button>
                                                            <button class="<%=ViewState["btncss3"] %>" type="button" onclick="javascript:window.location='JianLi.aspx?Zhuangtai=3';showwait();">
                                                                <font class="shadow_but">未合格</font></button>
                                                            <button class="<%=ViewState["btncss5"] %>" type="button" onclick="javascript:window.location='JianLi.aspx?Zhuangtai=2';showwait();">
                                                                <font class="shadow_but">已录用</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            ...
                                                            <asp:Button ID="Mianshi" runat="server" Text="面 试" CssClass="button_blue" OnClick="Jieshu_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    姓名：<asp:TextBox ID="Xingming" runat="server" Width="88px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="姓名" SortExpression="Xingming">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='JianLi_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="状态" SortExpression="A.Zhuangtai">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("Zhuangtai").ToString().Replace("1", "未面试").Replace("2", "合格录用").Replace("3", "未合格").Replace("4", "预约面试")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
