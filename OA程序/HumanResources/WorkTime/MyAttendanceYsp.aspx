<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAttendanceYsp.aspx.cs" Inherits="xyoa.HumanResources.WorkTime.MyAttendanceYsp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyAttendanceYsp.aspx?type=<%=Request.QueryString["type"] %>';showwait();">
