<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyAttendance.aspx.cs" Inherits="xyoa.HumanResources.WorkTime.MyAttendance" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='MyAttendance.aspx?type=<%=Request.QueryString["type"] %>';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='MyAttendanceYsp.aspx?type=<%=Request.QueryString["type"] %>';showwait();">
