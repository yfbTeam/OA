<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GongziSB.aspx.cs" Inherits="xyoa.HumanResources.Gongzi.GongziSB.GongziSB" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="<%=ViewState["btncss4"] %>" type="button" onclick="javascript:window.location='GongziSB.aspx?Zhuangtai=4';showwait();">
                                                                <font class="shadow_but">等待审批</font></button>
                                                            <button class="<%=ViewState["btncss1"] %>" type="button" onclick="javascript:window.location='GongziSB.aspx?Zhuangtai=1';showwait();">
                                                                <font class="shadow_but">正在审批</font></button>
                                                            <button class="<%=ViewState["btncss2"] %>" type="button" onclick="javascript:window.location='GongziSB.aspx?Zhuangtai=2';showwait();">
                                                                <font class="shadow_but">通过审批</font></button>
                                                            <button class="<%=ViewState["btncss3"] %>" type="button" onclick="javascript:window.location='GongziSB.aspx?Zhuangtai=3';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    工资主题：<asp:TextBox ID="Zhuti" runat="server" Width="88px"></asp:TextBox>
                                                                    对应帐套：<asp:DropDownList ID="Zhangtao" runat="server">
                                                                    </asp:DropDownList>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="工资主题" SortExpression="Zhuti">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='GongziSB_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
                                                                                <%# DataBinder.Eval(Container.DataItem, "Zhuti")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="StartTime" HeaderText="起始日期" SortExpression="StartTime"
                                                                        DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="EndTime" HeaderText="截止日期" SortExpression="EndTime" DataFormatString="{0:yyyy-MM-dd}"
                                                                        HtmlEncode="False">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="ZhangtaoName" HeaderText="对应帐套" SortExpression="Zhangtao">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
