<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GongziMG.aspx.cs" Inherits="xyoa.HumanResources.Gongzi.GongziMG.GongziMG" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="<%=ViewState["btncss1"] %>" type="button" onclick="javascript:window.location='GongziMG.aspx?Zhuangtai=1';showwait();">
                                                                <font class="shadow_but">未审批</font></button>
                                                            <button class="<%=ViewState["btncss2"] %>" type="button" onclick="javascript:window.location='GongziMG.aspx?Zhuangtai=2';showwait();">
