<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GongziMG_showYsp.aspx.cs" Inherits="xyoa.HumanResources.Gongzi.GongziMG.GongziMG_showYsp" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="GongziMG.aspx?Zhuangtai=2">
                                                                薪资管理 </a>>> 查看薪资上报</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">薪资管理</font>
                                                            </button>
                                                        </td>
