<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongGH_show.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongGH.YuangongGH_show" %>
...
{
    var num=Math.random();
    var k=window.showModalDialog("YuangongGH_show1.aspx?tmp="+num+"&id="+str+"",window,"dialogWidth:850px;DialogHeight=650px;status:no;scroll=yes;help:no")
}
