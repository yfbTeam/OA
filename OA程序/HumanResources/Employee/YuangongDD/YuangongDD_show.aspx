<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongDD_show.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongDD.YuangongDD_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        调动后部门：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:Label ID="BumenE" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                    ...
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        调动后职位：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:Label ID="ZhiweiE" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
