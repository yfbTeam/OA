<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongJC.aspx.cs" Inherits="xyoa.HumanResources.Employee.YuangongJC.YuangongJC" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='YuangongJC.aspx?Jiangcheng=<%=Request.QueryString["Jiangcheng"] %>';showwait();">
                                                                <font class="shadow_but">
                                                                    <%=ViewState["Jiangcheng"] %>记录</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    <%=ViewState["Jiangcheng"] %>类型：<asp:DropDownList ID="Leibie" runat="server">
                                                                    </asp:DropDownList>
                                                                    <%=ViewState["Jiangcheng"] %>日期从<asp:TextBox ID="Starttime" runat="server" Width="80px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" Width="80px"
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="员工姓名" SortExpression="A.RealnameYG">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='YuangongJC_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&Jiangcheng=<%# DataBinder.Eval(Container.DataItem, "Jiangcheng")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="LeixingName" HeaderText="类型" SortExpression="A.Leibie">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="日期" SortExpression="A.JiangchengSj">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("JiangchengSj").ToString().Replace("00:00:00", "").Replace("1900-01-01", "").Replace("0:00:00", "").Replace("1900-1-1", "")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                </Columns>
