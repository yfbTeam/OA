<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongJC_show.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongJC.YuangongJC_show" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="YuangongJC.aspx?Jiangcheng=<%=Request.QueryString["Jiangcheng"] %>">
                                                                <%=ViewState["Jiangcheng"] %>记录</a> >> 查看<%=ViewState["Jiangcheng"] %>记录</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                </table>
                                                        ...
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">
                                                                    <%=ViewState["Jiangcheng"] %>记录</font></button></td>
                                                        <td style="height: 26px" align="right">
                                                            <input id="Button3" type="button" value="打 印" onclick="printnewpage()" class="button_blue" /></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="17">
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <%=ViewState["Jiangcheng"] %>
                                                        日期：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:Label ID="JiangchengSj" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <%=ViewState["Jiangcheng"] %>类型：</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" width="85%" colspan="3">
                                                        <asp:Label ID="JianchengYy" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
