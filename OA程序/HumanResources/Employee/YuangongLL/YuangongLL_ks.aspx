<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongLL_ks.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLL.YuangongLL_ks" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn2on" type="button" onclick="javascript:window.location='YuangongLL_ks.aspx?id=<%=Request.QueryString["id"] %>';">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="考试主题" SortExpression="B.Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='KaoShi_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&ygid=<%=Request.QueryString["id"] %>'
                                                                                class="LinkLine">
