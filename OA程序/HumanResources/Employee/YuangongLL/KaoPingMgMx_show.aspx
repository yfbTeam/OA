<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingMgMx_show.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLL.KaoPingMgMx_show" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">考评明细</font></button></td>
                                                        <td style="height: 26px" align="right">
                                                            <input id="Button1" class="button_css" onclick="history.back()" type="button" value="返 回" /></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="17">
