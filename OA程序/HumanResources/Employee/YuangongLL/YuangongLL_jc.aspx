<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongLL_jc.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLL.YuangongLL_jc" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            ...
                                                            <button class="btn2on" type="button" onclick="javascript:window.location='YuangongLL_jc.aspx?id=<%=Request.QueryString["id"] %>';">
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="奖惩" SortExpression="A.Jiangcheng">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("Jiangcheng").ToString().Replace("1", "奖励").Replace("2", "惩罚")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
