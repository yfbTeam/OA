<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongLL_kp.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLL.YuangongLL_kp" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn2on" type="button" onclick="javascript:window.location='YuangongLL_kp.aspx?id=<%=Request.QueryString["id"] %>';">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="考评主题" SortExpression="B.Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='KaoPingMgMx_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
