<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyAttendance.aspx.cs" Inherits="xyoa.HumanResources.Employee.YuangongLL.MyAttendance" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="<%=ViewState["btncss1"] %>" type="button" onclick="javascript:window.location='MyAttendance.aspx?id=<%=Request.QueryString["id"] %>&type=1';">
                                                                <font class="shadow_but">出差</font></button>
                                                            <button class="<%=ViewState["btncss2"] %>" type="button" onclick="javascript:window.location='MyAttendance.aspx?id=<%=Request.QueryString["id"] %>&type=2';">
                                                                <font class="shadow_but">休假</font></button>
                                                            <button class="<%=ViewState["btncss3"] %>" type="button" onclick="javascript:window.location='MyAttendance.aspx?id=<%=Request.QueryString["id"] %>&type=3';">
