<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongLL_dd.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLL.YuangongLL_dd" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn2on" type="button" onclick="javascript:window.location='YuangongLL_dd.aspx?id=<%=Request.QueryString["id"] %>';">
