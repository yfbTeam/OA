<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongLL_fz.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLL.YuangongLL_fz" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn2on" type="button" onclick="javascript:window.location='YuangongLL_fz.aspx?id=<%=Request.QueryString["id"] %>';">
