<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongLL_tj.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLL.YuangongLL_tj" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            ...
                                                            <button class="btn2on" type="button" onclick="javascript:window.location='YuangongLL_tj.aspx?id=<%=Request.QueryString["id"] %>';">
