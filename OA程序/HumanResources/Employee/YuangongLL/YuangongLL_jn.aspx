<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongLL_jn.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLL.YuangongLL_jn" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            ...
                                                            <button class="btn2on" type="button" onclick="javascript:window.location='YuangongLL_jn.aspx?id=<%=Request.QueryString["id"] %>';">
