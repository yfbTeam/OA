<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongLL_lz.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLL.YuangongLL_lz" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn2on" type="button" onclick="javascript:window.location='YuangongLL_lz.aspx?id=<%=Request.QueryString["id"] %>';">
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            <input id="Button3" type="button" value="关 闭" onclick="window.close()" class="button_blue" /></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </td>
