<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Peixun_show.aspx.cs" Inherits="xyoa.HumanResources.Employee.YuangongLL.Peixun_show" %>
...
function chknull()
{
    if(document.getElementById('Tihui').value=='')
    {
        alert('心得体会内容不能为空');
        form1.Tihui.focus();
        return false;
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            ...
                                                            <input id="Button1" type="button" value="返 回" onclick="history.go(-1)" class="button_css" /></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="17">
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        培训类别：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:Label ID="Leibie" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        开始时间：</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:Label ID="RealnameCj" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        员工心得体会：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:Label ID="Tihui" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
