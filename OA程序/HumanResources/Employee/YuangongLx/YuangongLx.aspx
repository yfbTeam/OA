<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YuangongLx.aspx.cs" Inherits="xyoa.HumanResources.Employee.YuangongLx.YuangongLx" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="37%" valign="bottom">
                                                            人事管理 >> 数据字典 >> <%=ViewState["FileName"] %></td>
                                                        <td width="60%">
                                                            <img src="/oaimg/menu/2.gif">提醒：修改类型将自动更新其对应的数据。</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but"><%=ViewState["FileName"] %></font></button>
                                                        </td>
