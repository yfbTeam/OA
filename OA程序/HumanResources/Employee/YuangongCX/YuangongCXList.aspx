<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongCXList.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongCX.YuangongCXList" %>
...
{
    var num=Math.random();
    var k=window.showModalDialog("YuangongCXList_show.aspx?tmp="+num+"&id="+str+"",window,"dialogWidth:850px;DialogHeight=650px;status:no;scroll=yes;help:no")
}
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="YuangongCX.aspx" class="line_b">
                                                                档案查询</a> >> 查询结果
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='YuangongCX.aspx';showwait();">
                                                    ...
                                                    <td valign="top">
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="姓名" SortExpression="A.Xingming">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' class="LinkLine" onclick="showfrom1('<%# DataBinder.Eval(Container.DataItem, "ID") %>')">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="出生日期" SortExpression="A.Chusheng">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="BumenName" HeaderText="所在部门" SortExpression="A.Bumen">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="ZhiweiName" HeaderText="职位" SortExpression="A.Zhiwei">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="在职" SortExpression="A.Zaizhi">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("Zaizhi").ToString().Replace("1", "在职").Replace("2", "离职")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                </Columns>
