<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongTJ.aspx.cs" Inherits="xyoa.HumanResources.Employee.YuangongTJ.YuangongTJ" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='YuangongTJ.aspx';showwait();">
                                                                <font class="shadow_but">体检记录</font></button>
                                                        </td>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 体检结果：<asp:DropDownList
                                                                            ID="Leixing" runat="server">
                                                                        </asp:DropDownList>
                                                                    体检日期从<asp:TextBox ID="Starttime" runat="server" Width="80px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" Width="80px"
                                                                                onClick="WdatePicker()"></asp:TextBox>体检主题：<asp:TextBox ID="Zhuti" runat="server"
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="体检主题" SortExpression="A.Zhuti">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='YuangongTJ_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="LeixingName" HeaderText="离职类型" SortExpression="A.Jieguo">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="体检日期" SortExpression="A.Shijian">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
