<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongLZ_add.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongLZ.YuangongLZ_add" %>
...
function chknull()
{
    ...
    if (!confirm("["+document.getElementById('RealnameYG').value+"]确定离职吗，记录添加以后不允许再恢复？"))
    return false;
