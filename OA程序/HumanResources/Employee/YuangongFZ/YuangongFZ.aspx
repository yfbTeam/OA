<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YuangongFZ.aspx.cs" Inherits="xyoa.HumanResources.Employee.YuangongFZ.YuangongFZ" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='YuangongFZ.aspx';showwait();">
                                                                <font class="shadow_but">员工复职</font></button>
                                                        </td>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 复职类型：<asp:DropDownList
                                                                            ID="Leixing" runat="server">
                                                                        </asp:DropDownList>
                                                                    复职日期从<asp:TextBox ID="Starttime" runat="server" Width="80px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" Width="80px"
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="员工姓名" SortExpression="A.RealnameYG">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='YuangongFZ_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="LeixingName" HeaderText="复职类型" SortExpression="A.Leixing">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="复职日期" SortExpression="A.Riqi">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
