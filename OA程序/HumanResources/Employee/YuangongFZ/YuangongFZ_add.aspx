<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongFZ_add.aspx.cs"
    Inherits="xyoa.HumanResources.Employee.YuangongFZ.YuangongFZ_add" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">员工复职</font></button></td>
        ...
        <script language="javascript">	
           ...
           var  wName_3;  
            ...
            {  
                ...
                wName_3=window.showModalDialog("/OpenWindows/open_Username_two_lz.aspx?tmp="+num+"&requeststr="+str+"","window", "dialogWidth:550px;DialogHeight=480px;status:no;scroll=yes;help:no");                
