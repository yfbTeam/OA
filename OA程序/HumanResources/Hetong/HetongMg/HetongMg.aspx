<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HetongMg.aspx.cs" Inherits="xyoa.HumanResources.Hetong.HetongMg.HetongMg" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='HetongMg.aspx';showwait();">
                                                                <font class="shadow_but">合同管理</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    合同状态：<asp:DropDownList ID="Zhuangtai" runat="server">
