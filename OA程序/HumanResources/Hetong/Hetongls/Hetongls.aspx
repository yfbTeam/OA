<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Hetongls.aspx.cs" Inherits="xyoa.HumanResources.Hetong.Hetongls.Hetongls" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Hetongls.aspx';showwait();">
                                                                <font class="shadow_but">合同流水日志</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    签约合同：<asp:DropDownList ID="LeibieID" runat="server">
                                                                    </asp:DropDownList>
                                                                    日志类型：<asp:DropDownList ID="Leixing" runat="server">
                                                                        <asp:ListItem></asp:ListItem>
                                                                        <asp:ListItem Value="1">合同新签</asp:ListItem>
                                                                        <asp:ListItem Value="6">合同修改</asp:ListItem>
                                                                        <asp:ListItem Value="2">合同变更</asp:ListItem>
                                                                        <asp:ListItem Value="3">合同续签</asp:ListItem>
                                                                        <asp:ListItem Value="4">合同解除</asp:ListItem>
                                                                        <asp:ListItem Value="5">合同终止</asp:ListItem>
                                                                        <asp:ListItem Value="7">到期终止</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    操作人：<asp:TextBox ID="Realname" runat="server" Width="77px" CssClass="ReadOnlyText"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a>操作时间从<asp:TextBox
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "LeibieName") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                        </ItemTemplate>
