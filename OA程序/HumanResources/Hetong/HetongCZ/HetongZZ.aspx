<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HetongZZ.aspx.cs" Inherits="xyoa.HumanResources.Hetong.HetongCZ.HetongZZ" %>
<html>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        终止原因：</td>
                                                    <td class="newtd2" height="17" width="85%" colspan="3">
                                                        <asp:TextBox ID="Yuanyin" runat="server" Width="100%" Height="55px" TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
