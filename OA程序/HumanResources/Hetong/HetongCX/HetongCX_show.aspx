<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HetongCX_show.aspx.cs"
    Inherits="xyoa.HumanResources.Hetong.HetongCX.HetongCX_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        合同期限：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="83%">
                                                        <asp:DropDownList ID="Qixian" runat="server" Width="100%">
