<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HetongCX_SearchList.aspx.cs"
    Inherits="xyoa.HumanResources.Hetong.HetongCX.HetongCX_SearchList" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="HetongCX.aspx" class="line_b">
                                                                合同查询</a> >> 查询结果
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='HetongCX.aspx';showwait();">
                                                                <font class="shadow_but">合同查询</font></button>
                                                        </td>
