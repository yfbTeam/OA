<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HetongLb.aspx.cs" Inherits="xyoa.HumanResources.Hetong.HetongLb.HetongLb" %>
...
{
    var num=Math.random();
    window.showModalDialog("ziduan.aspx?tmp="+num+"&LeibieID="+str+"","window", "dialogWidth:700px;DialogHeight=480px;status:no;scroll=yes;help:no");         
}
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='HetongLb.aspx';showwait();">
                                                                <font class="shadow_but">合同类别</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    类别名称：<asp:TextBox ID="Mingcheng" runat="server" Width="88px"></asp:TextBox>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Mingcheng" HeaderText="类别名称" SortExpression="Mingcheng">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="字段列表">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' class="LinkLine" onclick='ziduan("<%# DataBinder.Eval(Container.DataItem, "id")%>")'>
                                                                                字段列表 </a>
                                                                        </ItemTemplate>
