<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YuangongBX_update.aspx.cs" Inherits="xyoa.HumanResources.KaoPing.YuangongBX.YuangongBX_update" %>
...
function chknull()
{
    if(document.getElementById('SjRealname').value=='')
    {
        alert('请选择事件人');
        form1.SjRealname.focus();
        return false;
    }	
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>事件人：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="SjRealname" runat="server" Width="95%" CssClass="ReadOnlyText"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap">
                                                        事件内容(<a href="javascript:void(0)" onclick="openqiupengmodle()">模版</a>)：</td>
