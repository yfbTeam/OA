<%@ Page Language="C#" AutoEventWireup="true" Codebehind="YuangongBX.aspx.cs" Inherits="xyoa.HumanResources.YuangongBX.YuangongBX" %>
...
<body class="newbody">
    <form id="form1" runat="server">
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='YuangongBX.aspx';showwait();">
                                                                <font class="shadow_but">员工表现</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    签约人：<asp:TextBox ID="SjRealname" runat="server" Width="88px" CssClass="ReadOnlyText"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 事件日期从<asp:TextBox
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "SjRealname") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="事件人" SortExpression="SjRealname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='YuangongBX_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                                <%# DataBinder.Eval(Container.DataItem, "SjRealname")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="事件日期" SortExpression="Riqi">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
        ...
        <asp:TextBox ID="SjUsername" runat="server" Style="display: none"></asp:TextBox>
        ...
        <script type="text/javascript">
           ...
           var  wName_3;  
            ...
            {  
                var num=Math.random();
                var str=""+document.getElementById('SjUsername').value+"|"+document.getElementById('SjRealname').value+"";
                ...
                { 
                    document.getElementById("SjUsername").value=arr[0]; 
                    document.getElementById("SjRealname").value=arr[1]; 
                }
            }
        </script>
