<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingQZ_show.aspx.cs"
    Inherits="xyoa.HumanResources.KaoPing.KaoPingQZ.KaoPingQZ_show" %>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">员工签字</font></button></td>
                                                ...
                                                <tr>
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center" id="printshow4">
                                                            <font face="宋体">
                                                                <asp:Button ID="Button1" runat="server" Text="签 字" CssClass="button_css" OnClick="Button1_Click" />
