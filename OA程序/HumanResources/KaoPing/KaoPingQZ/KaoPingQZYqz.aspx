<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingQZYqz.aspx.cs" Inherits="xyoa.HumanResources.KaoPing.KaoPingQZ.KaoPingQZYqz" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='KaoPingQZ.aspx';showwait();">
                                                                <font class="shadow_but">未签字</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='KaoPingQZYqz.aspx';showwait();">
                                                                <font class="shadow_but">已签字</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="考评主题" SortExpression="B.Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='KaoPingQZ_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="考评总分">
                                                                        <HeaderStyle CssClass="newtitle"  Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# decimal.Parse(Eval("FenshuMy").ToString()) * decimal.Parse(Eval("QuanzhongMy").ToString()) / 100 + decimal.Parse(Eval("Fenshu1").ToString()) * decimal.Parse(Eval("Quanzhong1").ToString()) / 100 + decimal.Parse(Eval("Fenshu2").ToString()) * decimal.Parse(Eval("Quanzhong2").ToString()) / 100 + decimal.Parse(Eval("Fenshu3").ToString()) * decimal.Parse(Eval("Quanzhong3").ToString()) / 100 + decimal.Parse(Eval("Fenshu4").ToString()) * decimal.Parse(Eval("Quanzhong4").ToString()) / 100 + decimal.Parse(Eval("Fenshu5").ToString()) * decimal.Parse(Eval("Quanzhong5").ToString()) / 100%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                </Columns>
