<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingQZ.aspx.cs" Inherits="xyoa.HumanResources.KaoPing.KaoPingQZ.KaoPingQZ" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='KaoPingQZ.aspx';showwait();">
                                                                <font class="shadow_but">未签字</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='KaoPingQZYqz.aspx';showwait();">
