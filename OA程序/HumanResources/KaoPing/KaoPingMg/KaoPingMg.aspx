<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingMg.aspx.cs" Inherits="xyoa.HumanResources.KaoPing.KaoPingMg.KaoPingMg" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='KaoPingMg.aspx';showwait();">
                                                                <font class="shadow_but">考评管理</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="考评主题" SortExpression="Zhuti">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='KaoPingMg_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&LeixingID=<%# DataBinder.Eval(Container.DataItem, "LeixingID")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="Starttime" HeaderText="考评生效日期" SortExpression="Starttime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Endtime" HeaderText="考评终止日期" SortExpression="Endtime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
