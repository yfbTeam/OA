<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingMg_show.aspx.cs"
    Inherits="xyoa.HumanResources.KaoPing.KaoPingMg.KaoPingMg_show" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" colspan="3">
                                                        <asp:Label ID="RealnameCy" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
