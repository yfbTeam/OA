<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingCxList.aspx.cs"
    Inherits="xyoa.HumanResources.KaoPing.KaoPingCx.KaoPingCxList" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="KaoPingCx.aspx" class="line_b">
                                                                考评查询</a> >> 查询结果
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="AddData" runat="server" Text="重新查询" CssClass="button_blue" OnClick="AddData_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="考评主题" SortExpression="B.Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='KaoPingCxList_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
