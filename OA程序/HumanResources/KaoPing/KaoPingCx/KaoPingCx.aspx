<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingCx.aspx.cs" Inherits="xyoa.HumanResources.KaoPing.KaoPingCx.KaoPingCx" %>
...
<body class="newbody">
    <form id="form1" runat="server">
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">考评查询</font></button>
                                                        </td>
                                                ...
                                                <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="newtd2" height="17" colspan="3">
                                                            <asp:TextBox ID="RealnameCy" runat="server" Width="90%" CssClass="ReadOnlyText" Height="61px"
        ...
        <asp:TextBox ID="UsernameCy" runat="server" Style="display: none"></asp:TextBox>
