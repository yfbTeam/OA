<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KaoPingSJ_ykp.aspx.cs" Inherits="xyoa.HumanResources.KaoPing.KaoPingSJ.KaoPingSJ_ykp" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='KaoPingSJ.aspx';showwait();">
                                                                <font class="shadow_but">未考评</font></button>
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='KaoPingSJ_ykp.aspx';showwait();">
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="考评主题" SortExpression="B.Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='KaoPingSJ_ykp_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
