<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingSJ_ykp_show.aspx.cs"
    Inherits="xyoa.HumanResources.KaoPing.KaoPingSJ.KaoPingSJ_ykp_show" %>
                                            ...
                                            <td valign="top">
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a href="javascript:void(0)" onclick="alert('只显示用户所处考评级别以前的数据\n例如：用户在三级考评的时候进行的考评，那么只显示三级考评以前的考评明细，即一级考评和二级考评的数据。')">说明←点击查看</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
