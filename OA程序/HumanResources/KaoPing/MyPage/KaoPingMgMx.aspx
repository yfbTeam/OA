<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingMgMx.aspx.cs" Inherits="xyoa.HumanResources.KaoPing.MyPage.KaoPingMgMx" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="<%=ViewState["btncss1"] %>" type="button" onclick="javascript:window.location='KaoPingMgMx.aspx?KpZhuangtaiMy=1';showwait();">
                                                                <font class="shadow_but">未考评</font></button>
                                                            <button class="<%=ViewState["btncss2"] %>" type="button" onclick="javascript:window.location='KaoPingMgMx.aspx?KpZhuangtaiMy=2';showwait();">
