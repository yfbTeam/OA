<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoPingMgMx_show.aspx.cs"
    Inherits="xyoa.HumanResources.KaoPing.MyPage.KaoPingMgMx_show" %>
...
function chknull()
{
    if(document.getElementById('FenshuMy').value=='')
    {
        alert('自我考评分数不能为空');
        form1.FenshuMy.focus();
        return false;
    }
    showwait();	
}  
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="KaoPingMgMx.aspx">自我考评</a>
                                                            >> 进行考评</td>
                                                        <td width="81%">
                                                            &nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">自我考评</font></button></td>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>自我考评分数：</td>
                                                    <td class="newtd2" height="17" width="35%">
                                                        <asp:TextBox ID="FenshuMy" runat="server" Width="100%"></asp:TextBox>
                                                    </td>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        自我考评权重：</td>
                                                    <td class="newtd2" height="17" width="35%">
