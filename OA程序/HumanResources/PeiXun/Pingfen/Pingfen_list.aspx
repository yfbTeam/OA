<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Pingfen_list.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.Pingfen.Pingfen_list" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Pingfen.aspx" class="line_b">
                                                                考试评分</a> >> 《<asp:Label ID="Zhutis" runat="server"></asp:Label>》参与考试人员列表
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Pingfen.aspx';showwait();">
                                                                <font class="shadow_but">人员列表</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="AddData" runat="server" Text="返 回" CssClass="button_blue" OnClick="AddData_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    人员姓名：<asp:TextBox ID="Realname" runat="server" Width="112px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="参与人员" SortExpression="Realname">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='Pingfen_list_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&KaoShiID=<%# DataBinder.Eval(Container.DataItem, "KaoShiID")%>'
                                                                                class="LinkLine">
