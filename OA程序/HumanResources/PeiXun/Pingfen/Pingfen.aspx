<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Pingfen.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.Pingfen.Pingfen" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Pingfen.aspx';showwait();">
                                                                <font class="shadow_but">考试评分</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="考试主题" SortExpression="Zhuti">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='Pingfen_list.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
