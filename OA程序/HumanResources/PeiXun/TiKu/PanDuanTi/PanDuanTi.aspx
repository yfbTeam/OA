<%@ Page Language="C#" AutoEventWireup="true" Codebehind="PanDuanTi.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.TiKu.PanDuanTi.PanDuanTi" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='PanDuanTi.aspx';showwait();">
                                                                <font class="shadow_but">判断题</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    题目名称：<asp:TextBox ID="Titles" runat="server" Width="88px"></asp:TextBox>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="题目名称" SortExpression="Titles">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='PanDuanTi_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="结果" SortExpression="Answer">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <img src="/oaimg/h/<%# DataBinder.Eval(Container.DataItem, "Answer")%>.png" />
                                                                        </ItemTemplate>
