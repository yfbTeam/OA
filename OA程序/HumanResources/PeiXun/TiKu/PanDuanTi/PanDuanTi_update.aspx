<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PanDuanTi_update.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.TiKu.PanDuanTi.PanDuanTi_update" %>
<html>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">判断题</font></button></td>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr class="" id="Tr5">
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        <font color="red">※</font>结果：</td>
                                                    <td class="newtd2" height="17" width="33%" colspan="3">
                                                        <asp:RadioButtonList ID="Answer" runat="server" RepeatDirection="Horizontal">
                                                            <asp:ListItem Selected="True" Value="1">正确</asp:ListItem>
                                                            <asp:ListItem Value="2">不正确</asp:ListItem>
                                                        </asp:RadioButtonList>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
