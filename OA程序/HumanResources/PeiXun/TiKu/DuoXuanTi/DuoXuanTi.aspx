<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DuoXuanTi.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.TiKu.DuoXuanTi.DuoXuanTi" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='DuoXuanTi.aspx';showwait();">
                                                                <font class="shadow_but">多选题</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="题目名称" SortExpression="Titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='DuoXuanTi_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
