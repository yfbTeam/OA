<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DanXuanTi.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.TiKu.DanXuanTi.DanXuanTi" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='DanXuanTi.aspx';showwait();">
                                                                <font class="shadow_but">单选题</font></button>
                                                        </td>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="题目名称" SortExpression="Titles">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='DanXuanTi_update.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
