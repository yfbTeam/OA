<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ShiJuan.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.ShiJuan.ShiJuan" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='ShiJuan.aspx';showwait();">
                                                                <font class="shadow_but">试卷管理</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    试卷名称：<asp:TextBox ID="Titles" runat="server" Width="88px"></asp:TextBox>
                                                                    题库类别：<asp:DropDownList ID="MingchengID" runat="server">
                                                                    </asp:DropDownList>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="试卷名称" SortExpression="Titles">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                          <a href='ShiJuanMxSd_show.aspx?ShijuanID=<%# DataBinder.Eval(Container.DataItem, "id")%>&MingchengID=<%# DataBinder.Eval(Container.DataItem, "MingchengID")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="Mingcheng" HeaderText="题库类别" SortExpression="MingchengID">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="试卷状态" SortExpression="Zhuangtai">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
