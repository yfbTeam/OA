<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShiJuan_update.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.ShiJuan.ShiJuan_update" %>
<html>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">试卷管理</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                <asp:Button ID="Button1" runat="server" Text="保存并设置明细" CssClass="button_css" OnClick="Button1_Click" />
                                                                &nbsp;
                                                                <asp:Button ID="Button3" runat="server" Text="保存并返回" CssClass="button_css" OnClick="Button3_Click"/>
