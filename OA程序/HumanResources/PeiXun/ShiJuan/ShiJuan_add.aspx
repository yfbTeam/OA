<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ShiJuan_add.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.ShiJuan.ShiJuan_add" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                <asp:Button ID="Button1" runat="server" Text="保存并进入自动出题" CssClass="button_css" OnClick="Button1_Click" />
                                                                &nbsp;
                                                                <asp:Button ID="Button3" runat="server" Text="保存并进入手动出题" CssClass="button_css" OnClick="Button3_Click" />
