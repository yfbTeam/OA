<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShiJuanMxSd_Add_Tiankong.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.ShiJuan.ShiJuanMxSd_Add_Tiankong" %>
<html>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="Button3" runat="server" Text="确定提交" OnClick="Button3_Click" CssClass="button_css"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#E0E0E0"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="Mingcheng" HeaderText="题库类别">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
