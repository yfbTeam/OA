<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Peixun.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.Peixun.Peixun" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Peixun.aspx';showwait();">
                                                                <font class="shadow_but">培训管理</font></button>
                                                        </td>
