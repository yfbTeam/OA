<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Peixun_add.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.Peixun.Peixun_add" %>
...
{  
    var num=Math.random();
    var number=document.getElementById('Number').value;
    window.showModalDialog("openzl.aspx?tmp="+num+"&number="+number+"&Leibie="+document.getElementById('Leibie').value+"","window","dialogWidth:700px;DialogHeight=580px;status:no;scroll=yes;help:no");                
}
</script>
