<%@ Page Language="C#" AutoEventWireup="true" Codebehind="PeixunZl.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.PeixunZl.PeixunZl" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='PeixunZl.aspx';showwait();">
                                                                <font class="shadow_but">培训资料</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    资料名称：<asp:TextBox ID="Name" runat="server" Width="88px"></asp:TextBox>
                                                                    资料类别：<asp:DropDownList ID="MingchengID" runat="server">
                                                                    </asp:DropDownList>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="资料名称" SortExpression="Name">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='/<%# DataBinder.Eval(Container.DataItem, "Newname")%>' class="LinkLine" target=_blank>
