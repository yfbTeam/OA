<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoShi.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.MyPage.KaoShi" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="<%=ViewState["btncss1"] %>" type="button" onclick="javascript:window.location='KaoShi.aspx?Zhuangtai=1';showwait();">
                                                                <font class="shadow_but">未参与</font></button>
                                                            <button class="<%=ViewState["btncss2"] %>" type="button" onclick="javascript:window.location='KaoShi.aspx?Zhuangtai=2';showwait();">
                                                                <font class="shadow_but">正在考试</font></button>
                                                            <button class="<%=ViewState["btncss3"] %>" type="button" onclick="javascript:window.location='KaoShi.aspx?Zhuangtai=3';showwait();">
                                                                <font class="shadow_but">考试结束</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    考试主题：<asp:TextBox ID="Zhuti" runat="server" Width="112px"></asp:TextBox>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="考试主题" SortExpression="B.Zhuti">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='KaoShi_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&Zhuangtai=<%# DataBinder.Eval(Container.DataItem, "Zhuangtai")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="StarttimeS" HeaderText="考试生效时间" SortExpression="StarttimeS">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="EndtimeS" HeaderText="考试终止时间" SortExpression="EndtimeS">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="ShijianS" HeaderText="答题时间" SortExpression="ShijianS">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
