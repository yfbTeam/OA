<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Peixun_show.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.MyPage.Peixun_show" %>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        <font color="red">※</font>我的心得体会：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:TextBox ID="Tihui" runat="server" Width="100%" Height="71px" TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center" id="printshow4">
                                                            <font face="宋体">
                                                                <asp:Button ID="Button1" runat="server" Text="填写心得体会" CssClass="button_css" OnClick="Button1_Click" />
