<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TikuLb.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.TikuLb" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='TikuLb.aspx';showwait();">
                                                                <font class="shadow_but">题库类别</font></button>
                                                        </td>
