<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoShi.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.KaoShi.KaoShi" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='KaoShi.aspx';showwait();">
                                                                <font class="shadow_but">网上考试</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="考试主题" SortExpression="Zhuti">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='KaoShi_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>&ShijuanID=<%# DataBinder.Eval(Container.DataItem, "ShijuanID")%>'
                                                                                class="LinkLine">
                                                                    ...
                                                                    <asp:BoundField DataField="ShijuanS" HeaderText="试卷" SortExpression="ShijuanS">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="考试状态" SortExpression="Zhuangtai">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("Zhuangtai").ToString().Replace("1", "正常").Replace("2", "停用")))%>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="Starttime" HeaderText="生效时间" SortExpression="Starttime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Endtime" HeaderText="终止时间" SortExpression="Endtime">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
