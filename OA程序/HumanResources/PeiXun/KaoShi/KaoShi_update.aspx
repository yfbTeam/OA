<%@ Page Language="C#" AutoEventWireup="true" Codebehind="KaoShi_update.aspx.cs"
    Inherits="xyoa.HumanResources.PeiXun.KaoShi.KaoShi_update" %>
...
var arr1 = wName_2.split("|");
for(var i=0;i<arr1.length;i++)
{ 
document.getElementById("PUsername").value=arr1[0]; 
document.getElementById("PRealname").value=arr1[1]; 
}
}
        </script>
