<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PeixunLb.aspx.cs" Inherits="xyoa.HumanResources.PeiXun.PeixunLb.PeixunLb" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='PeixunLb.aspx';showwait();">
                                                                <font class="shadow_but">培训类别</font></button>
                                                        </td>
