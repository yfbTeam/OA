<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sushe_update.aspx.cs" Inherits="xyoa.SchTable.Sushe.Sushe.Sushe_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Sushe.aspx">宿舍管理</a> >> 修改宿舍管理</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td class="newtd2" height="17" width="83%" colspan=3>
                                                        <asp:DropDownList ID="Louceng" runat="server" Width="100%">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
