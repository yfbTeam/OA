<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sushe.aspx.cs" Inherits="xyoa.SchTable.Sushe.Sushe.Sushe" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Sushe.aspx';showwait();">
                                                                <font class="shadow_but">宿舍管理</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            ...
                                                            <asp:Button ID="DelData" runat="server" Text="删 除" CssClass="button_blue" OnClick="DelData_Click" />
                                                             <asp:Button ID="Shengcheng" runat="server" Text="生成房间" CssClass="button_blue" OnClick="Shengcheng_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                <tr>
                                                    <td valign="top">
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    建筑：<asp:DropDownList ID="JianzhuId" runat="server">
                                                                    </asp:DropDownList>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="建筑名称" SortExpression="A.Mingcheng">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="楼层" SortExpression="A.Louceng">
                                                                        <ItemStyle Wrap="True" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Louceng")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="房间编号" SortExpression="A.Bianhao">
                                                                        <ItemStyle Wrap="True" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="面积" SortExpression="A.Mianji">
                                                                        <ItemStyle Wrap="True" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Mianji")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="座位数" SortExpression="A.Zuowei">
                                                                        <ItemStyle Wrap="True" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Zuowei")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="是否在用" SortExpression="A.Zaiyong">
                                                                        <ItemStyle Wrap="True" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Zaiyong")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                </Columns>
