<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Guanliren.aspx.cs" Inherits="xyoa.SchTable.Sushe.Guanliren.Guanliren" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Guanliren.aspx';showwait();">
                                                                <font class="shadow_but">管理人员</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    公寓：<asp:DropDownList ID="JianzhuId" runat="server">
                                                                    </asp:DropDownList>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="人员姓名" SortExpression="A.Xingming">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="工作类型" SortExpression="A.Leixing">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="负责公寓" SortExpression="A.Mingcheng">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="工作时间段" SortExpression="A.Shijian">
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="负责楼层" SortExpression="A.Louceng">
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="职务" SortExpression="A.Zhiwu">
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="联系方式" SortExpression="A.Lianxi">
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Lianxi")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
