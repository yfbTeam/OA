<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Xueqi.aspx.cs" Inherits="xyoa.SchTable.SysMag.Xueqi.Xueqi" %>
...
<body class="newbody">
    <form id="form1" runat="server">
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Xueqi.aspx';showwait();">
                                                                <font class="shadow_but">学期设置</font></button>
                                                        </td>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="学期名称" SortExpression="A.Mingcheng">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="启用学段" SortExpression="A.QiyongXueduan">
                                                                        <ItemStyle Wrap="True" Width="120px" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# ((Eval("QiyongXueduan").ToString().Replace("0,", "").Replace(",0", "")))%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                </Columns>
        ...
        <input id="SortText" type="hidden" runat="server" value="order by A.Mingcheng asc" />
