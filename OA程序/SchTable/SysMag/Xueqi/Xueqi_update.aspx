<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueqi_update.aspx.cs" Inherits="xyoa.SchTable.SysMag.Xueqi.Xueqi_update" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Xueqi.aspx">学期设置</a> >> 修改学期设置</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="83%">
                                                       ...
                                                       <asp:ListItem>2013-2014</asp:ListItem>
                                                        ...
                                                        <asp:TextBox ID="MingchengS" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
