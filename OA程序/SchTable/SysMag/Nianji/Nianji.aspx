<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Nianji.aspx.cs" Inherits="xyoa.SchTable.SysMag.Nianji.Nianji" %>
...
<body class="newbody">
    <form id="form1" runat="server">
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Nianji.aspx';showwait();">
                                                                <font class="shadow_but">年级设置</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            ...
                                                            <asp:Button ID="Piliang" runat="server" Text="复制年级" CssClass="button_blue" OnClick="Piliang_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "NianjiMc") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="学期名称" SortExpression="A.Xueqi">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Xueqi")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="NianjiMc" HeaderText="年级名称" SortExpression="NianjiMc">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="RuxueBiye" HeaderText="入学/毕业年级" SortExpression="RuxueBiye">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="上学期课程" SortExpression="A.Kecheng">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Kecheng" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Kecheng")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="Label1" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="下学期课程" SortExpression="A.Kecheng">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="KechengX" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "KechengX")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="Label2" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="考试类型" SortExpression="A.Kaoshilx">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Kaoshilx" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Kaoshilx")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="Label3" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                     <asp:TemplateField HeaderText="行课日程" SortExpression="A.Richeng1">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                          每周：<%#DataBinder.Eval(Container.DataItem, "Tianshu")%>天 上午：<%#DataBinder.Eval(Container.DataItem, "Richeng1")%>节 下午：<%#DataBinder.Eval(Container.DataItem, "Richeng2")%>节 晚上：<%#DataBinder.Eval(Container.DataItem, "Richeng3")%>节
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                </Columns>
        ...
        <input id="SortText" type="hidden" runat="server" value="order by A.Xueqi" />
