<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nianji_pl.aspx.cs" Inherits="xyoa.SchTable.SysMag.Nianji.Nianji_pl" %>
...
function chknull()
{
    ...
    if(document.getElementById('Xueqi').value==document.getElementById('XueqiC').value)
    {
        alert('来源学期和创建学期不能相同');
        form1.Xueqi.focus();
        return false;
    ...
    if(document.getElementById('XueqiC').value=='')
    {
        alert('创建学期名称不能为空');
        form1.XueqiC.focus();
        return false;
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Nianji.aspx">年级设置</a> >> 新增年级设置</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    ...
                                                    <td class="newtd2" colspan="3" height="17" width="83%">
                                                      ...
                                                      <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        <font color="red">※</font>创建学期名称：</td>
                                                    <td class="newtd2" colspan="3" height="17" width="83%">
                                                        <asp:DropDownList ID="XueqiC" runat="server">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
