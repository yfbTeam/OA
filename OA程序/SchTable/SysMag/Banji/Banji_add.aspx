<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Banji_add.aspx.cs" Inherits="xyoa.SchTable.SysMag.Banji.Banji_add" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    ...
                                                    <td class="newtd2" width="33%" style="height: 17px">
                                                        <asp:DropDownList ID="Nianji" runat="server" onchange="changxuenian();">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
