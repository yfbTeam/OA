<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pinggu_Bj.aspx.cs" Inherits="xyoa.SchTable.Chengji.Pinggu.Pinggu_Bj" %>
                                ...
                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                    ...
                                    <tr>
                                        <td style="height: 26px;">
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Pinggu.aspx';"
                                                runat="server" id="Button1">
                                                <font class="shadow_but">学生实力评估</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Pinggu_Bj.aspx';"
                                                runat="server" id="Button2">
                                                <font class="shadow_but">班级实力评估</font></button>
                    ...
                    <table width="200" border="0" cellpadding="4" cellspacing="1" class="maincss">
                        ...
                        <tr>
                            ...
                            <td valign="middle" bgcolor="#FFFFFF">
                                <div style='overflow-y: auto; scrollbar-face-color: #f8fcf5; height: 140px; width: 100%'>
                                    <asp:CheckBox ID="CheckBox2" runat="server" onclick='ReverseAll("Leixing")' ForeColor="Red"
