<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Henxiang.aspx.cs" Inherits="xyoa.SchTable.Chengji.Henxiang.Henxiang" %>
                                ...
                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                    ...
                                    <tr>
                                        <td style="height: 26px;">
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Henxiang.aspx';"
                                                runat="server" id="Button1">
                                                <font class="shadow_but">质量分析</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Henxiang_Mc.aspx';"
                                                runat="server" id="Button2">
                                                <font class="shadow_but">学生名次</font></button>
                        ...
                        <tr>
                            ...
                            <td height="100%" valign="middle" bgcolor="#FFFFFF">
                               <div style='overflow-y: auto; scrollbar-face-color: #f8fcf5; height: 140px; width: 100%'>
                                    <asp:CheckBox ID="CheckBox1" runat="server" onclick='ReverseAll("BanJi")' ForeColor="Red"
