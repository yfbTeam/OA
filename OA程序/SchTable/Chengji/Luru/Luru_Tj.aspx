<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Luru_Tj.aspx.cs" Inherits="xyoa.SchTable.Chengji.Luru.Luru_Tj" %>
                                ...
                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                    ...
                                    <tr>
                                        <td style="height: 26px;">
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Luru.aspx?Url=1';"
                                                runat="server" id="FONT1">
                                                <font class="shadow_but">成绩批量录入</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Luru.aspx?Url=2';"
                                                runat="server" id="FONT2"><font class="shadow_but">成绩单个录入</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Luru.aspx?Url=3';"
                                                runat="server" id="FONT3"><font class="shadow_but">成绩修改删除</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Luru_Tj.aspx';"
                                                runat="server" id="FONT4"><font class="shadow_but">成绩录入统计</font></button>
