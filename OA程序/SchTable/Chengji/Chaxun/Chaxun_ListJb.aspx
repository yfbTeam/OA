<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Chaxun_ListJb.aspx.cs" Inherits="xyoa.SchTable.Chengji.Chaxun.Chaxun_ListJb" %>
                                    ...
                                    <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                        <tr>
                                            ...
                                            <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                                查询类型：</td>
                                            <td class="newtd2" height="17" width="20%">
                                                <asp:DropDownList ID="ChaxuLx" runat="server">
                                                    <asp:ListItem Selected="True">组合成绩</asp:ListItem>
                                                    <asp:ListItem>成绩总分</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                                考试类型：</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="newtd2" colspan="7" height="17" width="95%">
