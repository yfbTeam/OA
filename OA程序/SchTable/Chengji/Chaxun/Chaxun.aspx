<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Chaxun.aspx.cs" Inherits="xyoa.SchTable.Chengji.Chaxun.Chaxun" %>
                                ...
                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                    ...
                                    <tr>
                                        <td style="height: 26px;">
                                            <button class="btn4off" type="button" onclick="javascript:window.nexthead.location='Chaxun_left.aspx?url=1';window.nextrform.location='Chaxun_List.aspx?id=0';"
                                                runat="server" id="FONT1">
                                                <font class="shadow_but">个人成绩查询</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.nexthead.location='Chaxun_left.aspx?url=2';window.nextrform.location='Chaxun_ListBj.aspx?id=0';"
                                                runat="server" id="FONT2">
                                                <font class="shadow_but">班级成绩查询</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.nexthead.location='Chaxun_leftNj.aspx?url=2';window.nextrform.location='Chaxun_ListNj.aspx?id=0';"
