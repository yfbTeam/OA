<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Beike.aspx.cs" Inherits="xyoa.SchTable.JiaoShi.Beike" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Beike.aspx';showwait();">
                                                                <font class="shadow_but">我的备课</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    主题：<asp:TextBox ID="titles" runat="server"></asp:TextBox>
                                                                    学期：<asp:DropDownList ID="Xueqi" runat="server">
                                                                    </asp:DropDownList>
                                                                    学期段：
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="主题" SortExpression="titles">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Beike_show.aspx?id= <%# DataBinder.Eval(Container.DataItem, "id")%>' class="LinkLine">
