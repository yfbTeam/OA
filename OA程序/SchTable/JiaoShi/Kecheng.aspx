<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Kecheng.aspx.cs" Inherits="xyoa.SchTable.JiaoShi.Kecheng" %>
                                            ...
                                            <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                ...
                                                <tr>
                                                    <td style="height: 26px;">
                                                        <button class="btn4off" type="button" runat="server" id="FONT1">
                                                            <font class="shadow_but">我的课程</font></button>
                                                    </td>
