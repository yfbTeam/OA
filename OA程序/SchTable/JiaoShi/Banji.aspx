<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banji.aspx.cs" Inherits="xyoa.SchTable.JiaoShi.Banji" %>
                                ...
                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                    ...
                                    <tr>
                                        <td style="height: 26px;">
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Banji.aspx';"
                                                runat="server" id="Button1">
                                                <font class="shadow_but">我的班级</font></button>
