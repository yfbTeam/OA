<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Beike_show.aspx.cs" Inherits="xyoa.SchTable.JiaoShi.Beike_show" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Beike.aspx">我的备课</a> >> 查看我的备课</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <input id="Button7" type="button" value="返 回" class="button_css" onclick="history.go(-1)" />
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
