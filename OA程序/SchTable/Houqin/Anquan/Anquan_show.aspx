<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Anquan_show.aspx.cs" Inherits="xyoa.SchTable.Houqin.Anquan.Anquan_show" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Anquan.aspx">学生安全教育</a> >> 查看学生安全教育</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        参与学生：</td>
                                                    <td class="newtd2" height="17" width="83%" colspan="3">
                                                        <asp:Label ID="Canyu" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        描述：</td>
                                                    <td class="newtd2" height="17" width="83%" colspan="3">
                                                        <asp:Label ID="Miaosu" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
