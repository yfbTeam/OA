<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Weixiu.aspx.cs" Inherits="xyoa.SchTable.Houqin.Weixiu.Weixiu" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Weixiu.aspx';showwait();">
                                                                <font class="shadow_but">维修记录</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    维修内容：<asp:TextBox ID="Neirong" runat="server"></asp:TextBox>
                                                                    维修时间：<asp:TextBox ID="Startime" runat="server" onClick="WdatePicker()" Width="76px"></asp:TextBox>至<asp:TextBox
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="维修内容" SortExpression="A.Neirong">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Weixiu_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'>
                                                                                <%# DataBinder.Eval(Container.DataItem, "Neirong")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="维修时间" SortExpression="A.Shijian">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="维修人员" SortExpression="A.Renyuan">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
