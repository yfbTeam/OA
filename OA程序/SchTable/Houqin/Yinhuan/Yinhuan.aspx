<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Yinhuan.aspx.cs" Inherits="xyoa.SchTable.Houqin.Yinhuan.Yinhuan" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='Yinhuan.aspx';showwait();">
                                                                <font class="shadow_but">隐患整改</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    整改内容：<asp:TextBox ID="Neirong" runat="server"></asp:TextBox>
                                                                    检查时间：<asp:TextBox ID="Startime" runat="server" onClick="WdatePicker()" Width="76px"></asp:TextBox>至<asp:TextBox
                                                                        ID="Endtime" runat="server" onClick="WdatePicker()" Width="76px"></asp:TextBox>
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="选择">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="LabNameVisible" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Zuzhizhe") %>'
                                                                                Visible="False" Width="0px"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="组织者" SortExpression="A.Zuzhizhe">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Yinhuan_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'>
                                                                                <%# DataBinder.Eval(Container.DataItem, "Zuzhizhe")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="检查时间" SortExpression="A.Shijian">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="参加人员" SortExpression="A.Renyuan">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Renyuan")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="整改内容" SortExpression="A.Neirong">
                                                                        <ItemStyle Wrap="True"  />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Neirong")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="地点" SortExpression="A.Didian">
                                                                        <ItemStyle Wrap="False"  />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "Didian")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
