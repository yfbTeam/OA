<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Yinhuan_update.aspx.cs" Inherits="xyoa.SchTable.Houqin.Yinhuan.Yinhuan_update" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Yinhuan.aspx">隐患整改记录</a> >> 修改隐患整改记录</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        <font color="red">※</font>组织者：</td>
                                                    <td class="newtd2" height="17" width="33%">
                                                        <asp:TextBox ID="Zuzhizhe" runat="server" Width="100%" MaxLength="25"></asp:TextBox>
                                                    </td>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        <font color="red">※</font>检查时间：</td>
                                                    <td class="newtd2" height="17" width="33%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="newtd2" height="17" width="83%" colspan="3">
                                                        <asp:TextBox ID="Renyuan" runat="server" Width="100%" MaxLength="2000" Height="78px"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        整改内容：</td>
                                                    <td class="newtd2" height="17" width="83%" colspan="3">
                                                        <asp:TextBox ID="Neirong" runat="server" Width="100%" MaxLength="2000" Height="78px"
                                                            TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        地点：</td>
                                                    <td class="newtd2" height="17" width="83%" colspan="3">
                                                        <asp:TextBox ID="Didian" runat="server" Width="100%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
