<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sifang_update.aspx.cs" Inherits="xyoa.SchTable.Houqin.Sifang.Sifang_update" %>
<html>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="Sifang.aspx">四防安全检查</a> >> 修改四防安全检查</td>
                                                        <td width="81%">
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td width="30%" style="height: 26px">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">四防安全</font></button></td>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        检查部位：</td>
                                                    <td class="newtd2" height="17" width="83%" colspan="3">
                                                        <asp:TextBox ID="Buwei" runat="server" Width="100%" MaxLength="2000" Height="78px"
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="17%">
                                                        检查情况：</td>
                                                    <td class="newtd2" height="17" width="83%" colspan="3">
                                                        <asp:TextBox ID="Qingkuan" runat="server" Width="100%" MaxLength="2000" Height="78px"
                                                            TextMode="MultiLine"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
