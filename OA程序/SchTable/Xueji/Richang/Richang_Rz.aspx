<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Richang_Rz.aspx.cs" Inherits="xyoa.SchTable.Xueji.Richang.Richang_Rz" %>
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                 学生姓名：<asp:TextBox ID="Xingming" runat="server" Width="100px"></asp:TextBox>
                                                                    类型：
                                                                     <asp:DropDownList ID="Xiangmu" runat="server">
                                                                            ...
                                                                            <asp:ListItem>毕业</asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    操作时间：<asp:TextBox
                                                                            ID="Nowtimes" runat="server" Width="85px" onClick="WdatePicker()"></asp:TextBox>
                                                                  详细描述：<asp:TextBox ID="Miaosu" runat="server" Width="100px"></asp:TextBox>
