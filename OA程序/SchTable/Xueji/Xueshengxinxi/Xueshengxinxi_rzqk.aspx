<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueshengxinxi_rzqk.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_rzqk" %>
<html>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="变化日期" SortExpression="D.Riqi">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Xueshengxinxi_rzqk_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'>
                                                                                <font color="blue">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="职务" SortExpression="D.Zhiwu">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Zhiwu" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Zhiwu")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="LZhiwu" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="Xueqi" HeaderText="变化学期" SortExpression="D.Xueqi">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="XueduanS" HeaderText="变化学段" SortExpression="D.Xueduan">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="True" />
                                                                    </asp:BoundField>
                                                                </Columns>
