<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueshengxinxi_cfqk_update.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_cfqk_update" %>
<html>
                                 ...
                                 <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                    ...
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            处罚信息：</td>
                                        <td class="newtd2" height="17" width="45%" colspan="3">
                                            <asp:TextBox ID="Chufa" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            处罚类别：</td>
                                        <td class="newtd2" height="17" width="20%">
                                        ...
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            处罚日期：</td>
                                        <td class="newtd2" height="17" width="20%">
                                            <asp:TextBox ID="Riqi" runat="server" Width="100px" onClick="WdatePicker()"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                        ...
                                        <td class="newtd2" height="17" width="95%" colspan="7">
                                            <asp:TextBox ID="Yuanyin" runat="server" Width="100%" Height="82px" TextMode="MultiLine"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            备注：</td>
                                        <td class="newtd2" height="17" width="95%" colspan="7">
                                            <asp:TextBox ID="Beizhu" runat="server" Width="100%" Height="82px" TextMode="MultiLine"></asp:TextBox></td>
                                    </tr>
                                    <tr id="printshow3">
