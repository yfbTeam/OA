<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueshengxinxi_jxqk_update.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_jxqk_update" %>
<html>
                             ...
                             <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                    ...
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            军训部队：</td>
                                        <td class="newtd2" height="17" width="20%">
                                            <asp:TextBox ID="Budui" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            军训成绩：</td>
                                        <td class="newtd2" height="17" width="20%">
                                            <asp:TextBox ID="Chengji" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            军训开始时间：</td>
                                        <td class="newtd2" height="17" width="20%">
