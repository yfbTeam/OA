<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Xueshengxinxi_wthd_show.aspx.cs"
    Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_wthd_show" %>
                                ...
                                <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                    ...
                                    <tr>
                                        ...
                                        <td class="newtd2" height="17" width="75%" colspan="5">
                                            <asp:Label ID="Huodong" runat="server"></asp:Label>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            参与时间：</td>
                                        <td class="newtd2" height="17" width="20%">
