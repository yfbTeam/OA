<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueshengxinxi_jspy_update.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_jspy_update" %>
<html>
                                ...
                                <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                    ...
                                    <tr>
                                        ...
                                        <td class="newtd2" height="17" width="95%" colspan="7">
                                            <asp:DropDownList ID="Zongpin" runat="server">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            评语：</td>
                                        <td class="newtd2" height="17" width="95%" colspan="7">
                                            <asp:DropDownList ID="PingyuS" runat="server" onchange="_change()">
                                            </asp:DropDownList>
                                            <asp:TextBox ID="Pingyu" runat="server" Width="100%" Height="82px" TextMode="MultiLine"></asp:TextBox></td>
                                    </tr>
                                    <tr id="printshow3">
