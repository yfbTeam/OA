<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueshengxinxi_jxqk_show.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_jxqk_show" %>
<html>
                             ...
                             <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                    ...
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            军训部队：</td>
                                        <td class="newtd2" height="17" width="20%">
                                             <asp:Label ID="Budui" runat="server"></asp:Label>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            军训成绩：</td>
                                        <td class="newtd2" height="17" width="20%">
                                        ...
                                        <td class="newtd2" height="17" width="20%">
                                             ...
                                             <asp:Label ID="Kaishi" runat="server"></asp:Label>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            军训结束时间：</td>
                                        <td class="newtd2" height="17" width="20%">
                                      
                                             <asp:Label ID="Jieshu" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr id="printshow3">
