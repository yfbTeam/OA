<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Xueshengxinxi_jfxx.aspx.cs"
    Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_jfxx" %>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="家访时间" SortExpression="D.Shijian">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Xueshengxinxi_jfxx_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'>
                                                                                <font color="blue">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="家访原因" SortExpression="D.Yuanyin">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
