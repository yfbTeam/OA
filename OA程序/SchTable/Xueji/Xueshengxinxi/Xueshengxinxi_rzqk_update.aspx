<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueshengxinxi_rzqk_update.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_rzqk_update" %>
                                ...
                                <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                   ...
                                   <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                        ...
                                        <td class="newtd2" height="17" width="45%" colspan="3">
                                            ...
                                            <asp:TextBox ID="XsUpId" runat="server" Visible=false></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
