<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueshengxinxi_xxjl_show.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_xxjl_show" %>
<html>
                                ...
                                <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                    <tr>
                                        ...
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            所在学校：</td>
                                        <td class="newtd2" height="17" width="20%">
                                            <asp:Label ID="Xuexiao" runat="server" Width="100%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            起始日期：</td>
                                        <td class="newtd2" height="17" width="20%">
                                            <asp:Label ID="Kaishi" runat="server" Width="100px"></asp:Label>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            结束日期：</td>
                                        <td class="newtd2" height="17" width="20%">
                                            <asp:Label ID="Jieshu" runat="server" Width="100px"></asp:Label>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            证明人：</td>
                                        <td class="newtd2" height="17" width="45%" colspan="3">
                                            <asp:Label ID="Zhengmingren" runat="server" Width="100%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                        ...
                                        <td class="newtd2" height="17" width="95%" colspan="7">
                                            <asp:Label ID="Beizhu" runat="server" Width="100%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr id="printshow3">
