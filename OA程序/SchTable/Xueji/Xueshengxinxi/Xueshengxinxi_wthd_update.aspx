<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueshengxinxi_wthd_update.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_wthd_update" %>
<html>
                            ...
                            <td height="35">
                               ...
                               <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                    ...
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            活动名称：</td>
                                        <td class="newtd2" height="17" width="75%" colspan="5">
                                            <asp:TextBox ID="Huodong" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            参与时间：</td>
                                        <td class="newtd2" height="17" width="20%">
