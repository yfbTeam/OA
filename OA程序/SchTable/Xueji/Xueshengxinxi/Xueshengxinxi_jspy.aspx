<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Xueshengxinxi_jspy.aspx.cs"
    Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_jspy" %>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="品德总评等第" SortExpression="Zongpin">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Zongpin" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Zongpin")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="LZongpin" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="评语" SortExpression="D.Pingyu">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Xueshengxinxi_jspy_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'>
                                                                                <font color="blue">
                                                                                  <%# ((Eval("Pingyu").ToString().Replace("\n", "<br>").Replace(" ", "&nbsp;&nbsp;")))%>
                                                                                </font></a>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="Realname" HeaderText="录入人" SortExpression="D.Realname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="XueduanS" HeaderText="学段" SortExpression="D.D.Xueduan">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="True" />
                                                                    </asp:BoundField>
                                                                </Columns>
