<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Xueshengxinxi_tjxx.aspx.cs"
    Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_tjxx" %>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="体检时间" SortExpression="D.Shijian">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='Xueshengxinxi_tjxx_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>'>
                                                                                <font color="blue">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="健康状况" SortExpression="D.Pingjia">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Pingjia" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "Pingjia")%>'
                                                                                Visible="false"></asp:Label>
                                                                            <asp:Label ID="LPingjia" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="Shengao" HeaderText="身高(cm)" SortExpression="D.Shengao">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="Tizhong" HeaderText="体重(kg)" SortExpression="D.Tizhong">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemStyle Wrap="False" />
                                                                    </asp:BoundField>
