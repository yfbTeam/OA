<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xueshengxinxi_shsj_update.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xueshengxinxi.Xueshengxinxi_shsj_update" %>
<html>
                                 ...
                                 <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                    ...
                                    <tr>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            实践项目：</td>
                                        <td class="newtd2" height="17" width="45%" colspan="3">
                                            <asp:TextBox ID="Xiangmu" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                        <td align="right" class="newtd1" height="17" nowrap="nowrap" width="5%">
                                            实践时间：</td>
                                        <td class="newtd2" height="17" width="20%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="newtd2" height="17" width="95%" colspan="7">
                                            <asp:TextBox ID="Miaoshu" runat="server" Width="100%" Height="72px" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr id="printshow3">
