<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Xuejika.aspx.cs" Inherits="xyoa.SchTable.Xueji.Xuejika.Xuejika" %>
                                ...
                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                    ...
                                    <tr>
                                        <td style="height: 26px;">
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Xuejika.aspx';"
                                                runat="server" id="Button1">
                                                <font class="shadow_but">学生学籍卡</font></button>
