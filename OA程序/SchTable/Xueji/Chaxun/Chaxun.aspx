<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Chaxun.aspx.cs" Inherits="xyoa.SchTable.Xueji.Chaxun.Chaxun" %>
                                    ...
                                    <tr>
                                        <td style="height: 26px;">
                                            ...
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Chaxun_Zh.aspx';"
                                                runat="server" id="Button2"><font class="shadow_but">综合查询</font></button>
                                            <button class="btn4off" type="button" onclick="javascript:window.location='Chaxun_Bys.aspx';"
                                                runat="server" id="Button3"><font class="shadow_but">毕业生查询</font></button>
                    ...
                    <table width="200" border="0" cellpadding="4" cellspacing="1" class="maincss">
                        ...
                        <tr>
                            ...
                            <td width="137" valign="top" bgcolor="#FFFFFF">
                                <asp:TextBox ID="Xingming" runat="server" Width="127px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
