<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Biangeng_PlBg.aspx.cs" Inherits="xyoa.SchTable.Xueji.Biangeng.Biangeng_PlBg" %>
<html>
...
function SelectItem()
{ 
    if(document.getElementById('PlXuejiZhuangtai').value!="")
    {
        var ck1="0";
        ...
        for (var i=2;i<Much1;i++)
        {
            try{
                if(parseFloat(i)<10)
                {
                   document.getElementById('GridView1_ctl0'+i+'_XuejiZhuangtai').value=document.getElementById('PlXuejiZhuangtai').value;
                }
                else
                {
                    document.getElementById('GridView1_ctl'+i+'_XuejiZhuangtai').value=document.getElementById('PlXuejiZhuangtai').value;
                }
            }
            catch(err){
            }
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                                ...
                                                                <tr>
                                                                    <td valign="top">
                                                                        生效学期：<asp:DropDownList ID="Xueqi" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Xueqi_SelectedIndexChanged" Enabled=false>
                                                                        </asp:DropDownList>
                                                                        生效学期段：
                                                                        ...
                                                                        批量选择状态： <asp:DropDownList ID="PlXuejiZhuangtai" runat="server" onchange="SelectItem();">
                                                                                </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                ...
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#E0E0E0"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="班级">
                                                                            <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                            <ItemTemplate>
                                                                              <%#DataBinder.Eval(Container.DataItem, "BanJiName")%>
                                                                            </ItemTemplate>
                                                                            <ItemStyle Wrap="False" HorizontalAlign="Left" />
                                                                        </asp:TemplateField>
                                                                          <asp:TemplateField HeaderText="当前学籍状态" SortExpression="XuejiZhuangtai">
                                                                            <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="IdXuejiZhuangtai" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "XuejiZhuangtai")%>'
                                                                                    Visible="false"></asp:Label>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="变化后学籍状态" SortExpression="XuejiZhuangtai">
                                                                            <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                            <ItemTemplate>
