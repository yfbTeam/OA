<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowListAll.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowListAll" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='WorkFlowListAll.aspx';showwait();">
                                                                <font class="shadow_but">全部工作</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='WorkFlowList.aspx';showwait();">
                                                                <font class="shadow_but">未接收</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='WorkFlowList_blz.aspx';showwait();">
                                                                <font class="shadow_but">办理中</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='WorkFlowList_ybj.aspx';showwait();">
                                                                <font class="shadow_but">已办结</font></button>
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='WorkFlowList_ywt.aspx';showwait();">
                                                                <font class="shadow_but">已委托</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    发起人：<asp:TextBox ID="FqRealname" runat="server" Width="75px" CssClass="ReadOnlyText"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="工作名称/文号" SortExpression="Name">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <img src="/oaimg/menu/<%# DataBinder.Eval(Container.DataItem, "JinJiChengDu")%>.gif" /><asp:Label
                                                                    ...
                                                                    <asp:BoundField DataField="States" HeaderText="状态" SortExpression="States">
                                                                        <ItemStyle Wrap="False" Width="45px" Font-Bold="True" ForeColor="Black" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                           <asp:BoundField DataField="UpTimeSet" HeaderText="最后办理时间" SortExpression="UpTimeSet">
                                                                        <ItemStyle Wrap="False"  HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
