<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowJkWt.aspx.cs" Inherits="xyoa.WorkFlow.WorkFlowJkWt" %>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
                                                        主办人：</td>
                                                    <td class="newtd2" height="17" colspan="3" width="85%">
                                                        <asp:Label ID="ZbObjectName" runat="server"></asp:Label>
                                                        <asp:Label ID="ZbObjectId" runat="server" Visible="false"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" class="newtd1" height="17" nowrap="nowrap" width="15%">
