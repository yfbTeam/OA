<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAddWorkFlowJb_lc.aspx.cs" Inherits="xyoa.WorkFlow.MyAddWorkFlowJb_lc" %>
<html>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr id="printshow3">
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <input id="Button2" type="button" value="查看流程设计图" class="button_css"  onclick='window.open ("AddWorkFlow_show_lc.aspx?FlowNumber=<%=FlowNumber%>&NodeName=<%=NodeNames%>", "_blank", "height=660, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=50,left=100")' />
