<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowDel.aspx.cs" Inherits="xyoa.WorkFlow.WorkFlowDel" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='WorkFlowDel.aspx';showwait();">
                                                                <font class="shadow_but">工作销毁</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <asp:Button ID="Button3" runat="server" Text="批量恢复" CssClass="button_blue" OnClick="Button3_Click" />
                                                            <asp:Button ID="DelData" runat="server" Text="批量删除" CssClass="button_blue" OnClick="DelData_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="流程操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="Huifu">恢复</asp:LinkButton>
