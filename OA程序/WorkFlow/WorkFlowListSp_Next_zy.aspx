<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowListSp_Next_zy.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowListSp_Next_zy" %>
...
function chknull()
{
    ...
    if (!confirm("是否确定要转交＂<%=ViewState["Name"] %>＂"))
    return false;
...
function gd()
{
    if (!confirm("是否确定结束工作＂<%=ViewState["Name"] %>＂"))
    return false;
    showwait();	
}  
...
<body class="newbody">
    <form id="form1" runat="server">
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                ...
                                                <tr>
                                                    <td class="newtd1" colspan="4" nowrap="nowrap">
                                                        ...
                                                        <strong>选择人员</strong> <a href='javascript:void(0)' onclick='window.open ("WorkFlowList_bl_lc.aspx?Number=<%=Request.QueryString["Number"]%>", "_blank", "height=660, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")'>
                                                            查看流程图</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="center" class="newtd2" colspan="4" height="26" width="33%">
                                                        <div align="center">
                                                            <font face="宋体">
                                                                ...
                                                                <asp:Button ID="Button3" runat="server" Text="返回重新办理" CssClass="button_css" OnClick="Button2_Click" />
                                                                <asp:Button ID="Button2" runat="server" Text="结束归档" CssClass="button_css" OnClick="Button2_Click1" />
                                                                <input id="Button5" type="button" value="取消转交并关闭" onclick="window.opener.location.href='WorkFlowList_ybj.aspx';window.close();"
                                                                    class="button_css" />
                                                            </font>
                                                        </div>
                                                    </td>
        ...
        <asp:TextBox ID="ZbUsername" runat="server"></asp:TextBox>
