<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowNodeFF.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowNodeFF" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='WorkFlowNodeFF.aspx';showwait();">
                                                                <font class="shadow_but">工作流传阅</font></button>
                                                        </td>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    工作名称/文号：<asp:TextBox ID="titles" runat="server" Width="95px"></asp:TextBox>
                                                                    发件人：
                                                                    ...
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 发件时间从<asp:TextBox
                                                                            ID="Starttime" runat="server" Width="72px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox
                                                                                ID="Endtime" runat="server" Width="72px" onClick="WdatePicker()"></asp:TextBox>
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="工作名称/文号" SortExpression="titles">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='WorkFlowNodeFF_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'>
