<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowList_ybj.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowList_ybj" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='WorkFlowList_ybj.aspx';showwait();">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="流程操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="ShanChu">收回</asp:LinkButton>
