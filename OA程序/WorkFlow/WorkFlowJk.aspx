<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowJk.aspx.cs" Inherits="xyoa.WorkFlow.WorkFlowJk" %>
...
<body class="newbody">
    <form id="form1" runat="server">
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button" onclick="javascript:window.location='WorkFlowJk.aspx';showwait();">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    工作名称/文号：<asp:TextBox ID="Name" runat="server" Width="75px"></asp:TextBox>
                                                                    表单名称：<asp:DropDownList ID="FormName" runat="server">
                                                                    </asp:DropDownList>
                                                                    ...
                                                                    发起人：<asp:TextBox ID="FqRealname" runat="server" Width="50px" CssClass="ReadOnlyText"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 当前办理人：<asp:TextBox
                                                                            ID="ZbObjectName" runat="server" Width="43px" CssClass="ReadOnlyText"></asp:TextBox>
                                                                    <a href="javascript:void(0)">
                                                                        <img onclick="openuser1();" alt="" src="/oaimg/FDJ.gif" border="0"></a> 发起时间：<asp:TextBox
                                                                            ID="Starttime" runat="server" onClick="WdatePicker()" Width="62px"></asp:TextBox>
                                                                    至<asp:TextBox ID="Endtime" runat="server" onClick="WdatePicker()" Width="62px"></asp:TextBox>
                                                        ...
                                                        <div id="Div1" class="mainDiv">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="表单名称" SortExpression="FormName">
                                                                        <HeaderStyle CssClass="newtitle"  Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="发起人" SortExpression="FqRealname">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='senduser("<%# DataBinder.Eval(Container.DataItem, "FqUsername")%>")'>
                                                                                <%# DataBinder.Eval(Container.DataItem, "FqRealname")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="主办人" SortExpression="ZbObjectName">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='senduser("<%# DataBinder.Eval(Container.DataItem, "ZbObjectId")%>")'>
                                                                                <%# DataBinder.Eval(Container.DataItem, "ZbObjectName")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="State" HeaderText="状态" SortExpression="State">
                                                                        <ItemStyle Wrap="False" Font-Bold="True" ForeColor="Black" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="步骤与流程图" SortExpression="UpNodeName">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:BoundField DataField="NowTimes" HeaderText="工作发起时间" SortExpression="NowTimes">
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
        ...
        <asp:TextBox ID="ZbObjectId" runat="server" Width="90%" Style="display: none"></asp:TextBox>
        <input id="SortText" type="hidden" runat="server" value="order by A.UpTimeSet desc" />
        ...
        <script language="javascript">	
            ...
            {  
                var num=Math.random();
                var str=""+document.getElementById('ZbObjectId').value+"|"+document.getElementById('ZbObjectName').value+"";
                ...
                for(var i=0;i<arr.length;i++)
                { 
                    document.getElementById("ZbObjectId").value=arr[0]; 
                    document.getElementById("ZbObjectName").value=arr[1]; 
                }
            }
        </script>
