<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowListKjLog.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowListKjLog" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">控件日志</font></button>
                                                        </td>
                                                        <td style="height: 26px" align="right">
                                                            <input type="button" value="关闭" onclick="window.close();" style="width: 72px" class="button_blue"
                                                                id="Button3"></td>
                                                    </tr>
                                                </table>
                                            </div>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            background="/images/nextline.gif">
                                                            <tr>
                                                                <td valign="top">
                                                                    操作字段：<asp:TextBox ID="ziduan" runat="server" Width="58px"></asp:TextBox>
                                                                    操作人：
                                                                    <asp:TextBox ID="banliren" runat="server" Width="58px"></asp:TextBox>
                                                                    操作时间从<asp:TextBox ID="Starttime" runat="server" Width="82px" onClick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="Endtime" runat="server" Width="82px"
                                                        ...
                                                        <div id="Div1">
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField DataField="BMingcheng" HeaderText="修改字段" SortExpression="B.Name">
                                                                        <ItemStyle Wrap="False" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                    <asp:TemplateField HeaderText="修改内容" SortExpression="neirong">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="操作人" SortExpression="banliren">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <%# DataBinder.Eval(Container.DataItem, "banliren")%>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="操作时间" SortExpression="shijian">
                                                                        <ItemStyle Wrap="True" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
