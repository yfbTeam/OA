<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MyAddWorkFlowJb.aspx.cs"
    Inherits="xyoa.WorkFlow.MyAddWorkFlowJb" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            <button class="btn4off" type="button">
                                                                <font class="shadow_but">经办过的工作</font></button>
                                                        </td>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    ...
                                                                    办理时间：<asp:TextBox ID="Starttime" runat="server" onClick="WdatePicker()" Width="62px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="表单名称" SortExpression="FormName">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='var aw = screen.width-300;var ah = screen.height-100;loc_x=(screen.availWidth-aw)/2;loc_y=(screen.availHeight-ah)/2;window.open ("MyAddWorkFlowJb_show.aspx?Number=<%# DataBinder.Eval(Container.DataItem, "Number")%>&id=<%#DataBinder.Eval(Container.DataItem, "id")%>&GlNum=<%# DataBinder.Eval(Container.DataItem, "GlNum")%>", "_blank", "height=" + ah + ", width=" + aw + ",toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=" + loc_y + ",left=" + loc_x + "")'>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="办理步骤" SortExpression="UpNodeName">
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='window.open ("MyAddWorkFlowJb_lc.aspx?Number=<%# DataBinder.Eval(Container.DataItem, "Number")%>&GlNum=<%# DataBinder.Eval(Container.DataItem, "GlNum")%>", "_blank", "height=660, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top=0,left=0")'>
                                                                                <%#DataBinder.Eval(Container.DataItem, "UpNodeName")%>
                                                                            </a>
                                                                        </ItemTemplate>
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                    </asp:TemplateField>
                                                                    <asp:BoundField DataField="NowTimes" HeaderText="办理时间" SortExpression="NowTimes">
                                                                        <ItemStyle Wrap="False" HorizontalAlign="Center" />
                                                                        <HeaderStyle CssClass="newtitle" Wrap="False" />
                                                                    </asp:BoundField>
                                                                </Columns>
