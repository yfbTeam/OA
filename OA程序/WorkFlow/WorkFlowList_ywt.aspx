<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowList_ywt.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowList_ywt" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px;">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='WorkFlowList_ywt.aspx';showwait();">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="流程操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                                                                                CommandName="ShanChu">取消委托</asp:LinkButton>
