<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowNodeGD_show.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowNodeGD_show" %>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" height="30px"
                                                            ...
                                                            <tr>
                                                                <td valign="top">
                                                                    工作名称/文号：<asp:TextBox ID="Name" runat="server" Width="100px"></asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="表单名称" SortExpression="FormName">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <a href='javascript:void(0)' onclick='var aw = screen.width-300;var ah = screen.height-200;loc_x=(screen.availWidth-aw)/2;loc_y=(screen.availHeight-ah)/2;window.open ("WorkFlowNodeGD_show_show.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>", "_blank", "height="+ah+", width="+aw+",toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no,top="+loc_y+",left="+loc_x+"")'>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="传阅">
                                                                        <ItemStyle HorizontalAlign="Center" Wrap="True" Width="40px" />
                                                                        <HeaderStyle CssClass="newtitle"  HorizontalAlign="Center" Wrap="False" />
                                                                        <ItemTemplate>
                                                                            <a href='WorkFlowNodeGD_show_ff.aspx?id=<%# DataBinder.Eval(Container.DataItem, "ID") %>'>
                                                                                传阅</a>
                                                                        </ItemTemplate>
                                                                        <FooterStyle Wrap="True" />
                                                                    </asp:TemplateField>
                                                        ...
                                                        <table align="center" class="nextpage" border="0" cellpadding="4" cellspacing="1"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="newtd2" colspan="3" width="85%" style="height: 17px">
                                                                    ...
                                                                    转移：<asp:DropDownList ID="Folder" runat="server">
                                                                    </asp:DropDownList>
                                                                    <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton7_Click">确定转移</asp:LinkButton>
                                                                    当前文件夹名：<font color="blue"><asp:Label ID="Namefile" runat="server"></asp:Label></font></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
