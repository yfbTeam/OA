<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowSearch_SearchList.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowSearch_SearchList" %>
                                                ...
                                                <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="81%" valign="bottom">
                                                            <a href="WorkFlowSearch.aspx?id=0"
                                                                class="line_b">工作查询</a> >> 查询结果
                                                        </td>
                                                        <td width="16%">
                                                            </td>
                                                    </tr>
