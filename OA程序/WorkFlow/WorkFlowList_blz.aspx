<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowList_blz.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowList_blz" %>
                                                ...
                                                <table align="center" background="/<%=Session["yangshi"]%>/bg0003.gif" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; ">
                                                               <button class="btn4off" type="button" onclick="javascript:window.location='WorkFlowListAll.aspx';showwait();">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='WorkFlowList_blz.aspx';showwait();">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="流程操作">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a href='WorkFlowListWt.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id") %>'
                                                                                onclick="showwait();">委托</a>
