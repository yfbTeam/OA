<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowListSp_zy.aspx.cs"
    Inherits="xyoa.WorkFlow.WorkFlowListSp_zy" %>
...
function openyz()
{
    ...
    myleft=200;
    window.open("WorkFlowListSpYzQp.aspx?Number=<%=ViewState["YzSealNumber"]%>&NodeName=自由流程","_blank","height="+ah+",width="+aw+",status=0,toolbar=no,menubar=no,location=no,top="+at+",left="+al+",resizable=yes");
    ...
    else
    {
        ...
        if (nameLen>0)
        {
            ...
            { 
                ...
                var tmp=Math.random();
                window.open("Document_online.aspx?tmp="+tmp+"&number="+num+"&file="+cValue+"&filetype="+rightName+"&NodeName=自由流程","newwindow","height=700, width=960, top=0, left=30, toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no");
...
{
var num= document.getElementById("number").value;
window.open ("AddWorkFlow_spyj.aspx?Number="+num+"&key=<%=ViewState["YijianZb"]%>&Buzhou=自由流程", "_blank", "height=660, width=800,toolbar=no, menubar=no, scrollbars=yes,resizable=yes,location=no, status=no")
}
...
{
var num= document.getElementById("number").value;
  window.banliyijian.location.href='AddWorkFlow_spyj.aspx?Number='+num+'&key=<%=ViewState["YijianZb"]%>&Buzhou=<%=ViewState["NodeName"]%>';
}
</script>
                                            ...
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    <td align="left" class="newtd2" colspan="4" width="33%" style="height: 22px">
                                                        ...
                                                        <strong>当前办理人：</strong><%=Session["realname"] %>&nbsp;&nbsp;&nbsp;<strong>紧急程度：</strong><asp:Label
