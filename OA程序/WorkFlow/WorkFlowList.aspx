<%@ Page Language="C#" AutoEventWireup="true" Codebehind="WorkFlowList.aspx.cs" Inherits="xyoa.WorkFlow.WorkFlowList" %>
                                                    ...
                                                    <tr>
                                                        <td style="height: 26px; ">
                                                           <button class="btn4off" type="button" onclick="javascript:window.location='WorkFlowListAll.aspx';showwait();">
                                                            ...
                                                            <button class="btn4on" type="button" onclick="javascript:window.location='WorkFlowList.aspx';showwait();">
