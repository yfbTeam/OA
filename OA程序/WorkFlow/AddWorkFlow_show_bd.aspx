<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWorkFlow_show_bd.aspx.cs" Inherits="xyoa.WorkFlow.AddWorkFlow_show_bd" %>
<html>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <table align="center" border="0" cellpadding="4" cellspacing="1" width="100%" class="nextpage">
                                                <tr>
                                                    <td  class="newtd2">
                                                    <asp:Label ID="FormContent" runat="server" Width="100%"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr id="printshow3">
